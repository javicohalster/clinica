...
$inserta_reg="insert into dns_certificadogenerado (certif_id,especi_id,clie_ci,med_ci,certifg_texto,usua_id,certifg_fecharegistro,nd_otorgado) values ('".$certif_id."','".$especi_id."','".$clie_ci."','".$med_ci."','".$certifg_texto."','".$usua_id."','".$certifg_fecharegistro."','".$nd_otorgado."');";
