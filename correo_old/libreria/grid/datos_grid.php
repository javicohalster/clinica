	...
	function leer_data($tabla,$filtro,$campofiltro,$tipocampof,$desplegar,$sqlbuscar,$DB_gogess)
	{
	 ...
	 // echo $desplegar;
	   if($this->campos_visualizar)
	   {
	    ...
	    $listacampos="select * from sibase_sisfield where fie_activelista=1 and tab_name ='".$tabla."' and fie_name in(".$this->campos_visualizar.") order by fie_ordengrid asc";
	   }
	   else
	   {
	    $listacampos="select * from sibase_sisfield where fie_activelista=1 and tab_name ='".$tabla."' order by fie_ordengrid asc";
	   }
