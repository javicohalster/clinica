...
function verificar_cambio($idusuario,$tiempocambio,$DB_gogess)
{
   ...
   $banderacambio=0;
   //fecha cambio clave   
   $buscausuario="select * from factur_usuarios where usua_id=".$idusuario;
 ...
 $buscacambio="select * from factur_controlclv where usua_id=".$idusuario." order by clvc_id desc limit 1";
