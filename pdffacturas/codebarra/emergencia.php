...
$claveaccesos='2503201501179097634300120010010000026427634300115';
$nombrearchivo='1790976343001201503251057123018DE147645259';
  include('Barcode.php');
  // -------------------------------------------------- //
  //                  PROPERTIES
  // -------------------------------------------------- //
  ...
  $code     = $claveaccesos; // barcode, of course ;)
  $type     = 'code128';
  ...
  imagefilledrectangle($im, 0, 0, 300, 60, $white);
 ...
 // imageline($im, 0, $y, 250, $y, $red);
  ...
  imagegif($im,"../../codigodebarra/".$nombrearchivo.'.gif');
  imagedestroy($im);  
?>