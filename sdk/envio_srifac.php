...
$lista_fac="select * from ".$tipocmp_tabla." where ".$tipocmp_campofirmado."='SI' and (".$tipocmp_estadosri."='' or ".$tipocmp_estadosri." not in('RECIBIDA','AUTORIZADO','NO AUTORIZADO')) and doccab_anulado=0 and doccab_id='".$doccab_id."' limit 1 ";
