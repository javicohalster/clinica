...
//firma
function firma_documentos($tipocmp_tabla,$tipocmp_campofirmado,$tipocmp_sinfirma,$tipocmp_campoxmlfirmado,$tipocmp_campoid,$valcentro,$tipocmp_anulado,$compretcab_id,$DB_gogess)
{
//===============================================================================


$lista_fac="select * from ".$tipocmp_tabla." where ".$tipocmp_campofirmado."=''  and ".$tipocmp_anulado."!='1' and compretcab_id='".$compretcab_id."' limit 1 ";
...
if($resultlist_fac)
		{
			while (!$resultlist_fac->EOF) {			
			  ...
			  $cert_ip=$result_cert->fields["cert_ip"];
			 ...
			 // echo $result_cert->fields["cert_nombre"];
			  ...
			  echo @$resultlist_fac->fields["compretcab_nretencion"]."<br>";
              ...
              $cliente = new nusoap_client('http://'.$cert_ip.'/doc_signalospinos/server.php?wsdl');
              $resultado = $cliente->call('SignDoc', array('Documento' =>$doc));	
			  ...
			  if($resultado["motivo"])
			   ...
			   { 
				if($resultado["resultado"]!='')
				 {
				  echo $actualiza="update ".$tipocmp_tabla." set ".$tipocmp_campoxmlfirmado." ='".$resultado["resultado"]."',".$tipocmp_campofirmado." ='SI' where  ".$tipocmp_campoid."='".$resultlist_fac->fields[$tipocmp_campoid]."'";
...
if($resultlist_ldocumentos)
		{
			while (!$resultlist_ldocumentos->EOF) {	
			    ...
			    firma_documentos($tipocmp_tabla,$tipocmp_campofirmado,$tipocmp_sinfirma,$tipocmp_campoxmlfirmado,$tipocmp_campoid,$valcentro,$tipocmp_anulado,$compretcab_id,$DB_gogess);
