...
//firma
function firma_documentos($tipocmp_tabla,$tipocmp_campofirmado,$tipocmp_sinfirma,$tipocmp_campoxmlfirmado,$tipocmp_campoid,$valcentro,$tipocmp_anulado,$doccab_id,$DB_gogess)
{
//===============================================================================

$lista_fac="select * from ".$tipocmp_tabla." where ".$tipocmp_campofirmado."=''  and ".$tipocmp_anulado."!='1'  and doccab_id='".$doccab_id."' limit 1 ";
				...
				if($resultado["resultado"]!='')
				 {
				  $actualiza="update ".$tipocmp_tabla." set ".$tipocmp_campoxmlfirmado." ='".$resultado["resultado"]."',".$tipocmp_campofirmado." ='SI' where  ".$tipocmp_campoid."='".$resultlist_fac->fields[$tipocmp_campoid]."'";
				   ...
				   echo "<br>".@$resultlist_fac->fields["doccab_ndocumento"]." Firmado con Exito...";			     
				 }				   
			   }	  
...
if($resultlist_ldocumentos)
		{
			while (!$resultlist_ldocumentos->EOF) {	
			    ...
			    firma_documentos($tipocmp_tabla,$tipocmp_campofirmado,$tipocmp_sinfirma,$tipocmp_campoxmlfirmado,$tipocmp_campoid,$valcentro,$tipocmp_anulado,$doccab_id,$DB_gogess);
