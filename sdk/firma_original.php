...
//firma
function firma_documentos($tipocmp_tabla,$tipocmp_campofirmado,$tipocmp_sinfirma,$tipocmp_campoxmlfirmado,$tipocmp_campoid,$valcentro,$DB_gogess)
{
//===============================================================================
...
$lista_fac="select * from ".$tipocmp_tabla." where ".$tipocmp_campofirmado."=''  and doccab_anulado=0 and doccab_ndocumento like '".$valcentro."%' limit 20";
echo $lista_fac."<br>";
...
if($resultlist_ldocumentos)
		{
			while (!$resultlist_ldocumentos->EOF) {	
			    ...
			    firma_documentos($tipocmp_tabla,$tipocmp_campofirmado,$tipocmp_sinfirma,$tipocmp_campoxmlfirmado,$tipocmp_campoid,$valcentro,$DB_gogess);
