...
function imprimir_datos()
{
   ...
   myWindow3=window.open('aplicativos/documental/datos_substandarform_print.php?iddata=<?php echo @$rs_dtabla->fields["tab_id"]; ?>&pVar2='+$('#<?php echo @$rs_dtabla->fields["tab_campoprimario"] ?>').val(),'ventana_imp','width=850,height=700,scrollbars=YES');
...
?>
 ...
 <div id="tabs">
  ...
  <ul>
    ...
    <li><a href="#tabs-2">Evaluaci&oacute;n</a></li>
