...
$valor_enlace='';
$tabla_gridvalor="faesa_griddedsarrolloinfantil";
$campo_id='desainfantil_id';
$campo_enlace='terfisic_enlace';
$campo_fecharegistro='desainfantil_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('escdesainfantil_nombre','desainfantil_percentil','desainfantil_edad','desainfantil_interpretacion','desainfantil_fecharegistro');
$campos_name=array('&Aacute;rea','Puntaje - Percentil','Edad Equivalente','Interpretaci&oacute;n Cualitativa','Fecha registro');

$tabla_combo1="faesa_areadesarolloinfantil";
$tabla_enlacecombo1="escdesainfantil_id";
