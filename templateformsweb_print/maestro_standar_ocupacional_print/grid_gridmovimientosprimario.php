...
$valor_enlace='';
$tabla_gridvalor="faesa_gridmovimientosprimario";
$campo_id='movipri_id';
$campo_enlace='ocupacio_enlace';
$campo_fecharegistro='movipri_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('alcanc_nombre','movipri_derecho','movipri_izquierdo');
$campos_name=array('Alcance','Derecho','Izquierdo');

$tabla_combo1="faesa_alcances";
$tabla_enlacecombo1="alcanc_id";
