...
$valor_enlace='';
$tabla_gridvalor="faesa_gridfuncionmanual";
$campo_id='funciman_id';
$campo_enlace='ocupacio_enlace';
$campo_fecharegistro='funciman_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('arafunman_nombre','funciman_derecho','funciman_izquierdo');
$campos_name=array('Area','Derecho','Izquierdo');

$tabla_combo1="faesa_areafuncionmanual";
$tabla_enlacecombo1="arafunman_id";
