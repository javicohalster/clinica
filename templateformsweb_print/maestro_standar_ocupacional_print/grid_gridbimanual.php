...
$valor_enlace='';
$tabla_gridvalor="faesa_gridbimanual";
$campo_id='biman_id';
$campo_enlace='ocupacio_enlace';
$campo_fecharegistro='biman_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('arabima_nombre','biman_resultado');
$campos_name=array('Area','Resultado');

$tabla_combo1="faesa_areabimanual";
$tabla_enlacecombo1="arabima_id";
