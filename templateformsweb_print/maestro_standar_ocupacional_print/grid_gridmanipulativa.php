...
$valor_enlace='';
$tabla_gridvalor="faesa_gridmanipulativa";
$campo_id='manipu_id';
$campo_enlace='ocupacio_enlace';
$campo_fecharegistro='manipu_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('areamanipu_nombre','manipu_resultado');
$campos_name=array('Area','Resultado');

$tabla_combo1="faesa_areamanipulativa";
$tabla_enlacecombo1="areamanipu_id";
