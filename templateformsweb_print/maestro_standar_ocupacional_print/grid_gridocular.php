...
$valor_enlace='';
$tabla_gridvalor="faesa_gridocular";
$campo_id='ocular_id';
$campo_enlace='ocupacio_enlace';
$campo_fecharegistro='ocular_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('areaocular_nombre','ocular_resultado');
$campos_name=array('Area','Resultado');

$tabla_combo1="faesa_areaocular";
$tabla_enlacecombo1="areaocular_id";
