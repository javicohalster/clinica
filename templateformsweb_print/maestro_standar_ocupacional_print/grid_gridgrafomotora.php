...
$valor_enlace='';
$tabla_gridvalor="faesa_gridgrafomotora";
$campo_id='grafom_id';
$campo_enlace='ocupacio_enlace';
$campo_fecharegistro='grafom_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('areagrafom_nombre','grafom_resultado');
$campos_name=array('Area','Resultado');

$tabla_combo1="faesa_areagrafomotora";
$tabla_enlacecombo1="areagrafom_id";
