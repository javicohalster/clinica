...
$valor_enlace='';
$tabla_gridvalor="faesa_gridprotocoloalimen";
$campo_id='protoalimen_id';
$campo_enlace='lenguaj_enlace';
$campo_fecharegistro='protoalimen_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('escprotoalimen_nombre','protoalimen_descripcion','protoalimen_resultado');
$campos_name=array('Marcador','Descripci&oacute;n','Resultado');

$tabla_combo1="faesa_areaprotoalimen";
$tabla_enlacecombo1="escprotoalimen_id";
...
if($rs_data)
 {
  ...
  <tr>
	...
	for($i=0;$i<count($campos_data);$i++)
	 {
		 if($campos_data[$i]=='escprotoalimen_nombre')
		 {
