...
$valor_enlace='';
$tabla_gridvalor="faesa_griddesainfantil";
$campo_id='desainfa_id';
$campo_enlace='lenguaj_enlace';
$campo_fecharegistro='desainfa_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('escdesainfa_nombre','desainfa_percentil','desainfa_edad','desainfa_interpretacion');
$campos_name=array('&Aacute;rea y Dominios','Puntaje - Percentil','Edad Equivalente','Interpretaci&oacute;n Cualitativa');

$tabla_combo1="faesa_areadesainfantil";
$tabla_enlacecombo1="escdesainfa_id";
...
if($rs_data)
 {
  ...
  <tr>
	...
	for($i=0;$i<count($campos_data);$i++)
	 {
		if($campos_data[$i]=='escdesainfa_nombre')
		{
		 echo '<td>'.utf8_encode(str_replace(".",".<br>",$rs_data->fields[$campos_data[$i]])).'</td>';
		 }
		 else
		 {
