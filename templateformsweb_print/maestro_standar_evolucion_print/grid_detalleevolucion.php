...
$valor_enlace='';
$tabla_gridvalor="faesa_evoluciondetalle";
$campo_id='evoludet_id';
$campo_enlace='evolu_enlace';
$campo_fecharegistro='evoludet_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('evoludet_fecha','evoludet_hora','evoludet_notas','evoludet_farmaindica','evoludet_farmaotros');
$campos_name=array('Fecha','Hora','Notas de Evoluci&oacute;n','Farmacoterapia e indicaciones','Farmacos y otros');
