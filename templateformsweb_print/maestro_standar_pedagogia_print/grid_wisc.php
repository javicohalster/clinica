...
$valor_enlace='';
$tabla_gridvalor="faesa_pedgridwisc";
$campo_id='wisc_id';
$campo_enlace='pedago_enlace';
$campo_fecharegistro='wisc_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('escwisc_nombre','wisc_marcador','wisc_observacion');
$campos_name=array('Sub Escalas','Puntaje-percentiles','Interpretaci&oacute;n');

$tabla_combo1="faesa_escalaswisc";
$tabla_enlacecombo1="escwisc_id";
...
if($rs_data)
 {
  ...
  <tr>
	...
	for($i=0;$i<count($campos_data);$i++)
	 {
		 if($campos_data[$i]=='escwisc_nombre')
		 {
