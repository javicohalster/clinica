...
$valor_enlace='';
$tabla_gridvalor="faesa_pedgridvelocidadpor";
$campo_id='velopor_id';
$campo_enlace='pedago_enlace';
$campo_fecharegistro='velopor_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('escvelopor_nombre','velopor_subescala','velopor_percentil','velopor_apreciacion');
$campos_name=array('Escala','Sub Escala','Percentil','Apreciaci&oacute;n');

$tabla_combo1="faesa_escalavelopor";
$tabla_enlacecombo1="escvelopor_id";
