...
$valor_enlace='';
$tabla_gridvalor="faesa_pedagogiaaprendizaje";
$campo_id='pedaprendiz_id';
$campo_enlace='pedago_enlace';
$campo_fecharegistro='pedaprendiz_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('tipoa_nombre','pedaprendiz_porcentaje','pedaprendiz_apreciacion');
$campos_name=array('Tipo','Porcentaje','Apreciaci&oacute;n');

$tabla_combo1="faesa_tipoarea2";
$tabla_enlacecombo1="tipoa_id";
