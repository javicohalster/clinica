...
$valor_enlace='';
$tabla_gridvalor="faesa_pedagogiacompetencias";
$campo_id='pedcompete_id';
$campo_enlace='pedago_enlace';
$campo_fecharegistro='pedcompete_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('tipcompe_nombre','pedcompete_observaciones','pedcompete_dificultades');
$campos_name=array('Tipo','Observaciones','Dificultades Espec&iacute;ficas');

$tabla_combo1="faesa_tipocompetencia";
$tabla_enlacecombo1="tipcompe_id";
