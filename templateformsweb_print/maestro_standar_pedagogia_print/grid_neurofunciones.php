...
$valor_enlace='';
$tabla_gridvalor="faesa_pedagogianeurofunciones";
$campo_id='pedneuro_id';
$campo_enlace='pedago_enlace';
$campo_fecharegistro='pedneuro_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('areev_nombre','pedneuro_marcador','pedneuro_observaciones');
$campos_name=array('&Aacute;rea','Marcador','Observaciones');

$tabla_combo1="faesa_areaev";
$tabla_enlacecombo1="areev_id";
...
if($rs_data)
 {
	  while (!$rs_data->EOF) {	
	    $cuenta++;
         ...
         if($rs_data->fields["pedneuro_marcador"])
         {
  ?>
  <tr>
	<?php
