...
$valor_enlace='';
$tabla_gridvalor="faesa_pedgridwppsi1";
$campo_id='wppsi1_id';
$campo_enlace='pedago_enlace';
$campo_fecharegistro='wppsi1_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('escwppsi1_nombre','wppsi1_marcador','wppsi1_observacion');
$campos_name=array('Sub Escalas','Puntaje-percentiles','Interpretaci&oacute;n');

$tabla_combo1="faesa_escalaswppsi";
$tabla_enlacecombo1="escwppsi1_id";
