...
$valor_enlace='';
$tabla_gridvalor="faesa_pedgridwppsi2";
$campo_id='wppsi2_id';
$campo_enlace='pedago_enlace';
$campo_fecharegistro='wppsi2_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('escwppsi2_nombre','wppsi2_marcador','wppsi2_observacion');
$campos_name=array('Sub Escalas','Puntaje-percentiles','Interpretaci&oacute;n');

$tabla_combo1="faesa_escalaswppsi2";
$tabla_enlacecombo1="escwppsi2_id";
