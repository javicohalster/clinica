...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="2">
  <tr>
    ...
    <td bgcolor="#D9E9EC" class="css_texto"><?php  $objformulario->generar_formulario_print(@$submit,$table,4,$DB_gogess); ?></td>
    <td bgcolor="#D9E9EC"><span class="css_titulo">C&Oacute;DIGO EVALUACI&Oacute;N:</span></td>
    <td bgcolor="#D9E9EC" class="css_texto"><?php  $objformulario->generar_formulario_print(@$submit,$table,8,$DB_gogess); ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#D9E9EC" class="css_texto"><?php echo @$rs_buscadatos_fecha->fields["asighor_fecha"]; ?></td>
  </tr>
  <tr>
