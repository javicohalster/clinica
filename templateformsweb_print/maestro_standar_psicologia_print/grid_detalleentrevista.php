...
$valor_enlace='';
$tabla_gridvalor="faesa_entrevistacomfamilescolar";
$campo_id='entrvfe_id';
$campo_enlace='psic_enlace';
$campo_fecharegistro='entrvfe_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('trast_nombre','entrvfe_percentil','entrvfe_observacion');
$campos_name=array('Caracteristica','Percentil','Observaciones');

$tabla_combo1="faesa_trastornoentrev";
$tabla_enlacecombo1="trast_id";
