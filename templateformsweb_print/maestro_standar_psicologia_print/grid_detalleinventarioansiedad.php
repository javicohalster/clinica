...
$valor_enlace='';
$tabla_gridvalor="faesa_invetarioansiedad";
$campo_id='invtans_id';
$campo_enlace='psic_enlace';
$campo_fecharegistro='invtans_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('tipans_nombre','invtans_marcador','invtans_observacion');
$campos_name=array('Ansiedad','Marcador','Observaciones');

$tabla_combo1="faesa_tipoansiedad";
$tabla_enlacecombo1="tipans_id";
...
if($rs_data)
 {
  ...
  <tr>
	...
	for($i=0;$i<count($campos_data);$i++)
	 {
		if($campos_data[$i]=='tipans_nombre')
		{
