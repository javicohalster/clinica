...
$valor_enlace='';
$tabla_gridvalor="faesa_gridescalamemoria";
$campo_id='escameno_id';
$campo_enlace='psic_enlace';
$campo_fecharegistro='escameno_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('escescameno_nombre','escameno_subescala','escameno_percentil','escameno_apreciacion');
$campos_name=array('Escala','Sub Escala','Percentil','Apreciaci&oacute;n');

$tabla_combo1="faesa_escalamemo";
$tabla_enlacecombo1="escescameno_id";
