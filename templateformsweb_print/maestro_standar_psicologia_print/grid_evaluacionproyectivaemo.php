...
$valor_enlace='';
$tabla_gridvalor="faesa_evaluacionproyectivaemo";
$campo_id='evaproyemo_id';
$campo_enlace='psic_enlace';
$campo_fecharegistro='evaproyemo_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('facto_nombre','evaproyemo_descripcion');
$campos_name=array('Factores','Descripci&oacute;n');
