...
$valor_enlace='';
$tabla_gridvalor="faesa_diagnosticodifirencial";
$campo_id='diagn_id';
$campo_enlace='psic_enlace';
$campo_fecharegistro='diagn_fecharegistro';
$campo_usuarioregistra='usua_id';
$campos_data=array('diagn_criteriodiagnostico','marcps_nombre','diagn_observacion');
$campos_name=array('Criterio Diagnostico','Marcador','Observaciones');

$tabla_combo1="faesa_marcadorps";
$tabla_enlacecombo1="marcps_id";
