...
if($objformulario->contenid[$campo_enlace])
{
$nlace_valor=$objformulario->contenid[$campo_enlace];
}
else
{
$nlace_valor=$objformulario->sendvar[$objformulario->fie_sendvar]; 
}

$clie_id=$objformulario->sendvar["clie_idx"];
...
function tipo_campo($campoodo_id,$odopie_id,$clie_id,$enlace,$DB_gogess)
{
  ...
  if($campoodo_id==1)
  {
	...
	$busca_data="select * from dns_odontograma where clie_id='".$clie_id."' and campoodo_id='".$campoodo_id."' and odopie_id='".$odopie_id."'";
	...
	$campo='<div style="border: 1px solid #000000; width:20px; height:17px;font-family: Verdana, Arial, Helvetica, sans-serif">'.$odonto_valor.'</div>';
  }
  if($campoodo_id==2)
  {
    ...
    $busca_supe="select * from dns_odontograma where clie_id='".$clie_id."' and campoodo_id='".$campoodo_id."' and odopie_id='".$odopie_id."' and odonto_posicion='sup'";
	...
	if($rs_supe)
        {
	       while (!$rs_supe->EOF) {
	            ...
	            $valor_supe.='<img src="../../archivo/'.$grafico_data.'" width="10" height="10" />';
	...
	$busca_inf="select * from dns_odontograma where clie_id='".$clie_id."' and campoodo_id='".$campoodo_id."' and odopie_id='".$odopie_id."' and odonto_posicion='inf'";
	...
	if($rs_inf)
        {
	       while (!$rs_inf->EOF) {
	            ...
	            $valor_inf.='<img src="../../archivo/'.$grafico_data.'" width="10" height="10" />';
	...
	$busca_izq="select * from dns_odontograma where clie_id='".$clie_id."' and campoodo_id='".$campoodo_id."' and odopie_id='".$odopie_id."' and odonto_posicion='izq'";
	...
	if($rs_izq)
        {
	       while (!$rs_izq->EOF) {
	            ...
	            $valor_izq.='<img src="../../archivo/'.$grafico_data.'" width="10" height="10" />';
	...
	$busca_der="select * from dns_odontograma where clie_id='".$clie_id."' and campoodo_id='".$campoodo_id."'  and odopie_id='".$odopie_id."' and odonto_posicion='der'";
	...
	if($rs_der)
        {
	       while (!$rs_der->EOF) {
	            ...
	            $valor_der.='<img src="../../archivo/'.$grafico_data.'" width="10" height="10" />';
...
$busca_centro="select * from dns_odontograma where clie_id='".$clie_id."' and campoodo_id='".$campoodo_id."' and odopie_id='".$odopie_id."' and odonto_posicion='centro'";
	...
	if($rs_centro)
        {
	       while (!$rs_centro->EOF) {
	            ...
	            $valor_centro.='<img src="../../archivo/'.$grafico_data.'" width="10" height="10" />';
    ...
    $busca_grupo="select * from dns_odontograma where clie_id='".$clie_id."' and campoodo_id='".$campoodo_id."' and odopie_id='".$odopie_id."' and odonto_posicion='grupo'";
	...
	if($rs_grupo)
        {
	       while (!$rs_grupo->EOF) {
	            ...
	            $valor_grupo.='<img src="../../archivo/'.$grafico_data.'" width="30" height="10" />';
...
<table width="60" height="60" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td height="5" colspan="4" ><center>'.$valor_supe.'
	&nbsp;</center></td>
  </tr>
  <tr>
    <td  ><center>'.$valor_izq.'&nbsp;</center></td>
    <td colspan="2"  ><center>'.$valor_centro.'&nbsp;</center></td>
    <td  ><center>'.$valor_der.'&nbsp;</center></td>
  </tr>
  
  <tr>
    <td height="5" colspan="4"  ><center>'.$valor_inf.'&nbsp;</center></td>
  </tr>
</table>

<table width="60" height="5" border="1" cellpadding="0" cellspacing="0">
  <tr>
...
{
        $retona_data='';
        $lista_d="select * from dns_odopiezadental where ogrp_id=".$ogrp_id." and tipofodo_id=".$tipofodo_id." and oubica_id=".$oubica_id." and campoodo_id=".$campoodo_id." order by tipofodo_codigo ".$orden;
        ...
        if($rs_datad)
        {
		   ...
		   $retona_data.='<td align="center" >'.$campo_tipo.''.$rs_datad->fields["tipofodo_codigo"].'</td>';
...
$lista_ar[$cuenta_ar]='<table width="100" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td  style="cursor:pointer"  ><img src="../../archivo/'.$rs_listasimb->fields["odosimb_grafico"].'" width="20" height="20" />
