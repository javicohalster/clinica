...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:8px; font-weight:bold" >RECESI&Oacute;N</td>
		<?php
		$despliega='';
      ...
      <tr>
        <td style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:8px; font-weight:bold" >MOVILIDAD</td>
        <?php
		$despliega='';
      ...
      <tr>
        <td style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:8px; font-weight:bold" >VESTIBULAR</td>
        <?php
		$despliega='';
	...
	<table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:8px; font-weight:bold" >LINGUAL</td>
		<?php
		$despliega='';
