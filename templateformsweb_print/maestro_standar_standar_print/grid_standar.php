...
{
$lista_servicios="select * from ".$sub_tabla." where ".$campo_enlace."='".$_POST['enlace']."' order by ".$campo_fecharegistro." asc";
				...
				case 'check':
					{
					 if($rs_data->fields[$fie_camposgridselect[$i]]==1)
						 {
							 echo '<td style="font-size:10px;" ><img src="visto_dns.png"  width="20" height="18" /></td>';
							}
							else
							{
							 echo '<td></td>';
