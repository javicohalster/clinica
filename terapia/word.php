...
if ($rs_diagnost)
			   {
			      while (!$rs_diagnost->EOF) {
					...
					$sql_buscount[$num_id]="select count(*) as total from ".$tabla_maestra." inner join ".$rs_diagnost->fields["tab_name"]." on ".$tabla_maestra.".".$id_atencion."=".$rs_diagnost->fields["tab_name"].".".$id_atencion." inner join ".$rs_diagnost->fields["fie_tablasubgrid"]." on ".$rs_diagnost->fields["tab_name"].".".$rs_diagnost->fields["fie_campoenlacesub"]."=".$rs_diagnost->fields["fie_tablasubgrid"].".".$rs_diagnost->fields["fie_campoenlacesub"]." where (".$rs_diagnost->fields["fie_campofecharegistro"].">='".$_POST["fechai"]."' and ".$rs_diagnost->fields["fie_campofecharegistro"]."<='".$_POST["fechaf"]."') and clie_ci='".$_POST["c1"]."'";
					...
					$sql_buscadiag[$num_id]="select * from ".$tabla_maestra." inner join ".$rs_diagnost->fields["tab_name"]." on ".$tabla_maestra.".".$id_atencion."=".$rs_diagnost->fields["tab_name"].".".$id_atencion." inner join ".$rs_diagnost->fields["fie_tablasubgrid"]." on ".$rs_diagnost->fields["tab_name"].".".$rs_diagnost->fields["fie_campoenlacesub"]."=".$rs_diagnost->fields["fie_tablasubgrid"].".".$rs_diagnost->fields["fie_campoenlacesub"]." where (".$rs_diagnost->fields["fie_campofecharegistro"].">='".$_POST["fechai"]."' and ".$rs_diagnost->fields["fie_campofecharegistro"]."<='".$_POST["fechaf"]."') and clie_ci='".$_POST["c1"]."'";
