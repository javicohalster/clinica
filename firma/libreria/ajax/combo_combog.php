...
else
{
	...
	printf("<option value=''>---Seleccionar--</option>");  
	$objformulario->fill_cmb($objformulario->fie_tabledb,$objformulario->fie_datadb,$valor," where ".$objformulario->fie_camporecibe." like '".$datobusca."' ".$objformulario->fie_sqlorder,$DB_gogess);
