...
////////////////////////////////////////////////////////////
  ...
  $sql = "SELECT con_id,con_titulo,secp_id FROM sibase_contenido WHERE secp_id  = '$tema' and con_activo=1 order by con_orden asc";
	...
	//////////////////////////////----
			...
			////////////..........................
					...
					//seccion alterna link
					 $sql_tx = "SELECT secalt_id FROM sibase_contenido WHERE con_id = ".$row["con_id"];
