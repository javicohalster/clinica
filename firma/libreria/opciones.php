				  ...
				  //boton guardar
				   ...
				   if (!($permiso)){
					 ...
					 <table border="0" cellpadding="0" cellspacing="0">
					  <tr>
						<td class="mano" onClick="nuevo_'.$table.'()" ><img src="'.$grafico.'"></td>
					  </tr>
					</table>					 
					 ';
			...
			case 'guardar':
			   {
				  //boton guardar
				   ...
				   if (!($permiso)){
					 $codigo_script='<input type="image" name="boton_nuevo_'.$table.'" src="'.$grafico.'" />';
					}
				}  
				break;
			...
			case 'borrar':
				{
				   ...
				   if (!($permiso)){
					 ...
					 <table border="0" cellpadding="0" cellspacing="0">
					  <tr>
						<td class="mano" onClick="borrar_'.$table.'()" ><img src="'.$grafico.'"></td>
					  </tr>
					</table>					 
					 ';
					}			   
			...
			case 'buscar':
				{
				   ...
				   if (!($permiso)){
					 ...
					 <table border="0" cellpadding="0" cellspacing="0">
					  <tr>
						<td class="mano" onClick="buscar_'.$table.'()" ><img src="'.$grafico.'"></td>
					  </tr>
					</table>					 
					 ';
					}			   
			...
			case 'imprimir':
				{
				   ...
				   if (!($permiso)){
					 ...
					 <table border="0" cellpadding="0" cellspacing="0">
					  <tr>
						<td class="mano" onClick="imp_documento_'.$table.'()" ><img src="'.$grafico.'"></td>
					  </tr>
					</table>					 
					 ';
					}			   
