       ...
       if (!($this->contenid[$nombre_campo]==""))
           {						
			...
			if(!($this->pdfformato))
			{
			 ...
			 <div class="cuadrot"><div id="despliegue_'.$nombre_campo.'">'.$rmp.'</div></div>';
			 }
			...
			echo '<tr>
			 ...
			 <td valign="top"  >
			 <input name="'.$nombre_campo.'"  id="'.$nombre_campo.'"  type="hidden"   value="'.$this->contenid[$nombre_campo].'">
			 <div class="cuadrot"><div id="despliegue_'.$nombre_campo.'">'.$this->contenid[$nombre_campo].'</div></div>
			 </td>
			 <td valign="top" class="'.$this->fie_style.'" >'.$this->fie_txtextra.'</td>	
			 </tr>';
			}
        ...
        else
          {
				  ...
				  if(!($this->pdfformato))
			{
			 ...
			 <td valign="top" >
			 <input name="'.$nombre_campo.'"  id="'.$nombre_campo.'"  type="hidden" value="'.$this->sendvar["$this->fie_sendvar"].'">
			 <div class="cuadrot"><div id="despliegue_'.$nombre_campo.'">'.$this->sendvar["$this->fie_sendvar"].'</div></div>
			 </td>
			 <td valign="top" class="'.$this->fie_style.'" >'.$this->fie_txtextra.'</td>	
			 </tr>';
			}	  
			  ...
			  if(!($this->pdfformato))
			{
			 ...
			 <div class="cuadrot"><div id="despliegue_'.$nombre_campo.'">'.$this->fie_value.'</div></div>
			 </td>
			 <td valign="top" class="'.$this->fie_style.'" >'.$this->fie_txtextra.'</td>	
			 </tr>';
			  }
