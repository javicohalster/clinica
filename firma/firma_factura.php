...
$cedulafirma=$_POST["cedula_firma"];
$emp_id_valor=$_POST["emp_id"];
...
//------------------------------
$buscafacsinxml="select * from beko_documentocabecera where not(doccab_firmado='SI') and not(doccab_estadosri='AUTORIZADO') and emp_id='".$emp_id_valor."' and doccab_id='".$doccab_id."'";
  $rs_lista = $DB_gogess->Execute($buscafacsinxml);
				...
				{   
				   ...
				   firmando($datosfirma,$emp_id_valor,'01',$rs_lista->fields["doccab_id"],$DB_gogess);
