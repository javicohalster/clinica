				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						...
						<div class="slider-caption-one">
							...
							<h3 data-animate="fadeInUp" data-delay="0.5s" data-duration="0.5">Registrate a la red de servicios</h3>
							
							
							<?php
							$linksvar="";
							$linksvarencri="";
							$linksvar="apl=16&secc=7&tipo=1";	
					        $linksvarencri=$objmenuweb->variables_segura($linksvar);
					        
							?>
							
							<a href="index.php?snp=<?php echo $linksvarencri; ?>" class="gp-bn-btn" data-animate="fadeInUp" data-delay="0.8s" data-duration="0.5">Registro Clientes</a>
							
							<?php
							$linksvar="";
							$linksvarencri="";
							$linksvar="apl=16&secc=7&tipo=2";	
					        $linksvarencri=$objmenuweb->variables_segura($linksvar);
					        
							?>
							
							<a href="index.php?snp=<?php echo $linksvarencri; ?>" class="gp-bn-btn" data-animate="fadeInUp" data-delay="0.8s" data-duration="0.5">Registro Expertos</a>
						</div>
					</div>
		...
		<section id="about">
			<div class="container">
				...
				<p class="caption wow fadeInUp" data-wow-delay="0.1s">
					<?php  echo utf8_encode($objportal->sys_texto1); ?>
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6">
							<div class="about-box wow fadeInUp" data-wow-delay="0.4s">
								...
								<?php  echo utf8_encode($objportal->sys_texto2); ?>
