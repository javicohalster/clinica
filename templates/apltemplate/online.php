...
mysql_connect($server, $db_user, $db_pass) or die ("kyradm_online Database CONNECT Error");                                                                   
mysql_db_query($database, "INSERT INTO kyradm_online VALUES ('$timestamp','$REMOTE_ADDR','$PHP_SELF')") or die("kyradm_online Database INSERT Error"); 
mysql_db_query($database, "DELETE FROM kyradm_online WHERE timestamp<$timeout") or die("kyradm_online Database DELETE Error");
$result=mysql_db_query($database, "SELECT DISTINCT ip FROM kyradm_online WHERE file='$PHP_SELF'") or die("kyradm_online Database SELECT Error");
