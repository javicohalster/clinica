...
$contenido = file_get_contents(@$director."jason_files/estructura/beko_mhdetallefactura.json");
...
if($script_busca)
{
  ...
  $busca_fpagox="select * from lpin_formapagoventa where doccab_id='".$rscampos_valor->fields["doccab_id"]."'";
...
$lista_eati="select distinct usua_nombre,usua_apellido from beko_mhdetallefactura inner join app_usuario on app_usuario.usua_id=beko_mhdetallefactura.usuaat_id where doccab_id='".$rscampos_valor->fields["doccab_id"]."'";
...
$lista_espe="select distinct prof_nombre from beko_mhdetallefactura inner join pichinchahumana_extension.dns_profesion profe on beko_mhdetallefactura.prof_id=profe.prof_id inner join dns_especialidad on dns_especialidad.especi_id=profe.especienc_id where doccab_id='".$rscampos_valor->fields["doccab_id"]."'";
