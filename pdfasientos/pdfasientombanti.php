...
$lista_data="select * from  app_anticipos where anti_id='".$xml."'";
...
$lista_data="select * from  lpin_comprobantecontable where comcont_tabla='app_anticipos' and comcont_idtabla='".$xml."'";
$registros_data = $DB_gogess->executec($lista_data,array());
