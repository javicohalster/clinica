...
$lista_data="select * from  lpin_comprobantecontable where comcont_tabla='lpin_lqtarjetacredito' and comcont_idtabla='".$xml."'";
$registros_data = $DB_gogess->executec($lista_data,array());
