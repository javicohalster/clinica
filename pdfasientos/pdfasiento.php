...
$lista_data="select * from  beko_documentocabecera where doccab_id='".$xml."'";
...
$lista_data="select * from  lpin_comprobantecontable where comcont_tabla='beko_documentocabecera' and comcont_idtabla='".$xml."'";
$registros_data = $DB_gogess->executec($lista_data,array());
...
$lista_data="select * from  lpin_comprobantecontable where comcont_tablas='beko_documentocabecera' and comcont_idtablas='".$xml."'";
$registros_data = $DB_gogess->executec($lista_data,array());
...
$lista_datanc="select * from  beko_documentocabecera where doccab_id='".$xml."'";
$registros_datanc = $DB_gogess->executec($lista_datanc,array());


if($registros_datanc->fields["tipocmp_codigo"]=='01')
{
//busca nota de credito//////////////////////////////////////////////////////////////////////////////////////

$busca_nc="select * from beko_documentocabecera nc where nc.tipocmp_codigo='04' and nc.doccab_ndocuafecta='".$registros_datanc->fields["doccab_ndocumento"]."'";
...
$xml=$busca_asientosnc->fields["doccab_id"];

$lista_data="select * from  lpin_comprobantecontable where comcont_anulado=0 and comcont_tabla='beko_documentocabecera' and comcont_idtabla='".$xml."'";
$registros_data = $DB_gogess->executec($lista_data,array());
...
//busca cruces
$busca_crixe="select * from lpin_crucedocumentos join pichinchahumana_extension.lpin_crucedetalle on lpin_crucedocumentos.crudoc_enlace = pichinchahumana_extension.lpin_crucedetalle.crudoc_enlace where crudet_documentoventa ='".$xml."'";
$registros_crixe = $DB_gogess->executec($busca_crixe,array());


$lista_data="select * from  lpin_comprobantecontable where comcont_tabla='lpin_crucedocumentos' and comcont_idtabla='".$registros_crixe->fields["crudoc_id"]."'";
$registros_data = $DB_gogess->executec($lista_data,array());
