...
for($i=0;$i<$numero;$i++){
///
	if ($tags[$i]=='xml' or $tags[$i]=='detapre_id')
	{
	///
	     $nombrevarget='';
...
$lista_data="select * from  dns_precuenta where precu_id='".$xml."'";
...
$lista_data="select * from  lpin_comprobantecontable where comcont_tabla='dns_precuenta' and comcont_idtabla='".$xml."' and detapre_id='".$detapre_id."'";
$registros_data = $DB_gogess->executec($lista_data,array());
