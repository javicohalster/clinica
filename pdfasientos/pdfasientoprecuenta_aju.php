...
for($i=0;$i<$numero;$i++){
///
	if ($tags[$i]=='xml' or $tags[$i]=='ajuspr_id')
	{
	///
	     $nombrevarget='';
...
$plantilla='<table width="90%" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>-tomfis_descripcion-</td>
  </tr>
  <tr>
    <td><b>Fecha Registro:</b></td>
    <td>-tomfis_fecharegistro-</td>
  </tr>
</table>
';
...
$lista_data="select * from  lpin_comprobantecontable where comcont_tablas='lpin_ajusteproducto' and comcont_idtablas='".$ajuspr_id."'";
$registros_data = $DB_gogess->executec($lista_data,array());
