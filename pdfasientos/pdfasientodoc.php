...
$busca_asiento="select * from lpin_comprobantecontable inner join lpin_detallecomprobantecontable on lpin_comprobantecontable.comcont_enlace=lpin_detallecomprobantecontable.comcont_enlace where crudet_id='".$xml."'";
...
$lista_data="select * from  lpin_comprobantecontable where comcont_tabla='lpin_crucedocumentos' and comcont_idtabla='".$comcont_idtabla."' and crudet_id='".$xml."'";
$registros_data = $DB_gogess->executec($lista_data,array());
