...

{
   ...
   $("#list_evaluacion").load("templateformsweb/maestro_standar_multiplefacturas/lista_evaluacion.php",{
...
$("#list_terapia").load("templateformsweb/maestro_standar_multiplefacturas/lista_terapia.php",{
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_multiplefacturas/agregar_insumo.php",{
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_multiplefacturas/agregar_evaluacion.php",{
...
$("#factura_terapia").load("templateformsweb/maestro_standar_multiplefacturas/facturar_terapias.php",{
