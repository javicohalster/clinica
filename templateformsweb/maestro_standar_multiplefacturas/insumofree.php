...
$("#list_tarifa").load("templateformsweb/maestro_standar_multiplefacturas/lista_tarifa.php",{
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_multiplefacturas/agregar_insumonuevo.php",{
