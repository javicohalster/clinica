...
<table >
             ...
             <tr>
			  ...
			  ?>
			   <td bgcolor="#FFFFFF" class="css_bordes" style="cursor:pointer" onclick="abrir_pantalla('templateformsweb/maestro_standar_multiplefacturas/detalle_form.php','editar','divBody_fac','divDialog_extra',700,500,$('#efacfaccab_id').val(),'<?php echo $rs_campos->fields["facturadet_id"] ?>',0,0,0,0,0)" ><img src="templateformsweb/maestro_standar_multiplefacturas/editarf.png" width="25" height="25" /></td>
			   <td bgcolor="#FFFFFF" class="css_bordes" style="cursor:pointer" onclick="borrar_item('<?php echo $rs_campos->fields["facturadet_id"] ?>')" ><img src="templateformsweb/maestro_standar_multiplefacturas/borrarf.png" width="25" height="25" /></td>
			   <?php
