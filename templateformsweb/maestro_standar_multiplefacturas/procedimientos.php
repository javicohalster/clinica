...
$("#list_insumo").load("templateformsweb/maestro_standar_multiplefacturas/lista_procedimientos.php",{
valor_b:$('#valor_b').val(),
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_multiplefacturas/agregar_procedimiento.php",{
