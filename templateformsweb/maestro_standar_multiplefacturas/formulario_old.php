...
abrir_standar("templateformsweb/maestro_standar_multiplefacturas/procedimientos.php","PROCEDIMIENTOS","divBody_insumo","divDialog_insumo",650,600,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,$('#tippo_id').val(),$('#conve_id').val(),$('#doccab_autorizacion').val());
...
<div class="row">
  ...
  <div class="col-sm-1">
	<div id="insumo_btn" ><div onClick="insumo_ver()" style="cursor:pointer" ><img src="images/coche.png"></div></div>
  </div>  
  ...
  <div id="div_xml" class="col-sm-1">
	<div onClick="ejecuta_proc('2')" style="cursor:pointer" ><img src="images/xml.png"></div>
  </div>
