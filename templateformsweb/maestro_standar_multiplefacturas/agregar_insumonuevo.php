...
$busca_agregado="select * from beko_multipledocumentodetalle where docdet_codprincipal='".$_POST["produ_id"]."' and doccab_id='".$_POST["enlace"]."'";
...
$borra_data="delete from beko_multipledocumentodetalle where docdet_codprincipal='".$_POST["produ_id"]."' and  doccab_id='".$_POST["enlace"]."'";
