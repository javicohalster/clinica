...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
  <tr>
    ...
    <td bgcolor="#D9E9EC"  class="texto_caja" style="font-weight: bold"><div align="center">CODIGO</div></td>
...
<div class="col-md-3">
<?php
$objformulario->generar_formulario(@$submit,$table,17,$DB_gogess); 
?>
</div>
</div>
...
<div class="col-md-12">
<?php
$objformulario->generar_formulario(@$submit,$table,18,$DB_gogess); 
?>
</div>
</div>
<div class="form-group">	
...
$objformulario->generar_formulario(@$submit,$table,20,$DB_gogess); 
?>
</div>
</div>
...
<div class="col-md-12">
<?php
$objformulario->generar_formulario(@$submit,$table,21,$DB_gogess); 
?>
</div>
</div>
...
<!--
$( "#imgag_fechatoma" ).datepicker({dateFormat: 'yy-mm-dd'});
$( "#imgag_fechasolicitud" ).datepicker({dateFormat: 'yy-mm-dd'});
...
<script>
     ...
     $(function() {
            $( "#diagn_ciex" ).autocomplete({
               source: "templateformsweb/maestro_standar_imagenologia/searchcie.php",
               minLength: 1,
 	  ...
 	  $(function() {
            $( "#prod_codigox" ).autocomplete({
               source: "templateformsweb/maestro_standar_imagenologia/searchpro.php",
               minLength: 1,
			   select: function( event, ui ) {
