...
if($b_data!='')
{
$lista_sql="select * from ".$fie_tabledb."  where provee_cedula like '".$b_data."%'";
$lista_sqlcount="select count(*) as total from ".$fie_tabledb."  where provee_cedula like '".$b_data."%'";
}
