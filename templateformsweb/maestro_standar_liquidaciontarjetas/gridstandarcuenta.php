...
abrir_standar('templateformsweb/maestro_standar_liquidaciontarjetas/buscador/busca_data.php','Buscador','divBody_buscadorgeneral','divDialog_buscadorgeneral',500,400,id,0,0,0,0,0,0);
...
function calcula_apagar()
{

var lqtran_depositox;
var lqtran_comisionx;
var lqtran_ivax;
var lqtran_baseretirx;
var lqtran_baseretivax;
var porcecrl_idx;
var porcecil_idx;
var lqtran_apagarx;

lqtran_depositox=$('#lqtran_depositox').val();
lqtran_comisionx=$('#lqtran_comisionx').val();
lqtran_ivax=$('#lqtran_ivax').val();

lqtran_baseretirx=$('#lqtran_baseretirx').val();
lqtran_baseretivax=$('#lqtran_baseretivax').val();

porcecrl_idx=$('#porcecrl_idx').val();
porcecil_idx=$('#porcecil_idx').val();
tpliq_valornodeducible=$('#tpliq_valornodeducible').val();

$("#v_apagar").load("<?php echo $this->formulario_path; ?>calculoapagar.php",{
   
lqtran_depositox:lqtran_depositox,
lqtran_comisionx:lqtran_comisionx,
lqtran_ivax:lqtran_ivax,
lqtran_baseretirx:lqtran_baseretirx,
lqtran_baseretivax:lqtran_baseretivax,
porcecrl_idx:porcecrl_idx,
porcecil_idx:porcecil_idx,
lqtran_apagarx:lqtran_apagarx,
tpliq_valornodeducible:tpliq_valornodeducible,
tpliq_id:$('#tpliq_id').val()
...
$("#v_apagar").html("Espere un momento...");

}

$( "#lqtran_depositox" ).on( "keyup", function() {
    calcula_apagar();
} );

$( "#lqtran_comisionx" ).on( "keyup", function() {
    calcula_apagar();
} );

$( "#lqtran_ivax" ).on( "keyup", function() {
    calcula_apagar();
} );

$( "#lqtran_baseretirx" ).on( "keyup", function() {
    calcula_apagar();
} );

$( "#lqtran_baseretivax" ).on( "keyup", function() {
    calcula_apagar();
} );

$( "#tpliq_valornodeducible" ).on( "keyup", function() {
    calcula_apagar();
} );

$( "#porcecrl_idx" ).change(function() {
   
   calcula_apagar();
   
});

$( "#porcecil_idx" ).change(function() {
