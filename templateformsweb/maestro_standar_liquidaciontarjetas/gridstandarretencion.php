...
function lista_retenciones()
{
	 ...
	 $("#l_detallerete").load("templateformsweb/maestro_standar_liquidaciontarjetas/retenciones/lista_retenciones.php",{
...
function actualiza_retenciones()
{
	 ...
	 $("#acv_retencion").load("templateformsweb/maestro_standar_liquidaciontarjetas/retenciones/actualizar_lista.php",{
        campo_enlace:'<?php echo $valor_enlace; ?>'
	  },function(result){  
