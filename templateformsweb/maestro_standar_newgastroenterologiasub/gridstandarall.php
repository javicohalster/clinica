...
if($rs_lvalcombo)
{
	  ...
	  $camidcl='';
	  if($fie_tablasubgrid=='pichinchahumana_extension.dns_newgastroenterologiaevoluciongridorgano')
      {
	    $camidcl='opcorg_id';
	  }
	  else
	  ...
	  $chequea_valorSP='';
	  $color_fondo='';
	  $busca_estado="select tiporg_nombre from ".$fie_tablasubgrid." where ".$camidcl."='".$rs_lvalcombo->fields[$saca_nombredatavalor[0]]."' and conext_enlace='".$valor_enlace."'";
