...
<script>
		 ...
		 <?php
		if($rs_centro->fields["permif_id"]==1)
		{
		  echo '$( "#imgag_resonacia" ).prop( "disabled", true );';
		  echo '$( "#imgag_tomografia" ).prop( "disabled", true );';
		  echo '$( "#imgag_procedimiento" ).prop( "disabled", true );';
