...
$rs_lcanp = $DB_gogess->executec($lista_campos,array());
 if($rs_lcanp)
 {
	 ...
	 $campo_combollena=explode(",",$rs_fields->fields["gridfield_camposcmb"]);
...
$campos_datainserta=explode(",",$campo_verificax.",".$campo_defa);
...
if($rs_lcombo)
{
	  ...
	  $busca_existe="select ".$campo_verificax." from ".$sub_tabla." where ".$campo_enlace."='".$_POST["enlace"]."' and ".$campo_verificax."='".$post_data[$campo_verificax."x"]."'";
