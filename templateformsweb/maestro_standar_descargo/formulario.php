...
//$linkcambior="onclick=abrir_standar('aplicativos/documental/cambio_fecha.php','CAMBIO','divBody_foto','divDialog_foto',500,300,'enfermeria',$('#enferm_id').val(),0,0,0,0,0) style='cursor:pointer'";
//echo '&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-warning" '.$linkcambior.'  style="cursor:pointer"> CAMBIAR FECHA REGISTRO </button>';

//$linkhistorialr="onclick=abrir_standar('aplicativos/documental/historial_fecha.php','CAMBIO','divBody_foto','divDialog_foto',790,300,'enfermeria',$('#enferm_id').val(),0,0,0,0,0) style='cursor:pointer'";
		 ...
		 $(function() {
            $( "#plantrai_codigox" ).autocomplete({
			   ...
			   select: function( event, ui ) {
				  ...
				  $('#plantrai_bodegax').val(ui.item.bodega_id);	
