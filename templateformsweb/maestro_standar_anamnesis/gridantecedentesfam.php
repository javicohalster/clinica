...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_detalleantecedentesfam.php",{

enlace:enlacep,
idgrid:id_grid,
opcion:opcionp,
enlace:enlacep,
antef_informacionx:$('#antef_informacionx').val(),
antef_descripcionx:$('#antef_descripcionx').val(),
fie_id:'<?php echo $this->fie_id;  ?>'

 },function(result){       

	$('#antef_informacionx').val("");	
	$('#antef_descripcionx').val("");	 
...
<div class="col-md-6">
	 <select class="form-control" name="antef_informacionx" id="antef_informacionx"  >

                <option value="" >--Seleccion Tipo--</option>

<?php
$this->fill_cmb('dns_tipofamiliar','tipfam_nombre,tipfam_nombre','',' order by tipfam_nombre asc',$DB_gogess);
?>
            </select>
...
<div class="col-md-6">
	...
	<textarea placeholder="Descripci&oacute;n" name="antef_descripcionx" id="antef_descripcionx"  class="form-control"  ></textarea>
