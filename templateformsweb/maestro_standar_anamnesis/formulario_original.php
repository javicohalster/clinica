...
<!--
$( "#anam_fup" ).datepicker({dateFormat: 'yy-mm-dd'});
$( "#anam_fuc" ).datepicker({dateFormat: 'yy-mm-dd'});
$( "#anam_fum" ).datepicker({dateFormat: 'yy-mm-dd'});
//  End -->
</script>
<script>
         $(function() {
            $( "#diagn_ciex" ).autocomplete({
               source: "templateformsweb/maestro_standar_anamnesis/searchcie.php",
               minLength: 1,
            ...
            $( "#prod_codigox" ).autocomplete({
               source: "templateformsweb/maestro_standar_anamnesis/searchpro.php",
               minLength: 1,
			   select: function( event, ui ) {
