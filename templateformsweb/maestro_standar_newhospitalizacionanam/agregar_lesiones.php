...
$busca_lesiones="insert into dns_registrolesioneshospi (les_id,anam_enlace,usua_id,less_fecharegistro,less_x) values ('".$les_id."','".$anam_enlace."','".$usua_id."','".$less_fecharegistro."','".$less_x."')"; 
