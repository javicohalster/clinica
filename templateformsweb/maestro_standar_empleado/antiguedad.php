...
$obtiene_anios="select * from app_cliente inner join grid_infolaboral3 on app_cliente.clie_enlace=grid_infolaboral3.standar_enlace inner join app_tipounidad on 		
grid_infolaboral3.info_unidad=app_tipounidad.tipouni_id inner join cmb_puestoinstitucional on grid_infolaboral3.info_puestoinstitucional=cmb_puestoinstitucional.tipoinst_id left join cmb_ocupacional on tipoocu_id=info_grupoocupacional left join cmb_tipocontrato on tdct_id=info_tipodecontrato  where info_fechadesalida='0000-00-00' and app_cliente.clie_id='".$clie_id."' order by info_id desc limit 1";
...
$tipoocu_nombre=$rs_anios->fields["tipoocu_nombre"];
$tipouni_nombre=$rs_anios->fields["tipouni_nombre"];
$tipoinst_nombre=$rs_anios->fields["tipoinst_nombre"];
echo utf8_encode($tipoocu_nombre."<br>".$tipouni_nombre."<br>".$tipoinst_nombre."<br>");

if($info_fechaingreso!='0000-00-00')
{
?>
...
else
{
	...
	echo "<b>Alert!!! Datos incompletos...</b><br>";
}
}
?>
