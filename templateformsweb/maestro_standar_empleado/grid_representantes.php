...
$campos_datainserta=array('tipoident_codigo','repres_ci','repres_nombre','repres_telefono','repres_parentesco','repres_observacion');
...

{
 ...
 $sql_inserta=$objvarios->genera_insert($tabla_gridvalor,$campo_enlace,$campo_fecharegistro,$_POST["enlace"],$_POST['sess_id'],date("Y-m-d"),$_POST,$campos_datainserta);
...
( '1', '".$_POST["tipoident_codigox"]."', '".$_POST["repres_cix"]."', '".$_POST["repres_nombrex"]."', '', '', '".$_POST["repres_telefonox"]."', '', '', '".date("Y-m-d")."', 0, '');";
