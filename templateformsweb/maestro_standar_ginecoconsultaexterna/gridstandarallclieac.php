...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_standarallclieac.php",{
...
clie_idx:'<?php echo $this->sendvar["clie_idx"]; ?>',
