...
$campo_activo='';
if($sub_tabla=='pichinchahumana_extension.dns_rehabilitacionevoluciongridorgano')
{
  $campo_activo='opcorg_activo';
}
if($sub_tabla=='pichinchahumana_extension.dns_rehabilitacionevogridexamenfisico')
{
