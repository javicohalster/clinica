...
abrir_standar('templateformsweb/maestro_standar_cobropago/buscadorform/busca_data.php','Buscador','divBody_buscadorgeneral','divDialog_buscadorgeneral',550,500,id,$('#frocob_id').val(),0,0,0,0,0);
...
abrir_standar('templateformsweb/maestro_standar_cobropago/crearform/formulario.php','New','divBody_buscadorgeneral','divDialog_buscadorgeneral',550,500,id,valor,0,0,0,0,0);
