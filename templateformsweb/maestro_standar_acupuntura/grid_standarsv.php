	 ...
	 {		
		...
		switch ($fie_camposgridselect[$i]) {
			case 'signovita_presionarterial':
				...
				if($totalv>0)
				{	
				  $valor_txt='<span style="color:#FF0000;font-size:11px;padding:2px;" ><b>Signo Alterado</b></span>';
				}
				else
				{
				  $valor_txt='<span style="color:#000000;font-size:11px;padding:2px;" ><b>Normal</b></span>';
				}		
