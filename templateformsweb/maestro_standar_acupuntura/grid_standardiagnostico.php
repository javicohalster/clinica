...
<table class="table table-bordered"  style="width:100%" >
  <tr>
   ...
   <?php
	...
	?>
	<td bgcolor="#DFE9EE" style="font-size:11px;padding:2px;" >Alerta</td>
  </tr>
<?php
$cuenta=0;
if($tabla_combo)
...
//echo $lista_servicios;
 ...
 if($rs_data)
 {
  ...
  ?>
  <tr>
    <td onClick="grid_extras_<?php echo $_POST["fie_id"]; ?>('<?php echo $rs_data->fields[$campo_enlace]; ?>','<?php echo $rs_data->fields[$campo_id]; ?>',2)" style="cursor:pointer;font-size:11px;padding:2px;" ><span class="glyphicon glyphicon-ban-circle"></span></td>
	...
	if($vaalertahuefana==1)
		 {
		 $mensaje3='<div style="color:#FF0000" >Enfermedad Huerfana</div>';	 
		}
		
		echo '<td style="font-size:11px;padding:2px;" >'.$mensaje1.' '.$mensaje2.' '.$mensaje3.'</td>';
	?>
