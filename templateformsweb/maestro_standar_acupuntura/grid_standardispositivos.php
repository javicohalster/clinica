...
$campos_dataedit=explode(",",$rs_fields->fields["fie_tablasubgridcampos"].",plantrai_preciocompra,plantrai_porcentajeadm,plantrai_porcentajeiva,plantrai_valorplanilla");

$campos_datainserta=array();
$campos_datainserta=explode(",",$rs_fields->fields["fie_tablasubgridcampos"].",plantrai_preciocompra,plantrai_porcentajeadm,plantrai_porcentajeiva,plantrai_valorplanilla");
//tabla combo
...
$busca_preciosx="select cuadrobm_preciodispositivo from dns_cuadrobasicomedicamentos where cuadrobm_codigoatc='".trim($_POST["plantrai_codigox"])."'";
$rs_bpreciox = $DB_gogess->executec($busca_preciosx,array());

//plantrai_preciocompra
//plantrai_porcentajeadm
//plantrai_porcentajeiva
//plantrai_valorplanilla

$_POST["plantrai_preciocomprax"]=$rs_bpreciox->fields["cuadrobm_preciodispositivo"];
$_POST["plantrai_porcentajeadmx"]=$rs_dttarifario->fields["emp_valorgastosadm"];
$_POST["plantrai_porcentajeivax"]=$rs_dttarifario->fields["emp_valoriva"];

$calcula_por=($rs_bpreciox->fields["cuadrobm_preciodispositivo"]*$rs_dttarifario->fields["emp_valorgastosadm"])/100;
$calcula_iva=($rs_bpreciox->fields["cuadrobm_preciodispositivo"]*$rs_dttarifario->fields["emp_valoriva"])/100;
$plantra_valorplanillax=$rs_bpreciox->fields["cuadrobm_preciodispositivo"]+$calcula_por+$calcula_iva;
$_POST["plantrai_valorplanillax"]=$plantra_valorplanillax;
...
{
$lista_servicios="select *,DATE_ADD(".$campo_fecharegistro.",INTERVAL 3 DAY) as fechacierre from ".$sub_tabla." where ".$campo_enlace."='".$_POST['enlace']."'";
