...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_standarquimica.php",{
...
function valida_rango()
{
   ...
   $("#div_rangos").load("templateformsweb/maestro_standar_laboratorioinforme/validaquimica.php",{
    gquimica_tipox:$('#gquimica_tipox').val(),
	clie_id:$('#clie_id').val()
  },function(result){  


  });  
  $("#div_rangos").html("Espere un momento...");  

}

 $( "#gquimica_tipox" ).change(function() {
                   valida_rango();
				});
