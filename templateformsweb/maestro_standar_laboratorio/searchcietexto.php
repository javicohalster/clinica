...
$rs_clientes = $DB_gogess->executec($lista_clientes,array());
 if($rs_clientes)
 {
	 ...
	 $companies[$ic]["label"]=utf8_encode($rs_clientes->fields["cie_descripcion"]);
	 $companies[$ic]["value"]=utf8_encode($rs_clientes->fields["cie_descripcion"]);
	 $companies[$ic]["descripcion"]=utf8_encode($rs_clientes->fields["cie_descripcion"]);
	 $companies[$ic]["codigo"]=utf8_encode($rs_clientes->fields["cie_codigo"]);
