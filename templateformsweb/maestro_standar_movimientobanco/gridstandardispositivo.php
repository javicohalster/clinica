...
sess_id:'<?php echo $_SESSION['datadarwin2679_sessid_inicio']; ?>'
    ...
    for($i=0;$i<count($campos_dataedit);$i++)
     ...
     ?>	
	 enviar_formulariodata('form_dns_anamesisexamenfisico')
  });  
...
<div class="form-group">	
<div class="col-md-12">
<!-- <button type="button" class="mb-sm btn btn-primary"  onClick="buscar_productoapi()"  style="background-color:#000066" >Buscar Producto</button> -->
...
function buscar_productoapi()
{


$("#listap_b").load("<?php echo $this->formulario_path; ?>/apilector.php",{
plantrai_codigox:$('#plantrai_codigox').val()
...
$("#listap_b").html("Espere un momento...");
