<?php
	  ...
	  //echo $tipomov_idx;
       ...
       $per_activo=$objformulario->replace_cmb("dns_periodobodega","perio_activo,perio_anio"," where perio_activo=",1,$DB_gogess);
			...
			$tipom_idx=$objformulario->replace_cmb("dns_compras","compra_id,tipom_id"," where compra_id=",$compra_id,$DB_gogess);
			$tipomov_idx=$objformulario->replace_cmb("dns_compras","compra_id,tipomov_id"," where compra_id=",$compra_id,$DB_gogess);
			...
			//echo $compra_id;
			$moviin_redpublicax=$objformulario->replace_cmb("dns_compras","compra_id,compra_redpublica"," where compra_id=",$compra_id,$DB_gogess);
			$objformulario->sendvar["moviin_redpublicax"]=$moviin_redpublicax;
			
			$moviin_laboratoriox=$objformulario->replace_cmb("dns_compras","compra_id,moviin_laboratorio"," where compra_id=",$compra_id,$DB_gogess);
...
abrir_standar("../../../../../templateformsweb/maestro_standar_mcompras2/buscar_producto.php","Buscar","divBody_producto","divDialog_producto",750,450,0,0,0,0,0,0,0);
...
function busca_contexto()
  {
	  $("#lista_buc").load("../../../../../templateformsweb/maestro_standar_mcompras2/lista_bu.php",{
...
function lista_sugerencias()
{
	...
	$("#lista_bucsuge").load("../../../../../templateformsweb/maestro_standar_mcompras2/lista_busuge.php",{
...
$("#r_calculo").load("../../../../../templateformsweb/maestro_standar_mcompras2/calculo.php",{
...
$("#ac_unidad").load("../../../../../templateformsweb/maestro_standar_mcompras2/acuidad.php",{
