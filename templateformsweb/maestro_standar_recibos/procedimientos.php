...
$("#list_insumo").load("templateformsweb/maestro_standar_recibos/lista_procedimientos.php",{
valor_b:$('#valor_b').val(),
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_recibos/agregar_procedimiento.php",{
