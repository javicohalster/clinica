...
{
   $("#div_gpago").load("templateformsweb/maestro_standar_recibos/guarda_pago.php",{
valorp:valor,
frm_idp:frm_id,
...
<div id="div_gpago" >
<?php
$lista_fpagot="select doccab_total from beko_recibocabecera where doccab_id='".$_POST["pVar1"]."'";
