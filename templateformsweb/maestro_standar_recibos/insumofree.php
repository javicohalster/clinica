...
$("#list_tarifa").load("templateformsweb/maestro_standar_recibos/lista_tarifa.php",{
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_recibos/agregar_insumonuevo.php",{
