...

{
   ...
   $("#list_evaluacion").load("templateformsweb/maestro_standar_recibos/lista_evaluacion.php",{
...
$("#list_terapia").load("templateformsweb/maestro_standar_recibos/lista_terapia.php",{
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_recibos/agregar_insumo.php",{
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_recibos/agregar_evaluacion.php",{
...
$("#factura_terapia").load("templateformsweb/maestro_standar_recibos/facturar_terapias.php",{
