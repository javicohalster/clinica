...
<input type="button" name="btn_micro_id" id="btn_micro_id" value="MICROBIOLOG&Iacute;A"  onclick="ocultar_mostrarlab('micro_id')" />

<input type="button" name="btn_otros_id" id="btn_otros_id" value="OTROS"  onclick="ocultar_mostrarlab('otros_id')" />
 ...
 function ocultar_mostrarlab(muestra)
  {
	...
	$('#micro_id').hide();
	cambio_inactivo('micro_id',0);	
	
	$('#otros_id').hide();
	cambio_inactivo('otros_id',0);	
