...
<?php
			...
			$datos_centrodata="select * from dns_centrosalud inner join app_provincia on dns_centrosalud.prob_codigo=app_provincia.prob_codigo inner join app_canton on dns_centrosalud.cant_codigo=app_canton.cant_codigo where centro_id='".$_SESSION['datadarwin2679_centro_id']."'";
			
            //$rs_centrodata = $DB_gogess->executec($datos_centrodata,array());
			
			//$objformulario->sendvar["cantonx"]=$rs_centrodata->fields["cant_nombre"];
			//$objformulario->sendvar["provinciax"]=$rs_centrodata->fields["prob_nombre"];
