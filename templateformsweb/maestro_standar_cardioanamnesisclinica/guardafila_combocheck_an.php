...
if($_POST["valor"]=='true')
{
$actualiza_datos="update ".$_POST["tabla"]." set ".$_POST["campo"]."='1',".$_POST["fecha_reg"]."='".date("Y-m-d H:i:s")."' where ".$_POST["campoid"]."=".$_POST["valorid"];
}
else
{
$actualiza_datos="update ".$_POST["tabla"]." set ".$_POST["campo"]."='0' where ".$_POST["campoid"]."=".$_POST["valorid"];
}

//echo $actualiza_datos;
