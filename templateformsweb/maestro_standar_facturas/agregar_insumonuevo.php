...
$busca_agregado="select * from beko_documentodetalle where docdet_codprincipal='".$_POST["produ_id"]."' and doccab_id='".$_POST["enlace"]."'";
...
$borra_data="delete from beko_documentodetalle where docdet_codprincipal='".$_POST["produ_id"]."' and  doccab_id='".$_POST["enlace"]."'";
