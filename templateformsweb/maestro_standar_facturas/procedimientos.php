...
$("#list_insumo").load("templateformsweb/maestro_standar_facturas/lista_procedimientos.php",{
valor_b:$('#valor_b').val(),
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_facturas/agregar_procedimiento.php",{
