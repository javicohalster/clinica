...

{
   ...
   $("#list_evaluacion").load("templateformsweb/maestro_standar_facturas/lista_evaluacion.php",{
...
$("#list_terapia").load("templateformsweb/maestro_standar_facturas/lista_terapia.php",{
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_facturas/agregar_insumo.php",{
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_facturas/agregar_evaluacion.php",{
...
$("#factura_terapia").load("templateformsweb/maestro_standar_facturas/facturar_terapias.php",{
