...

{
    ...
    $("#lista_hijos").load("templateformsweb/maestro_standar_facturas/lista_hijos.php",{
...
$("#grid_div").load("templateformsweb/maestro_standar_facturas/grid_detalle.php",{
...
abrir_standar("templateformsweb/maestro_standar_facturas/procedimientos.php","PROCEDIMIENTOS","divBody_insumo","divDialog_insumo",700,600,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,$('#tippo_id').val(),$('#conve_id').val(),$('#doccab_autorizacion').val());
...
abrir_standar("templateformsweb/maestro_standar_facturas/procedimientosapi.php","PROCEDIMIENTOS","divBody_insumo","divDialog_insumo",700,600,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,$('#tippo_id').val(),$('#conve_id').val(),$('#doccab_autorizacion').val());
...
abrir_standar("templateformsweb/maestro_standar_facturas/insumofree.php","INSUMO","divBody_insumo","divDialog_insumo",500,500,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,0,0,0);
...

{
     ...
     $("#div_actualizac").load("templateformsweb/maestro_standar_facturas/actualiza_campo.php",{
...

{
     ...
     $("#div_actualizac").load("templateformsweb/maestro_standar_facturas/actualiza_campodescuento.php",{
...

{
    ...
    if(confirm("Alerta. Desea borrar este registro ?")) { 
	      ...
	      $("#grid_borraitemv").load("templateformsweb/maestro_standar_facturas/borrar_item.php",{idenlace:id_borrar
...
abrir_standar("templateformsweb/maestro_standar_facturas/fpago.php","FORMA_PAGO","divBody_fpago","divDialog_fpago",600,500,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,0,0,0);
...
abrir_standar("templateformsweb/maestro_standar_facturas/insumo_barra.php","BARRA","divBody_insumo","divDialog_insumo",500,400,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,0,0,0);
...
$("#genera_xml").load("templateformsweb/maestro_standar_facturas/generar_xml.php",{
...
$("#genrap_tvalor").load("templateformsweb/maestro_standar_facturas/genera_turno.php",{
...
function guardar_cliente_data()
{
   ...
   $("#grid_clientef").load("templateformsweb/maestro_standar_facturas/guarda_cliente.php",{
...

{
 ...
 $("#g_claveacceso").load("templateformsweb/maestro_standar_facturas/gclavedeacceso.php",{
...
<script>
         ...
         $(function() {
            ...
            $( "#doccab_rucci_cliente" ).autocomplete({
               ...
               source: "templateformsweb/maestro_standar_facturas/search.php",
...
if($objformulario->contenid["doccab_id"])
{
	$busca_estado_sri="select doccab_estadosri from beko_documentocabecera where doccab_id='".$objformulario->contenid["doccab_id"]."'";
...
abrir_standar("templateformsweb/maestro_standar_facturas/personal.php","PERSONAL","divBody_insumo","divDialog_insumo",900,600,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,$('#doccab_id').val(),0,$('#conve_id').val(),$('#doccab_autorizacion').val(),'<?php echo $envio_valorvert; ?>');
...
abrir_standar("templateformsweb/maestro_standar_facturas/sri.php","SRI","divBody_insumo","divDialog_insumo",400,180,0,0,0,0,0,0,0);
...
$("#g_claveacceso").load("templateformsweb/maestro_standar_facturas/guarda_fpago.php",{
