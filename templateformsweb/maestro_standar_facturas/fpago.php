...
{
   $("#div_gpago").load("templateformsweb/maestro_standar_facturas/guarda_pago.php",{
valorp:valor,
frm_idp:frm_id,
...
if($rs_data)
{
	 ...
	 $busca_sidata="select docfpag_id,docfpag_valor from beko_documentoformapago where frm_id=".$rs_data->fields["frm_id"]." and doccab_id='".$_POST["pVar1"]."'";
...
<div id="div_gpago" >
<?php
$lista_fpagot="select doccab_total from beko_documentocabecera where doccab_id='".$_POST["pVar1"]."'";
