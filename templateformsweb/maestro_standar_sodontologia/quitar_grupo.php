...
$rs_clientes = $DB_gogess->executec($lista_clientes,array());
 if($rs_clientes)
 {
	  ...
	  $busca_existe="delete from dns_dispositivosodontologia where plantrai_despachado='' and plantrai_codigo='".$rs_clientes->fields["cuadrobm_codigoatc"]."' and  subsecodont_enlace='".$_POST["subsecodont_enlace"]."'";
