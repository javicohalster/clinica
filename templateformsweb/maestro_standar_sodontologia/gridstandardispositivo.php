...
function agrega_grupo(grupo)
{
   ...
   $("#div_aggrupo").load("templateformsweb/maestro_standar_sodontologia/agergar_grupo.php",{
	
    grupo:grupo,
	subsecodont_enlace:'<?php echo $valor_enlace; ?>'
...
function quitar_grupo(grupo)
{
   ...
   $("#div_aggrupo").load("templateformsweb/maestro_standar_sodontologia/quitar_grupo.php",{
