...
<div align="right">
  ...
  <tr>
    <td width="221"><input name="fecha_impi" type="text" class="form-control" id="fecha_impi" value="<?php echo date("Y-m-d"); ?>" ></td>
	<td width="20">&nbsp;</td>
	<td width="221"><input name="fecha_impf" type="text" class="form-control" id="fecha_impf" value="<?php echo date("Y-m-d"); ?>" ></td>
    <td width="20">&nbsp;</td>
    <td width="145"><button type="button" class="mb-sm btn btn-primary" onClick="imprimir_recet()" style="background-color:#000066" >IMPRIMIR</button></td>
  </tr>
</table>
</div>
...
<script type="text/javascript">
<!--
$('#fecha_impi').datepicker({dateFormat: 'yy-mm-dd'});
$('#fecha_impf').datepicker({dateFormat: 'yy-mm-dd'});

function imprimir_recet()
{
   window.open('terapia/terapia_standar.php?fechaf='+$("#fecha_impf").val()+'&fechai='+$("#fecha_impi").val()+'&idcl='+$("#clie_id").val()+'&fieid=<?php echo $_POST["fie_id"]; ?>&enlace=<?php echo $_POST['enlace']; ?>', '_blank');
}
//  End -->
</script>
