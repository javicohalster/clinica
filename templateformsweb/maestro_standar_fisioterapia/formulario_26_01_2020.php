...
<?php
			...
			$objformulario->sendvar["fisiot_enlacex"]=$aletorioid;
  ...
  <tr>
    ...
    <td bgcolor="#F1F7F8" class="css_texto"><span class="texto_caja">
      ...
      <?php  $objformulario->generar_formulario(@$submit,$table,55,$DB_gogess); ?>
       ...
       <input name="npacienteoculto" type="hidden" id="npacienteoculto" value="<?php echo utf8_encode($rs_dcliente->fields["clie_nombre"]." ".$rs_dcliente->fields["clie_apellido"]); ?>" />
    </span></td>
...
switch (trim($rs_atencion->fields["atenc_estadorehabilitacion"])) {
    case 'SUBSECUENTE':
        $estadoval1='checked';
        break;
    case 'ALTA':
...
<div class="alert alert-info" role="alert">
  ...
  INFORME DE TERAPIA y REGISTRO TERAPIA se unifico en solo REGISTRO TERAPIA ahi se ingesar&aacute; la evoluci&oacute;n para no repetir informaci&oacute;n, la opci&oacute;n de INFORME DE TERAPIA quedara como informativo ya que tiene datos registrados anteriormente ahora todo se registrara solo en REGISTRO TERAPIA  </p>
</div>
<?php
...
<script>
		 ...
		 function click_radiob()
		 {
		   ...
		   $("#div_estadoatencion").load("templateformsweb/maestro_standar_fisioterapia/estadog.php",{
