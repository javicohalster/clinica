<?php
			...
			$aletorioid=$nunico.@$_SESSION['datadarwin2679_sessid_cedula'].$_SESSION['datadarwin2679_sessid_inicio'].date("Ymdhis");
			$objformulario->sendvar["hill_enlacex"]=$aletorioid;
