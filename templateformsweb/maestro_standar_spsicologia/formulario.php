...
$linkcambior="onclick=abrir_standar('aplicativos/documental/cambio_fecha.php','CAMBIO','divBody_foto','divDialog_foto',500,300,'subpsicologia',$('#subsecpsico_id').val(),0,0,0,0,0) style='cursor:pointer'";
echo '&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-warning" '.$linkcambior.'  style="cursor:pointer"> CAMBIAR FECHA REGISTRO </button>';

$linkhistorialr="onclick=abrir_standar('aplicativos/documental/historial_fecha.php','CAMBIO','divBody_foto','divDialog_foto',790,300,'subpsicologia',$('#subsecpsico_id').val(),0,0,0,0,0) style='cursor:pointer'";
...
//cambio de fecha registro
			...
			$objformulario->sendvar["psicolo_idx"]=$_POST["pVar7"];
			...
			$objformulario->sendvar["subsecpsico_enlacex"]=$aletorioid;
