...
$tipopac_id='';
?>
<table width="460" border="1" align="center" cellpadding="2" cellspacing="1">
  <tr>
...
?>
  <tr bgcolor="#EFF3F5">
   <!-- <td onClick="agregar_insumo('<?php echo $rs_bproductos->fields["cuadrobm_id"]; ?>','')" style="cursor:pointer" ><img src="images/bekosell.png"></td> -->
     <td><b><?php echo $rs_bproductos->fields["cuadrobm_codigoatc"]; ?></b></td>
    <td><b><?php echo $rs_bproductos->fields["cuadrobm_nombrecomercial"]; ?></b></td>
	...
	<td><input type="button" name="Submit" value="--&gt;&gt;" onClick="ejecuta_despachar('<?php echo $cuadrobm_id; ?>','<?php echo $centro_id; ?>','<?php echo $maximo_permitido; ?>','<?php echo $proveeve_id; ?>')" ></td>
  </tr>
<?php
     }
