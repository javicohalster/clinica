...
<table class="table table-bordered"  style="width:100%" >
 ...
 if($rs_data)
 {
	  ...
	  while (!$rs_data->EOF) {	
		...
		{
		  $precio_valor=0;	
		  $busca_detalles="select sum(mhdetfac_total) as total from beko_mhdetallefactura where doccab_id='".$pVar1."'  and mhdetfac_detallea='MAC'";
...
$("#agregar_serviciohill").load("templateformsweb/maestro_standar_ventas/agregar_serviciohill.php",{
hill_id:hill_id,
valor_porcentaje:'<?php echo $valor_porcentaje; ?>',
enlace:'<?php echo $pVar1; ?>',
