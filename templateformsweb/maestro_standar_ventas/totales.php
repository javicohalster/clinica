...
$ttiva_code=0;
$ttiva_code=$lista_valor[2]+$lista_valor[4];
...
{
?>
$('#doccab_subtotaliva').val('<?php echo round($ttiva_code, 2); ?>');
...
if($usua_farmacia==1)
{
$inserta_data="INSERT INTO lpin_formapagoventa ( doccab_id, frmc_codigo, frmpven_plazo, untiem_id, frmpven_valor, usua_id, frmpven_fecharegistro) VALUES ( '".$doccab_id."','01', 0, 1,".round($ttotal, 2).",'".$_SESSION['datadarwin2679_sessid_inicio']."', '".date("Y-m-d H:i:s")."');";
