...
function saca_detallado($tipo,$precu_id,$doccab_id,$doccab_pgacont,$valor_ptarjeta,$DB_gogess)
{
...
//detallado
  $tipo=1;
  saca_detallado($tipo,$precu_id,$doccab_id,$doccab_pgacont,$valor_ptarjeta,$DB_gogess);
  $tipo=2;
  saca_detallado($tipo,$precu_id,$doccab_id,$doccab_pgacont,$valor_ptarjeta,$DB_gogess);
  $tipo=3;
  saca_detallado($tipo,$precu_id,$doccab_id,$doccab_pgacont,$valor_ptarjeta,$DB_gogess);
