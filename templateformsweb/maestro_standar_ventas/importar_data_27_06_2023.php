...
$listac_camposx="proveeve_id,doccab_rucci_cliente,tipoident_codigo,doccab_nombrerazon_cliente,doccab_direccion_cliente,doccab_telefono_cliente,doccab_email_cliente,doccab_nautorizacion";
...
$('#doccab_fechadocmodi').val('<?php echo $doccab_fechaemision_cliente; ?>');
$('#doccab_autoirzacionmodif').val('<?php echo $doccab_nautorizacion; ?>');
