...
if($b_data!='')
{
$lista_sql="select * from ".$fie_tabledb."  where ".$sql_quita." provee_ruc like '".$b_data."%'";
$lista_sqlcount="select count(*) as total from ".$fie_tabledb."  where ".$sql_quita." provee_ruc like '".$b_data."%'";
}
//echo $lista_sql;
