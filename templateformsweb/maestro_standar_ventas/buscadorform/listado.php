...
{
$lista_sql="select * from ".$fie_tabledb."  where ".$sql_quita." (".$listabusqueda.") and ".$gridfield_filtrobuscador;
}
else
{
$lista_sql="select * from ".$fie_tabledb."  where ".$sql_quita." (".$listabusqueda.") ";
}
