...
<div class="row">
  ...
  <div id="div_panelsri" class="col-sm-1">
   ...
   <div id="div_panelprecuenta" class="col-sm-1">
	<div id="precuentapanel_btn" ><div onClick="verpanel_precuenta()" style="cursor:pointer" ><span class="material-symbols-outlined" style="font-size: 75px;">request_quote</span></div></div> <!--<img src="images/listafactura.png" width="60px" >-->	
  </div> 
  
  <div id="div_panelcobropago" class="col-sm-1">
	<div id="precuentapanel_btn" ><div onClick="crear_dataformcobropago($('#doccab_id').val(),'1')" style="cursor:pointer" ><span class="material-symbols-outlined" style="font-size: 75px;">payments</span></div></div> <!--<img src="images/cobropago.png" width="60px" >-->
  </div><br />
  
  <div id="div_panelcruze" class="col-sm-1">
	<div id="crucepanel_btn" ><div onClick="crear_dataformcruce($('#doccab_id').val(),'1')" style="cursor:pointer" ><span class="material-symbols-outlined" style="font-size: 75px;">grid_goldenratio</span></div></div> <!--<img src="images/cruce.png" width="60px" >	-->
  </div> 
  
   <div id="div_panelascontable" class="col-sm-1">
	<div id="ascontable_btn" >
	   <div onClick="ver_asientoc($('#doccab_id').val())" style="cursor:pointer" ><span class="material-symbols-outlined" style="font-size: 75px;">receipt_long</span>
	   </div>
	 </div>	
  </div> <!--<img src="images/ascontable.png" width="60px" >-->
  
  
  <div id="div_panelfarmacia" class="col-xs-4 col-sm-1"> 

	<div id="insumo_btn"><div onclick="insumo_ver()" style="cursor:pointer"><img src="images/coche2.png"></div></div>

  </div>
  
  <div id="div_panelfarmacia2" class="col-xs-4 col-sm-1"> 

	<div id="insumo_btn"><div onclick="proforma_ver()" style="cursor:pointer"><img src="images/coche3.png"></div></div>
...
<input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary text-white" type="button" name="btn_docdet_idpl" id="btn_docdet_idpl" value="PRODUCTOS" onclick="ocultar_mostrar3('docdet_idpl')" />
<input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary text-white" type="button" name="btn_gridmhdetallefactura_id" id="btn_gridmhdetallefactura_id" value="VARIOS" onclick="ocultar_mostrar3('gridmhdetallefactura_id')" />
<input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary text-white" type="button" name="btn_cueven_idpl" id="btn_cueven_idpl" value="CUENTAS"  onclick="ocultar_mostrar3('cueven_idpl')" />
<input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary text-white" type="button" name="btn_frmpven_idpl" id="btn_frmpven_idpl" value="FORMA DE PAGO"  onclick="ocultar_mostrar3('frmpven_idpl')" />
<input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary text-white" type="button" name="btn_retencionesv_id" id="btn_retencionesv_id" value="RETENCIONES"  onclick="ocultar_mostrar3('retencionesv_id')" />
...
abrir_standar("templateformsweb/maestro_standar_ventas/insumo_proforma.php","PROFORMA","divBody_insumo","divDialog_insumo",700,600,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,$('#tippo_id').val(),$('#conve_id').val(),$('#doccab_autorizacion').val());
...
abrir_standar("templateformsweb/maestro_standar_ventas/insumo.php","PROCEDIMIENTOS","divBody_insumo","divDialog_insumo",700,600,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,$('#tippo_id').val(),$('#conve_id').val(),$('#doccab_autorizacion').val());
...
abrir_standar("templateformsweb/maestro_standar_ventas/sri.php","SRI","divBody_insumo","divDialog_insumo",450,280,$('#doccab_id').val(),0,0,0,0,0,0);
...
function ver_pdf(idfactura,opcion)
{
	...
	<?php
	if($xml_sri!='AUTORIZADO' and $xml_sri!='RECIBIDA')
    {
	?>
...
function importar_datafac()
{
    ...
    if(confirm("Alerta. Importar Datos de la Factura ?")) { 
		  ...
		  //grid_factura(0);
		  grid_extras_9771($('#doccab_id').val(),0,4);
		  grid_extras_10271($('#doccab_id').val(),0,4);
		  grid_extras_9770($('#doccab_id').val(),0,4);
		  grid_extras_9931($('#doccab_id').val(),0,4);
...
$('#div_panelprecuenta').hide();
//$('#div_panelcobropago').hide();
$('#div_panelcruze').hide();
$('#hill_btn').hide();
$('#div_panelfarmacia').show();
$('#div_panelfarmacia2').show();
$('#btn_docdet_idpl').hide();

$('#btn_cueven_idpl').hide();
$('#btn_retencionesv_id').hide();
$('#bloque_doccab_pgacont').hide();
<?php
}
else
{
?>
$('#div_panelfarmacia').hide();
$('#div_panelfarmacia2').hide();
<?php
}
?>
//  End -->
