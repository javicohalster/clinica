...
<?php
 $lista_campor="select * from dns_cuadrobasicomedicamentos where cuadrobm_historial=0  and (cuadrobm_codigoatc like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_principioactivo like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_nombrecomercial like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_nombredispositivo like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_primerniveldesagregcion like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_presentacion like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_concentracion like '%".$_POST["bu_txtproducto"]."%')  order by  cuadrobm_principioactivo asc";
...
?>
  <tr>
    <td width="82"><input type="button" name="Button" value="Seleccionar" onClick="selecciona_p('<?php echo $rs_tabla->fields["cuadrobm_id"]; ?>','<?php echo $precio_comprav; ?>','<?php echo $cuadrobm_codigoatc; ?>')"></td>
