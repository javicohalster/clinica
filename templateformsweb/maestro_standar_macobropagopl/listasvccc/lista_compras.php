...
?>
		<div align="center">
			<select name="busca_compra" id="busca_compra" style="width:200px" class="js-example-basic-single form-control">
		...
		<?php
		$consulta_valor = " where planc_codigoc in (" . $paralista_sql . ") and planc_nombre like '%anticipo%' and planc_codigoc like '1.%'";
		?>
	...
	<script type="text/javascript">
		...
		function lista_compras() {
			...
			$("#lista_ventasec").load("templateformsweb/maestro_standar_macobropagopl/listasvccc/compras.php", {
