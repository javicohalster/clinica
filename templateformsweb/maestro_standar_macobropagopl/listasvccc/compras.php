...
if (@$_SESSION['datadarwin2679_sessid_inicio']) {
  ...
  $busca_compras = "select * from app_proveedor where (provee_nombre like '%" . $busca_compra . "%' or provee_cedula like '%" . $busca_compra . "%' or provee_ruc like '%" . $busca_compra . "%') order by provee_nombre asc";
...
?>
    ...
    <script type="text/javascript">
      ...
      function enviar_registros() {
        ...
        $("#div_procesaentrega").load("templateformsweb/maestro_standar_macobropagopl/listasvccc/asig_compras.php", {
