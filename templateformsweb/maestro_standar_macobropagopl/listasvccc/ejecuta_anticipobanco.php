...
$nombre_campoid='anti_id';
$tabla_asiento='app_anticipos';
$mnupan_id=187;
...
//principal
$cuenta_lista=0;
$busca_principal="select * from app_anticipos where anti_id='".$anti_idbu."'";
$rs_bprincipal = $DB_gogess->executec($busca_principal);

$movantic_id=$rs_bprincipal->fields["movantic_id"];
$tmv_id=$movantic_id;

$busca_printotal="select sum(movanti_monto) as total from app_anticipos inner join lpin_movanticipos on app_anticipos.anti_enlace=lpin_movanticipos.anti_enlace where anti_id='".$anti_idbu."'";
...
$busca_principalx="select * from app_anticipos where anti_id='".$anti_idbu."'";
