...
<table width="300" border="1" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><input name="crb_fechaac" id="crb_fechaac" type="text" value="" maxlength="" autocomplete="off" /></td>
    </tr>
    <tr>
      <td># de Comprobante:&nbsp;</td>
      <td> <input name="crb_ncomprobanteac" id="crb_ncomprobanteac" type="text" value="" maxlength="" autocomplete="off" /></td>
    </tr>
    <tr>
      <td>Descripci&oacute;n: </td>
      <td><textarea placeholder="Descripci&oacute;n:" name="crb_descripcionac" id="crb_descripcionac" rows="0" wrap="virtual" cols="25"></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
...
<button type="button" class="mb-sm btn btn-info" onclick="actualizar_cabecera()" style="cursor:pointer" id="btn_compra"> ACTUALIZA CABECERA </button> 
<?php
}
?>
...
<!--
$( "#crb_fechaac" ).datepicker({dateFormat: 'yy-mm-dd'});
...
function actualizar_cabecera() {
   ...
   if (confirm("Esta seguro que quiere hacer este cambio!") == true) {
   ...
   else
   {
     return false;
		...
		$("#divBody_actcabecera").load("templateformsweb/maestro_standar_macobropagopl/actualiza/act_data.php", {
			crb_id: $('#crb_id').val(),
			crb_fechaac: $('#crb_fechaac').val(),
			crb_ncomprobanteac: $('#crb_ncomprobanteac').val(),
			crb_descripcionac: $('#crb_descripcionac').val()
		}, function(result) {
  
  
            $('#crb_fecha').val($('#crb_fechaac').val());
			$('#crb_ncomprobante').val($('#crb_ncomprobanteac').val());
			$('#crb_descripcion').val($('#crb_descripcionac').val());
			
		
		});

		$("#divBody_actcabecera").html("Espere un momento...");
...
<div id="divBody_actcabecera"></div>