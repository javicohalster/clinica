...
$lista_clientes="select prod_codigo,prod_nombre,prod_precio from efacsistema_producto where prod_nivel=".$rs_bnivel->fields["permif_id"]." and prod_codigo like '".$_GET[ "term" ]."%'";
