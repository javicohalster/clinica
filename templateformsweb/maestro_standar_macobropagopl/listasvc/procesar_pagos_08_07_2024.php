...
$lista_pagos="select * from lpin_masivocobropago inner join lpin_masivocobropagodetalle on lpin_masivocobropago.crb_enlace=lpin_masivocobropagodetalle.crb_enlace where crb_id='".$crb_id."'";
