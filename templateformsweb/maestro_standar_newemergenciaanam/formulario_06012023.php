...
$templateGridSectionAdditionals = [
    "<div class='col-md-12'><div class='form-group'><div class='col-xs-12' style='background-color:#000033;color:#FFFFFF' id='anam_etiquetatopografico_html'> DIAGRAMA TOPOGRAFICO </div></div></div>",
    <<<ITEM
        <div class='col-md-6'>
            <img src="templateformsweb/maestro_standar_newemergenciaanam/images/diagramatopografico.jpg" width="450" height="425" />
