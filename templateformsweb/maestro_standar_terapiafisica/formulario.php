...
return $resultado;
			...
			$objformulario->sendvar["terfisic_enlacex"]=$aletorioid;
         ...
         $(function() {
            ...
            $( "#terfisic_cie" ).autocomplete({
			   ...
			   select: function( event, ui ) {
				  ...
				  $('#terfisic_cie_visorcie').val(ui.item.descripcion);
...
function terfisic_cie_agregar() {

var datos;

datos=$('#terfisic_impresiondiagnostica').val() + $('#terfisic_cie_visorcie').val()+ ",";

$('#terfisic_impresiondiagnostica').val(datos);
...
$('#terfisic_impresiondiagnostica').ckeditor(config1);
$('#terfisic_recomterapeutica').ckeditor(config1);	 
$('#terfisic_recomfamiliares').ckeditor(config1);	 
$('#terfisic_recomescolares').ckeditor(config1);	
$('#terfisic_recommultidiciplinarias').ckeditor(config1);
