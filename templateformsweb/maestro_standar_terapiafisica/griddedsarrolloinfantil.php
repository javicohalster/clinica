...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_griddedsarrollofisico.php",{
...
sess_id:'<?php echo $_SESSION['datadarwin2679_sessid_inicio']; ?>'
    ...
    for($i=0;$i<count($campos_dataedit);$i++)
     ...
     ?>	
     enviar_formulario('form_faesa_terapiafisica');
  });  
...
<div class="form-group">
	 <div class="col-md-3">
	  <select class="form-control" name="escdesainfantil_idx" id="escdesainfantil_idx"  >
       <option value="" >--Seleccion &Aacute;rea--</option>
		<?php
		$this->fill_cmb('faesa_areadesarolloinfantil','escdesainfantil_id,escdesainfantil_nombre','',' order by escdesainfantil_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-3">
	 <textarea placeholder="Puntaje - Percentil" name="desainfantil_percentilx" id="desainfantil_percentilx"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-3">
	 <textarea placeholder="Edad Equivalente" name="desainfantil_edadx" id="desainfantil_edadx"  class="form-control"  ></textarea>
      </div>
	  
	   <div class="col-md-3">
	 <textarea placeholder="Interpretaci&oacute;n Cualitativa" name="desainfantil_interpretacionx" id="desainfantil_interpretacionx"  class="form-control"  ></textarea>
