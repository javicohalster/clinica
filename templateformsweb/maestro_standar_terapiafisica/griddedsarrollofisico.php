...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="escdesafisico_idx" id="escdesafisico_idx"  >
       <option value="" >--Seleccion &Aacute;rea--</option>
		<?php
		$this->fill_cmb('faesa_areadesafisico','escdesafisico_id,escdesafisico_nombre','',' order by escdesafisico_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Descripci&oacute;n" name="desafisico_descripcionx" id="desafisico_descripcionx"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-4">
	 <textarea placeholder="Resultado" name="desafisico_resultadox" id="desafisico_resultadox"  class="form-control"  ></textarea>
