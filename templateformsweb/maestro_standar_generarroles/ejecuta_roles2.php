		  ...
		  if($resultl_ingresos)
           {
		       while (!$resultl_ingresos->EOF)
		       {
					...
					if($rubrg_ingresoegreso==2 or $rubrg_ingresoegreso==3)					
					{
...
//
 ...
 $busca_cabeceraasiento="select * from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and 	comcont_rol=2";
...
$concepto='';
$concepto=$n_tipo.' ROLES PROVICIONES'.$genr_anio.'-'.$genr_mes.' '.$genr_observacion.' CODE:'.$genr_id;
//$concepto=$concepto;
//concepto factura
//++++++++++++++++++++++++++
