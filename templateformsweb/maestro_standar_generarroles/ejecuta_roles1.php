...
//
 ...
 $busca_cabeceraasiento="select * from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and 	comcont_rol=1";
...
$concepto='';
$concepto=$n_tipo.' ROLES NOMINA'.$genr_anio.'-'.$genr_mes.' '.$genr_observacion.' CODE:'.$genr_id;
//$concepto=$concepto;
//concepto factura
//++++++++++++++++++++++++++
