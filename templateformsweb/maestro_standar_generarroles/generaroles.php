...
$cuenta_d=0;
//lista clientes
$busca_clientes="select * from app_usuario inner join grid_infolaboral3 on app_usuario.clie_enlace=grid_infolaboral3.standar_enlace where (info_fechadesalida='0000-00-00' or info_fechadesalida is null) order by info_id desc";
