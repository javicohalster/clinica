...
if($_POST["opcion"]==2)
{
 ...
 //$busca_parabcc="select * from lpin_comprobantecontable where comcont_tabla='app_anticipos' and comcont_idtabla=".$_POST["idgrid"];
// $rs_parabcc = $DB_gogess->executec($busca_parabcc,array()); 
 //$comcont_id=$rs_parabcc->fields["comcont_id"];
 ...
 //if($comcont_id>0)
 //{
   //$borra_reg1="update lpin_comprobantecontable set  comcont_anulado=1 where comcont_id='".$comcont_id."'";
...
if($_POST["opcion"]==1)
{
		...
		if($_POST[$campo_id."x"]>0)
			...
			// $busca_parab="select * from lpin_productocompra where ".$campo_enlace."='".$_POST["enlace"]."' and ".$campo_id."='".$_POST[$campo_id."x"]."'";
			 ...
			 //$update_temp="update dns_temporalovimientoinventario set unid_id='".$_POST["unid_idx"]."',centrorecibe_cantidad='".$_POST["prcomp_cantidadx"]."',moviin_preciocontable='".$_POST["prcomp_preciounitariox"]."' where cdxml_id='".$cdxml_id."'";
...
if($tabla_combo)
{
$lista_servicios="select *,DATE_ADD(".$campo_fecharegistro.",INTERVAL 120 DAY) as fechacierre from ".$sub_tabla." inner join  ".$tabla_combo." on ".$sub_tabla.".".$idtabla_combo."=".$tabla_combo.".".$idtabla_combo." where ".$campo_enlace."='".$_POST['enlace']."'";
}
else
{
$lista_servicios="select *,DATE_ADD(".$campo_fecharegistro.",INTERVAL 120 DAY) as fechacierre from ".$sub_tabla." where ".$campo_enlace."='".$_POST['enlace']."' order by ".$campo_fecharegistro." desc";
}
