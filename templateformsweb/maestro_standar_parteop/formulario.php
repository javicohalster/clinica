...
abrir_standar('templateformsweb/maestro_standar_parteop/buscadorform/busca_data.php','Buscador','divBody_buscadorgeneral','divDialog_buscadorgeneral',550,500,id,0,0,0,0,0,0);
...
abrir_standar('templateformsweb/maestro_standar_parteop/crearform/formulario.php','New','divBody_buscadorgeneral','divDialog_buscadorgeneral',550,500,id,valor,0,0,0,0,0);
...
function ver_sitienevalor()
{
	  ...
	  $("#valida_cuenta").load("templateformsweb/maestro_standar_parteop/valida_cuenta.php",{
