...
function guarda_check_cmb<?php echo $this->fie_id;  ?>(campoid,valorid,tabla,campo,valor,id,campoafecta,valorrecibe,ordrecibe)
{
   
 $("#combo_edita_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/guardafila_combocheck.php",{
		fie_id:'<?php echo $this->fie_id;  ?>',
		sess_id:'<?php echo $_SESSION['datadarwin2679_sessid_inicio']; ?>',
		campoid:campoid,
		valorid:valorid,
