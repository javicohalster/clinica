...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_standarvacunas.php",{
...
$rs_lcanp = $DB_gogess->executec($lista_campos,array());
 if($rs_lcanp)
 {
	  ...
	  if($rs_lcanp->fields["gridfield_tipo"]=='select')
	  {
		  ...
		  if($rs_lcanp->fields["gridfield_nameid"]=='activivac_idx' or $rs_lcanp->fields["gridfield_nameid"]=='activi_idx')
		  {
		  $this->fill_cmb($rs_lcanp->fields["gridfield_tablecmb"],$rs_lcanp->fields["gridfield_camposcmb"],'',' where activi_tipo=2 '.$rs_lcanp->fields["gridfield_ordercmb"],$DB_gogess);
		  }
		  else{
