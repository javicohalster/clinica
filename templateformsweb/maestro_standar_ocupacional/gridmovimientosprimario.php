...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="alcanc_idx" id="alcanc_idx"  >
       <option value="" >--Seleccion Alcance--</option>
		<?php
		$this->fill_cmb('faesa_alcances','alcanc_id,alcanc_nombre','',' order by alcanc_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Derecho" name="movipri_derechox" id="movipri_derechox"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-4">
	 <textarea placeholder="Izquierdo" name="movipri_izquierdox" id="movipri_izquierdox"  class="form-control"  ></textarea>
