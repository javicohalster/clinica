...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_gridocular.php",{
...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="areaocular_idx" id="areaocular_idx"  >
       <option value="" >--Seleccion Area--</option>
		<?php
		$this->fill_cmb('faesa_areaocular','areaocular_id,areaocular_nombre','',' order by areaocular_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Resultado" name="ocular_resultadox" id="ocular_resultadox"  class="form-control"  ></textarea>
