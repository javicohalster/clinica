...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="arafunman_idx" id="arafunman_idx"  >
       <option value="" >--Seleccion Area--</option>
		<?php
		$this->fill_cmb('faesa_areafuncionmanual','arafunman_id,arafunman_nombre','',' order by arafunman_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Derecho" name="funciman_derechox" id="funciman_derechox"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-4">
	 <textarea placeholder="Izquierdo" name="funciman_izquierdox" id="funciman_izquierdox"  class="form-control"  ></textarea>
