...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_gridbimanual.php",{
...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="arabima_idx" id="arabima_idx"  >
       <option value="" >--Seleccion Area--</option>
		<?php
		$this->fill_cmb('faesa_areabimanual','arabima_id,arabima_nombre','',' order by arabima_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Resultado" name="biman_resultadox" id="biman_resultadox"  class="form-control"  ></textarea>
