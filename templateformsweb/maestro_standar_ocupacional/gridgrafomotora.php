...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_gridgrafomotora.php",{
...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="areagrafom_idx" id="areagrafom_idx"  >
       <option value="" >--Seleccion Area--</option>
		<?php
		$this->fill_cmb('faesa_areagrafomotora','areagrafom_id,areagrafom_nombre','',' order by areagrafom_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Resultado" name="grafom_resultadox" id="grafom_resultadox"  class="form-control"  ></textarea>
