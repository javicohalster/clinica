...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_gridmanipulativa.php",{
...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="areamanipu_idx" id="areamanipu_idx"  >
       <option value="" >--Seleccion Area--</option>
		<?php
		$this->fill_cmb('faesa_areamanipulativa','areamanipu_id,areamanipu_nombre','',' order by areamanipu_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Resultado" name="manipu_resultadox" id="manipu_resultadox"  class="form-control"  ></textarea>
