...
{
$ic=0;
$lista_clientes="select * from  dns_hill where hill_codigo like '".$_GET[ "term" ]."%'";
...
// fclose($file);
 ...
 if($rs_clientes)
 {
	 ...
	 $companies[$ic]["label"]=$rs_clientes->fields["hill_codigo"];
	 $companies[$ic]["value"]=$rs_clientes->fields["hill_codigo"];
