...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="tipans_idx" id="tipans_idx"  >
       <option value="" >--Seleccion Ansiedad--</option>

		<?php

		$this->fill_cmb('faesa_tipoansiedad','tipans_id,tipans_nombre','',' order by tipans_id asc',$DB_gogess);
	 ...
	 <textarea placeholder="Marcador" name="invtans_marcadorx" id="invtans_marcadorx"  class="form-control"  ></textarea>

     </div>

	  <div class="col-md-4">

     <input placeholder="Observaci&oacute;n" name="invtans_observacionx" id="invtans_observacionx" class="form-control" value=""  type="text"  >
