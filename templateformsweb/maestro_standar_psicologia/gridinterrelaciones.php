...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="aippsc_idx" id="aippsc_idx"  >
       <option value="" >--Seleccion &aacute;rea--</option>
		<?php
		$this->fill_cmb('faesa_areasintepersonalespsc','aippsc_id,aippsc_nombre','',' order by aippsc_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Marcador" name="inteperson_marcadorx" id="inteperson_marcadorx"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-4">
	 <textarea placeholder="Observaci&oacute;n" name="inteperson_observacionx" id="inteperson_observacionx"  class="form-control"  ></textarea>
