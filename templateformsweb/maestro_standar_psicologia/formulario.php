...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td bgcolor="#D9E9EC" class="css_texto"><?php echo utf8_encode($rs_dcliente->fields["clie_instruccion"]);  ?></td>
  </tr>
  <tr>
    <td bgcolor="#D9E9EC"><span class="css_paciente">FECHA DE NACIMIENTO:</span></td>
    <td bgcolor="#D9E9EC" class="css_texto"><?php echo $rs_dcliente->fields["clie_fechanacimiento"];  ?></td>
    <td bgcolor="#D9E9EC"><span class="css_paciente">INSTITUCI&Oacute;N:</span></td>
    <td bgcolor="#D9E9EC" class="css_texto"><?php echo utf8_encode($rs_dcliente->fields["clie_institucion"]);  ?></td>
  </tr>
  <tr>
    <td bgcolor="#D9E9EC"><span class="css_paciente">EDAD (A la fecha de la evaluaci&oacute;n):</span></td>
    <td bgcolor="#D9E9EC" class="css_texto"><?php
  ...
  <tr>
    ...
    <td bgcolor="#D9E9EC" class="css_texto"><?php echo utf8_encode($rs_dcliente->fields["clie_direccion"]);  ?></td>
    <td bgcolor="#D9E9EC"><span class="css_paciente">FECHA DE EVALUACI&Oacute;N:</span></td>
    <td bgcolor="#D9E9EC" class="css_texto">
	<?php
  ...
  <tr>
    ...
    <td bgcolor="#D9E9EC" class="css_texto"><?php echo $rs_dcliente->fields["clie_celular"];  ?></td>
...
<script>
         ...
         $(function() {
            ...
            $( "#psic_cie" ).autocomplete({

               source: "templateformsweb/maestro_standar_psicologia/searchcie.php",

               minLength: 1,

			   select: function( event, ui ) {

				  $('#psic_cie_visorcie').val(ui.item.descripcion);
...
function psic_cie_agregar() {

var datos;

datos=$('#psic_impresiondiagnostica').val() + $('#psic_cie_visorcie').val()+ " ";

$('#psic_impresiondiagnostica').val(datos);
...
$('#psic_impresiondiagnostica').ckeditor(config1);
$('#psic_recomterapeutica').ckeditor(config1);	 
$('#psic_recomfamiliares').ckeditor(config1);	 
$('#psic_recomescolares').ckeditor(config1);	
$('#psic_recommultidiciplinarias').ckeditor(config1);
