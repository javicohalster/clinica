...
<div class="form-group">
	 ...
	 <div class="col-md-4">
	  ...
	  <select class="form-control" name="trast_idx" id="trast_idx"  >
       <option value="" >--Seleccion caracteristica--</option>

		<?php

		$this->fill_cmb('faesa_trastornoentrev','trast_id,trast_nombre','',' order by trast_id asc',$DB_gogess);
	 ...
	 <textarea placeholder="Percentil" name="entrvfe_percentilx" id="entrvfe_percentilx"  class="form-control"  ></textarea>

     </div>

	  <div class="col-md-4">

     <input placeholder="Observaci&oacute;n" name="entrvfe_observacionx" id="entrvfe_observacionx" class="form-control" value=""  type="text"  >
