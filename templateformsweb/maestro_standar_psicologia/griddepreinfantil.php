...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="escdepreinf_idx" id="escdepreinf_idx"  >
       <option value="" >--Seleccion Factor--</option>
		<?php
		$this->fill_cmb('faesa_factordepre','escdepreinf_id,escdepreinf_nombre','',' order by escdepreinf_id asc',$DB_gogess);
		?>
       </select>
      </div> 
	  <div class="col-md-4">
	 <textarea placeholder="Percentil" name="depreinf_percentilx" id="depreinf_percentilx"  class="form-control"  ></textarea>
      </div>
	  
	   <div class="col-md-4">
	 <textarea placeholder="Descripci&oacute;n" name="depreinf_descripcionx" id="depreinf_descripcionx"  class="form-control"  ></textarea>
