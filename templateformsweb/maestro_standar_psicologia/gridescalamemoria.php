...
<div class="form-group">
	 <div class="col-md-3">
	  <select class="form-control" name="escescameno_idx" id="escescameno_idx"  >
       <option value="" >--Seleccion Escala--</option>
		<?php
		$this->fill_cmb('faesa_escalamemo','escescameno_id,escescameno_nombre','',' order by escescameno_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-3">
	 <textarea placeholder="Sub Escala" name="escameno_subescalax" id="escameno_subescalax"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-3">
	 <textarea placeholder="Percentil" name="escameno_percentilx" id="escameno_percentilx"  class="form-control"  ></textarea>
      </div>
	  
	   <div class="col-md-3">
	 <textarea placeholder="Apreciaci&oacute;n" name="escameno_apreciacionx" id="escameno_apreciacionx"  class="form-control"  ></textarea>
