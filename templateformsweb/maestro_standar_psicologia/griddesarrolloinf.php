...
<div class="form-group">
	 <div class="col-md-3">
	  <select class="form-control" name="escdesarrinf_idx" id="escdesarrinf_idx"  >
       <option value="" >--Seleccion &Aacute;reas y dominios--</option>
		<?php
		$this->fill_cmb('faesa_areadesarrollo','escdesarrinf_id,escdesarrinf_nombre','',' order by escdesarrinf_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-3">
	 <textarea placeholder="Puntaje - Percentil" name="desarrinf_percentilx" id="desarrinf_percentilx"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-3">
	 <textarea placeholder="Edad equivalente" name="desarrinf_edadx" id="desarrinf_edadx"  class="form-control"  ></textarea>
      </div>
	  
	   <div class="col-md-3">
	 <textarea placeholder="Interpretaci&oacute;n cualitativa" name="desarrinf_interpretacionx" id="desarrinf_interpretacionx"  class="form-control"  ></textarea>
