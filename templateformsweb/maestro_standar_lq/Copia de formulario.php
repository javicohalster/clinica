...
$("#grid_factura_panel").load("templateformsweb/maestro_standar_lq/grid_factura.php",{enlace:$('#efacfaccab_id').val(),psolover:'<?php echo @$solover; ?>'
...
function borrar_item(id_borrar)
{
   ...
   ?>
    ...
    if(confirm("Alerta. Desea borrar este registro ?")) { 
	      ...
	      $("#grid_borraitemfactura").load("templateformsweb/maestro_standar_lq/borrar_item.php",{idenlace:id_borrar
...
function calculo_factura()
{
 ...
 // $('#efacfaccab_total').val(total_val);  
      ...
      $("#div_calculofac").load("templateformsweb/maestro_standar_lq/calculo.php",{efacfaccab_subtotal:$('#efacfaccab_subtotal').val(),efacfaccab_iva:$('#efacfaccab_iva').val(),efacfaccab_descuento:$('#efacfaccab_descuento').val(),efacfaccab_ice:$('#efacfaccab_ice').val(),efacfaccab_propina:$('#efacfaccab_propina').val(),efacfaccab_subtotalsiniva:$('#efacfaccab_subtotalsiniva').val(),efacfaccab_id:$('#efacfaccab_id').val(),efacfaccab_subtnoobjetoi:$('#efacfaccab_subtnoobjetoi').val(),efaecfaccab_pordescuento:$('#efaecfaccab_pordescuento').val()
		  },function(result){  	  
...
abrir_pantalla('templateformsweb/maestro_standar_lq/pago_form.php','FORMA_PAGO','divBody_fpago','divDialog_fpago',750,450,$('#efacfaccab_id').val(),0,0,0,0,0,0);
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td
    onclick="abrir_pantalla('templateformsweb/maestro_standar_lq/detalle_form.php','Nuevo','divBody_fac','divDialog_extra',700,450,$('#efacfaccab_id').val(),0,0,0,0,0,0);" style="cursor:pointer" ><img src="templateformsweb/maestro_standar_lq/BotonCrearNuevo.png" width="243"   height="41" /></td>
  </tr>
</table>
<?php   
        }
