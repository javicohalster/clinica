...

{
    ...
    $("#lista_hijos").load("templateformsweb/maestro_standar_lq/lista_hijos.php",{
...
$("#grid_div").load("templateformsweb/maestro_standar_lq/grid_detalle.php",{
...
abrir_standar("templateformsweb/maestro_standar_lq/procedimientos.php","PROCEDIMIENTOS","divBody_insumo","divDialog_insumo",700,600,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,$('#tippo_id').val(),$('#conve_id').val(),$('#doccab_autorizacion').val());


}

function insumo_verapi()
{

abrir_standar("templateformsweb/maestro_standar_lq/procedimientosapi.php","PROCEDIMIENTOS","divBody_insumo","divDialog_insumo",700,600,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,$('#tippo_id').val(),$('#conve_id').val(),$('#doccab_autorizacion').val());
...
abrir_standar("templateformsweb/maestro_standar_lq/insumofree.php","INSUMO","divBody_insumo","divDialog_insumo",500,500,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,0,0,0);
...

{
     ...
     $("#div_actualizac").load("templateformsweb/maestro_standar_lq/actualiza_campo.php",{
...

{
     ...
     $("#div_actualizac").load("templateformsweb/maestro_standar_lq/actualiza_campodescuento.php",{
...

{
    ...
    if(confirm("Alerta. Desea borrar este registro ?")) { 
	      ...
	      $("#grid_borraitemv").load("templateformsweb/maestro_standar_lq/borrar_item.php",{idenlace:id_borrar
...
abrir_standar("templateformsweb/maestro_standar_lq/fpago.php","FORMA_PAGO","divBody_fpago","divDialog_fpago",600,500,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,0,0,0);
...
abrir_standar("templateformsweb/maestro_standar_lq/insumo_barra.php","BARRA","divBody_insumo","divDialog_insumo",500,400,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,0,0,0);
...
$("#genera_xml").load("templateformsweb/maestro_standar_lq/generar_xml.php",{
...
function guarda_firma()
{
 ...
 $("#guarda_firma").load("firma_doc/gfirma_doclq.php",{
...
$("#sri_panel").load("autoriza/envio_lq.php",{
...
$("#sri_panel").load("autoriza/autoriza_lq.php",{
...
function activa_boton()
{
  ...
  $("#div_imprimirtiket").html('<a target="_blank" class="btnPrint_imp" href="impresionlq/imprimir.php?imp=<?php echo $rs_cfgimp->fields["imp_id"]; ?>&pa='+$("#doccab_id").val()+'"  ><img src="images/btn_imp.png" border=0 /></a>');
...
<?php
			...
			$objformulario->sendvar["tipocmp_codigox"]='03';
...
<div class="row">
  ...
  <div class="col-sm-4" id="divf_pagov">
  
  
  <table width="300" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr>
    <td bgcolor="#FFFFFF" class="txt_titulofpago" ><div align="center">
	<?php
	$seleccionado='';
	if($objformulario->contenid["doccab_fpago"])
	{
		if($objformulario->contenid["doccab_fpago"]=='01')
		{
	...
	?>
      <input name="fpago_valor" type="radio" value="01" <?php echo $seleccionado; ?> onclick="seleccionar_fpago()" /><br />
	  <b>EFECTIVO</b>
    </div></td>
    <td bgcolor="#F8F8F8" class="txt_titulofpago" ><div align="center">
	<?php
	$seleccionado='';
	if($objformulario->contenid["doccab_fpago"]=='19')
	{
	  $seleccionado='checked="checked"';
	}
	?>
      <input name="fpago_valor" type="radio" value="19" <?php echo $seleccionado; ?> onclick="seleccionar_fpago()" /><br />
	  <b>TARJETA DE CREDITO</b>
    </div></td>
    <td bgcolor="#FFFFFF" class="txt_titulofpago" ><div align="center">
	<?php
	$seleccionado='';
	if($objformulario->contenid["doccab_fpago"]=='16')
	{
	  $seleccionado='checked="checked"';
	}
	?>
      <input name="fpago_valor" type="radio" value="16" <?php echo $seleccionado; ?> onclick="seleccionar_fpago()" /><br />
	  <b>TARJETA DE DEBITO</b>
    </div></td>
    <td bgcolor="#FFFFFF"><div id="fpago_div">
  <div align="center">

	
	<!-- <div id="fpago_btn" ><div onClick="forma_pago()" style="cursor:pointer" ><img src="images/fpago.png" width="60px"></div></div> -->
  ...
  <div class="col-sm-1">
	<div id="apip_btn" ><div  style="cursor:pointer" ></div></div>
  </div>  
  ...
  <div class="col-sm-1"> 
	<div id="terapia_btn" ><div  ></div></div>
  </div>

  <div class="col-sm-1">
	<div id="libre_btn" ><div onClick="insumo_verlibre()" style="cursor:pointer" ><img src="images/cochelibre.png" width="60px" ></div></div>
  </div>
  ...
  <div id="div_pdf" class="col-sm-1">
	<div onClick="ver_pdf($('#doccab_id').val(),'03')" style="cursor:pointer" ><img src="images/pdf.png" width="60px" ></div>
  </div>  

  <div id="div_xml" class="col-sm-1">
	<div onClick="ver_xml($('#doccab_id').val(),'03')" style="cursor:pointer" ><img src="images/xml.png" width="60px" ></div>
  </div>
...
function genera_turnovalor()
{

$("#genrap_tvalor").load("templateformsweb/maestro_standar_lq/genera_turno.php",{
...
function guardar_cliente_data()
{
   ...
   $("#grid_clientef").load("templateformsweb/maestro_standar_lq/guarda_cliente.php",{
...

{
 ...
 $("#g_claveacceso").load("templateformsweb/maestro_standar_lq/gclavedeacceso.php",{
...
<script>
         ...
         $(function() {
            ...
            $( "#doccab_rucci_cliente" ).autocomplete({
               ...
               source: "templateformsweb/maestro_standar_lq/search.php",
...
{
$busca_xmlexistente="select doccab_xml from beko_lqcabecera where doccab_id=".$objformulario->contenid["doccab_id"];
...
if($objformulario->contenid["doccab_id"])
{
$busca_xmlexistentex="select doccab_xmlfirmado from beko_lqcabecera where doccab_id=".$objformulario->contenid["doccab_id"];
...
if($objformulario->contenid["doccab_id"])
{
	$busca_estado_sri="select doccab_estadosri from beko_lqcabecera where doccab_id='".$objformulario->contenid["doccab_id"]."'";
...
<script language="javascript">
<!--
	  $("#doccab_rucci_cliente").attr('readonly','true');	  
	  $("#tipoident_codigo").attr('readonly','true');
	  $("#doccab_nombrerazon_cliente").attr('readonly','true');
	  $("#doccab_direccion_cliente").attr('readonly','true');
	  $("#doccab_telefono_cliente").attr('readonly','true');
	  $("#doccab_email_cliente").attr('readonly','true');
	  $("#doccab_ndet").attr('readonly','true');
	  $("#doccab_apellidorazon_cliente").attr('readonly','true');
	  $("#doccab_identificacionpaciente").attr('readonly','true');
...
abrir_standar("templateformsweb/maestro_standar_lq/personal.php","PERSONAL","divBody_insumo","divDialog_insumo",900,600,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,$('#doccab_id').val(),0,$('#conve_id').val(),$('#doccab_autorizacion').val(),'<?php echo $envio_valorvert; ?>');
...
abrir_standar("templateformsweb/maestro_standar_lq/sri.php","SRI","divBody_insumo","divDialog_insumo",400,180,0,0,0,0,0,0,0);
...
function seleccionar_fpago()
{
   var tomadata;
   tomadata=$('input:radio[name=fpago_valor]:checked').val();
   $('#doccab_fpago').val(tomadata);
...
function guarda_formapago()
{

$("#g_claveacceso").load("templateformsweb/maestro_standar_lq/guarda_fpago.php",{

doccab_id:$('#doccab_id').val(),
fpago_valor:$('input:radio[name=fpago_valor]:checked').val(),
doccab_total:$('#doccab_total').val()
...
{
  abrir_standar("templateformsweb/maestro_standar_lq/paciente.php","PACIENTE","divBody_pacientedata","divDialog_pacientedata",900,600,0,25,0,0,0,0,$('#doccab_identificacionpaciente').val());
}
