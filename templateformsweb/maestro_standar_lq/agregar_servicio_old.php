...
{
//
    $nombre_espe=$rs_precio->fields["usua_formaciondelprofesional"]." ";
	//if($rs_pr->fields["prod_nombre"]==$rs_precio->fields["usua_formaciondelprofesional"])
	//{
	 // $nombre_espe='';	
	//}
	
	$cadena_de_texto = $rs_pr->fields["prod_nombre"];
    $cadena_buscada   = $rs_precio->fields["usua_formaciondelprofesional"];
