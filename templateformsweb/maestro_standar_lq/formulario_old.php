...
abrir_standar("templateformsweb/maestro_standar_lq/procedimientos.php","PROCEDIMIENTOS","divBody_insumo","divDialog_insumo",650,600,$('#<?php echo $rs_detalle->fields["subgri_campoenlace"]; ?>').val(),0,0,0,$('#tippo_id').val(),$('#conve_id').val(),$('#doccab_autorizacion').val());
