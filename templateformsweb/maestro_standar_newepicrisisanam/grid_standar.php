...
{
$lista_servicios="select *,DATE_ADD(".$campo_fecharegistro.",INTERVAL ".$intervalo_v." DAY) as fechacierre from ".$sub_tabla." where ".$campo_enlace."='".$_POST['enlace']."' order by ".$campo_fecharegistro." desc";
