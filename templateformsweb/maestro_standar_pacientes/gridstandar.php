...
$rs_lcanp = $DB_gogess->executec($lista_campos,array());
 if($rs_lcanp)
 {
	  ...
	  {
		  echo '<div class="col-md-'.$rs_lcanp->fields["gridfield_tamano"].'">'.$rs_lcanp->fields["gridfield_title"];
	  ...
	  {
	      echo '<div class="col-md-'.$rs_lcanp->fields["gridfield_tamano"].'">'.$rs_lcanp->fields["gridfield_title"];
		  echo '<textarea  name="'.$rs_lcanp->fields["gridfield_nameid"].'" id="'.$rs_lcanp->fields["gridfield_nameid"].'"  class="form-control"  '.$rs_lcanp->fields["gridfield_extra"].' ></textarea>';
		  echo '</div>';
	  }
...
if($rs_lcanp->fields["gridfield_tipo"]=='hora')
	  {
	      echo '<div class="col-md-'.$rs_lcanp->fields["gridfield_tamano"].'">'.$rs_lcanp->fields["gridfield_title"];
		  echo '<input  name="'.$rs_lcanp->fields["gridfield_nameid"].'" id="'.$rs_lcanp->fields["gridfield_nameid"].'" class="form-control timepicker" value="" type="text" '.$rs_lcanp->fields["gridfield_extra"].' />';
		  echo '</div>';
