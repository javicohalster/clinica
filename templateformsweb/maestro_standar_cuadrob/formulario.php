...
?>
<div class="TableScroll_VTN" >
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#DDEDF0"><div align="center"><strong>VENTAS</strong></div></td>
  </tr>
  <tr>
    <td><div id="lista_ventasdata">&nbsp;</div></td>
  </tr>
</table>
</div>
<br /><br />
...
{
   $("#lista_ventasdata").load("templateformsweb/maestro_standar_cuadrob/lista_ventasdata.php",{
  ...
  $("#lista_ventasdata").html("Espere un momento");  
}
...
abrir_standar('templateformsweb/maestro_standar_cuadrob/buscadorform/busca_data.php','Buscador','divBody_buscadorgeneral','divDialog_buscadorgeneral',550,500,id,0,0,0,0,0,0);
...
abrir_standar('templateformsweb/maestro_standar_cuadrob/crearform/formulario.php','New','divBody_buscadorgeneral','divDialog_buscadorgeneral',550,500,id,valor,0,0,0,0,0);
...
function ver_sitienevalor()
{
	  ...
	  $("#valida_cuenta").load("templateformsweb/maestro_standar_cuadrob/valida_cuenta.php",{
