...
//vacida datos
$vacia_data="TRUNCATE  ".$nombre_tabla."";
...
//procesa  inicial
$pinicial="select * from ".$nombre_tabla."";
$rs_pinicial = $DB_gogess->executec($pinicial);
if($rs_pinicial)
 {
	  while (!$rs_pinicial->EOF) {
	  
	  $busca_medi="select * from dns_cuadrobasicomedicamentos where cuadrobm_codigoatc='".$rs_pinicial->fields["tinicial_codigo"]."'";
	  $rs_medi = $DB_gogess->executec($busca_medi);
	  
	  $cuadrobm_id=$rs_medi->fields["cuadrobm_id"];
	  $centro_id='55';
	  $tipom_id='1';
	  $tipomov_id='1';
	  $moviin_nlote="LOTE".$rs_pinicial->fields["tinicial_codigo"];	  
	  $moviin_fechadecaducidad="2024-01-01";
	  $moviin_comprobantedeingreso='';
	  $moviin_fechaingreso='';
	  $centroenvia_id='';
	  $centrorecibe_id='';
	  $centrorecibe_observacion='';
	  $centrorecibe_cantidad=$rs_pinicial->fields["tinicial_cantidad"];
	  ...
	  $unid_id=$rs_pinicial->fields["tinicial_unidadalmacena"];
	  $uniddesg_id=$rs_pinicial->fields["tinicial_unidaddescarga"];
	  $moviin_cantidadunidadconsumo=1;
	  $moviin_totalenunidadconsumo=$rs_pinicial->fields["tinicial_cantidad"]*$moviin_cantidadunidadconsumo;
	  $moviin_fechadeelaboracion='';
	  $moviin_nombreproveedor='';
	  $moviin_nombrefabricante='';
	  $moviin_presentacioncomercial='';
	  $moviin_preciocompra=$rs_pinicial->fields["tinicial_costounitario"]/$moviin_cantidadunidadconsumo;
	  $moviin_total=$rs_pinicial->fields["tinicial_total"];
	  $moviin_rsanitario='';
	  $compra_id='1';
	  $moviin_autorizado='';
	  ...
	  $moviin_aprobo='';
	  $perioac_id='2023';
	  $moviin_codigoproveedor=$rs_pinicial->fields["tinicial_codigo"];
	  $cdxml_id='0';
	  $moviin_codeext='';
	  $moviin_descext='';
	  $moviin_cantidadcontable='0';
	  $moviin_preciocontable=$rs_pinicial->fields["tinicial_costounitario"];
	  $prcomp_id='0';
	  $moviin_verificado='0';

 $insert_datainvi="INSERT INTO dns_temporalovimientoinventario ( cuadrobm_id, centro_id, tipom_id, tipomov_id, moviin_nlote, moviin_fechadecaducidad, moviin_comprobantedeingreso, moviin_fechaingreso, centroenvia_id, centrorecibe_id, centrorecibe_observacion, centrorecibe_cantidad, centrorecibe_documento, centrorecibe_bodegamatriz, usua_id, moviin_fechaenvio, moviin_nombrerecibe, moviin_cedularecibe, moviin_gradorecibe, moviin_fecharegistro, unid_id, uniddesg_id, moviin_cantidadunidadconsumo, moviin_totalenunidadconsumo, moviin_fechadeelaboracion, moviin_nombreproveedor, moviin_nombrefabricante, moviin_presentacioncomercial, moviin_preciocompra, moviin_total, moviin_rsanitario, compra_id, moviin_autorizado, moviin_fechaautorizado, moviin_aprobo, perioac_id, moviin_codigoproveedor, cdxml_id, moviin_codeext, moviin_descext, moviin_cantidadcontable, moviin_preciocontable, prcomp_id, moviin_verificado) VALUES
('".$cuadrobm_id."','".$centro_id."','".$tipom_id."','".$tipomov_id."','".$moviin_nlote."','".$moviin_fechadecaducidad."','".$moviin_comprobantedeingreso."','".$moviin_fechaingreso."','".$centroenvia_id."','".$centrorecibe_id."','".$centrorecibe_observacion."','".$centrorecibe_cantidad."','".$centrorecibe_documento."','".$centrorecibe_bodegamatriz."','".$usua_id."','".$moviin_fechaenvio."','".$moviin_nombrerecibe."','".$moviin_cedularecibe."','".$moviin_gradorecibe."','".$moviin_fecharegistro."','".$unid_id."','".$uniddesg_id."','".$moviin_cantidadunidadconsumo."','".$moviin_totalenunidadconsumo."','".$moviin_fechadeelaboracion."','".$moviin_nombreproveedor."','".$moviin_nombrefabricante."','".$moviin_presentacioncomercial."','".$moviin_preciocompra."','".$moviin_total."','".$moviin_rsanitario."','".$compra_id."','".$moviin_autorizado."','".$moviin_fechaautorizado."','".$moviin_aprobo."','".$perioac_id."','".$moviin_codigoproveedor."','".$cdxml_id."','".$moviin_codeext."','".$moviin_descext."','".$moviin_cantidadcontable."','".$moviin_preciocontable."','".$prcomp_id."','".$moviin_verificado."');";

$rs_invi = $DB_gogess->executec($insert_datainvi);


	  
	   $rs_pinicial->MoveNext();
	  }
  }	  
