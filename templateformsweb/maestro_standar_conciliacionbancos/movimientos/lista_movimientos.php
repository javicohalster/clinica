...
echo '<br><button type="button" class="mb-sm btn btn-primary" onclick=""><span class="glyphicon glyphicon-print"></span> IMPRIMIR </button><br>';
...
<?php
echo "Valor conciliado:" . $suma_valort . "<br>";
echo "Valor no conciliado:" . $suma_valortno . "<br>";
