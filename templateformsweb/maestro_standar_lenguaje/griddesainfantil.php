...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_gridtestplon.php",{
...
<div class="form-group">
	 <div class="col-md-3">
	  <select class="form-control" name="escdesainfa_idx" id="escdesainfa_idx"  >
       <option value="" >--Seleccion &Aacute;rea y Dominios--</option>
		<?php
		$this->fill_cmb('faesa_areadesainfantil','escdesainfa_id,escdesainfa_nombre','',' order by escdesainfa_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-3">
	 <textarea placeholder="Puntaje - Percentil" name="desainfa_percentilx" id="desainfa_percentilx"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-3">
	 <textarea placeholder="Edad Equivalente" name="desainfa_edadx" id="desainfa_edadx"  class="form-control"  ></textarea>
      </div>
	  
	  <div class="col-md-3">
	 <textarea placeholder="Interpretaci&oacute;on cualitativa" name="desainfa_interpretacionx" id="desainfa_interpretacionx"  class="form-control"  ></textarea>
