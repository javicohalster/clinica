...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="esctestelce_idx" id="esctestelce_idx"  >
       <option value="" >--Seleccion &Aacute;rea--</option>
		<?php
		$this->fill_cmb('faesa_areatestelce','esctestelce_id,esctestelce_nombre','',' order by esctestelce_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Descripci&oacute;n" name="wppsi2_marcadorx" id="testelce_descripcionx"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-4">
	 <textarea placeholder="Resultado" name="testelce_resultadox" id="testelce_resultadox"  class="form-control"  ></textarea>
