...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="esctestplon_idx" id="esctestplon_idx"  >
       <option value="" >--Seleccion &Aacute;rea--</option>
		<?php
		$this->fill_cmb('faesa_areatestplon','esctestplon_id,esctestplon_nombre','',' order by esctestplon_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Descripci&oacute;n" name="wppsi2_marcadorx" id="testplon_descripcionx"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-4">
	 <textarea placeholder="Resultado" name="testplon_resultadox" id="testplon_resultadox"  class="form-control"  ></textarea>
