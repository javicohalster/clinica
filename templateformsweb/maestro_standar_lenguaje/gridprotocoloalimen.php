...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="escprotoalimen_idx" id="escprotoalimen_idx"  >
       <option value="" >--Seleccion Marcador--</option>
		<?php
		$this->fill_cmb('faesa_areaprotoalimen','escprotoalimen_id,escprotoalimen_nombre','',' order by escprotoalimen_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Descripci&oacute;n" name="wppsi2_marcadorx" id="protoalimen_descripcionx"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-4">
	 <textarea placeholder="Resultado" name="protoalimen_resultadox" id="protoalimen_resultadox"  class="form-control"  ></textarea>
