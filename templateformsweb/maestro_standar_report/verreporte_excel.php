 ...
 // print_r($sql);
...

  {
   ...
   ?>
        ...
        <td   bgcolor="#00008B" class="css_bordetitulo"><?php echo utf8_decode($camponom) ?></td>
		...
		if ($objgridtablareporte->fie_value=="replace")
				...
				//echo $objgridtablareporte->campo_cmbtcampo."<br>";
				  ...
				  $valorbus=trim($datoslista[$camposdata]);	
				    ...
				    $rmp= utf8_decode(utf8_decode($objformulario->replace_cmb($objgridtablareporte->fie_tabledb,$objgridtablareporte->fie_datadb,$objgridtablareporte->fie_sql,$valorbus,$conn)));
...

			      {
			        ...
			        $rmp= utf8_decode($datoslista[$camposdata]);			 
