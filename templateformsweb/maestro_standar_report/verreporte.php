...
//echo $nombre_campo."--".$typeSqlv."<br>";
			...
			//echo "dddd".$objformulario->fie_typereport;
...
// echo $sqlconcatena;
 ...
 // $_SESSION['datadarwin2679_sessid_emp_id']

if($_SESSION['datadarwin2679_sessid_emp_id'])
{
//$sql100=" emp_id=".$_SESSION['datadarwin2679_sessid_emp_id']." and ";
}
 // print_r($sql);
if($sqlconcatena)
{
$sqlconcatena=substr($sqlconcatena.$sql100,0,-4);
}
	 ...
	 foreach($objgridtablareporte->arrcampos as $camposdata): 
		...
		if ($objformulario->fie_value=="replace")
			     ...
			     {			
				    ...
				    $rmp= utf8_decode($objformulario->replace_cmb($objformulario->fie_tabledb,$objformulario->fie_datadb,$objformulario->fie_sql,$valorbus,$DB_gogess));
