...
$linkcambior="onclick=abrir_standar('aplicativos/documental/cambio_fecha.php','CAMBIO','divBody_foto','divDialog_foto',500,300,'procedimientos',$('#prinvas_id').val(),0,0,0,0,0) style='cursor:pointer'";
//echo '&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-warning" '.$linkcambior.'  style="cursor:pointer"> CAMBIAR FECHA REGISTRO </button>';

$linkhistorialr="onclick=abrir_standar('aplicativos/documental/historial_fecha.php','CAMBIO','divBody_foto','divDialog_foto',790,300,'procedimientos',$('#prinvas_id').val(),0,0,0,0,0) style='cursor:pointer'";
...
//cambio de fecha registro
			...
			$objformulario->sendvar["prinvas_horainiciox"]='00 : 00';
			$objformulario->sendvar["prinvas_horafinx"]='00 : 00';
			...
			$objformulario->sendvar["prinvas_enlacex"]=$aletorioid;
