...
$sql_actualiza="update dns_atencionevaluacion set eteneva_observacion='".$_POST["eteneva_observacionx"]."',eteneva_lab='".$_POST["eteneva_labx"]."',eteneva_img='".$_POST["eteneva_imgx"]."',eteneva_fechaentrega='".$_POST["eteneva_fechaentregax"]."',eteneva_fecharegistro='".date("Y-m-d")."',usua_id='".$_POST['sess_id']."' where eteneva_id=".$_POST["eteneva_idx"];
...
//busca producto
 ...
 $sql_inserta="INSERT INTO `dns_atencionevaluacion` (eteneva_observacion,eteneva_lab,eteneva_img,eteneva_fechaentrega,eteneva_fecharegistro,atenc_enlace,usua_id,prod_id,prod_precio,clie_id,centro_id,eteneva_num) VALUES ('".$_POST["eteneva_observacionx"]."','".$_POST["eteneva_labx"]."', '".$_POST["eteneva_imgx"]."','".$_POST["eteneva_fechaentregax"]."','".date("Y-m-d")."','".$_POST["enlace"]."','".$_POST['sess_id']."','".$rs_serial->fields["prod_id"]."','".$rs_serial->fields["prod_precio"]."','".$_POST["clie_id"]."','".$_POST['centro_id']."','".$estees_uno."')";
...
<table class="table table-bordered"  style="width:100%" >
  <tr>
	...
	{
	   $concatena_camp.=" <td>".$lista_espe[$i]["nombre"]."</td> ";
	}
	echo $concatena_camp;
	?>	
	<td>Fecha Entrega</td>
...
<td onClick="ver_informepdf(1,'<?php echo $rs_data->fields["eteneva_id"]; ?>')" style="cursor:pointer" ><span class="glyphicon glyphicon-list-alt"></span></td>
	...
	if($rs_data->fields["eteneva_lab"]=='true')
	...
	if($rs_data->fields["eteneva_img"]=='true')
