				...
				case 'doccabcp_idx':
					{
						...
						{
		                $this->fill_cmb($rs_lcanp->fields["gridfield_tablecmb"],$rs_lcanp->fields["gridfield_camposcmb"],''," where doccab_id in (".$despliega_nopg.") and doccab_rucci_cliente='".$rs_rucd->fields["provee_ruc"]."' ".$rs_lcanp->fields["gridfield_ordercmb"],$DB_gogess);
						}
