...
function cambio_fcocajac()
{
   var jsLang = $("#detmovcj_id").val();
  // alert($('#ttra_id').val());
   
   if($('#detmovcj_id').val()>='1')
   {   
    //cobro
	switch (jsLang) 
	{ 
		case '1': 
			{
				$('#bloque_cajachica_ordenpago').show();
				$('#bloque_cajachica_cheque').show();
				$('#bloque_cajachica_fechacheque').show();
 
			   $('#bloque_cajachica_numcomprobante').hide();
		...
		case '2': 
			{
			   ...
			   $('#bloque_cajachica_numcomprobante').show();
			   
			    $('#bloque_cajachica_ordenpago').hide();
				$('#bloque_cajachica_cheque').hide();
				$('#bloque_cajachica_fechacheque').hide();
