<?php	  
			...
			$objformulario->sendvar["egrec_tipox"]=1;	
			$objformulario->sendvar["tdes_idx"]=1;		
...
if (confirm("Esta seguro que desea realizar este proceso ?"))
  ...
  $("#proceso_divval").load("egresovarios/procesar_despacho.php",{
...
function imprimir_despacho()
{
  ...
  tablas_verlista('egresovarios/verlista.php',$.base64.encode($('#egrec_id').val()));
