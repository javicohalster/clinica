...
if($rs_lvalcombo)
{
	  ...
	  $camidcl='';
	  if($fie_tablasubgrid=='pichinchahumana_extension.dns_gridexamenfisicopedia')
      {
	    $camidcl='opcexa_id';
	  }
	  ...
	  $LLENA_SP='';
	  $color_fondo='';
	  $busca_estado="select tiporg_nombre from ".$fie_tablasubgrid." where ".$camidcl."='".$rs_lvalcombo->fields[$saca_nombredatavalor[0]]."' and ".$campo_enlace."='".$valor_enlace."'";
...
<table border="0" width="100%">
  ...
  <tr>
	...
	<input name="radio_sel'.$this->fie_id.'_'.$rs_lvalcombo->fields[$saca_nombredatavalor[0]].'" type="radio" value="CP" onclick="'.$clicvalor.'"  '.$LLENA_CP.' />
	</div>
	</td>
    <td><input name="radio_sel'.$this->fie_id.'_'.$rs_lvalcombo->fields[$saca_nombredatavalor[0]].'" type="radio" value="SP" onclick="'.$clicvalor.'"  '.$LLENA_SP.' /></td>
  </tr>
</table>
