...
<?php	  
			...
			$objformulario->sendvar["asigr_enlacex"]=$aletorioid;
...
abrir_standar('templateformsweb/maestro_standar_rubro/buscadorform/busca_data.php','Buscador','divBody_buscadorgeneral','divDialog_buscadorgeneral',550,500,id,0,0,0,0,0,0);
