...
$rs_lcanp = $DB_gogess->executec($lista_campos,array());
 if($rs_lcanp)
 {
	  ...
	  {
		  echo '<div class="col-md-'.$rs_lcanp->fields["gridfield_tamano"].'"><b>'.utf8_encode($rs_lcanp->fields["gridfield_title"]),'</b>';
	  ...
	  {
	      echo '<div class="col-md-'.$rs_lcanp->fields["gridfield_tamano"].'"><b>'.utf8_encode($rs_lcanp->fields["gridfield_title"]),'</b>';
		  echo '<textarea placeholder="'.utf8_encode($rs_lcanp->fields["gridfield_title"]).'" name="'.utf8_encode($rs_lcanp->fields["gridfield_nameid"]).'" id="'.$rs_lcanp->fields["gridfield_nameid"].'"  class="form-control"  '.$rs_lcanp->fields["gridfield_extra"].' ></textarea>';
		  echo '</div>';
	  }
	  ...
	  {
	      echo '<div class="col-md-'.$rs_lcanp->fields["gridfield_tamano"].'">';
