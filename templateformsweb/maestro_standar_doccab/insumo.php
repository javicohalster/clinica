...
$("#list_insumo").load("templateformsweb/maestro_standar_doccab/lista_insumo.php",{
valor_b:$('#valor_b').val()
 },function(result){       
...
$("#agregar_insumo").load("templateformsweb/maestro_standar_doccab/agregar_insumo.php",{
