 ...
 if($rs_data)
 {
				...
				default:
				   {
					 ...
					 $arreglo_data[$fie_camposgridselect[$i]]=$arreglo_data[$fie_camposgridselect[$i]]+$rs_data->fields[$fie_camposgridselect[$i]];
  ...
  <tr>
   ...
   <?php
	for($i=0;$i<count($fie_camposgridselect);$i++)
	 {
       if($fie_camposgridselect[$i]=='gsabucal_placa' or $fie_camposgridselect[$i]=='gsabucal_calculo' or $fie_camposgridselect[$i]=='gsabucal_gingivitis')
	   {
	   echo '<td bgcolor="#DFE9EE" >'.$arreglo_data[$fie_camposgridselect[$i]].'</td>';
	   }
	   else
	   {
	   echo '<td bgcolor="#DFE9EE" ></td>';
