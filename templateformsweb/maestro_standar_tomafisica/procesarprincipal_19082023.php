  ...
  if($rs_paraentrega)
   {
	  ...
	  //envios pacientes
	  $busca_entregados="select sum(moviin_totalenunidadconsumo) as totalv from dns_principalmovimientoinventario where centro_id='".$centro_id."' and (entregamoviin_id='".$rs_paraentrega->fields["moviin_id"]."' or  entregamoviin_id='0') and tipom_id=2 and moviin_nlote ='".$rs_paraentrega->fields["moviin_nlote"]."' and cuadrobm_id='".$cuadrobm_id."' and centro_id='".$centro_id."' and perioac_id='".$periodo_actual."' and moviincent_id=0";
	  $rs_entregados = $DB_gogess->executec($busca_entregados,array());
	  // envios pacientes
	  //echo $busca_entregados."<br>";
	  //trasnferencias
	  
	  $busca_entregadost="select sum(moviin_totalenunidadconsumo) as totalv from dns_principalmovimientoinventario where centro_id='".$centro_id."' and entregamoviin_id='0' and tipom_id=2 and moviin_nlote ='".$rs_paraentrega->fields["moviin_nlote"]."' and cuadrobm_id='".$cuadrobm_id."' and centro_id='".$centro_id."' and perioac_id='".$periodo_actual."' and moviincent_id='".$rs_paraentrega->fields["moviin_id"]."'";
