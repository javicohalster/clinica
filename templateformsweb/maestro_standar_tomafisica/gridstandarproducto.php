...
if($('#tomfis_id').val()=='')
{
  alert("Para realizar el proceso debe guardar el registro...");
  return false;
}

if($('#centro_id').val()=='')
{
  alert("Para realizar el proceso debe seleccionar una bodega si usted cambia de bodega una ves que ya registro los productos esto ocacionara problemas en el ajuste...");
  return false;
}
...
<div id="detaprecio" style="font-size:14px;"></div>
<br />
</div>
...
abrir_standar('templateformsweb/maestro_standar_tomafisica/buscador/busca_data.php','Buscador','divBody_buscadorgeneral','divDialog_buscadorgeneral',500,400,id,0,0,0,0,0,0);
...
$("#lista_producto").load("<?php echo $this->formulario_path; ?>calculo.php",{
   ...
   ajuspr_cantidadx:$('#ajuspr_cantidadx').val(),
   ajuspr_crealx:$('#ajuspr_crealx').val()  
