...
echo $centro_redpublica=$objformulario->replace_cmb("dns_centrosalud","centro_id,centro_redpublica"," where centro_id=",$centro_id,$DB_gogess);
...
$busca_movimientoult="select * from dns_movimientoinventario where cuadrobm_id='".$cuadrobm_id."' and tipom_id='1' and centro_id='".$centro_id."' order by moviin_id desc limit 1";
  ...
  if($rs_paraentrega)
   {
	 ...
	 // $actual_porlote=0;
	  ...
	  if($actual_porlote>0)
	  {
		...
		$ajuspr_diferencia=ir_quitandoporlote($moviin_idvalor,$centro_id,$ajuspr_diferencia,$disponible_lote,$ajuspr_id,$centro_redpublica,$objformulario,$DB_gogess);
...
function ir_quitandoporlote($moviin_idvalor,$centro_id,$ajuspr_diferencia,$disponible_lote,$ajuspr_id,$centro_redpublica,$objformulario,$DB_gogess)
{
