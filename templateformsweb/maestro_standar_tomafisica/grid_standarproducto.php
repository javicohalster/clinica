...
<table class="table table-bordered"  style="width:100%" >
  <tr>
   ...
   <?php
	...
	<td bgcolor="#DFE9EE" >Variaci&oacute;n</td>
  </tr>
<?php
$cuenta=0;
if($tabla_combo)
...
$validat_sello=0;	
 if($validat_sello>0)
 {
  ...
  ?>
	...
	<td bgcolor="#DFE9EE" <?php echo $m_alerta; ?> ><?php echo $variacionp; ?></td>
...
if($bandera_pr==1)
{
  echo 'alert("Hay productos sin precio porfavor corregir antes de realizar el ajuste.");
  ';
  //echo '$("#procesa_ajusev").hide(); ';  
 // echo '$("#genera_ascv").hide();  ';
}
?>
