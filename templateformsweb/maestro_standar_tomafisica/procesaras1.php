...
$datos_produ="select * from lpin_tomafisica inner join lpin_ajusteproducto on lpin_tomafisica.tomfis_enlace=lpin_ajusteproducto.tomfis_enlace where tomfis_id='".$tomfis_id."' and ajuspr_id='".$ajuspr_id."'";
...
if($rs_produ)
 {
	  while (!$rs_produ->EOF) {	
	     ...
	     ///////////////////////////lista de productos////////////////////////////////////////////////////////////
			...
			$categ_cuentacontableventas=$rs_cuentabu->fields["categ_cuentacosto"];
