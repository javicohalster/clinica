...
<input type="button" name="btn_gridmhdetallefactura_id" id="btn_gridmhdetallefactura_id" value="MCGRAW HILL/PRECUENTA CONSUMO" onclick="ocultar_mostrar3('gridmhdetallefactura_id')" />
...
abrir_standar("templateformsweb/maestro_standar_ventas/sri.php","SRI","divBody_insumo","divDialog_insumo",400,180,0,0,0,0,0,0,0);
...
abrir_standar("templateformsweb/maestro_standar_ventas/precuenta.php","PRECUENTAS","divBody_insumo","divDialog_insumo",800,480,$('#doccab_identificacionpaciente').val(),0,0,0,0,0,0);
