...
$('#crudet_fechaemisionx').val('<?php echo $doccab_fechaemision_cliente; ?>');
$('#crudet_tipodocumentox').val('<?php echo $tipdoc_id; ?>');
$('#crudet_valorx').val('<?php echo $valor_sinretencion; ?>');
$('#crudet_valorpagox').val('');
