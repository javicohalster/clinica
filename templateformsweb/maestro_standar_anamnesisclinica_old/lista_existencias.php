...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>
  <tr>
    <td bgcolor="#E6F3F9" class="css_txt" ><?php echo utf8_encode($rs_centros->fields["centro_nombre"]); ?></td>
	<td bgcolor="#F2F2F2" class="css_txt" ><?php echo utf8_encode($rs_centros->fields["centro_direccion"]); ?></td>
	<td bgcolor="#E6F3F9" class="css_txt" ><?php echo utf8_encode($rs_cbmedicamento->fields["cuadrobm_codigoatc"]) ?></td>
	<td bgcolor="#E6F3F9" class="css_txt" ><?php echo utf8_encode($rs_cbmedicamento->fields["cuadrobm_principioactivo"]) ?></td>
    <td bgcolor="#E6F3F9" class="css_txt" ><?php echo utf8_encode($rs_cbmedicamento->fields["cuadrobm_primerniveldesagregcion"]) ?></td>
