	...
	for($i=0;$i<count($fie_camposgridselect);$i++)
	 {
		...
		/* $link_guarda="guarda_check_cmb".$_POST["fie_id"]."('".$campo_id."','".$rs_data->fields[$campo_id]."','".$sub_tabla."','".$fie_camposgridselect[$i]."',$('#".$fie_camposgridselect[$i].$rs_data->fields[$campo_id].$i."').val(),'".$i."','".$rs_lcanpz->fields["gridfield_campoafectacheck"]."','".$rs_lcanpz->fields["gridfield_valordefault"]."','".$rs_lcanpz->fields["gridfield_orderecibe"]."','".$campo_fecharegistro."');";	 
		 ...
		 {
		 echo '<td style="font-size:10px;"  > <input onclick="'.$link_guarda.'" type="checkbox" id="'.$fie_camposgridselect[$i].$rs_data->fields[$campo_id].$i.'" name="'.$fie_camposgridselect[$i].$rs_data->fields[$campo_id].$i.'" value="'.$rs_data->fields[$fie_camposgridselect[$i]].'" checked="checked" /> </td>';
		 }
		 else
		 {
		 echo '<td style="font-size:10px;"  > <input onclick="'.$link_guarda.'" type="checkbox" id="'.$fie_camposgridselect[$i].$rs_data->fields[$campo_id].$i.'" name="'.$fie_camposgridselect[$i].$rs_data->fields[$campo_id].$i.'" value="'.$rs_data->fields[$fie_camposgridselect[$i]].'"  /> </td>';
		 }*/
