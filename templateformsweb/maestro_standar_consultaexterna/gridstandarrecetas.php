...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_standarrecetas.php",{
...
$rs_lcanp = $DB_gogess->executec($lista_campos,array());
 if($rs_lcanp)
 {
	  ...
	  if($rs_lcanp->fields["gridfield_tipo"]=='textnumerico')
	  {
...
<div id="div_disponibilidad" align="center"></div>
