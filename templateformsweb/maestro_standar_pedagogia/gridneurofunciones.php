...
<?php echo $campo_id; ?>x:id_grid
	...
	?>
    enviar_formulario('form_faesa_pedagogia');
  });  
...
<button type="button" class="btn btn-primary btn-sm"  onClick="agregar_varios_cmb<?php echo $this->fie_id;  ?>('<?php 
...
?>')"  style="background-color:#000066" >AGREGAR TODOS</button>
     ...
     <div class="col-md-4">
      ...
      <select class="form-control" name="areev_idx" id="areev_idx"  >
         ...
         <option value="" >--Seleccion Producto--</option>
			...
			$this->fill_cmb('faesa_areaev','areev_id,areev_nombre','',' order by areev_orden asc',$DB_gogess);
