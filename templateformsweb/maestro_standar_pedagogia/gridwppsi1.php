...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_wisc.php",{
...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="escwppsi1_idx" id="escwppsi1_idx"  >
       <option value="" >--Seleccion Sub escala--</option>
		<?php
		$this->fill_cmb('faesa_escalaswppsi','escwppsi1_id,escwppsi1_nombre','',' order by escwppsi1_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Puntaje - Percentil" name="wppsi1_marcadorx" id="wppsi1_marcadorx"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-4">
	 <textarea placeholder="Interpretaci&oacute;n" name="wppsi1_observacionx" id="wppsi1_observacionx"  class="form-control"  ></textarea>
