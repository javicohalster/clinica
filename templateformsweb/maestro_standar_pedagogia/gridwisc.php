...
<div class="form-group">
	 <div class="col-md-4">
	  <select class="form-control" name="escwisc_idx" id="escwisc_idx"  >
       <option value="" >--Seleccion Sub escala--</option>
		<?php
		$this->fill_cmb('faesa_escalaswisc','escwisc_id,escwisc_nombre','',' order by escwisc_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-4">
	 <textarea placeholder="Puntaje - Percentil" name="wisc_marcadorx" id="wisc_marcadorx"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-4">
	 <textarea placeholder="Interpretaci&oacute;n" name="wisc_observacionx" id="wisc_observacionx"  class="form-control"  ></textarea>
