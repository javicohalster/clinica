...
$("#lista_detalles_<?php echo $this->fie_id;  ?>").load("<?php echo $this->formulario_path; ?>/grid_velocidadpor.php",{
...
<div class="form-group">
	 <div class="col-md-3">
	  <select class="form-control" name="escvelopor_idx" id="escvelopor_idx"  >
       <option value="" >--Seleccion Escala--</option>
		<?php
		$this->fill_cmb('faesa_escalavelopor','escvelopor_id,escvelopor_nombre','',' order by escvelopor_id asc',$DB_gogess);
		?>
       </select>
      </div> 
      <div class="col-md-3">
	 <textarea placeholder="Sub Escala" name="velopor_subescalax" id="velopor_subescalax"  class="form-control"  ></textarea>
     </div>
	  <div class="col-md-3">
	 <textarea placeholder="Percentil" name="velopor_percentilx" id="velopor_percentilx"  class="form-control"  ></textarea>
      </div>
	  
	   <div class="col-md-3">
	 <textarea placeholder="Apreciaci&oacute;n" name="velopor_apreciacionx" id="velopor_apreciacionx"  class="form-control"  ></textarea>
...
{
?>
 grid_extras_<?php echo $this->fie_id;  ?>('<?php echo @$this->sendvar["pedago_enlacex"]; ?>',0,0);
<?php
}
?>
 //  End -->
