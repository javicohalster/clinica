...
<div class="panel panel-default">
	<div class="panel-body">
		<button type="button" class="mb-sm btn btn-primary" onClick="genera_copia()" style="background-color:#000066">COPIAR EL PRIMERO A TODOS</button>
...
<script type="text/javascript">
	...
	function genera_copia() {
		...
		$("#g_copias").load("<?php echo $this->formulario_path; ?>actualizartodo.php", {
		...
		$("#g_copias").html("Espere un momento...");
