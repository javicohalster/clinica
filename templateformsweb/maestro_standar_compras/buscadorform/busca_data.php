...
<script type="text/javascript">
  ...
  function buscar_datavalor() {
    ...
    $("#despliega_data").load("templateformsweb/maestro_standar_compras/buscadorform/listado.php", {
      b_data: $('#b_data').val(),
      fie_id: '<?php echo $fie_id; ?>',
      frocob_id: '<?php echo $frocob_id; ?>'
    }, function(result) {
