...
$busca_autorizada1="select * from comprobante_retencion_cab where compretcab_estadosri='AUTORIZADO' and compretcab_anulado='' and compra_id='".$compra_id."'";
$rsburet_auto = $DB_gogess->executec($busca_autorizada1);

if($rsburet_auto->fields["compretcab_id"])
{
   echo "Retencion ya fue autorizada";
