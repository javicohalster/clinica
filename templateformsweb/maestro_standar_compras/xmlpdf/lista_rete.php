...
function enviar_correoret(compretcab_id)
{

$("#area_retsri").load("correo/email_retencion.php",{
...
<div id="asiento_retencioncomp"></div>
<script language="javascript">
<!--

function genera_asientoretencioncompra()
{

   $("#asiento_retencioncomp").load("aplicativos/documental/asientos/compras/ejecuta_comprasretencion.php",{
      valor_id:$('#compra_id').val(),
