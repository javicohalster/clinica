...
$gridfield_filtrodespliegalista=$rs_obtdata->fields["gridfield_filtrodespliegalista"];
$filtro_data='';
if($gridfield_filtrodespliegalista)
	{
	    $filtro_data=$gridfield_filtrodespliegalista;		
		$filtro_data=str_replace('-enlace-','xxx',$filtro_data);	  
	}
...
$ordena_bu="";
		  ...
		  {
		       $consulta_valor=" ".$filtro_data." and planc_codigoc in (".$paralista_sql.") and ";
...
{
$lista_sql="select * from ".$gridfield_tablecmb."  where ".$consulta_valor." (".$listabusqueda.") and ".$gridfield_filtrobuscador." ".$ordena_bu;
}
else
{
$lista_sql="select * from ".$gridfield_tablecmb."  where ".$consulta_valor." (".$listabusqueda.") ".$ordena_bu;
}
