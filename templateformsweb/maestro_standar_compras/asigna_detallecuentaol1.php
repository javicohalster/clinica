...
$inserta_data="INSERT INTO lpin_cuentacompra ( compra_enlace, cuecomp_cantidad, cuecomp_preciounitario, porcecr_id, porceci_id, cuecomp_descuento, cuecomp_descuentodolar, cuecomp_subtotal, usua_id, cuecomp_fecharegistro, cuecomp_codigoext, cuecomp_descripext, cdxml_id,taric_id) VALUES
('".$compra_enlace."','".$cuecomp_cantidad."','".$cuecomp_preciounitario."','".$porcecr_id."','".$porceci_id."','".$cuecomp_descuento."','".$cuecomp_descuentodolar."','".$cuecomp_subtotal."','".$usua_id."','".$cuecomp_fecharegistro."','".$cuecomp_codigoext."','".$cuecomp_descripext."','".$cdxml_id."','".$taric_id."');";
