...
<table border="0" cellpadding="0" cellspacing="3">
			  <tr>
			    ...
			    <td>&nbsp;</td>
			    <td><button type="button" class="mb-sm btn btn-danger"  onClick="funcion_cerrar_pop('.$comillasimple.'divDialog_reg'.$comillasimple.')"  >Cancelar</button></td>
			  </tr>
			</table>
</div>';	
...
$mensajege='<span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#006600;" >Registro guardado con exito...</span>';
		...
		$funcionextrag="despues_guardar()";
		$funciones_cuandofalla="falla_guardado()";
  		$template_reemplazo='templateformsweb/maestro_standar_registro/';			  

?>


<div align="center" >	 
<div id="acceso_registro" >
