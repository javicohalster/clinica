		  ...
		  else
           {
			 ...
			 echo $objformulario->fie_title." ".$objformulario->fie_txtizq."<input name='".$nombre_campo."' type='text' class='".$objformulario->fie_styleobj."'  value='".$objformulario->sendvar[$objformulario->fie_sendvar]."' maxlength='".$len."' ".$objformulario->fie_attrib." size='".$objformulario->fie_lencampo."'  >".$objformulario->fie_txtextra;
             ...
             else
              {
				...
				{
                   echo $objformulario->fie_title." ".$objformulario->fie_txtizq."Desde:<input name='".$nombre_campo."' type='text' class='".$objformulario->fie_styleobj."'  value='".$_POST[$nombre_campo]."' maxlength='".$len."' ".$objformulario->fie_attrib." size='7' >".$objformulario->fie_txtextra;				   				  
				   
				    echo "Hasta: <input name='".$nombre_campo."2' type='text' class='".$objformulario->fie_styleobj."'  value='".$_POST[$nombre_campo."2"]."' maxlength='".$len."' ".$objformulario->fie_attrib." size='7' >".$objformulario->fie_txtextra;				   				  
					
				 }
				 else
				 {
				 
				  echo $objformulario->fie_title." ".$objformulario->fie_txtizq."kkk<input name='".$nombre_campo."' type='text' class='".$objformulario->fie_styleobj."'  value='".$objformulario->fie_value."' maxlength='".$len."' ".$objformulario->fie_attrib." size='10' >".$objformulario->fie_txtextra;				   				  
