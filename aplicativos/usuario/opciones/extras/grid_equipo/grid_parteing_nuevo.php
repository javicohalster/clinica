...
$mensajege='<span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#006600;" >Registro guardado con exito...</span>';
		...
		$funcionextrag="desplegar_gr_partes('".$_POST["pVar2"]."');
		
		";
  		$template_reemplazo='templateformsweb/maestro_standar_ingparte/';			  
...
<script type="text/javascript">
<!--
$( "#pi_fecha_adquisicion" ).datepicker({dateFormat: 'yy-mm-dd'});
$( "#pi_fecha_finalizacion_prestamo" ).datepicker({dateFormat: 'yy-mm-dd'});
$( "#pi_fecha_finalizacion_prestamo_adquisicion" ).datepicker({dateFormat: 'yy-mm-dd'});
