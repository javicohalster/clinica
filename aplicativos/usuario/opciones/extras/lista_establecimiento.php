...
$listacajas="select distinct factura_establecimiento.estab_id,estab_codigo from factura_usuariocaja,factura_puntoemision,factura_establecimiento,factura_empresa where factura_usuariocaja.emi_id=factura_puntoemision.emi_id and  factura_puntoemision.estab_id=factura_establecimiento.estab_id and factura_establecimiento.emp_id=factura_empresa.emp_id  and usua_ciruc='".$_POST["pruc_valor"]."' and usca_activo=1 and factura_empresa.emp_id=".$_POST["emp_id"];	 
