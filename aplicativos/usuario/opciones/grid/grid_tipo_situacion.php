...
if($_POST["ts_situacion_val"])
{
   $sql1="ts_situacion like '".$_POST["ts_situacion_val"]."' and ";
}
...
$subindice="_tipo_situacion";
$tabla="ca_tipo_situacion";
$campoidtabla="ts_id";
$objgrid_fk->campos_visualizar="'ts_id','ts_situacion'";
$ordenlistado="order by ts_id desc";
