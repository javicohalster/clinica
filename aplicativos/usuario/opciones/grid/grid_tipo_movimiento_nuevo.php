...
<table border="0" cellpadding="0" cellspacing="3">
			  <tr>
			    ...
			    <td>&nbsp;</td>
			    <td onClick="funcion_cerrar_pop('.$comillasimple.'divDialog_tipo_movimiento'.$comillasimple.')"  style="cursor:pointer" ><img src="images/cancelar.png" ></td>
			  </tr>
			</table>
</div>';	
...
$mensajege='<span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#006600;" >Registro guardado con exito...</span>';
		...
		$funcionextrag="desplegar_grid()";
  		$template_reemplazo='templateformsweb/maestro_standar_tipo_movimiento/';			  
...
{
        $("#lista_resultado").load("aplications/usuario/opciones/extras/lista_tipo_movimiento.php",{
