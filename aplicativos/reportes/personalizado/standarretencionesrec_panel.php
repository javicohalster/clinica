...
<SCRIPT LANGUAGE=javascript>
  ...
  function ejecuta_reporte() {
    ...
    $("#ver_reporte").load("lospinos/listastandar_retencionesrec.php", {
      ...
      compretcab_nombrerazon_cliente: $('#compretcab_nombrerazon_cliente').val(),
      estado_sri: $('#estado_sri').val()
...
<table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td bgcolor="#E6F1F2" class="style1"></td>
    <td bgcolor="#E6F1F2" class="style1">N RETENCION</td>
    <td bgcolor="#E6F1F2" class="style1">&nbsp;</td>
    <td bgcolor="#E6F1F2" class="style1">&nbsp;</td>
    <td bgcolor="#E6F1F2" class="style1">&nbsp;</td>
    <td bgcolor="#E6F1F2" class="style1">&nbsp;</td>
  ...
  <tr>
    ...
    <td>
      <select name="compretcab_rucci_cliente" id="compretcab_rucci_cliente" style="width:200px" class="js-basic-single3 form-control">
        <option value="">--seleccionar cliente--</option>
        <?php
        $objformulario->fill_cmb("beko_documentocabecera_vista", "doccab_rucci_cliente,doccab_nombrerazon_cliente", @$cliente_ruc, " order by 	doccab_nombrerazon_cliente asc", $DB_gogess);
        ?>
      </select>

    </td>
    <td>
      <input name="compretcab_nombrerazon_cliente" type="hidden" id="compretcab_nombrerazon_cliente" value="" />
    </td>
    <td>

      <input name="estado_sri" type="text" id="estado_sri" value="" />
...
<script type="text/javascript">
  ...
  function ver_excel() {
    ...
    location.href = "lospinos/listastandar_retencionesrec.php?estado_sri=" + $('#estado_sri').val() + "&compretcab_nombrerazon_cliente=" + $('#compretcab_nombrerazon_cliente').val() + "&compretcab_rucci_cliente=" + $('#compretcab_rucci_cliente').val() + "&fecha_inicio=" + $('#fecha_inicio').val() + "&fecha_fin=" + $('#fecha_fin').val() + "&previsual=2&clie_institucionval=" + $('#clie_institucionval').val() + "&ireport=<?php echo $ireport; ?>";
  ...
  function ver_pdf() {
    ...
    window.open("lospinos/listastandar_retencionesrec.php?estado_sri=" + $('#estado_sri').val() + "&compretcab_nombrerazon_cliente=" + $('#compretcab_nombrerazon_cliente').val() + "&compretcab_rucci_cliente=" + $('#compretcab_rucci_cliente').val() + "&fecha_inicio=" + $('#fecha_inicio').val() + "&fecha_fin=" + $('#fecha_fin').val() + "&previsual=3&clie_institucionval=" + $('#clie_institucionval').val() + "&ireport=<?php echo $ireport; ?>", '_blank');
