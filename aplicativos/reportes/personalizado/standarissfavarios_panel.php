...
<SCRIPT LANGUAGE=javascript>
    ...
    function ejecuta_reporte() {
        ...
        $("#ver_reporte").load("lospinos/listastandarvarios_issfa.php", {
...
<table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td>
            ...
            <select name="clie_institucionval" id="clie_institucionval" style="width:200px" class="js-basic-single3 form-control">
                <option value="">--seleccionar cliente--</option>
                <?php
                $objformulario->fill_cmb("pichinchahumana_extension.dns_convenios", "conve_id,conve_nombre", @$cliente_ruc, " order by 	conve_nombre asc", $DB_gogess);
                ?>
            </select>
...
<script type="text/javascript">
    ...
    function ver_pdf() {
        ...
        window.open("lospinos/listastandarvarios_issfa.php?usua_id=" + $('#usua_id').val() + "&precu_facturar=" + $('#precu_facturar').val() + "&precu_activo=" + $('#precu_activo').val() + "&convepr_id=" + $('#convepr_id').val() + "&categesp_id=" + $('#categesp_id').val() + "&especipr_id=" + $('#especipr_id').val() + "&clie_id=" + $('#clie_id').val() + "&centro_id=" + $('#centro_id').val() + "&fecha_inicio=" + $('#fecha_inicio').val() + "&fecha_fin=" + $('#fecha_fin').val() + "&previsual=3&clie_institucionval=" + $('#clie_institucionval').val() + "&ireport=<?php echo $ireport; ?>", '_blank');
