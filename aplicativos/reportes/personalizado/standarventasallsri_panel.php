...
<SCRIPT LANGUAGE=javascript>
  ...
  function ejecuta_reporte() {
    ...
    $("#ver_reporte").load("lospinos/listastandar_ventasallsri.php", {
...
<table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>
      <select name="cliente_ruc" id="cliente_ruc" style="width:200px" class="js-basic-single3 form-control">
...
<script type="text/javascript">
  ...
  function ver_excel() {
    ...
    location.href = "lospinos/listastandar_ventasallsri.php?cliente_ruc=" + $('#cliente_ruc').val() + "&centro_id=" + $('#centro_id').val() + "&fecha_inicio=" + $('#fecha_inicio').val() + "&fecha_fin=" + $('#fecha_fin').val() + "&previsual=2&clie_institucionval=" + $('#clie_institucionval').val() + "&ireport=<?php echo $ireport; ?>";
  ...
  function ver_pdf() {
    ...
    window.open("lospinos/listastandar_ventasallsri.php?cliente_ruc=" + $('#cliente_ruc').val() + "&centro_id=" + $('#centro_id').val() + "&fecha_inicio=" + $('#fecha_inicio').val() + "&fecha_fin=" + $('#fecha_fin').val() + "&previsual=3&clie_institucionval=" + $('#clie_institucionval').val() + "&ireport=<?php echo $ireport; ?>", '_blank');
