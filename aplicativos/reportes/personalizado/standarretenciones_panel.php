...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("lospinos/listastandar_retenciones.php",{
...
<table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
	 ...
	 <td bgcolor="#E6F1F2" class="style1">PROVEEDOR RUC/CI</td>
	 <td bgcolor="#E6F1F2" class="style1">NOMBRE PROVEEDOR</td>
	 <td bgcolor="#E6F1F2" class="style1">ESTADO SRI</td>
     <td bgcolor="#E6F1F2" class="style1">&nbsp;</td>
	 <td bgcolor="#E6F1F2" class="style1">&nbsp;</td>
	 <td bgcolor="#E6F1F2" class="style1">&nbsp;</td>
	 <td bgcolor="#E6F1F2" class="style1">&nbsp;</td>
  ...
  <tr>
	...
	<td>
	<input name="compretcab_rucci_cliente" type="text" id="compretcab_rucci_cliente" value="" />	
	</td>
	<td>
	<input name="compretcab_nombrerazon_cliente" type="text" id="compretcab_nombrerazon_cliente" value="" />	
	</td>
	<td>
...
function ver_excel()
{
 if($('#fecha_inicio').val()=='' && $('#fecha_fin').val()=='')
 {
  ...
  location.href = "lospinos/listastandar_retenciones.php?estado_sri="+$('#estado_sri').val()+"&compretcab_nombrerazon_cliente="+$('#compretcab_nombrerazon_cliente').val()+"&compretcab_rucci_cliente="+$('#compretcab_rucci_cliente').val()+"&fecha_inicio="+$('#fecha_inicio').val()+"&fecha_fin="+$('#fecha_fin').val()+"&previsual=2&clie_institucionval="+$('#clie_institucionval').val()+"&ireport=<?php echo $ireport; ?>";
...
function ver_pdf()
{
 ...
 if($('#fecha_inicio').val()=='' && $('#fecha_fin').val()=='')
 {
  ...
  return false;
   ...
   window.open("lospinos/listastandar_retenciones.php?estado_sri="+$('#estado_sri').val()+"&compretcab_nombrerazon_cliente="+$('#compretcab_nombrerazon_cliente').val()+"&compretcab_rucci_cliente="+$('#compretcab_rucci_cliente').val()+"&fecha_inicio="+$('#fecha_inicio').val()+"&fecha_fin="+$('#fecha_fin').val()+"&previsual=3&clie_institucionval="+$('#clie_institucionval').val()+"&ireport=<?php echo $ireport; ?>", '_blank');  
