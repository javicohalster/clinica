...
if($planc_codigoc)
{
$sql6=" detcc_cuentacontable like '".trim($planc_codigoc)."%' and ";
}  
...
$documento.='<table width="700" border="1"  cellpadding="2" cellspacing="0">
    <tr bgcolor="#E9E9E9" >
    <td width="153" ><div align="center"><strong>FECHA</strong></div></td>
	<td width="153" ><div align="center"><strong>CONCEPTO</strong></div></td>
    <td width="153" ><div align="center"><strong>NUMERO C</strong></div></td>
	<td width="356" ><div align="center"><strong>DESCRIPCION</strong></div></td>
	<td width="356" ><div align="center"><strong>REFERENCIA</strong></div></td>
	<td width="356" ><div align="center"><strong>CUENTA CONTABLE</strong></div></td>
    <td width="356" ><div align="center"><strong>DEBE</strong></div></td>	
	<td width="356" ><div align="center"><strong>HABER</strong></div></td>
	<td width="356" ><div align="center"><strong>AUTORIZACION</strong></div></td>
    <td width="179" ><div align="center"><strong>FECHA AUTORIZACION</strong></div></td>
	 <td width="179" ><div align="center"><strong>N DOCUMENTO</strong></div></td>
  </tr>';
  
//comcont_fecha,comcont_concepto,comcont_numeroc,detcc_descricpion,detcc_referencia,detcc_cuentacontable,detcc_debe,detcc_haber,doccab_nautorizacion,doccab_fechaaut,doccab_ndocumento 
...
//$listadiario="select * from lpin_detallecomprobantecontable_vista where ".$concatena_sql." and comcont_anulado=0 order by comcont_fecha,detcc_id asc";
 ...
 $listadiario="SELECT comcont_fecha,comcont_concepto,comcont_numeroc,detcc_descricpion,detcc_referencia,detcc_cuentacontable,detcc_debe,detcc_haber,doccab_nautorizacion,doccab_fechaaut,doccab_ndocumento FROM lpin_comprobantecontable inner join lpin_detallecomprobantecontable on lpin_comprobantecontable.comcont_enlace=lpin_detallecomprobantecontable.comcont_enlace left join beko_documentocabecera on comcont_idtabla=doccab_id  WHERE ".$concatena_sql." and comcont_anulado=0 order by comcont_fecha asc";
...
//$link_ver=" onclick=abrir_standarasiento('ver_asiento.php','Asiento','divBody_as','divDialog_as',500,499,'".$rs_listadiario->fields["comcont_id"]."',0,0,0,0,0,0)";	
	...
	//comcont_fecha,comcont_concepto,comcont_numeroc,detcc_descricpion,detcc_referencia,detcc_cuentacontable,detcc_debe,detcc_haber,doccab_nautorizacion,doccab_fechaaut,doccab_ndocumento 
	 ...
	 $documento.='<tr>
			...
			<td nowrap="nowrap" >'.$rs_listadiario->fields["comcont_numeroc"].'</td>
			<td nowrap="nowrap" >'.$rs_listadiario->fields["detcc_descricpion"].'</td>
			<td nowrap="nowrap" >'.$rs_listadiario->fields["detcc_referencia"].'</td>	
			<td nowrap="nowrap" >'.$rs_listadiario->fields["detcc_cuentacontable"].'</td>						
			<td>$'.number_format($rs_listadiario->fields["detcc_debe"], 2, '.', ',').'</td>
			<td>$'.number_format($rs_listadiario->fields["detcc_haber"], 2, '.', ',').'</td>
			<td nowrap="nowrap" style=mso-number-format:"@" >'.$rs_listadiario->fields["doccab_nautorizacion"].'</td>
			<td nowrap="nowrap" >'.$rs_listadiario->fields["doccab_fechaaut"].'</td>
			<td nowrap="nowrap" >'.$rs_listadiario->fields["doccab_ndocumento"].'</td>	
		  </tr>';
