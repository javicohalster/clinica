...
$contenido.="<docModificado></docModificado>\n";
$contenido.="<estabModificado></estabModificado>\n";
$contenido.="<ptoEmiModificado></ptoEmiModificado>\n";
$contenido.="<secModificado></secModificado>\n";
$contenido.="<autModificado></autModificado>\n";
...
$contenido.="<tipoEmision>F</tipoEmision>\n";
...
$suma_tventas=$suma_tventas+$baseImponible+$baseImpGrav;
$suma_ivast=$suma_ivast+$montoIva;
...
$contenido.="<ventaEst>\n";
$contenido.="<codEstab>001</codEstab>\n";
$contenido.="<ventasEstab>".number_format($suma_tventas, 2, '.', '')."</ventasEstab>\n";
$contenido.="<ivaComp>".number_format($suma_ivast, 2, '.', '')."</ivaComp>\n";
$contenido.="</ventaEst>\n";
$contenido.="</ventasEstablecimiento>\n";
...
$contenido_ca.="<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\" ?>\n";
$contenido_ca.="<iva>\n";
$contenido_ca.="<TipoIDInformante>R</TipoIDInformante>\n";
$contenido_ca.="<IdInformante>1792935261001</IdInformante>\n";
$contenido_ca.="<razonSocial>CLINICA LOS PINOS GUERRA GUZMAN PINOSMED CIALTDA</razonSocial>\n";
$contenido_ca.="<Anio>".$saca_aniio[0]."</Anio>\n";
$contenido_ca.="<Mes>".$saca_aniio[1]."</Mes>\n";
$contenido_ca.="<numEstabRuc>001</numEstabRuc>\n";
$contenido_ca.="<totalVentas>".number_format($suma_tventas, 2, '.', '')."</totalVentas>\n";
$contenido_ca.="<codigoOperativo>IVA</codigoOperativo>\n";
$contenido_ca.="<compras>\n";

///echo $contenido;
$documento=$contenido_ca.$contenido;
///programacion reporte
