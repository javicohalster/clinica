...
if($concatena_sql)
{  
$lista_doc="SELECT doccab_id,doccab_ndocumento,doccab_rucci_cliente,doccab_nombrerazon_cliente,doccab_fechaemision_cliente,doccab_estadosri,doccab_anulado,doccab_motivoanulado,doccab_total,retencion,subtotal,doccab_iva,saldo,tipocmp_nombre FROM beko_documentocabecera_vista  where ".$concatena_sql."  and doccab_anulado!='ANULADO' and tipocmp_nombre='FACTURA' and saldo>0";
}
else
{
$lista_doc="SELECT doccab_id,doccab_ndocumento,doccab_rucci_cliente,doccab_nombrerazon_cliente,doccab_fechaemision_cliente,doccab_estadosri,doccab_anulado,doccab_motivoanulado,doccab_total,retencion,subtotal,doccab_iva,saldo,tipocmp_nombre FROM beko_documentocabecera_vista  where compra_anulado!='ANULADO' and tipocmp_nombre='FACTURA' and saldo>0";
