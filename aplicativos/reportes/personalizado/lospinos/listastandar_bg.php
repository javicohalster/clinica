...
$ib=0;
 if($rs_listadiario)
 {
	 ...
	 $sumatotales_r="select round(sum(detcc_debe - detcc_haber),2) as totales from lpin_temporalresultadoeje_vista where ".$concatena_sql." and detcc_cuentacontablep like '".$rs_listadiario->fields["planc_codigoc"].".%' and comcont_anulado=0";	 
