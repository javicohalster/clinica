...
if($concatena_sql)
{  
$lista_doc="SELECT *,'0' as ivagasto,'0' as ice FROM beko_documentocabecera inner join app_proveedor on beko_documentocabecera.proveeve_id=app_proveedor.provee_id where ".$concatena_sql." and doccab_anulado=0 ";
}
else
{
$lista_doc="SELECT *,'0' as ivagasto,'0' as ice FROM beko_documentocabecera inner join app_proveedor on beko_documentocabecera.proveeve_id=app_proveedor.provee_id where doccab_anulado=0 ";
