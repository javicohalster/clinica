...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("lospinos/listastandar_cxp.php",{
...
<table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<select name="cliente_ruc" id="cliente_ruc" style="width:200px">
	  ...
	  <?php
	    $objformulario->fill_cmb("app_proveedor_cxp","provee_id,provee_nombre",@$cliente_ruc," order by provee_nombre asc",$DB_gogess);
	  ?> 
    </select>
	</td>
...
function ver_excel()
{
 ...
 // alert("seleccione el rango de fecha");
  ...
  location.href = "lospinos/listastandar_cxp.php?cliente_ruc="+$('#cliente_ruc').val()+"&centro_id="+$('#centro_id').val()+"&fecha_inicio="+$('#fecha_inicio').val()+"&fecha_fin="+$('#fecha_fin').val()+"&previsual=2&clie_institucionval="+$('#clie_institucionval').val()+"&ireport=<?php echo $ireport; ?>";
...
function ver_pdf()
{
 ...
 if($('#fecha_inicio').val()=='' && $('#fecha_fin').val()=='')
 {
  ...
  //return false;
   ...
   window.open("lospinos/listastandar_cxp.php?cliente_ruc="+$('#cliente_ruc').val()+"&centro_id="+$('#centro_id').val()+"&fecha_inicio="+$('#fecha_inicio').val()+"&fecha_fin="+$('#fecha_fin').val()+"&previsual=3&clie_institucionval="+$('#clie_institucionval').val()+"&ireport=<?php echo $ireport; ?>", '_blank');  
