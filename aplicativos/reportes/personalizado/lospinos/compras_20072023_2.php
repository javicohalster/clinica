...
if($tipdoc_id=='9')
{
 $signo=-1;
	  ...
	  ?>
	  <tr>
    <td  nowrap="nowrap"><?php echo $tipdoc_id; ?></td>
    ...
    <td><?php  ?></td>
    <td><?php echo ($rs_data->fields["compra_subtotaliva"]*$signo);
	@$total1=@$total1+ ($rs_data->fields["compra_subtotaliva"]*$signo);
	 ?></td>
    <td><?php echo ($rs_data->fields["compra_subtotalceroiva"]*$signo); 
	
	@$total2=@$total2+ ($rs_data->fields["compra_subtotalceroiva"]*$signo);
	?></td>
    <td><?php echo ($rs_data->fields["noobjeto"]*$signo); 
	@$total3=@$total3+ ($rs_data->fields["noobjeto"]*$signo);
	
	?></td>
    <td><?php echo ($rs_data->fields["subtotal"]*$signo); 
	@$total4=@$total4+ ($rs_data->fields["subtotal"]*$signo);
	?></td>
    <td><?php echo ($rs_data->fields["compra_iva"]*$signo); 
	...
	?></td>
    <td><?php echo ($rs_data->fields["compra_total"]*$signo); 
