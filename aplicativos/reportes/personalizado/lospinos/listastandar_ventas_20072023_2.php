...
$documento.='<td></td>';
$documento.='<td></td>';
$documento.='<td>'.($rs_data->fields["doccab_subtotaliva"]*$signo).'</td>';
@$total1=@$total1+ ($rs_data->fields["doccab_subtotaliva"]*$signo);
$documento.='<td>'.($rs_data->fields["doccab_subtotalsiniva"]*$signo).'</td>';	
...
$documento.='<td>'.($rs_data->fields["doccab_iva"]*$signo).'</td>';
...
$documento.='<td>'.($rs_data->fields["doccab_total"]*$signo).'</td>'; 
