...
if($concatena_sql)
{  
$lista_doc="SELECT compra_id,compra_fecha,provee_nombre,compra_nfactura,compra_descripcion,neto,compra_iva,compra_total,compra_anulado,totalret,saldo,sriretencion,tipdoc_nombre FROM dns_compras_vista  where ".$concatena_sql."  and compra_anulado=0 and tipdoc_id!=9";
}
else
{
$lista_doc="SELECT compra_id,compra_fecha,provee_nombre,compra_nfactura,compra_descripcion,neto,compra_iva,compra_total,compra_anulado,totalret,saldo,sriretencion,tipdoc_nombre FROM dns_compras_vista  where compra_anulado=0 and tipdoc_id!=9";
