...
<table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
     ...
     <td bgcolor="#E6F1F2" class="style1">ID COMPROBANRE </td>
  ...
  <tr>
	...
	<select name="planc_codigoc" id="planc_codigoc">
	  ...
	  <?php
	   	$busca_usuarios="select * from lpin_plancuentas order by planc_orden asc";
    ...
    <td><input name="comprobante_codex" type="text" id="comprobante_codex" value=""  /></td>
...
function ver_excel()
{
 if($('#fecha_inicio').val()=='' && $('#fecha_fin').val()=='')
 {
  ...
  location.href = "lospinos/mayorglobal_analitico.php?comprobante_codex="+$('#comprobante_codex').val()+"&planc_codigoc="+$('#planc_codigoc').val()+"&cliente_ruc="+$('#cliente_ruc').val()+"&centro_id="+$('#centro_id').val()+"&fecha_inicio="+$('#fecha_inicio').val()+"&fecha_fin="+$('#fecha_fin').val()+"&previsual=2&clie_institucionval="+$('#clie_institucionval').val()+"&ireport=<?php echo $ireport; ?>";
...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("lospinos/mayorglobal_analitico.php",{
	...
	comprobante_codex:$('#comprobante_codex').val()
