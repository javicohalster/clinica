...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("pichincha/prestaciones_items.php",{
    anio_id:$('#anio_id').val(),
	mes_id:$('#mes_id').val(),
	usua_id:$('#usua_id').val()
  },function(result){  
...
function a_excel() {
window.open('pichincha/prestaciones_itemsexcel.php?excel=1&anio_id='+$('#anio_id').val()+'&mes_id='+$('#mes_id').val()+'&usua_id='+$('#usua_id').val(),'ventana_excel','width=750,height=500,scrollbars=YES');
