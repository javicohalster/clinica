...
<table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<select name="planc_codigoc" id="planc_codigoc">
	  ...
	  <?php
	   	echo $busca_usuarios="select * from lpin_plancuentas order by planc_orden asc";
...
function ver_excel()
{
 if($('#fecha_inicio').val()=='' && $('#fecha_fin').val()=='')
 {
  ...
  location.href = "lospinos/mayorgl_analitico.php?planc_codigoc="+$('#planc_codigoc').val()+"&cliente_ruc="+$('#cliente_ruc').val()+"&centro_id="+$('#centro_id').val()+"&fecha_inicio="+$('#fecha_inicio').val()+"&fecha_fin="+$('#fecha_fin').val()+"&previsual=2&clie_institucionval="+$('#clie_institucionval').val()+"&ireport=<?php echo $ireport; ?>";
...
function ver_pdf()
{
 ...
 if($('#fecha_inicio').val()=='' && $('#fecha_fin').val()=='')
 {
  ...
  return false;
   ...
   window.open("lospinos/mayorgl_analitico.php?planc_codigoc="+$('#planc_codigoc').val()+"&cliente_ruc="+$('#cliente_ruc').val()+"&centro_id="+$('#centro_id').val()+"&fecha_inicio="+$('#fecha_inicio').val()+"&fecha_fin="+$('#fecha_fin').val()+"&previsual=3&clie_institucionval="+$('#clie_institucionval').val()+"&ireport=<?php echo $ireport; ?>", '_blank');  
...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("lospinos/mayorgl_analitico.php",{
