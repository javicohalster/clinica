...
<div align="center" class="style1">PRODUCTIVIDAD OPERTIVA</div>
<p>&nbsp;</p>
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><input name="fecha_fin" type="text" id="fecha_fin" autocomplete="off" ></td>
     ...
     <td>
	 <div id="ver_usuarios"><select name="usua_id" id="usua_id">
      <option value="">--seleccionar--</option>
	  <?php
...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("dns/productividadopertiva.php",{
...
<script>
    $("#btnExport").click(function(e) {
		...
		a.download = 'productividadop_<?php echo date("Y-m-d"); ?>.xls';
