...
<table width="500" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    ...
    <td bgcolor="#D2E2EE"><span class="css_titulo">No. EVOLUCIONES</span></td>
  </tr>
  <?php
  //psicologia
  if($_POST["usua_id"])
 ...
 $lista_ecoluciones="select count(*) as total,evos.usua_id from faesa_informeevolucionsemestral evos   where infevolucion_fecharegistro>='".$_POST["fecha_inicio"]."' and infevolucion_fecharegistro<='".$_POST["fecha_fin"]."' and evos.usua_id=".$_POST["usua_id"]." group by evos.usua_id";
...
else
{
 ...
 $lista_ecoluciones="select count(*) as total,evos.usua_id from faesa_informeevolucionsemestral evos   where infevolucion_fecharegistro>='".$_POST["fecha_inicio"]."' and infevolucion_fecharegistro<='".$_POST["fecha_fin"]."' group by evos.usua_id";
