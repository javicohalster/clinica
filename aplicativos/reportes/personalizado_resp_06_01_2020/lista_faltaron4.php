...
//echo $listacampos1;
 ...
 if($rs_gogessform)
 {
		...
		if(@$_POST["even_id"])
       {
		$fechas_menores="select asis_id,asis_asiste from app_asistencia left join app_eventos on app_asistencia.even_id=app_eventos.even_id where clie_id=".$rs_gogessform->fields["clie_id"]." and asis_fecharegistro >= '".$_POST["fecha_inicio"]."' and asis_fecharegistro<='".$_POST["fecha_fin"]."' and app_asistencia.even_id=".$_POST["even_id"];
		}
		else
		{
		
		$fechas_menores="select asis_id,asis_asiste from app_asistencia left join app_eventos on app_asistencia.even_id=app_eventos.even_id where clie_id=".$rs_gogessform->fields["clie_id"]." and asis_fecharegistro >= '".$_POST["fecha_inicio"]."' and asis_fecharegistro<='".$_POST["fecha_fin"]."'";
		}
  ...
  <tr>
    ...
    <td><span class="style8"><?php echo $rs_gogessform->fields["clie_registro"]; ?></span></td>
