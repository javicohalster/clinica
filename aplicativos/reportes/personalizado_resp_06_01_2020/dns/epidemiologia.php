...
<table width="1200" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="18"><table width="100%" border="0" cellspacing="0">
      <tr>
        <td valign="top" class="css_listat">Provincia :<br />
          Parroquia : <br />
          Nombre del Establecimiento : <br />
          Tipo de Establecimiento : <br />
          Instituci&oacute;n :</td>
        <td valign="top" class="css_listat"><p>Zona:</p>
          <p> PUBLICA</p></td>
        <td valign="top" class="css_listat">Cant&oacute;n: <br />
          Distrito de Salud: <br />
          Mes de: <br />
          A&ntilde;o:</td>
        <td class="css_listat"><?php 
...
//echo $cuenta_sql="select cie,clie_genero,clie_fechanacimiento,fecharegistro,TIMESTAMPDIFF(YEAR,clie_fechanacimiento,fecharegistro) AS edad, TIMESTAMPDIFF( MONTH, clie_fechanacimiento, fecharegistro ) % 12 as mes,".$menor_mes.",".$deuno_a11mes.",".$deuno_acuatro.",".$de5_a9.",".$de10_a14.",".$de15_a19.",".$de20_a49.",".$de50_a64.",".$de65_a120.",atenc_condiciondeegreso from (".$union_data.") tbl where fecharegistro>='".$_POST["fecha_inicio"]."' and fecharegistro<='".$_POST["fecha_fin"]."'";	
