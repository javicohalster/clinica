...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("faesa/asistenciaxpaciente.php",{
...
window.open('lista_faltaronexel.php?fecha_inicio=' + fecha_inicio +'&fecha_fin='+fecha_fin+'&clie_id='+clie_id,'ventana1','width=750,height=500,scrollbars=YES');
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><input name="fecha_fin" type="text" id="fecha_fin"></td>
     <td><select name="clie_id" id="clie_id">
      <option value="">--seleccionar evento--</option>
	  <?php
	    $objformulario->fill_cmb("app_cliente","clie_id,clie_nombre,clie_apellido",@$clie_id,@$orden,$DB_gogess);
	  ?> 
    </select>
    </td>
