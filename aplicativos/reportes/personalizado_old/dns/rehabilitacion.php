...
$saca_citas='select fisiot_id as id_tbl,clie_id,dns_fisioterapia.usua_id,DATE(cuabas_fecharegistro) as fecharegistro,TIME(cuabas_fecharegistro) as hora,"dns_fisioterapia" as tabla,"" as prenatal_p,"" as prenatal_s,"" as parto,"" as postparto,"" planificacion_p,"" as planificacion_s,"" as uterino,"" as mamario,dns_fisioterapia.fisiot_enlace as enlace,dns_fisioterapia.centro_id,fisiot_centrorefiere,fisiot_profesionarefiere,usua_ciruc,usua_nombre,usua_apellido,"PRIMERA" as tipo_at,prod_codigo,prod_descripcion,prod_precio,atenc_id
from dns_fisioterapia inner join app_usuario on dns_fisioterapia.usua_id=app_usuario.usua_id 
inner join dns_tarifariofisioterapia on dns_fisioterapia.fisiot_enlace=dns_tarifariofisioterapia.fisiot_enlace
union 

select regterapia_id as id_tbl,clie_id,dns_regfisioterapia.usua_id,regterapia_fecha as fecharegistro,regterapia_hora as hora,"dns_fisioterapia" as tabla,"" as prenatal_p,"" as prenatal_s,"" as parto,"" as postparto,"" planificacion_p,"" as planificacion_s,"" as uterino,"" as mamario,dns_fisioterapia.fisiot_enlace as enlace,dns_fisioterapia.centro_id,fisiot_centrorefiere,fisiot_profesionarefiere,usua_ciruc,usua_nombre,usua_apellido,"SUBSECUENTE" as tipo_at,"" as prod_codigo,"" as prod_descripcion,"" as prod_precio,atenc_id
from dns_fisioterapia inner join dns_regfisioterapia on dns_fisioterapia.fisiot_enlace=dns_regfisioterapia.fisiot_enlace inner join app_usuario on dns_regfisioterapia.usua_id=app_usuario.usua_id
';
...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td><div align="center" class="css_listat">NOMBRE Y APELLIDO  DEL MEDICO GENERAL Y/O ESPECIALISTA QUE REMITE (MEDICO QUE EMITE LA 007 ENVIA)</div></td>
	<td><div align="center" class="css_listat">ESPECIALIDAD MEDICA QUE REMITE (MEDICO QUE REMITE ESOECIALIDAD)</div></td>
	<td><div align="center" class="css_listat">CIE 10</div></td>
	<td><div align="center" class="css_listat">DESCRIPCION DEL CIE 10</div></td>
	<td><div align="center" class="css_listat">FECHA DE REFERENCIA DEL MEDICO GENERAL Y/O ESPECIALISTA (FECHA QUE EMITE 007)</div></td>
	...
	<td><div align="center" class="css_listat">TIPO DE ATENCION</div></td>
	...
	<td><div align="center" class="css_listat">CODIGO TNS/CODIGO DE PROCEDIMIENTO</div></td>
	<td><div align="center" class="css_listat">DESCRIPCION</div></td>
	<td><div align="center" class="css_listat">CANTIDAD</div></td>
	<td><div align="center" class="css_listat">VALOR UNITARIO DE LA TERAPIA</div></td>
	<td><div align="center" class="css_listat">CONDICION DE EGRESO DEL PACIENTE</div></td>
  </tr>
  
  <?php
  if($_POST["usua_id"])
  {
$cuenta_sql="select id_tbl,tabla,clie_id,usua_id,prenatal_p,prenatal_s,parto,postparto,planificacion_p,planificacion_s,uterino,mamario,fecharegistro,enlace,hora,fisiot_profesionarefiere,fisiot_centrorefiere,usua_ciruc,usua_nombre,usua_apellido,tipo_at,prod_codigo,prod_descripcion,prod_precio,atenc_id from (".$saca_citas.") tbl where fecharegistro>='".$_POST["fecha_inicio"]."' and fecharegistro<='".$_POST["fecha_fin"]."' and usua_id='".$_POST["usua_id"]."' and centro_id='".$centro_id."'";
}
else
{
$cuenta_sql="select id_tbl,tabla,clie_id,usua_id,prenatal_p,prenatal_s,parto,postparto,planificacion_p,planificacion_s,uterino,mamario,fecharegistro,enlace,hora,fisiot_profesionarefiere,fisiot_centrorefiere,usua_ciruc,usua_nombre,usua_apellido,tipo_at,prod_codigo,prod_descripcion,prod_precio,atenc_id from (".$saca_citas.") tbl where fecharegistro>='".$_POST["fecha_inicio"]."' and fecharegistro<='".$_POST["fecha_fin"]."' and centro_id='".$centro_id."'";
...
//echo $cuenta_sql;
 ...
 if($rs_gogessform)
 {
	...
	if($rs_cliente->fields["clie_numerodecedulatitular"]==$rs_cliente->fields["clie_rucci"])
	{
	   $nombre_titulars=$rs_cliente->fields["clie_apellido"].' '.$rs_cliente->fields["clie_nombre"];
	   $cedula_titulars=$rs_cliente->fields["clie_rucci"];
	...
	{
	   if($rs_cliente->fields["clie_numerodecedulatitular"]=='')
	   {
	     $nombre_titulars='';
	     $cedula_titulars='';
		 if($rs_cliente->fields["clie_parentescopaciente"]=='TITULAR')
			 {
	   ...
	   {
	      $nombre_titulars=$rs_cliente->fields["clie_nombretitulardelseguro"];
	      $cedula_titulars=$rs_cliente->fields["clie_numerodecedulatitular"];
		...
		$busca_tiposeguro="select tipopac_nombre from faesa_tipopaciente where tipopac_id='".$rs_cliente->fields["tipopac_id"]."'";	
	...
	$edad_val=$objvarios->calcular_edad($rs_cliente->fields["clie_fechanacimiento"],$rs_gogessform->fields["fecharegistro"]);
	
	
	
	//nacionalidad
	$busca_nacionalidad="select nac_nombre from dns_nacionalidad where nac_id='".$rs_cliente->fields["nac_id"]."'";	
    $rs_nacionalidad = $DB_gogess->executec($busca_nacionalidad,array());
	
	 
	//EGRESO
	$busca_atencion="select atenc_condiciondeegreso from dns_atencion where atenc_id='".$rs_gogessform->fields["atenc_id"]."'";	
  ...
  <tr>
    ...
    <td nowrap="NOWRAP" class="css_lista"><?php echo $rs_gogessform->fields["fisiot_profesionarefiere"]; ?></td>
    ...
    <td nowrap="NOWRAP" class="css_lista"><?php echo $rs_cliente->fields["clie_rucci"]; ?></td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo $rs_cliente->fields["clie_parentescopaciente"]; ?></td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo utf8_encode($nombre_titulars); ?></td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo $cedula_titulars; ?></td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo utf8_encode(@$rs_cliente->fields["clie_apellido"].' '.$rs_cliente->fields["clie_nombre"]); ?></td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo @$rs_cliente->fields["clie_rucci"]; ?></td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo $rs_tseguro->fields["tipopac_nombre"]; ?></td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo $rs_gogessform->fields["tipo_at"]; ?></td>
    <td nowrap="NOWRAP" class="css_lista">&nbsp;</td>
    ...
    <td nowrap="NOWRAP" class="css_lista"><?php echo $rs_cliente->fields["clie_celular"]; ?></td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo $rs_gogessform->fields["prod_codigo"]; ?></td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo $rs_gogessform->fields["prod_descripcion"]; ?></td>
    <td nowrap="NOWRAP" class="css_lista">1</td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo $rs_gogessform->fields["prod_precio"]; ?></td>
    <td nowrap="NOWRAP" class="css_lista"><?php echo $rs_atencion->fields["atenc_condiciondeegreso"]; ?></td>
  </tr>
