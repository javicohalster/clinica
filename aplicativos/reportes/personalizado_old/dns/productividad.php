...
if(@$_POST["centro_id"])
{
$lista_centros="select * from dns_centrosalud where centro_activo in (1,2) and centro_id='".$_POST["centro_id"]."'";
}
else
{
$lista_centros="select * from dns_centrosalud where centro_activo in (1,2) and centro_activosistema=1";
}
