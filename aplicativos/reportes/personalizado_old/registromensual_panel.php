  ...
  <tr>
    ...
    <td><input name="fecha_fin" type="text" id="fecha_fin" autocomplete="off"  ></td>
     <td><select name="usua_id" id="usua_id">
	  ...
	  <?php
	   	$busca_usuarios="select * from app_usuario where usua_estado=1 and usua_formaciondelprofesional='MEDICINA GENERAL' order by usua_apellido asc ";
...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("dns/mensual.php",{
