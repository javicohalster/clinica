...
<div align="center" class="style1">ALERTAS DE SUBCENTROS QUE NO ENVIAN </div>
<p>&nbsp;</p>
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><input type="button" name="btnExport" id="btnExport" value="Excel" onclick="a_excel()" /></td>
  </tr>
</table>
<br><br>
...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("dns/financiero2.php",{
...
<script>
    $("#btnExport").click(function(e) {
		...
		a.download = 'alerta_financiero_<?php echo date("Y-m-d"); ?>.xls';
