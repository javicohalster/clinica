...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("lista_faltaron4.php",{
...
window.open('lista_faltaron4exel.php?fecha_inicio=' + fecha_inicio +'&fecha_fin='+fecha_fin+'&even_id='+even_id,'ventana1','width=750,height=500,scrollbars=YES');
...
<div align="center" class="style1">NO HA ASISTIDO EN LAS ULTIMAS 4 SEMANAS</div>
<div align="center" class="style1">PARA ESTE REPORTE SE TOMA ENCUENTA LA FECHA ACTUAL COMO INICIO,Y SI YA ASISTIERON ALGUNA VES Y SU ASISTENCIA FUE REGUSTRADA</div>
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><input name="fecha_inicio" type="text" id="fecha_inicio" value="<?php echo $dt_laSemanaPasada; ?>"></td>
    <td><input name="fecha_fin" type="text" id="fecha_fin" value="<?php echo $fecha_hoy ?>"></td>
