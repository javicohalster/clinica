...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("lista_primera.php",{
...
window.open('lista_primeraexel.php?fecha_inicio=' + fecha_inicio +'&fecha_fin='+fecha_fin+'&even_id='+even_id,'ventana1','width=750,height=500,scrollbars=YES');
...
<div align="center" class="style1">REPORTE PRIMERA VEZ RANGO DE FECHA</div>
<p>&nbsp;</p>
