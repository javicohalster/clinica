...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("faesa/terapiasxcliente.php",{
    fecha_inicio:$('#fecha_inicio').val(),
	fecha_fin:$('#fecha_fin').val(),
	tipopac_id:$('#tipopac_id').val(),
...
<div align="center" class="style1">NUMERO DE TERAPIAS POR CLIENTE </div>
<p>&nbsp;</p>
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td bgcolor="#E6F1F2" class="style1"><strong>Fecha fin </strong></td>
     ...
     <td bgcolor="#E6F1F2" class="style1">Tipo Cliente</td>
  ...
  <tr>
	...
	<td><select name="centro_id" id="centro_id">
     ...
     <td><select name="tipopac_id" id="tipopac_id">
      <option value="">--seleccionar tipo--</option>
	  <?php
	    $objformulario->fill_cmb("faesa_tipopaciente","tipopac_id,tipopac_nombre",@$tipopac_id,@$orden,$DB_gogess);
	  ?> 
    </select>
    </td>
