...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td bgcolor="#E6F1F2" class="style1"><strong><strong><strong>Asegurador / Financiador</strong></strong></strong></td>
  ...
  <tr>
    <td><select name="anio_valor" id="anio_valor" class="form-control" >
     ...
     <td><select name="tipopac_id" id="tipopac_id">
       <option value="">--seleccionar--</option>
       <?php
	    $objformulario->fill_cmb("faesa_tipopaciente","tipopac_id,tipopac_nombre",@$centro_id,"",$DB_gogess);
	  ?>
     </select></td>
...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("dns/financiero4.php",{
