...
<div align="center" class="style1">REGISTRO DIARIO LABORATORIO</div>
<p>&nbsp;</p>
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#E6F1F2" class="style1"><strong>Fecha </strong></td>
  ...
  <tr>
    <td><input name="fecha_inicio" type="text" id="fecha_inicio" value="<?php echo $fecha_dhoy; ?>" autocomplete="off" ></td>
     <td><select name="usua_id" id="usua_id">
	  ...
	  <?php
	   	$busca_usuarios="select * from app_usuario inner join dns_gridfuncionprofesional on app_usuario.usua_enlace=dns_gridfuncionprofesional.usua_enlace where usua_estado=1 and prof_id in (67,69,911113) order by usua_apellido asc ";
...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("dns/diariolab.php",{
...
<script>
    ...
    $("#btnExport").click(function(e) {
		...
		a.download = 'laboratorio_<?php echo date("Y-m-d"); ?>.xls';
