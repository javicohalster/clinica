...
<div align="center" class="style1">CONSOLIDADO MENSUAL DE ATENCIONES MEDICINA</div>
<p>&nbsp;</p>
  ...
  <tr>
    ...
    <td><input name="fecha_fin" type="text" id="fecha_fin" autocomplete="off"  ></td>
     <td><select name="usua_id" id="usua_id">
	  ...
	  <?php
	   	$busca_usuarios="select * from app_usuario where usua_estado=1 and usua_formaciondelprofesional='ENFERMERIA' order by usua_apellido asc ";
...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("dns/mensualenfermeria.php",{
...
<script>
    ...
    $("#btnExport").click(function(e) {
		...
		a.download = 'mensual_<?php echo date("Y-m-d"); ?>.xls';
