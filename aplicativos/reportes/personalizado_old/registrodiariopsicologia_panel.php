...
<div align="center" class="style1">REGISTRO DIARIO PSICOLOGIA</div>
<p>&nbsp;</p>
  ...
  <tr>
    <td><input name="fecha_inicio" type="text" id="fecha_inicio" autocomplete="off"  ></td>
     ...
     <td><select name="usua_id" id="usua_id">
	  ...
	  <?php
	   	$busca_usuarios="select * from app_usuario where usua_estado=1 and usua_formaciondelprofesional='PSICOLOGIA' order by usua_apellido asc ";
...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("dns/diariopsicologia.php",{
...
<script>
    $("#btnExport").click(function(e) {
		...
		a.download = 'psicologia_<?php echo date("Y-m-d"); ?>.xls';
