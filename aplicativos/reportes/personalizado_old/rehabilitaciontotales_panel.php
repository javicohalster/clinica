...
<div align="center" class="style1">REHABILITACION TOTALES</div>
<p>&nbsp;</p>
...
function ejecuta_reporte()
{
 ...
 $("#ver_reporte").load("dns/rehabilitaciontotales.php",{
...
<script>
    $("#btnExport").click(function(e) {
		...
		a.download = 'rehabilitacion_<?php echo date("Y-m-d"); ?>.xls';
