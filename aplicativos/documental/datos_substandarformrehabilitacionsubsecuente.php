...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_substandarrehabilitacionsubsecuente.php','Perfil','divBody_ext',0,'<?php echo @$clie_id; ?>','114','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>','<?php echo $anam_id; ?>','<?php echo $centro_id; ?>')" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
...
echo '&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-primary" '.$linkimprimiran.'  style="cursor:pointer"><span class="glyphicon glyphicon-print"></span> VER REHABILITACI&Oacute;N - ANAMNESIS </button>';

//cambio de fecha registro
$linkcambior="onclick=abrir_standar('aplicativos/documental/cambio_fecha.php','CAMBIO','divBody_foto','divDialog_foto',500,300,'rehabilitacionexterna',$('#conext_id').val(),0,0,0,0,0) style='cursor:pointer'";
echo '&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-warning" '.$linkcambior.'  style="cursor:pointer"> CAMBIAR FECHA REGISTRO </button>';

$linkhistorialr="onclick=abrir_standar('aplicativos/documental/historial_fecha.php','CAMBIO','divBody_foto','divDialog_foto',790,300,'rehabilitacionexterna',$('#conext_id').val(),0,0,0,0,0) style='cursor:pointer'";
...
function imprimir_datosan()
{
   ...
   myWindow3=window.open('aplicativos/documental/datos_substandarformunico_print.php?iddata=406&pVar2=<?php echo @$clie_id; ?>&pVar4=<?php echo $atenc_id; ?>&pVar5=0&pVar3=113&pVar9=<?php echo $anam_id; ?>','ventana_reporteunico','width=850,height=700,scrollbars=YES');
