...
echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button style="width:300px" type="button" class="mb-sm btn btn-primary" '.$linksubsecuente.'  style="cursor:pointer">  <span class="glyphicon glyphicon-list"></span> SUBSECUENTES EVOLUCI&Oacute;N Y PRESCRIPCIONES </button>';
