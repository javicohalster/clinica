...
function imprimir_datosan()
{
   ...
   myWindow3=window.open('aplicativos/documental/datos_substandarformunico_print.php?iddata=556&pVar2=<?php echo @$clie_id; ?>&pVar4=<?php echo $atenc_id; ?>&pVar5=0&pVar3=-principal-&pVar9=<?php echo $anam_id; ?>','ventana_reporteunico','width=850,height=700,scrollbars=YES');
