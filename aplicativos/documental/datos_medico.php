...
if($csearch)
{
$busca_datosus="select * from corpo_medico where clie_id=?";
...
';	
        ...
        @$funciones_cuandoguarda="$('#".@$divresultado."').html('".@$mensajege."')";
  		$template_reemplazo='templateformsweb/maestro_standar_medicoadm/';
?>	
<style>
label.error{
color:red;
...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_medico.php','Perfil','divBody_ext',0,0,0,0,0,0,0)" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
<p></p>
