...
$busca_dtabla="select * from gogess_sistable where tab_id='".$_GET["iddata"]."'";
...
$busca_sihaydata="select * from ".$table." where ".$campo_primariodata."='".$valor_busca."'";
...
//para cambiar el formato de algunos campos     
	...
	$variableb=0;
		...
		{
		$template_reemplazo='templateformsweb_print/maestro_standar_substandar_print/';
		}
...
<div class="container" style="padding-top: 1em; padding-right:1em; padding-left:1em; max-width:100%;">
  ...
  <div align="center"><img src="../../images/informe_logo.jpg" width="161"  />
  </div>
  <div align="center" >
  <?php
  $nciudad='';
