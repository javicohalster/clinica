...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewpediatriaanamnesis.php','Editar','divBody_ext','','".@$clie_id."','203','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewpediatriasubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'204',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";
...
$linkeditar= 'onClick=abrir_laboratorionewj();';
echo '&nbsp;&nbsp;<a href="javascript:abrir_laboratorionewj();"><img src="images/labiconnew.png?dtt='.date("his").'">.<span class="selected"></span></a>';
...
function abrir_laboratorionewj()
{
   if($('#<?php echo $campo_primario; ?>').val()=='')
   {
     alert("Guarde el registro para hacer el pedido de laboratorio");
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewpediatriasubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','204','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
