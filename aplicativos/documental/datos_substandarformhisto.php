...
$obtiene_enlacearray=array();
$obtiene_enlacearray=explode("_",$campo_primariodata);
$obtiene_enlace='';
$obtiene_enlace=$obtiene_enlacearray[0]."_enlace";
...
<div align="center">
         ...
         <div class="col-xs-12"><div id="boton_guardarformdata">
			<button type="button" class="mb-sm btn btn-primary" onclick="guarda_datalocal()"  > '.$titulo_btn.'  </button>
		</div></div>
		</div>
...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantallaextendida('aplicativos/documental/opciones/panel/panel_substandarformularioshisto.php','Perfil','divBody_ext',0,'<?php echo @$clie_id; ?>','<?php echo $mnupan_id; ?>','<?php echo $atenc_id; ?>',0,0,0,0,0,0,'<?php echo $protoop_idenlace; ?>','<?php echo $protoop_tblprincipal; ?>')" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
