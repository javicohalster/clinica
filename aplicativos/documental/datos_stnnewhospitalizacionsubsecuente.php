...
$busca_sihaydata="select *,DATE_ADD(conext_fecharegistro,INTERVAL 20 DAY) as fechacierre from ".$table." where ".$campo_primariodata."=?";
...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewhospitalizacionsubsecuente.php','Perfil','divBody_ext',0,'<?php echo @$clie_id; ?>','211','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>','<?php echo $anam_id; ?>','<?php echo $centro_id; ?>')" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
...
//////////
$linkimprimir='onClick=genera_pdfevolucionuno();';
...
$linkimprimir='onClick=genera_pdfevolucionunourg();';
echo '&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-info" '.$linkimprimir.'  style="cursor:pointer"><span class="glyphicon glyphicon-print"></span>IMPRIMIR URG</button>';
...
function imprimir_datosan()
{
   ...
   myWindow3=window.open('aplicativos/documental/datos_substandarformunico_print.php?iddata=576&pVar2=<?php echo @$clie_id; ?>&pVar4=<?php echo $atenc_id; ?>&pVar5=0&pVar3=-principal-&pVar9=<?php echo $anam_id; ?>','ventana_reporteunico','width=850,height=700,scrollbars=YES');
...
////
function genera_pdfevolucionuno()
{
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {	 
	    location.href = "pdfformularios/pdfformevolucionnewhospitalizacionuno.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val();
	 }
	 else
	 {
       alert("Por favor guarde el resgistro para imprimir");	 
...
function genera_pdfevolucionunourg()
{
 

   if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {		    
		 myWindow3=window.open('pdfformularios/pdfformevolucionnewhospitalizacionunomrg.php?ssr=<?php echo $campos_data64."|" ?>'+$('#<?php echo $campo_primariodata; ?>').val(),'ventana_reporteudatax','width=850,height=700,scrollbars=YES');
		 myWindow3.focus();
