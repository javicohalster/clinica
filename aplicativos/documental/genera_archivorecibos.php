...
$("#archivo_plano").load("aplicativos/documental/srifile/archivo_planorecibo.php",{
...
window.open('aplicativos/documental/srifile/excelrecibo.php?desde_val='+$('#desde_val').val()+'&hasta_val='+$('#hasta_val').val()+'&centro_id='+$('#centro_id').val(),'_blank');
...
window.open('aplicativos/documental/reporte_recibos.php?desde_val='+$('#desde_val').val()+'&hasta_val='+$('#hasta_val').val()+'&centro_id='+$('#centro_id').val(),'_blank');
...
window.open('aplicativos/documental/reporte_recibosxarea.php?desde_val='+$('#desde_val').val()+'&hasta_val='+$('#hasta_val').val()+'&centro_id='+$('#centro_id').val(),'_blank');
...
<div class="col-xs-2">
Desde:<input name="desde_val" type="text" id="desde_val" class="form-control">
</div>

<div class="col-xs-2">

Desde:<input name="hasta_val" type="text" id="hasta_val" class="form-control">
</div>
