...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewcardiologiasubsecuente.php','Perfil','divBody_ext',0,'<?php echo @$clie_id; ?>','207','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>','<?php echo $anam_id; ?>','<?php echo $centro_id; ?>')" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
...
$linkeditar= 'onClick=abrir_laboratorionewm();';
echo '&nbsp;&nbsp;<a href="javascript:abrir_laboratorionewm();"><img src="images/labiconnew.png?dtt='.date("his").'">.<span class="selected"></span></a>';
...
function abrir_laboratorionewm()
{
   if($('#<?php echo $campo_primariodata; ?>').val()=='')
   {
     alert("Guarde el registro para hacer el pedido de laboratorio");
...
function genera_pdf()
{
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {	 
	    location.href = "pdfformularios/pdformularionewcardiologia.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val();
	 }
	 else
	 {
       alert("Por favor guarde el resgistro para imprimir");	 
