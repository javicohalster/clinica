...
if ($_SESSION['datadarwin2679_sessid_inicio']) {
	...
	$namemodulo = "liquidaciontarjetas";
	...
	<script type="text/javascript">
		...
		function imprimir_datos() {
			if ($('#<?php echo $campo_primariodata; ?>').val() > 0) {
				myWindow3 = window.open('templateformsweb/maestro_standar_liquidaciontarjetas/imprimir/imprimir.php?iddata=<?php echo $tab_id ?>&pVar2=<?php echo @$clie_id; ?>&pVar4=<?php echo $atenc_id; ?>&pVar5=<?php echo $eteneva_id; ?>&pVar3=<?php echo $mnupan_id; ?>&pVar9=' + $('#<?php echo $campo_primariodata; ?>').val(), 'ventana_reporteunico', 'width=850,height=700,scrollbars=YES');
...
function genera_asientolqtarjeta()
{
   ...
   if($('#tpliq_id').val()==2)
    {
	  urlasiento='aplicativos/documental/asientos/lqtarjeta/ejecuta_lqtarjeta.php';	
	}
	else
	{
	  urlasiento='aplicativos/documental/asientos/lqtarjeta/ejecuta_lqfactura.php';
	}

   $("#asiento_cm5").load(urlasiento,{
  ...
  $("#asiento_cm5").html("Espere un momento");  
