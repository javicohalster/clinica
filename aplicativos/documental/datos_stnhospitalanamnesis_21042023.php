...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnhospitalanamnesis.php','Editar','divBody_ext','','".@$clie_id."','122','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnhospitalsubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'123',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";
...
function abrir_protocolo()
{
  ...
  $link_protocolo='ver_formularioenpantallaextendida(\'aplicativos/documental/opciones/panel/panel_substandarformunicoprotocolooperatorio.php\',\'Perfil\',\'divBody_ext\',\'\',\''.$clie_id.'\',\'127\',\''.$atenc_id.'\',0,\'0\',\''.$centro_id.'\',0,0,0,$(\'#'.$campo_primario.'\').val(),\''.$table.'\')';
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnhospitalsubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','123','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
...
function genera_pdf()
{
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {	 
	    location.href = "pdfformularios/pdformulariohospital.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val()+"&filtro="+$('input:checkbox[name=check_imp]:checked').val();
	 }
	 else
	 {
       alert("Por favor guarde el resgistro para imprimir");	 
