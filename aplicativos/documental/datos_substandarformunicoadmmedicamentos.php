...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_substandarformunicoadmmedicamentos.php','Editar','divBody_ext','','".@$clie_id."','128','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
