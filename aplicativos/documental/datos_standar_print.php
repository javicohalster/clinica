...
$lista_tabla="select * from gogess_sistable where tab_id=".$_GET["iddata"];
...
//para cambiar el formato de algunos campos     
	...
	$variableb=0;
		...
		//else
		//{
		 $template_reemplazo='templateformsweb_print/maestro_print/';
		//}
...
<?php		
		if ($psic_id_valor>0)
		{	
		include("tablas_standarprint.php");
		}
		else
		{	
