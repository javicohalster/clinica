...
';	
 ...
 $botonenvio='
<div align="center" id="btn_superior">
		 <div class="form-group">
         <div class="col-xs-12">
...
$botonenvio2='
<div align="center" id="btn_inferior" >
		 <div class="form-group">
         <div class="col-xs-12">
			<button type="button" class="mb-sm btn btn-primary" onclick="guarda_data()"  > GRABAR</button>
		</div>
...
';
		...
		{
		$template_reemplazo='templateformsweb/maestro_standar_tomafisica/';	
...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_tomafisica.php','Perfil','divBody_ext',0,'<?php echo $_POST["pVar2"]; ?>',0,0,0,0,0)" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
...
&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-primary" onclick="ver_formularioenpantalla('aplicativos/documental/datos_tomafisica.php','TARIFARIO','divBody_ext',0,'<?php echo $mnupan_id; ?>',0,0,0,0,0)" style="cursor:pointer"><span class="glyphicon glyphicon-plus"></span>NUEVO REGISTRO</button>
