...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewcardiologiaanamnesis.php','Editar','divBody_ext','','".@$clie_id."','206','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewcardiologiasubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'207',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewcardiologiasubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','207','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
