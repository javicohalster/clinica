...
function abrir_epicrisis()
{
  ...
  $link_protocolo='ver_formularioenpantallaextendida(\'aplicativos/documental/opciones/panel/panel_stnepicrisisanamnesis.php\',\'Perfil\',\'divBody_ext\',\'\',\''.$clie_id.'\',\'125\',\''.$atenc_id.'\',0,\'0\',\''.$centro_id.'\',0,0,0,$(\'#'.$campo_primario.'\').val(),\''.$table.'\')';
