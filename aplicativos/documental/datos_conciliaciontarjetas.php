...
if ($_SESSION['datadarwin2679_sessid_inicio']) {
	...
	$namemodulo = "conciliaciontarjetas";
	...
	<script type="text/javascript">
		...
		function imprimir_datos() {
			if ($('#<?php echo $campo_primariodata; ?>').val() > 0) {
				myWindow3 = window.open('templateformsweb/maestro_standar_conciliaciontarjetas/imprimir/imprimir.php?iddata=<?php echo $tab_id ?>&pVar2=<?php echo @$clie_id; ?>&pVar4=<?php echo $atenc_id; ?>&pVar5=<?php echo $eteneva_id; ?>&pVar3=<?php echo $mnupan_id; ?>&pVar9=' + $('#<?php echo $campo_primariodata; ?>').val(), 'ventana_reporteunico', 'width=850,height=700,scrollbars=YES');
