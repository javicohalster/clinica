                ...
                <div class="card my-4">
                    ...
                    <div class="ms-3 pe-md-3 align-items-center">
                        <button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary"
                            onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_usuario.php','Perfil','divBody_ext',0,'<?php echo $_POST["pVar2"]; ?>',0,0,0,0,0)"
                            style="cursor:pointer"><span
                                class="glyphicon glyphicon-arrow-left"></span>&nbsp;&nbsp;REGRESAR</button>
