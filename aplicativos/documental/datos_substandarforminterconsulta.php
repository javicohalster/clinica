...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantallapreconsulta('aplicativos/documental/opciones/panel/panel_substandarformulariointerconsulta.php','Perfil','divBodyref_ext',0,'<?php echo @$clie_id; ?>','<?php echo $mnupan_id; ?>','<?php echo $atenc_id; ?>','<?php echo $id_llega; ?>','<?php echo $tabla_llega; ?>',0,0,0,'<?php echo $proviene_de; ?>')" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
...
?>
<span class="alert alert-success"> <B>INTERCONSULTA</B> </span>
