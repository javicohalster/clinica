...
$busca_listabrrado="select crucue_id from lpin_crucedocumentos inner join pichinchahumana_extension.lpin_crucecuentas on lpin_crucedocumentos.crudoc_enlace=pichinchahumana_extension.lpin_crucecuentas.crudoc_enlace where crudoc_id='".$crudoc_id."'";

$asiento_elimina="delete from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='7' and crucue_id not in (".$busca_listabrrado.")";
//$rs_aeli = $DB_gogess->executec($asiento_elimina);
//borra los que ya no existen

$busca_cobros="select * from lpin_crucedocumentos inner join pichinchahumana_extension.lpin_crucecuentas on lpin_crucedocumentos.crudoc_enlace=pichinchahumana_extension.lpin_crucecuentas.crudoc_enlace inner join lpin_ttransac on lpin_crucedocumentos.crudoc_tipotransaccion=lpin_ttransac.ttra_id where crudoc_id='".$crudoc_id."'";
...
$cuenta_lista=0;	
$array_haber=array();		
$total=$rs_bcobros->fields["crucue_valorpago"];	
$crucue_id=$rs_bcobros->fields["crucue_id"];
$compracp_id='';

//detalle asiento
$array_haber[$cuenta_lista]["TIPO"]="DEBE";
$array_haber[$cuenta_lista]["CUENTA"]=$rs_bcobros->fields["crucue_cuenta"];
...
$busca_cabeceraasiento="delete from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='7' and comcont_tablas='beko_documentocabecera' and comcont_idtablas='".$rs_bcobros->fields["crudoc_ndocumentoventa"]."' and crucue_id='".$rs_bcobros->fields["crucue_id"]."'";
...
$busca_cabeceraasiento="select * from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='7' and comcont_tablas='beko_documentocabecera' and comcont_idtablas='".$rs_bcobros->fields["crudoc_ndocumentoventa"]."' and crucue_id='".$rs_bcobros->fields["crucue_id"]."'";
$rs_bcabecera = $DB_gogess->executec($busca_cabeceraasiento);
...
$concepto='';
$concepto='ING. COBRO. CRUCE CC '.$doccab_ndocumento.' '.$doccab_nombrerazon_cliente.' '.$doccab_apellidorazon_cliente.' '.$rs_bcobros->fields["crudoc_descripcion"];
//$concepto=$concepto;
//concepto factura
//++++++++++++++++++++++++++
//preguntar se anula la factura se anula pago
$actualiza_data="update lpin_comprobantecontable set comcont_idtablas='".$rs_bcobros->fields["crudoc_ndocumentoventa"]."',comcont_anulado='".$doccab_anulado."',comcont_fecha='".$crudoc_fechaemision."',comcont_concepto='".$concepto."',comcont_numeroc='".$doccab_ndocumento."' where comcont_id='".$rs_bcabecera->fields["comcont_id"]."'";
...
$inserta_cab="INSERT INTO lpin_comprobantecontable ( tipoa_id, comcont_fecha, comcont_concepto, comcont_numeroc, comcont_estado, comcont_diferencia, comcont_enlace, usua_id, comcont_fecharegistro, centro_id, comcont_tabla, comcont_idtabla,comcont_obs,comcont_anulado,comcont_tablas,comcont_idtablas,crucue_id) VALUES
( '7', '".$crudoc_fechaemision."', '".$concepto."', '".$doccab_ndocumento."', 'APROBADO', 0, '".$comcont_enlace."', '".$_SESSION['datadarwin2679_sessid_inicio']."', '".$fecha_hoy."','".$_SESSION['datadarwin2679_centro_id']."', '".$tabla_asiento."', '".$valor_id."','AUTOMATICO','".$doccab_anulado."','beko_documentocabecera','".$rs_bcobros->fields["crudoc_ndocumentoventa"]."','".$crucue_id."');";
