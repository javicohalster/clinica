...
$lista_cuentas='';
$lista_productos="select * from dns_precuenta inner join dns_detalleprecuenta on dns_precuenta.precu_id=dns_detalleprecuenta.precu_id inner join dns_cuadrobasicomedicamentos on dns_detalleprecuenta.detapre_codigop=dns_cuadrobasicomedicamentos.cuadrobm_codigoatc where dns_precuenta.precu_id='".$valor_id."'";
...
$fecha_asiento=$rs_dattos->fields["precu_fechafinal"];

if($rs_dattos->fields["precu_fechafinal"]=='')
{
//fecha
$busca_fecha="select detapre_fecharegistro from dns_detalleprecuenta where 	precu_id='".$valor_id."' order by detapre_fecharegistro desc limit 1";
...
$concepto='';
$concepto='INVENTARIO . PRECUENTA:'.$doccab_ndocumento.' CI: '.$clie_rucci.' - '.$doccab_nombrerazon_cliente.' '.$doccab_apellidorazon_cliente;
