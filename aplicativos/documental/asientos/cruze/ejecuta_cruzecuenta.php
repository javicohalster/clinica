...
$asiento_elimina="delete from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='8' and crucue_id not in (".$busca_listabrrado.")";
...
$busca_cabeceraasiento="delete from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='8' and comcont_tablas='dns_compras' and comcont_idtablas='".$rs_bcobros->fields["crudoc_ndocumento"]."' and crucue_id='".$rs_bcobros->fields["crucue_id"]."'";
...
$busca_cabeceraasiento="select * from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='8' and comcont_tablas='dns_compras' and comcont_idtablas='".$rs_bcobros->fields["crudoc_ndocumento"]."' and crucue_id='".$rs_bcobros->fields["crucue_id"]."'";
$rs_bcabecera = $DB_gogess->executec($busca_cabeceraasiento);
...
$concepto='';
$concepto='EGR. PAGO. CRUCE CC '.$doccab_ndocumento.' '.$doccab_nombrerazon_cliente.' '.$doccab_apellidorazon_cliente.' '.$rs_bcobros->fields["crudoc_descripcion"];
//$concepto=$concepto;
//concepto factura
//++++++++++++++++++++++++++
...
( '8', '".$crudoc_fechaemision."', '".$concepto."', '".$doccab_ndocumento."', 'APROBADO', 0, '".$comcont_enlace."', '".$_SESSION['datadarwin2679_sessid_inicio']."', '".$fecha_hoy."','".$_SESSION['datadarwin2679_centro_id']."', '".$tabla_asiento."', '".$valor_id."','AUTOMATICO','".$doccab_anulado."','dns_compras','".$rs_bcobros->fields["crudoc_ndocumento"]."','".$crucue_id."');";
