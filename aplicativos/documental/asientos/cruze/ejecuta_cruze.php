...
$asiento_elimina="delete from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='8' and cruant_id not in (".$busca_listabrrado.")";
...
$compracp_id=$rs_bcobros->fields["crudoc_ndocumento"];
...
if($num_detasiento==0)
{
 ...
 $busca_cabeceraasiento="delete from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='8' and comcont_tablas='dns_compras' and comcont_idtablas='".$rs_bcobros->fields["crudoc_ndocumento"]."' and cruant_id='".$rs_bcobros->fields["cruant_id"]."'";
...
$busca_cabeceraasiento="select * from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='8' and comcont_tablas='dns_compras' and comcont_idtablas='".$rs_bcobros->fields["crudoc_ndocumento"]."' and cruant_id='".$rs_bcobros->fields["cruant_id"]."'";
$rs_bcabecera = $DB_gogess->executec($busca_cabeceraasiento);
...
$concepto='';
$concepto='EGR. PAGO. CRUCE ANTICIPO'.$doccab_ndocumento.' '.$doccab_nombrerazon_cliente.' '.$doccab_apellidorazon_cliente;
//$concepto=$concepto;
//concepto factura
//++++++++++++++++++++++++++
//preguntar se anula la factura se anula pago
$actualiza_data="update lpin_comprobantecontable set comcont_idtablas='".$rs_bcobros->fields["crudoc_ndocumento"]."',comcont_anulado='".$doccab_anulado."',comcont_fecha='".$cruant_fechaemision."',comcont_concepto='".$concepto."',comcont_numeroc='".$doccab_ndocumento."' where comcont_id='".$rs_bcabecera->fields["comcont_id"]."'";
...
( '8', '".$cruant_fechaemision."', '".$concepto."', '".$doccab_ndocumento."', 'APROBADO', 0, '".$comcont_enlace."', '".$_SESSION['datadarwin2679_sessid_inicio']."', '".$fecha_hoy."','".$_SESSION['datadarwin2679_centro_id']."', '".$tabla_asiento."', '".$valor_id."','AUTOMATICO','".$doccab_anulado."','dns_compras','".$rs_bcobros->fields["crudoc_ndocumento"]."','".$cruant_id."');";
