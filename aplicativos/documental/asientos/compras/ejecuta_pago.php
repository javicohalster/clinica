...
//principal
$busca_principal="select * from lpin_cobropago where crb_id='".$crb_id."'";
$rs_bprincipal = $DB_gogess->executec($busca_principal);
$doccab_id=$rs_bprincipal->fields["doccab_id"];
//principal

//borra los que ya no existen
$busca_listabrrado="select crpadet_id from lpin_cobropago inner join lpin_cobropagodetalle on lpin_cobropago.crb_enlace=lpin_cobropagodetalle.crb_enlace where crb_id='".$crb_id."'";
...
$busca_cobros="select * from lpin_cobropago inner join lpin_cobropagodetalle on lpin_cobropago.crb_enlace=lpin_cobropagodetalle.crb_enlace inner join lpin_ttransac on lpin_cobropago.ttra_id=lpin_ttransac.ttra_id where crb_id='".$crb_id."'";
