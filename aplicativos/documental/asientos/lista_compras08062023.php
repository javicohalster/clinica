...
<?php
//and compra_id=122
echo $busca_listatx="select * from dns_compras where  compra_id!=1 and compra_fecha>'2023-03-31'";
...
function genera_asientocompraf1(num)
{
   ...
   var urlasiento;
	...
	if($('#tipdoc_id').val()=='9')
	{
	   urlasiento='compras/ejecuta_nc.php';	
	}
	else
	{
	  urlasiento='compras/ejecuta_compras.php';	
	}
