...
$busca_listatx="select * from comprobante_retencion_cab where compretcab_fechaemision_cliente>='2023-10-01' and compretcab_fechaemision_cliente<='2023-11-15'";
