...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantalla('aplicativos/documental/datos_newsubstandarformlab.php','Perfil','divBodylab_ext','<?php echo $_POST["pVar7"]; ?>','<?php echo @$clie_id; ?>','<?php echo $mnupan_id; ?>','<?php echo $atenc_id; ?>','<?php echo $id_llega; ?>','<?php echo $tabla_llega; ?>',0)" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar a Pedido </button>

<?php
//$linkimprimir='onClick=imprimir_datosinfolab();';
...
&nbsp;&nbsp;&nbsp;<B> LABORATORIO - INFORME </B>
<?php
//cambio de fecha registro
$linkcambior="onclick=abrir_standar('aplicativos/documental/cambio_fecha.php','CAMBIO','divBody_foto','divDialog_foto',500,300,'informelaboratorio',$('#labinfor_id').val(),0,0,0,0,0) style='cursor:pointer'";
//echo '&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-warning" '.$linkcambior.'  style="cursor:pointer"> CAMBIAR FECHA REGISTRO </button>';

$linkhistorialr="onclick=abrir_standar('aplicativos/documental/historial_fecha.php','CAMBIO','divBody_foto','divDialog_foto',790,300,'informelaboratorio',$('#labinfor_id').val(),0,0,0,0,0) style='cursor:pointer'";
...
function imprimir_datosinfolab()
{
...
if($table=='dns_laboratorioinforme')
{
  $linkpdf="pdflaboratorioinforme";
  
$campos_data='';
$campos_data64='';
$campos_data='iddata='.$rs_datosmenu->fields["tabsecundario_id"].'&pVar2='.@$clie_id.'&pVar4='.$atenc_id.'&pVar5='.$eteneva_id.'&pVar3=91';
