...
<button type="button" class="mb-sm btn btn-success" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewgastroenterologiasubsecuente.php','Perfil','divBody_ext',0,'<?php echo @$clie_id; ?>','209','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>','<?php echo $anam_id; ?>','<?php echo $centro_id; ?>')" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>
...
$linkimprimir='onClick=genera_pdfevolucionuno'.$tab_id.'();';
echo '<button type="button" class="mb-sm btn btn-info" '.$linkimprimir.'  style="cursor:pointer"><span class="glyphicon glyphicon-print"></span></button>&nbsp;&nbsp;';
...
echo '<button type="button" class="mb-sm btn btn-info" '.$linkimprimir.'  style="cursor:pointer"><span class="glyphicon glyphicon-print"></span> VER ANAMNESIS Y EXAMEN FISICO </button>';

//////
//$linkimprimir='onClick=genera_pdf();';

//echo '<button type="button" class="mb-sm btn btn-info" '.$linkimprimir.'  style="cursor:pointer"><span class="glyphicon glyphicon-print"></span>888VER ANAMNESIS Y EXAMEN FISICO</button>';
//////
?>
...
$linkeditar= 'onClick=abrir_laboratorionewl();';
echo '&nbsp;&nbsp;<a href="javascript:abrir_laboratorionewl();"><img src="images/labiconnew.png?dtt='.date("his").'">.<span class="selected"></span></a>';
...
$link_imagen= 'abrir_standar('.$comill_s.'aplicativos/documental/opciones/panel/panel_substandarformimagennew.php'.$comill_s.','.$comill_s.'IMAGEN'.$comill_s.','.$comill_s.'divBodypop_ext'.$comill_s.','.$comill_s.'divDialogpop_ext'.$comill_s.',900,700,'.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.'217'.$comill_s.','.$comill_s.$atenc_id.$comill_s.',$('.$comill_s.'#'.$campo_primariodata.$comill_s.').val(),'.$comill_s.$table.$comill_s.','.$comill_s.$centro_id.$comill_s.');';    
...
function abrir_laboratorionewl()
{
   if($('#<?php echo $campo_primariodata; ?>').val()=='')
   {
     alert("Guarde el registro para hacer el pedido de laboratorio");
...
<?php
$comill_s="'";
$link_laboratorio= 'abrir_standar('.$comill_s.'aplicativos/documental/opciones/panel/panel_newsubstandarformlab.php'.$comill_s.','.$comill_s.'LABORATORIO'.$comill_s.','.$comill_s.'divBodypop_ext'.$comill_s.','.$comill_s.'divDialogpop_ext'.$comill_s.',900,700,'.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.'219'.$comill_s.','.$comill_s.$atenc_id.$comill_s.',$('.$comill_s.'#'.$campo_primariodata.$comill_s.').val(),'.$comill_s.$table.$comill_s.','.$comill_s.$centro_id.$comill_s.');';   
...
function imprimir_datosan()
{
   ...
   myWindow3=window.open('aplicativos/documental/datos_substandarformunico_print.php?iddata=555&pVar2=<?php echo @$clie_id; ?>&pVar4=<?php echo $atenc_id; ?>&pVar5=0&pVar3=-principal-&pVar9=<?php echo $anam_id; ?>','ventana_reporteunico','width=850,height=700,scrollbars=YES');
...
function genera_pdf()
{
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {	 
	    location.href = "pdfformularios/pdformularionewgastroenterologia.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val();
	 }
	 else
	 {
       alert("Por favor guarde el resgistro para imprimir");	 
...
////
function genera_pdfevolucionuno<?php echo $tab_id; ?>()
{
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {	 
	    location.href = "pdfformularios/pdfformevolucionnewstandarnuno.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val();
	 }
	 else
	 {
       alert("Por favor guarde el resgistro para imprimir");	 
