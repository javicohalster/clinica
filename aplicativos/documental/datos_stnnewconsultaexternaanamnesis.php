...
$saca_sipermite="select * from app_usuario where usua_id='".$_SESSION['datadarwin2679_sessid_inicio']."'";
$rs_spermite = $DB_gogess->executec($saca_sipermite,array());
$usua_permisomodificacionform=0;
$usua_permisomodificacionform=$rs_spermite->fields["usua_permisomodificacionform"];
...
if($usua_permisomodificacionform==1)
{
  $bloque_registro=0;
}
...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewconsultaexternaanamnesis.php','Editar','divBody_ext','','".@$clie_id."','199','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewconsultaexternasubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'200',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";
...
<?php
$comill_s="'";
//if($_SESSION['datadarwin2679_sessid_inicio']=='1')
//{
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewconsultaexternasubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','200','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
