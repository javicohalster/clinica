...
<table width="100" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="5" bgcolor="#CEDCE3"><div align="center"><span class="Estilo1">CITAS DEL DIA </span></div></td>
    </tr>
  <tr>
  ...
  <?php
   $lista_buscat="select * from  faesa_terapiasregistro inner join app_cliente on faesa_terapiasregistro.clie_id=app_cliente.clie_id where faesa_terapiasregistro.usua_id=".$usua_id." and terap_fecha>='".$fecha_hoy."' order by terap_fecha asc limit 20";
...
<td>&nbsp;</td>
	   ...
	   <table width="300" border="1" cellpadding="0" cellspacing="0">
         <tr>
           <td colspan="2" bgcolor="#CEDCE3"><div align="center"><span class="Estilo1">PACIENTES QUE AUN NO PAGAN </span></div></td>
         </tr>
         <?php
	    $lista_buscat="select distinct faesa_terapiasregistro.clie_id,clie_nombre,clie_apellido,terap_nfactura from  faesa_terapiasregistro inner join app_cliente on faesa_terapiasregistro.clie_id=app_cliente.clie_id where  terap_fecha>='".$fecha_hoy."' and faesa_terapiasregistro.centro_id='".$_SESSION['datadarwin2679_centro_id']."'";
			...
			?>
         <tr>
           <td><?php echo ucwords(strtolower(utf8_encode($rs_lbuscat->fields["clie_nombre"]." ".$rs_lbuscat->fields["clie_apellido"]))); ?></td>
           <td>Terapia</td>
         </tr>
         <?php
		 }
