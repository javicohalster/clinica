...
$linkeditar= 'onclick=abrir_standar("aplicativos/documental/opciones/grid/'.$carpeta.'/grid'.$subindice.'_nuevo.php","Nuevo","divBody'.$subindice.'","divDialog'.$subindice.'",750,500,0,0,0,0,0,0,0) style=cursor:pointer';	
