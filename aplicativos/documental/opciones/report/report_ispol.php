...
$valor_especialidad_d='';
$valor_especialidad_d=$rs_btarifario->fields["dns_especialidad"];
if($nivel_establ==2)
{
    if($valor_especialidad_d==76)
	{
	   $valor_especialidad_d=78;	
	}
}

$n_especialiddnm=0;
$n_especialiddnm=$objformulario->replace_cmb("pichinchahumana_extension.dns_profesion","prof_nombre,prof_id"," where prof_nombre like ",$rs_btarifario->fields["usua_formaciondelprofesional"],$DB_gogess); 
	...
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$n_especialiddnm.'</span></td>
