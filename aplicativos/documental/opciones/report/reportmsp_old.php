...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="2">
  <tr>
    <td width="25%"><img src="../../../../images/logo2.png" width="123" height="98" /></td>
    <td width="25%"><div align="right"><img src="../../../../images/ministerio.jpg"  height="98" /></div></td>
  </tr>
  <tr>
...
<table width="800" border="1" align="center" cellpadding="3" cellspacing="1">
  <tr>
    <td colspan="5" nowrap bgcolor="#E0EBF1"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2"><B>No. Tr&aacute;mite: </B></td>
  ...
  $numeracion_exp=0;
$lista_servicios="select * from  dns_atencion inner join app_cliente on dns_atencion.clie_id=app_cliente.clie_id where dns_atencion.centro_id='".$_GET["centro_id"]."' and atenc_fecharegistro like '".$_GET["anio_valor"]."-".$_GET["mes_valor"]."-%' ";
$totalexp=0;
 ...
 if($rs_anamesisexamenfisicol)
 {
  ...
  <tr>
	...
	<td nowrap bgcolor="#E9F1F5"><?php echo $rs_data->fields["clie_rucci"]; ?></td>
	 <td nowrap bgcolor="#E9F1F5"><?php echo utf8_encode($rs_data->fields["clie_apellido"]." ".$rs_data->fields["clie_nombre"]); ?></td>
	 
	<td nowrap bgcolor="#E9F1F5"><?php echo $rs_anamesisexamenfisicol->fields["prod_precio"]; ?></td>
  </tr>
 <?php
 $total_g=$total_g+$rs_anamesisexamenfisicol->fields["prod_precio"];
...
<?php 
  ...
  <tr>
    ...
    <td nowrap bgcolor="#E9F1F5">&nbsp;</td>
    <td nowrap bgcolor="#E9F1F5">&nbsp;</td>
    <td nowrap bgcolor="#E9F1F5"><?php echo $total_g; ?></td>
  </tr>
...
$('#total_gvalor').val('<?php echo $total_g; ?>');
