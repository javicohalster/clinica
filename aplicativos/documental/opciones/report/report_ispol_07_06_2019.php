...
$cuenta_d=0;
$union_data='';
$busca_tblparaplanillar="select distinct gogess_sistable.tab_name,fie_tablasubgrid,fie_campoenlacesub from gogess_sistable inner join gogess_sisfield on gogess_sistable.tab_name=gogess_sisfield.tab_name where ttbl_id in(2)";
...
$cuadro_lista='<table width="100%" border="1" cellpadding="2" cellspacing="0">
  <tr>
	...
	<td nowrap><div align="center"><span class="css_txttitulo">CODIGO DE VALIDACION 
SOLO RED COMPLEMENTARIA</span></div></td>
...
$separa_datafechaF=explode(" ",$rs_btarifario->fields["atenc_fechasalida"]);
	...
	<td style=mso-number-format:"@" ><span class="css_txtval">'.$rs_btarifario->fields["atenc_hc"].'</span></td>
	<td style=mso-number-format:"@" ><span class="css_txtval">'.$rs_btarifario->fields["dns_especialidad"].'</span></td>
	<td style=mso-number-format:"@" ><span class="css_txtval">NO APLICA</span></td>
	<td style=mso-number-format:"@" ><span class="css_txtval">'.$separa_datafecha[0].'</span></td>
	<td style=mso-number-format:"@" ><span class="css_txtval">'.$separa_datafecha[1].'</span></td>
	<td style=mso-number-format:"@" ><span class="css_txtval">'.$separa_datafechaF[0].'</span></td>
	<td style=mso-number-format:"@" ><span class="css_txtval">'.$separa_datafechaF[1].'</span></td>';
	...
	if($rs_diag)
	{
		...
		$cuadro_lista.='<td><span class="css_txtval">'.$rs_diag->fields["diagn_cie"].'</span></td>';
		$cuenta_cie++;
	...
	$cuadro_lista.='<td style=mso-number-format:"@" ><span class="css_txtval">'.$rs_btarifario->fields["clie_nombretitulardelseguro"].'</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" ><span class="css_txtval">'.$rs_btarifario->fields["clie_numerodecedulatitular"].'</span></td>';
	...
	$cuadro_lista.='<td style=mso-number-format:"@" ><span class="css_txtval">'.$rs_btarifario->fields["nac_id"].'</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" ><span class="css_txtval">'.$rs_btarifario->fields["prod_famprod"].'</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" ><span class="css_txtval">'.$rs_btarifario->fields["cuabas_fecharegistro"].'</span></td>';
