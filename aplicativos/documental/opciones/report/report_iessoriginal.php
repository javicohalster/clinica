...
$cuadro_lista='<table width="100%" border="1" cellpadding="2" cellspacing="0">
  <tr>
    <td nowrap><div align="center"><span class="css_txttitulo">CODIGO DEPENDENCIA</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">PLANILLA</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">FECHA</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">TIPO DE SEGURO</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">IDENTIFICACI&Oacute;N BENEFICIARIO</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">NOMBRE PACIENTE</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">CODIGO DEL PROCEDIMIENTO</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">NOMBRE DEL PROCEDIMIENTO</span></div></td>
	
	<td nowrap><div align="center"><span class="css_txttitulo">DIAGNOSTICO 1 CODIGO CIE10</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">DIAGNOSTICO 2 CODIGO CIE10</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">DIAGNOSTICO 3 CODIGO CIE10</span></div></td>
	
	<td nowrap><div align="center"><span class="css_txttitulo">CANTIDAD</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">VALOR</span></div></td>
	
	<td nowrap><div align="center"><span class="css_txttitulo">DURACION CONSULTA</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">PARENTESCO</span></div></td>
	
	<td nowrap><div align="center"><span class="css_txttitulo">IDENTIFICACION AFILIADO</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">NOMBRE AFILIADO</span></div></td>
    <td nowrap><div align="center"><span class="css_txttitulo">CODIGO DE DERIVACION</span></div></td>
    <td nowrap><div align="center"><span class="css_txttitulo"># SECUENCIAL DERIVACION</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">CONTINGENCIA CUBIERTA</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">DIAGNOSTICO PRESUNTIVO</span></div></td>
	
	
    <td nowrap><div align="center"><span class="css_txttitulo">TIEMPO DE ANESTESIA</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">DIAGNOSTICO 4 CODIGO CIE10</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">DIAGNOSTICO 5 CODIGO CIE10</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">DIAGNOSTICO 6 CODIGO CIE10</span></div></td>
	
	<td nowrap><div align="center"><span class="css_txttitulo">PORCENTAJE IVA</span></div></td>
    <td nowrap><div align="center"><span class="css_txttitulo">VALOR IVA UNITARIO</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">MARCA</span></div></td>	
...
$parent_valord='';
	...
	switch($rs_btarifario->fields["clie_parentescopaciente"])
    {
		case 'ESPOSO';
		{
  ...
  if($parentescos_data=='TITULAR')
     {
	      if($rs_btarifario->fields["situ_id"]==1)
		  {
		     $tipo_segurox='SG';
		  }
		  if($rs_btarifario->fields["situ_id"]==2)
		  {
		     $tipo_segurox='JU';
		  }
		  if($rs_btarifario->fields["situ_id"]==3)
		  {
		     $tipo_segurox='MO';
		  }
	...
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$n_establgeneral.'</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$numeracion_exp.'</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$formato_fecha.'</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$tipo_segurox.'</span></td>';
	...
	//------diagnostico
	$cuenta_cie=0;
	$lista_diag="select * from ".$rs_tbldiag->fields["fie_tablasubgrid"]." where ".$rs_tbldiag->fields["fie_campoenlacesub"]."='".$rs_btarifario->fields["sub_enlace"]."' limit 3";
	...
	if($rs_diag)
	{
		...
		$num_punto=str_replace(".X","",$num_punto);	
	...
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval"></span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$parent_valord.'</span></td>';
	...
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">CVCEC</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">999999</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">1</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">D</span></td>';
	...
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">0</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">0</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$rs_btarifario->fields["clie_genero"].'</span></td>';
	
	//$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">AMBULATORIO</span></td>';
	//$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$mesanio.'</span></td>';
	//$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$rs_tbltotales->fields["total"].'</span></td>';		
