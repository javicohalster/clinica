...
$cuadro_lista='<table width="100%" border="1" cellpadding="2" cellspacing="0">
  <tr>
    <td nowrap><div align="center"><span class="css_txttitulo">NUMERO DE PLANILLAS</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">CODIGO DE AFILIACION DE TITULAR</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">CODIGO DE AFILIACION DE PACIENTE</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">NOMBRES Y APELLIDOS</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">FECHA DE INGRESO</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">FECHA DE SALIDA</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">DIAGNOSTICO 1</span></div></td>
    <td nowrap><div align="center"><span class="css_txttitulo">DIAGNOSTICO 2</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">ESTADO</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">FECHA DE TARIFARIO VIGENTE</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">CODIGO DE SERVICIO</span></div></td>
	...
	<td nowrap><div align="center"><span class="css_txttitulo">VALOR PACIENTE</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">MODIFICADOR</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">NOMBRE MEDICAMENTO</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">IDENTIFICADOR S,M,I</span></div></td>
...
//$nombre_unidad_general=$nombre_establ;
	...
	$fecha_ingsepara=explode(" ",$rs_btarifario->fields["atenc_fechaingreso"]);
	
	$fecha_salidasepara=explode(" ",$rs_btarifario->fields["atenc_fechasalida"]);
	
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.str_replace('-','',$fecha_ingsepara[0]).'</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.str_replace('-','',$fecha_salidasepara[0]).'</span></td>';
	...
	$fecha_formatocubas=explode(" ",$rs_btarifario->fields["cuabas_fecharegistro"]);
	
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.str_replace("-","",$fecha_formatocubas[0]).'</span></td>';
	...
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">S</span></td>';
