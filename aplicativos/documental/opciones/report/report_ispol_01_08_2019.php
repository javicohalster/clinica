...
$cuenta_d=0;
$union_data='';
$busca_tblparaplanillar="select distinct gogess_sistable.tab_name,fie_tablasubgrid,fie_campoenlacesub,tab_codigoesp from gogess_sistable inner join gogess_sisfield on gogess_sistable.tab_name=gogess_sisfield.tab_name where ttbl_id in(2) and gogess_sistable.tab_name not in ('dns_imagenologiainfo')";
//$busca_tblparaplanillar="";
...
atenc_hc,
".$tabla_principal.".".$campo_enlaceval." as sub_enlace,
atenc_condiciondeegreso,
clie_rucci,
clie_nombre as clie_nombre,
clie_apellido,
...
0 as gestion_adm,
0 as valor_iva,
clie_parentescopaciente,
prod_clasificacionporcargo
from dns_atencion 
...
where ".$tabla_principal.".centro_id='".$_GET["centro_id"]."' and cuabas_fecharegistro like '".$_GET["anio_valor"]."-".$_GET["mes_valor"]."-%' and  prod_nivel=".$nivel_establ."  and tipopac_id=".$codigo_seguro.' UNION ';
...
//codigo generico(RECETAS)  -> FARMACIA
$arreglos_data=array();
$cuenta_d=0;
//$union_data='';
$busca_tblparaplanillar="select distinct gogess_sistable.tab_name,fie_tablasubgrid,fie_campoenlacesub,tab_codigoesp from gogess_sistable inner join gogess_sisfield on gogess_sistable.tab_name=gogess_sisfield.tab_name where ttbl_id in(3) and gogess_sistable.tab_name not in ('dns_imagenologiainfo','dns_referencia')";
//$busca_tblparaplanillar="";
$rs_tblpla = $DB_gogess->executec($busca_tblparaplanillar,array());
if($rs_tblpla)
	{
...
centro_ruc,
centro_nombre,
'AMBULATORIO' as tiposerv_nombre,
atenc_condiciondeingreso,
atenc_hc,
".$tabla_principal.".".$campo_enlaceval." as sub_enlace,
atenc_condiciondeegreso,
...
".$tabla_subgrid.".plantra_valorplanilla as prod_precio,
'".$tabla_especialidad."' as dns_especialidad,
plantra_cantidad as prod_cantidad,
plantra_preciotechosinporcentaje as prod_techo,
plantra_porcentajeiva as prod_iva,
1 as gestion_adm,
0 as valor_iva,
clie_parentescopaciente,
'FARMACIA' as prod_clasificacionporcargo
from dns_atencion 
inner join ".$tabla_principal." on dns_atencion.atenc_id=".$tabla_principal.".atenc_id
inner join app_cliente on dns_atencion.clie_id=app_cliente.clie_id
inner join ".$tabla_subgrid." on ".$tabla_principal.".".$campo_enlaceval."=".$tabla_subgrid.".".$campo_enlaceval."
...
where centrod_id='".$_GET["centro_id"]."' and plantra_despachado='SI' and plantra_fechadespacho like '".$_GET["anio_valor"]."-".$_GET["mes_valor"]."-%'  and tipopac_id=".$codigo_seguro.' UNION ';
...
//codigo generico(DISPOSITIVOS)--> INSUMOS
$arreglos_data=array();
$cuenta_d=0;
//$union_data='';
$busca_tblparaplanillar="select distinct gogess_sistable.tab_name,fie_tablasubgrid,fie_campoenlacesub,tab_codigoesp from gogess_sistable inner join gogess_sisfield on gogess_sistable.tab_name=gogess_sisfield.tab_name where ttbl_id in(4) and gogess_sistable.tab_name not in ('dns_imagenologiainfo','dns_referencia')";
//$busca_tblparaplanillar="";
$rs_tblpla = $DB_gogess->executec($busca_tblparaplanillar,array());
if($rs_tblpla)
	{
		while (!$rs_tblpla->EOF) {
		  ...
		  $tabla_especialidad=$rs_tblpla->fields["tab_codigoesp"];
	       ...
	       $union_data.="select 
			...
			".$tabla_subgrid.".plantrai_valorplanilla as prod_precio,
			'".$tabla_especialidad."' as dns_especialidad,
			plantrai_cantidad as prod_cantidad,			
			0 as prod_techo,
			plantrai_porcentajeiva as prod_iva,
			1 as gestion_adm,
            1 as valor_iva,
			clie_parentescopaciente,
			'INSUMOS' as prod_clasificacionporcargo
			from dns_atencion 
			inner join ".$tabla_principal." on dns_atencion.atenc_id=".$tabla_principal.".atenc_id
			inner join app_cliente on dns_atencion.clie_id=app_cliente.clie_id
			inner join ".$tabla_subgrid." on ".$tabla_principal.".".$campo_enlaceval."=".$tabla_subgrid.".".$campo_enlaceval."
			...
			inner join app_usuario on ".$tabla_subgrid.".usua_id=app_usuario.usua_id
			inner join dns_centrosalud on dns_atencion.centro_id=dns_centrosalud.centro_id
			where centrod_id='".$_GET["centro_id"]."'  and plantrai_despachado='SI'  and plantrai_fechadespacho like '".$_GET["anio_valor"]."-".$_GET["mes_valor"]."-%' and tipopac_id=".$codigo_seguro.' UNION ';
...
//$nombre_unidad_general=$nombre_establ;
	...
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$rs_btarifario->fields["centro_ruc"].'</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$n_establgeneral.'</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$nombre_unidad_general.'</span></td>
	...
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">NA</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">5</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$rs_btarifario->fields["tiposerv_id"].'</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$rs_btarifario->fields["clie_rucci"].'</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$rs_btarifario->fields["dns_especialidad"].'</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval"></span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$formato_fecha.'</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$solo_hora[0].":".$solo_hora[1].'</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$formato_fecha.'</span></td>
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval"></span></td>';
	...
	//------diagnostico
	$cuenta_cie=0;
	$lista_diag="select * from ".$rs_tbldiag->fields["fie_tablasubgrid"]." where ".$rs_tbldiag->fields["fie_campoenlacesub"]."='".$rs_btarifario->fields["sub_enlace"]."' limit 2";
   ...
   // $cuadro_lista.='<td style=mso-number-format:"@" ><span class="css_txtval">'.$edad_val["anio"].'</span></td>';
	...
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$valor_sumado.'</span></td>';	
