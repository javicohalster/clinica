...
$cuadro_lista='<table width="100%" border="1" cellpadding="2" cellspacing="0">
  <tr>
    <td nowrap><div align="center"><span class="css_txttitulo">No</span></div></td>
	...
	<td nowrap><div align="center"><span class="css_txttitulo">IESS</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">CAMPESIONO</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">ISSPOL</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">ISFA TOTAL</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">MSP</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">SPATT</span></div></td>
	...
	<td nowrap><div align="center"><span class="css_txttitulo">PRIMERA</span></div></td>
	<td nowrap><div align="center"><span class="css_txttitulo">SUBSECUENTE</span></div></td>
...
//$nombre_unidad_general=$nombre_establ;
	...
	<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$contadorlist.'</span></td>
	...
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval"></span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval"></span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">x</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval"></span></td>';
	...
	$prim='x';
	$subs='';
	if('dns_consultaexterna'==$rs_btarifario->fields["tabla"])
	{
	$prim='';
	$subs='x';
	}
	
	if('dns_psicologia'==$rs_btarifario->fields["tabla"])
	{
	$prim='x';
	$subs='';
	}
	if('dns_subsecuenteodontologia'==$rs_btarifario->fields["tabla"])
	{
	$prim='';
	$subs='x';
	}
	...
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$prim.'</span></td>';
	$cuadro_lista.='<td style=mso-number-format:"@" nowrap="nowrap" ><span class="css_txtval">'.$subs.'</span></td>';
...
//datos cabecera
$codigo_val='';
$codigo_val=$mes_valor."-".$nombremes."-".str_replace("ESTABLECIMIENTO DE ","",utf8_decode($nombre_establ))."-".$anio_valor; 
...
$lee_plantilla=str_replace("-establecimiento-",utf8_decode($nombesta),$lee_plantilla);
$lee_plantilla=str_replace("-establecimiento-",utf8_decode($nombesta),$lee_plantilla);
