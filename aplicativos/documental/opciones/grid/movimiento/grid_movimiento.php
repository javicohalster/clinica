...
if($_POST["pVar7"])
{
  //$sql2="centro_id=".@$_SESSION['datadarwin2679_centro_id']." and ";
  $sql3="cuadrobm_id='".@$_POST["pVar7"]."' and ";
}
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_standar.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo $_POST["pVar2"]; ?>\',0,0,0,0,\'<?php echo @$_POST["pVar7"]; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
