...
$array_data[0]["titulo"]="Proveedor";
$array_data[0]["col"]="3";
$array_data[0]["campo"]="provee_nombre";
$array_data[0]["tipo"]="text";
$array_data[0]["tablacmb"]="gogess_sino";
$array_data[0]["campocmb"]="value,etiqueta";
$array_data[0]["orderby"]="";

$array_data[1]["titulo"]="Fecha Emisi&oacute;n";
$array_data[1]["col"]="2";
$array_data[1]["campo"]="movban_fechaemision";
$array_data[1]["tipo"]="fecha";
$array_data[1]["tablacmb"]="";
$array_data[1]["campocmb"]="";
$array_data[1]["orderby"]="";

$array_data[2]["titulo"]="Tipo Movimientoo";
$array_data[2]["col"]="3";
$array_data[2]["campo"]="tmv_nombre";
$array_data[2]["tipo"]="text";
$array_data[2]["tablacmb"]="";
$array_data[2]["campocmb"]="";
$array_data[2]["orderby"]="";

$array_data[3]["titulo"]="Detalle Tipo Movimientoo";
$array_data[3]["col"]="2";
$array_data[3]["campo"]="detmov_nombre";
$array_data[3]["tipo"]="text";
$array_data[3]["tablacmb"]="";
$array_data[3]["campocmb"]="";
$array_data[3]["orderby"]="";

$array_data[4]["titulo"]="Descripci&oacute;n";
$array_data[4]["col"]="2";
$array_data[4]["campo"]="movban_descripcion";
...
$funcion_buscar="desplegar_grid_movimientosbancos();";
$col_buscar="3";
...
echo '<table id="'.$_POST["namemodulo"].'" class="table align-items-center mb-0 dataTable" cellspacing="0" width="100%">
<thead><tr>';
//echo '<th >Imprimir </th>';
 ...
 $('#<?php echo $_POST["namemodulo"]; ?>').DataTable( {
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="borrar_registromovibanco(\'<?php echo $tabla;  ?>\',\'<?php echo $campo_id; ?>\','+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">scan_delete</span></td></tr></table>'; //<center><img src="images/delete.png"  /></center>
...
function borrar_registro(tabla,campo,valor)
{
 ...
 if (confirm("Esta seguro que desea borrar este registro ?"))
    ...
    desplegar_grid_movimientosbancos();
...
function borrar_registromovibanco(tabla,campo,valor)
{

	 if (confirm("Esta seguro que desea borrar este registro ?"))
	 { 

	 $("#grid_borrar_mb").load("aplicativos/documental/opciones/grid/grid_borrarmovbanco.php",{
     ptabla:tabla,
	 pcampo:campo,
	 pvalor:valor
  },function(result){  
     ...
     desplegar_grid_movimientosbancos();
	  $('#divBody_interno_movimientosbancos').html('');

  });  

  $("#grid_borrar_mb").html("Espere un momento");  
