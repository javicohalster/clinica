...
$subindice="_usuario";
$tabla="media_usuario";
$objgrid_fk->campos_visualizar="'usua_id','usua_ciruc','usua_nombre','usua_usuario','usua_estado'";
$ordenlistado="order by usua_id desc";
$objgrid_fk->orden=$ordenlistado;
$objgrid_fk->leer_data("media_usuario","","","",90,$sqltotal,$DB_gogess);
...
echo '<thead>
	...
	if(count($objgrid_fk->filas)>0)
	   ...
	   echo '<tr>';
		 ...
		 $linkeditar= 'onclick=abrir_standar("aplicativos/documental/opciones/grid/grid'.$subindice.'_nuevo.php","Editar","divBody'.$subindice.'","divDialog'.$subindice.'",990,500,'.$datoslista["usua_id"].',0,0,0,0,0,0) style=cursor:pointer';
