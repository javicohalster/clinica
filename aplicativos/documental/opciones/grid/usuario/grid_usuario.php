...
echo '<h3 class="text-white text-capitalize ps-3 panel-title">'.$ntabla.'</h3>'; //<div style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold;" align="center" >'.$ntabla.'</div><br>
echo '</div>';
echo '</div><br>';
...
echo '<table id="datatable1" class="table align-items-center mb-0 dataTable" cellspacing="0" width="100%">

<thead><tr>';

//echo '<th >Imprimir </th>';

echo '<th class="text-uppercase text-secondary font-weight-bolder opacity-7 sorting">Editar</th>';
if(@$_SESSION['datadarwin2679_usua_adm']==1)
{
	echo '<th class="text-uppercase text-secondary font-weight-bolder opacity-7 sorting">Perfil</th>';
	echo '<th class="text-uppercase text-secondary font-weight-bolder opacity-7 sorting">Historial</th>';
	echo '<th class="text-uppercase text-secondary font-weight-bolder opacity-7 sorting">R.Anteriores</th>';
}
...
echo '<th class="text-uppercase text-secondary font-weight-bolder opacity-7 sorting">Borrar</th>';
...

	{
		 ...
		 //echo '<th class="text-uppercase text-secondary font-weight-bolder opacity-7 sorting">'.utf8_encode($objgrid_fk->arrcampos_titulo[$i]).'</th>';
		echo '<th class="text-uppercase text-secondary font-weight-bolder opacity-7 sorting">' . 
     		mb_convert_encoding($objgrid_fk->arrcampos_titulo[$i] ?? '', 'UTF-8', 'ISO-8859-1') . 
     		'</th>';
    ...
    "columns": [

        {
...

            {
                ...
                return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_standarusuario.php\',\'Editar\',\'divBody_ext\',' +
		 ...
		 ?>,
        {
...

            {
                ...
                return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/opciones/grid/usuario/perfil.php\',\'Perfil\',\'divBody_perfil\',\'divDialog_perfil\',500,390,' +
                    full["<?php echo $campo_id ?>"] +
                    ',0,0,0,0,0,0)" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">manage_accounts</span></td></tr></table>'; //<center><img src="images/opciones/perfil.png"  /></center>
        ...
        },
        {
...

            {
                ...
                return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/opciones/grid/usuario/historialmd.php\',\'Ver_Historial\',\'divBody_perfil\',\'divDialog_perfil\',500,390,' +
                    full["<?php echo $campo_id ?>"] +
                    ',0,0,0,0,0,0)" style=cursor:pointer ><span class="ms-4 fs-1 material-symbols-outlined">manage_search</span></td></tr></table>'; //<center><img src="images/opciones/perfil.png"  /></center>
        ...
        },
        {
...

            {
                ...
                return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/opciones/grid/usuario/reganterior.php\',\'Registros_Anteriores\',\'divBody_perfil\',\'divDialog_perfil\',500,390,' +
                    full["<?php echo $campo_id ?>"] +
                    ',0,0,0,0,0,0)" style=cursor:pointer ><span class="ms-5 fs-1 material-symbols-outlined">manage_history</span></td></tr></table>'; //<center><img src="images/opciones/perfil.png"  /></center>
		 ...
		 ?>,
        {
            ...
            "mRender": function(data, type, full) {
                return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="borrar_registro(\'<?php echo $tabla;  ?>\',\'<?php echo $campo_id; ?>\',' +
                    full["<?php echo $campo_id ?>"] +
                    ')" style=cursor:pointer ><center><img src="images/delete.png"  /></center></td></tr></table>';
            }
        }
        <?php
		 }
