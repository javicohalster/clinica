...
$banderaexiste=0;
$listalinkstr="select * from app_usuariosperfil where usua_id='".$_POST["usua_idx"]."' and per_codobj=".$_POST["mnupan_idx"];
...
if($banderaexiste)
{
   ...
   $actualiza="update app_usuariosperfil set per_activo='".$activox_val."' where usua_id='".$_POST["usua_idx"]."' and per_codobj=".$_POST["mnupan_idx"];
...
else
{
   ...
   $actualiza="insert into app_usuariosperfil (usua_id,per_codobj,per_activo) values ('".$_POST["usua_idx"]."','".$_POST["mnupan_idx"]."','".$activox_val."')";
   $okval = $DB_gogess->executec($actualiza,array());
