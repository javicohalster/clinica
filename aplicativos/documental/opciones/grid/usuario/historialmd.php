...
$("#perfil_div").load("aplicativos/documental/opciones/grid/usuario/historial_g.php",{
...
<table width="300" border="0" cellpadding="4" cellspacing="0">
      ...
      <tr>
        ...
        <td bgcolor="#F0F7F7" style="font-size:11px" >Historial</td>
      ...
      <tr>
		...
		<?php
	 $listaitem="select * from gogess_menupanel where mnupan_id not in(15,16,28,31,34,38,39,47,49,54,55,25,29,32,42,56,57,58,69,72,73,74,67,77,79,78,84,81,93,94,95,87,85,46,48,50,52,53,37,41,43,97,96,92,86,45,51,76,80,82,6,61,63,33,35,36,40,98) order by mnupan_id asc"; 	  
	  ...
	  if($resultadoitem)
	    {  
		   ...
		   while (!$resultadoitem->EOF) {
			...
			$listaperfil="select * from pichinchahumana_extension.app_usuarioshistorial where usua_id='".$_POST["pVar1"]."' and per_codobj=".$resultadoitem->fields["mnupan_id"];
