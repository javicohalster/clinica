...
$rs_datosmenu = $DB_gogess->executec($lista_datosmenu,array(57));
 ...
 $('#datatable_ext').DataTable( {
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_vacaciones.php\',\'Editar\',\'divBody_extvaca\','+full["<?php echo $campo_id ?>"]+',57,0,0,0,0,\'<?php echo $_POST["pVar7"]; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
