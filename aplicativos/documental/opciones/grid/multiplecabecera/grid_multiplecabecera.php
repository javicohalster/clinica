...
//echo $rs_tabla_vista->fields["tab_name"];;
...
$sql6=" centro_id='".$_SESSION['datadarwin2679_centro_id']."' and ";	
		...
		"mRender": function (data,type,full)
				{
				 ...
				 {
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_multiplecabecera.php\',\'Editar\',\'divBody_ext\',\''+full["<?php echo $campo_id ?>"]+'\',\'<?php echo $_POST["pVar2"]; ?>\',0,0,0,0,0)" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
				 }
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/datos_multipleanular.php\',\'Anular\',\'divBody_anular\',\'divDialog_anular\',400,290,\''+full["<?php echo $campo_id ?>"]+'\',0,0,0,0,0,0)" style=cursor:pointer ><center><img src="images/anular.png"  /></center></td></tr></table>';
