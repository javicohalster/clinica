...
$carpeta='substandartraumatologiaanamnesis';
...
$subindice="_substandartraumatologiaanamnesis";
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_substandartraumatologiaanamnesis.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo @$_POST["pVar2"]; ?>\',\'<?php echo @$_POST["pVar3"]; ?>\',\'<?php echo @$_POST["pVar4"]; ?>\',0,\'<?php echo $tipofor_id; ?>\',\'<?php echo @$_POST["pVar7"]; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
