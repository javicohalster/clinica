...
$busca_pagados="select crb_id from lpin_cobropago inner join lpin_cobropagodetalle on lpin_cobropago.crb_enlace=lpin_cobropagodetalle.crb_enlace where lpin_cobropagodetalle.doccabcp_id='".$doccab_id."'";
