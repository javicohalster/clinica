		...
		"mRender": function (data,type,full)
				{
				 ...
				 {
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_cabeceralq.php\',\'Editar\',\'divBody_ext\',\''+full["<?php echo $campo_id ?>"]+'\',\'<?php echo $_POST["pVar2"]; ?>\',0,0,0,0,0)" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
				 }
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/datos_anularlq.php\',\'Anular\',\'divBody_anular\',\'divDialog_anular\',400,290,\''+full["<?php echo $campo_id ?>"]+'\',0,0,0,0,0,0)" style=cursor:pointer ><center><img src="images/anular.png"  /></center></td></tr></table>';
