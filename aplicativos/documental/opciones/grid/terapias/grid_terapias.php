...
echo '<div style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold;" align="center" >Lista</div><br>';
...
echo '<th >Notas Evoluci&oacute;n</th>';
...
if($campo_id==$camposdata or $camposdata=='emp_id' or $camposdata=='clie_id' or $camposdata=='usuam_id')
 ...
 $('#datatable1').DataTable( {
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_standarterapia.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',\'42\',0,0,0,0,0)" style=cursor:pointer ><center><img src="images/notas.png"  /></center></td></tr></table>';
