...
echo '<th class="text-uppercase text-secondary font-weight-bolder opacity-7">Anular</th>';
if($boto_borrar)
{
...
///del buscador
$campors_buscador=$_POST["campors_buscador"];
$sqlb1='';
$sqlb2='';
$sqlb3='';
$sqlb4='';
...
if($campors_buscador)
{
 ...
 {
    $ncampo='';
	$ncampo=trim($listado_buscador[$z]);
	$$ncampo=$_POST[$ncampo];	
...
{
   $sqlb1=" (doccab_fechaemision_cliente>='".$fechai."' and doccab_fechaemision_cliente<='".$fechaf."') and ";
}  
else
{
  ...
  if($fechai!='' and $fechaf=='')
  {  
    $sqlb1=" doccab_fechaemision_cliente>='".$fechai."' and ";
  }
  else
  {
    if($fechai=='' and $fechaf!='')
	{
	   $sqlb1=" doccab_fechaemision_cliente<='".$fechaf."' and ";  
    }
  }
...
if($doccab_rucci_cliente)
  {
   $sqlb2=" doccab_rucci_cliente like '%".$doccab_rucci_cliente."%' and ";
  } 

if($doccab_nombrerazon_cliente)
  {
   $sqlb3=" doccab_nombrerazon_cliente like '%".$doccab_nombrerazon_cliente."%' and ";
  } 
  
if($doccab_ndocumento)
  {
   $sqlb4=" doccab_ndocumento like '%".$doccab_ndocumento."%' and ";
  } 
...
if($estado_sri)
  {
      if($estado_sri=='PENDIENTE')
      {
	    $sqlb6=" doccab_estadosri ='' and ";
	  }
	  else
	  {
	    $sqlb6=" doccab_estadosri ='".$estado_sri."' and ";
	  }
  } 
...
if($doccab_anulado)
{
  ...
  if($doccab_anulado=='SI')
      {
	    $sqlb7=" doccab_anulado ='ANULADO' and ";
	  }
  
  if($doccab_anulado=='NO')
      {
	    $sqlb7=" doccab_anulado ='' and ";
	  }
...
$buscador_sql='';
echo $buscador_sql=$sqlb1.$sqlb2.$sqlb3.$sqlb4.$sqlb5.$sqlb6.$sqlb7.$sqlb8.$sqlb9.$sqlb10;
...
$('#datatable1').DataTable({
    "order": [
        [<?php echo $coloum_ord; ?>, "<?php echo $ascdesc_ord; ?>"]
    ],
    "language": {
    ...
    "columns": [{
            ...
            "mRender": function(data, type, full) {
                ...
                return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_ventas.php\',\'Editar\',\'divBody_ext\',' +
        ...
        },
        {
            ...
            "mRender": function(data, type, full) {
				...
				{
				?>
                return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/datos_anular.php\',\'Anular\',\'divBody_anular\',\'divDialog_anular\',400,290,\'' +
                    full["<?php echo $campo_id ?>"] +
                    '\',0,0,0,0,0,0)" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">block</span></td></tr></table>'; //<center><img src="images/anular.png"  /></center>
                <?php
				 }
				 else
				 {
...

        {
...

            {
                ...
                if (full["<?php echo $mnupan_campoarchivo; ?>"] == '') {
                    ...
                    return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="" style=cursor:pointer ><center><a href="archivo/' +
                        full["<?php echo $mnupan_campoarchivo; ?>"] +
                        '" target="_blank" class="thumbnail" ><img src="archivo/file.png" alt="125x125" width="70px" ></a></center></td></tr></table>';
                }
