...
if($clie_id)
{
$sql2=" clie_id=".$clie_id." and ";
}

if($atenc_id)
{
$sql3=" atenc_id=".$atenc_id." and ";
}

//if($tipofor_id)
//{
//$sql4=" tipofor_id=".$tipofor_id." and ";
//}

if($protoop_idenlace)
{
$sql5=" protoop_idenlace='".$protoop_idenlace."' and ";
}

if($protoop_tblprincipal)
{
$sql6=" protoop_tblprincipal='".$protoop_tblprincipal."' and ";
}
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantallaextendida(\'aplicativos/documental/datos_substandarformunicoprotocolooperatorio.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo @$_POST["pVar2"]; ?>\',\'<?php echo @$_POST["pVar3"]; ?>\',\'<?php echo @$_POST["pVar4"]; ?>\',0,\'<?php echo $tipofor_id; ?>\',\'<?php echo @$_POST["pVar7"]; ?>\',0,0,0,\'<?php echo $protoop_idenlace; ?>\',\'<?php echo $protoop_tblprincipal; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
