...
if($id_llega)
{
$sql4=" imgag_idexterno='".$id_llega."' and ";
}

if($tabla_llega)
{
$sql5=" imgag_tablaexterno='".$tabla_llega."' and ";
}
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_substandarformimagennew.php\',\'Editar\',\'divBodylab_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo @$_POST["pVar2"]; ?>\',\'<?php echo @$_POST["pVar3"]; ?>\',\'<?php echo @$_POST["pVar4"]; ?>\',\'<?php echo @$id_llega; ?>\',\'<?php echo @$tabla_llega; ?>\',0)" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
