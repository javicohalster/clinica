...
$rs_datosmenu = $DB_gogess->executec($lista_datosmenu,array(47));
...
echo '<table id="datatable_evol" class="display responsive cell-border" cellspacing="0" width="100%">
<thead><tr>';
//echo '<th >Imprimir </th>';
echo '<th >Editar</th>';
if($boto_borrar)
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/opciones/grid/informeevolucion/grid_informeevolucion_nuevo.php\',\'Editar\',\'divBody_interno<?php echo $_POST["indice_grid"]; ?>\','+full["<?php echo $campo_id ?>"]+',\'<?php echo @$_POST["pVar2"]; ?>\',\'<?php echo '47'; ?>\',0,0,0,0)" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
...
//enviar
$varable_enviafunc=base64_encode("desplegar_grid_informeevolucion();");
