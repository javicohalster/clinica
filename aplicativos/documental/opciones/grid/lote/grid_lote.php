		...
		"mRender": function (data,type,full)
				{
				   ...
				   return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td class="align-middle text-center text-sm"><span class="badge fs-6 badge-sm bg-gradient-danger">-</span></td></tr></table>'; //<td style="color: rgb(255, 255, 255); background-color: rgb(153, 0, 0);" ><center></center></td>
