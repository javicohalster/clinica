...
$busca_egreso="select *,dns_invtemporaldespacho.tempdsp_id as idtempdsp_id from dns_invegresosvarios inner join dns_invtemporaldespacho on dns_invegresosvarios.egrec_id=dns_invtemporaldespacho.egrec_id inner join dns_movimientoinventario on dns_movimientoinventario.moviin_id=dns_invtemporaldespacho.moviin_id where dns_invegresosvarios.egrec_id='".$egrec_id."'";
...
$egrecentrecentro_id=$egrec_id;
$moviincent_id=$rs_egrpro->fields["moviin_id"];
$moviinb_redpublica=$rs_egrpro->fields["moviinb_redpublica"];



$procesa_compra="INSERT INTO dns_principalmovimientoinventario (cuadrobm_id,centro_id,tipom_id,tipomov_id,moviin_nlote,moviin_fechadecaducidad,moviin_comprobantedeingreso,moviin_fechaingreso,centroenvia_id,centrorecibe_id,centrorecibe_observacion,centrorecibe_cantidad,centrorecibe_documento,centrorecibe_bodegamatriz,usua_id,moviin_fechaenvio,moviin_nombrerecibe,moviin_cedularecibe,moviin_gradorecibe, moviin_fecharegistro,unid_id,uniddesg_id,moviin_cantidadunidadconsumo,moviin_totalenunidadconsumo,moviin_fechadeelaboracion,moviin_nombreproveedor,moviin_nombrefabricante,moviin_preciocompra,moviin_total, moviin_rsanitario,compra_id,moviin_autorizado,moviin_fechaautorizado,moviin_aprobo,moviintemp_id,perioac_id,tempdspcent_id,egrecentrecentro_id,moviincent_id,moviin_presentacioncomercial,moviin_redpublica) values ('".$cuadrobm_id."','".$centro_id."','".$tipom_id."','".$tipomov_id."','".$moviin_nlote."','".$moviin_fechadecaducidad."','".$moviin_comprobantedeingreso."','".$moviin_fechaingreso."','".$centroenvia_id."','".$centrorecibe_id."','".$centrorecibe_observacion."','".$centrorecibe_cantidad."','".$centrorecibe_documento."','".$centrorecibe_bodegamatriz."','".$usua_id."','".$moviin_fechaenvio."','".$moviin_nombrerecibe."','".$moviin_cedularecibe."','".$moviin_gradorecibe."','".$moviin_fecharegistro."','".$unid_id."','".$uniddesg_id."','".$moviin_cantidadunidadconsumo."','".$moviin_totalenunidadconsumo."','".$moviin_fechadeelaboracion."','".$moviin_nombreproveedor."','".$moviin_nombrefabricante."','".$moviin_preciocompra."','".$moviin_total."','".$moviin_rsanitario."','".$compra_id."','".$moviin_autorizado."','".$moviin_fechaautorizado."','".$moviin_aprobo."','".$moviintemp_id."','".$perioac_id."','".$tempdspcent_id."','".$egrecentrecentro_id."','".$moviincent_id."','".$moviin_presentacioncomercial."','".$moviinb_redpublica."')";


//echo $procesa_compra."<br>";

$rs_okv='';
$rs_okv = $DB_gogess->executec($procesa_compra);

if($rs_okv)
{
  //actualiza egreso

$act_data="update dns_invegresosvarios set usuareci_id='".$_SESSION['datadarwin2679_sessid_inicio']."',egrec_recibido='1',egrec_fecharecibe='".date("Y-m-d H:i:s")."' where egrec_id='".$egrec_id."'";
