...
$concatena_v='';
$busca_sindespachar="select * from dns_egresocentros where egrec_procesado=0 and egrec_tipo=0";
...
?></center>
		  ...
		  <table border="1" align="center" cellpadding="0" cellspacing="1" id="tabla" class="table-hover record_table" >
			  ...
			  <td bgcolor="#AEDBE8"><strong>Centro Destino</strong></td>
  ...
  $busca_compras='';
   ...
   if($atc_val)
   {
		 ...
		 $sql_cp=" and dns_egresocentros.egrec_id in (".$busca_compras.") ";
				   ...
				   if($sqlconcatenado)
				   { 
				   $lista_campor="select * from dns_egresocentros inner join dns_centrosalud on  dns_egresocentros.centrod_id=dns_centrosalud.centro_id where ".$sqlconcatenado." and dns_egresocentros.emp_id='".@$_SESSION['datadarwin2679_sessid_emp_id']."' and tipom_id=2 and tipomov_id=5 ".$sql2." ".$sql_cp." order by  egrec_id desc limit 300";
				   }
				   else
				   {
				   $lista_campor="select * from dns_egresocentros inner join dns_centrosalud on  dns_egresocentros.centrod_id=dns_centrosalud.centro_id where  dns_egresocentros.emp_id='".@$_SESSION['datadarwin2679_sessid_emp_id']."' and tipom_id=2 and tipomov_id=5 ".$sql2." ".$sql_cp." order by  egrec_id desc limit 300";
				   }
