                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 panel-heading">
                            <h3 class="text-white text-capitalize ps-3 panel-title"><?php echo $ncentro; ?>INGRESOS
                                VARIOS</h3>
                        </div>
                    </div>
                            ...
                            <table class="table align-items-center mb-0" border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" type="button"
                                                name="Button" value="Nuevo Comprobante de Ingreso"
                                                onclick="abrir_standar('variosingresos/grid_ingresos_nuevo.php','Ingresos','divBody_producto','divDialog_producto',800,600,0,0,0,0,0,'<?php echo $bodega_principal; ?>','<?php echo $_GET["insu"]; ?>')" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
?>
    ...
    function ingresos_prkprod(compra_id) {
        //alert(compra_id);
        abrir_standar('movimiento_variosingresos/movimiento.php', 'Ingresos_<?php echo $nombre_lista; ?>',
            'divBody<?php echo $subindice; ?>', 'divDialog<?php echo $subindice; ?>', 990, 700, 0, compra_id, 0, 0,
