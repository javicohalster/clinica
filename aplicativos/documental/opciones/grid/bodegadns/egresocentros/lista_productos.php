			    ...
			    <td colspan="9">
				 ...
				 $lista_compras="select * from dns_compras RIGHT join dns_principalmovimientoinventario on dns_compras.compra_id=dns_principalmovimientoinventario.compra_id where dns_principalmovimientoinventario.tipom_id=1  and cuadrobm_id='".$cuadrobm_id."' order by moviin_fechadecaducidad asc";
                    ...
                    if($rs_lcompras)
				    {
						...
						$busca_asig="select sum(cantidad_val) as totalegreso from dns_temporaldespacho inner join dns_egresocentros on dns_temporaldespacho.egrec_id=dns_egresocentros.egrec_id where moviin_id='".$rs_lcompras->fields["moviin_id"]."' and egrec_anulado=0 and  egrec_procesado=0";
				 ...
				 else
				 {
                    ...
                    <tr>
                      ...
                      <td><?php echo $rs_lcompras->fields["moviin_fechadeelaboracion"].' '.$rs_lcompras->fields["moviin_id"].' - cod:'.$cuadrobm_id; ?></td>
					...
					<?php
					$sumatcv=$sumatcv+$restante_valor;
					     }
					...
					<tr>
					  ...
					  <td bgcolor="#DEF0F5"><div align="center"> </div></td>
                      <td bgcolor="#DEF0F5"><div align="center"></div></td>
                      <td bgcolor="#BCE0EB"><div align="center"></div></td>
                      <td bgcolor="#DEF0F5"><div align="center"></div></td>
                      <td bgcolor="#DEF0F5"><div align="center"></div></td>
                      <td bgcolor="#DEF0F5"><div align="center"><?php echo $sumatcv; ?></div></td>
                      <td bgcolor="#DEF0F5"><div align="center"></div></td>
					  <td bgcolor="#FFE6E6"><div align="center"></div></td>
                    </tr>
