...
<table border="0" cellpadding="0" cellspacing="3">					  
			  ...
			  <tr>
				<td><button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" style="width:150px" onclick="imprimir_despacho()" >Imprimir</button></td>
			  </tr>			  
			  <tr>
				<td><br></td>
			  </tr>	  
...
<table border="0" cellpadding="0" cellspacing="3">
			  <tr>
				<td><button type="submit" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" style="width:150px" >Guardar / Actualizar</button></td>
			  </tr>			  
			   <tr>
				<td><br></td>
			  </tr>			  
			  ...
			  <tr>
				<td><button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" style="width:150px" onclick="procesar_despacho()" >Procesar</button></td>
			  </tr>
</table>
</div>';
...
$template_reemplazo='templateformsweb/maestro_standar_egresocentros2/';			  
...
<?php
$busca_sinporcesar="select count(*) sinprocesar from dns_egresocentros where egrec_procesado=0 and egrec_fecharegistro>='2024-02-01 00:00:00'";
$rs_sinproce = $DB_gogess->executec($busca_sinporcesar,array()); 


$valida_existe=0;
if(!($csearch))
{
 $valida_existe=$rs_sinproce->fields["sinprocesar"];
}
?>
...
echo "<center><br><br><br><b>No se puede crear un egreso ya que tiene pendientes por procesar...</b><br></center>";
}
else
{
?>
