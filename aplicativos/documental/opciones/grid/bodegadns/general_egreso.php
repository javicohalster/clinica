      ...
      <td><input name="txtbusca" type="text" id="txtbusca" /></td>
	   ...
	   <td><select name="centro_idbu" id="centro_idbu"  style="font-size:11px; width:360px" >
          <?php
			  ...
			  $objformulario->fill_cmb("cmb_destino_vista","centro_id,centro_nombre",""," where centro_id!=55 order by centro_nombre asc",$DB_gogess);
           ?>
      </select></td>
...
function borrar_registro_bucontrol(tabla,campo,valor)
{

if (confirm("Esta seguro que desea borrar este registro ?"))
	 { 

	 $("#grid_borrarcontrol").load("../../../../../aplicativos/documental/opciones/grid/grid_borrarcontrol.php",{
     ptabla:tabla,
	 pcampo:campo,
	 pvalor:valor
  },function(result){ 
  ...
  $("#grid_borrarcontrol").html("Espere un momento...");  
