...
$leeplantilla=leer_contenido_completo("../../../../../../plantillas/variosingresosv_lista.php");	
...
$lista_data="select * from  dns_varioscompras where compra_id='".base64_decode($_GET["aleat"])."'";
...
$lista_pro='';
$lista_miv="select *,concat(cuadrobm_principioactivo,' ',cuadrobm_nombredispositivo,' ',cuadrobm_primerniveldesagregcion,' ',cuadrobm_presentacion,' ',cuadrobm_concentracion) nombre_med from  dns_tmpvariosovimientoinventario inner join dns_cuadrobasicomedicamentos on dns_tmpvariosovimientoinventario.cuadrobm_id=dns_cuadrobasicomedicamentos.cuadrobm_id where compra_id='".$id_mob."'";
