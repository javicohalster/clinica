...
$carpeta='movimiento';
$tabla="dns_tmpvariosovimientoinventario";
$tabla_vista="dns_tmpvariosovimientoinventario_vista";
...
$busca_cierre=$objformulario->replace_cmb("dns_varioscompras","compra_id,compra_procesado"," where compra_id=",$compra_id,$DB_gogess);
$columna_ordena=4;
if($busca_cierre==0)
{
  $boto_borrar=1;
...
$busca_eltotal="select sum(centrorecibe_cantidad*moviin_preciocompra) as totalc from dns_tmpvariosovimientoinventario_vista where compra_id='".$compra_id."'";
$rs_eltotal = $DB_gogess->executec($busca_eltotal,array());

echo '<div class="container-fluid py-2">';
echo '<div class="row">';
echo '<div class="col-12">';
echo '<div style="font-size:17px"><b>Total de todos los ingresos de esta factura:'.number_format($rs_eltotal->fields["totalc"], 2, '.', '').'</b></div>';
		...
		"mRender": function (data,type,full)
				{
				 ...
				 if(full["moviin_verificado"]=='0')
				    {
					 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="desplegar_formulario('+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">edit_note</span></td></tr></table>'; //<center><img src="editarsv.png"  /></center>					
					}
					else
					{
				      return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="desplegar_formulario('+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">edit_note</span></td></tr></table>'; //<center><img src="editaral.png"  /></center>
				    }
				 ...
				 else
				 {
				   if(full["moviin_verificado"]=='0')
				    ...
				    {
				    return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="desplegar_formulario('+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">edit_note</span></td></tr></table>';	//<center><img src="../../../../../images/editar.png"  /></center>
				 	}		 
				 }
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="borrar_registro_comp(\'<?php echo $tabla;  ?>\',\'<?php echo $campo_id; ?>\','+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">scan_delete</span></td></tr></table>'; //<center><img src="../../../../../images/delete.png"  /></center>
				}
		 }
		 <?php
		 }
