...
$busca_categorias=$objformulario->replace_cmb("dns_varioscompras","compra_id,categ_id"," where compra_id=",$compra_id,$DB_gogess);
...
$("#<?php echo $subindice_formulario; ?>").load("movimiento_variosingresos/grid_movimiento_nuevo.php",{
...
function desplegar_grid_su()
{
   ...
   $("#div_grid").load("movimiento_variosingresos/grid_movimiento.php",{
