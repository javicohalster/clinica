...
$table='dns_tmpvariosovimientoinventario'; 
...
(
	...
	'moviin_codeext'=>'hidden3',
	'moviin_descext'=>'hidden3',
	'cuadrobm_id'=>'selectpekeutf8filtromd'
...
<table border="0" cellpadding="0" cellspacing="3">
			  <tr>
				<td><button type="submit" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary">Aceptar</button></td>
				<td>&nbsp;</td>
				<td><button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" onclick="desplegar_formulario(0);" >Nuevo</button></td>
...
<table border="0" cellpadding="0" cellspacing="3">
			  <tr>
				<td><button type="submit" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary">Aceptar</button></td>	
				<td>&nbsp;</td>
				<td><button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" onclick="cerrar_formu();" >Cerrar</button></td>		
			  </tr>
			</table>
</div>';	
...
$template_reemplazo='templateformsweb/maestro_standar_mcompras3/';			  
