				  ...
				  //echo $lista_campor;
                   ...
                   if($rs_listacmp)
				   {
                       ...
                       // if($rs_stactua->fields["stactual"]>0)
						...
						$busca_compras="select * from dns_principalmovimientoinventario where cuadrobm_id=".$rs_listacmp->fields[$ide_producto]." order by moviin_id desc limit 1";
                   ...
                   if($rs_listcent1)
				   {
						...
						$stockactual1="select sum(stock_cantidad*stock_signo) as stactual from dns_principalstockactual where centro_id=".$rs_listcent1->fields["centro_id"]." and cuadrobm_id=".$rs_listacmp->fields["cuadrobm_id"];
