...
?>
  ...
  ?></h3>
	  ...
	  ?>
                                        ...
                                        <td>
                                            <!-- <input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" type="button" name="Button" value="Nuevo <?php echo $nombre_lista ?>" onclick="abrir_standar('producto/grid_producto_nuevo.php','<?php echo $nombre_lista ?>','divBody_producto','divDialog_producto',990,600,0,0,0,0,0,0,'<?php echo $insu_valorx; ?>')" />  -->
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
