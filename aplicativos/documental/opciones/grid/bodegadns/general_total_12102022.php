...
<div align="center">
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
	  ...
	  {
	     echo '<input name="subcateg_idx" type="hidden" id="subcateg_idx" value="" />';
	  }
	  ?>
	  ...
	  {
	  ?>
	  <select name="produ_idip" id="produ_idip" class="Estilo2" >
          <?php
	          printf("<option value=''>---Insumo Preparado--</option>");  
			  $objformulario->fill_cmb("page_producto","produ_id,produ_nombre",""," where catpr_id=7 order by produ_nombre asc",$DB_gogess);
           ?>
      </select>
	  <?php
	  }
      ...
      <td><!-- <input type="button" name="Button" value="Nuevo <?php echo $nombre_lista ?>" onclick="abrir_standar('producto/grid_producto_nuevo.php','<?php echo $nombre_lista ?>','divBody_producto','divDialog_producto',990,600,0,0,0,0,0,0,'<?php echo $insu_valorx; ?>')" />  --></td>
    </tr>
  </table>
  <br />
</div>
