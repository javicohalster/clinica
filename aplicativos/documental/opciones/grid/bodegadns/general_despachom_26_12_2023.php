...
<div align="center">
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td><input type="button" name="Button" value="Nueva Egreso a Sub-Bodega" onclick="abrir_standar('egresocentros/grid_egresocentros_nuevo.php','Egreso_a_Centros','divBody_producto','divDialog_producto',800,600,0,0,0,0,0,0,'<?php echo $_GET["insu"]; ?>')" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
  </table>
...
function compras_prkprod(egrec_id)
 {
    //alert(compra_id);
	 abrir_standar('egresocentros/seleccionarp.php','DESPACHO','divBody<?php echo $subindice; ?>','divDialog<?php echo $subindice; ?>',990,700,0,egrec_id,0,0,0,'<?php echo $bodega_principal; ?>','<?php echo $insu_valorx; ?>');
...
if (confirm("Esta seguro que desea borrar este registro ?"))
	 ...
	 $("#div_borraritemvalor").load("../../../../../aplicativos/documental/opciones/grid/grid_borraritemvalor.php",{
     ptabla:tabla,
	 pcampo:campo,
	 pvalor:valor
  },function(result){ 
