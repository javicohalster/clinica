...
<table border="1" align="center" cellpadding="0" cellspacing="1" id="tabla" class="table-hover record_table" >
		  ...
		  <?php
				  ...
				  $lista_campor="select * from dns_temporaldespacho inner join dns_cuadrobasicomedicamentos on dns_temporaldespacho.cuadrobm_id=dns_cuadrobasicomedicamentos.cuadrobm_id inner join dns_principalmovimientoinventario on dns_temporaldespacho.moviin_id=dns_principalmovimientoinventario.moviin_id where dns_temporaldespacho.egrec_id='".$egrec_id."'";
				  //echo $lista_campor;
		           $cuenta=0;
                   ...
                   if($rs_listacmp)
				   {
						...
						$link_borrar="";
						$link_borrar="borrar_registro_temp('dns_temporaldespacho','tempdsp_id','".$rs_listacmp->fields["tempdsp_id"]."')";
