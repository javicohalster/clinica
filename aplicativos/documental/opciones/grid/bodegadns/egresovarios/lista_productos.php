...
<table border="1" align="center" cellpadding="0" cellspacing="1" id="tabla" class="table-hover record_table" >
  ...
  <tr>
	  ...
	  EGRESOS NO PROCESADOS PORFAVOR VERIFICAR
	  <?php
	  
	  //busca no procesados
	  
	  $busca_nproc="select * from dns_temporaldespacho inner join dns_egresocentros on dns_temporaldespacho.egrec_id=dns_egresocentros.egrec_id where moviin_id='224' and egrec_anulado=0 and egrec_procesado=0"
