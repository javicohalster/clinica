...
$campos_paragrid="'moviin_id','nombre_med','tipom_nombre','tipomov_nombre ','moviin_nlote','moviin_fechadecaducidad','moviin_fecharegistro','moviin_totalenunidadconsumo','moviin_preciocompra','centrorecibe_observacion','moviin_verificado'";
$campo_id="moviin_id";
$sqltotal="";
		...
		"mRender": function (data,type,full)
				{
				 ...
				 if(full["moviin_verificado"]=='0')
				    {
					 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="desplegar_formulario('+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><center><img src="editarsv.png"  /></center></td></tr></table>';					
					}
					else
					{
				      return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="desplegar_formulario('+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><center><img src="editaral.png"  /></center></td></tr></table>';
				    }
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="borrar_registro_comp(\'<?php echo $tabla;  ?>\',\'<?php echo $campo_id; ?>\','+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><center><img src="../../../../../images/delete.png"  /></center></td></tr></table>';
				}
		 }
		 <?php
		 }
