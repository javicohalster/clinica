...
{
   $("#<?php echo $subindice_formulario; ?>").html("");  
...
function desplegar_grid_su()
{
   ...
   $("#div_grid").load("movimiento_compras/grid_movimiento.php",{
    ...
    insu_valorx:'<?php echo $_POST["pVar7"]; ?>',
	centro_id:'<?php echo $_POST["pVar6"]; ?>',
	compra_id:'<?php echo $compra_id; ?>'
...
function borrar_registro_comp(tabla,campo,valor)
{
...
{
?>
<center><b>ALERTA INGRESAR PRECIOS SIN IVA</b></center>
<?php
}
?>
