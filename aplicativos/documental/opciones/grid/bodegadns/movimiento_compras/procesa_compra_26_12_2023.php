...
if($rs_listax)
		{
			...
			if($rs_bup->fields["precio_id"]>0)
			{
			 ...
			 $act_data="update  dns_redppreciostiempo set  precio_compra='".$precio_c."',precio_pvp='".$pvp_valor."',precio_ispol='".$pvp_ispol."',precio_plasticos='".$pvp_plasticos."',precio_techo='".$precio_techo."' where precio_id='".$rs_bup->fields["precio_id"]."'";
			...
			echo $act_datai="insert into dns_redppreciostiempo (cuadrobm_id,precio_compra,precio_pvp,precio_ispol,precio_fechamodi,precio_plasticos,precio_techo) values ('".$cuadrobm_id."','".$precio_compra."','".$precio_pvp."','".$precio_ispol."','".$precio_fechamodi."','".$precio_plasticos."','".$precio_techo."');";			
