...
function genera_asientocrucedoc()
{
   ...
   {
   ?>
	   urlasiento='aplicativos/documental/asientos/cruzeventa/ejecuta_cruzedoc.php';		
	<?php
	}
	?>
   ...
   {
   ?>
	   urlasiento='aplicativos/documental/asientos/cruze/ejecuta_cruzedoc.php';		
	<?php
	}
	?>
