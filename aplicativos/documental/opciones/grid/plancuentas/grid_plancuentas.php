...
$array_data[0]["titulo"]="Cuenta contable";
$array_data[0]["col"]="3";
$array_data[0]["campo"]="planc_codigoc";
...
$array_data[1]["col"]="2";
$array_data[1]["campo"]="planc_nombre";
...
$funcion_buscar="desplegar_grid_plancuentas();";
$col_buscar="3";
...
echo '<button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" onclick="imprimir_plan();" style="cursor:pointer"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;IMPRIMIR PLAN DE CUENTAS</button>';

echo '&nbsp;&nbsp;&nbsp;<button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" onclick="imprimir_planexcel();" style="cursor:pointer"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;IMPRIMIR PLAN DE CUENTAS EXCEL</button>';
...
function imprimir_plan()
{
   ...
   myWindow3=window.open('aplicativos/documental/plandecuentas/plandecuaentas.php','ventana_pladecuentas','width=850,height=700,scrollbars=YES');

   myWindow3.focus();
     
}

function imprimir_planexcel()
{
 
   myWindow3=window.open('aplicativos/documental/plandecuentas/plandecuaentasexcel.php','ventana_pladecuentas','width=850,height=700,scrollbars=YES');
