...
$mensajege='<span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#006600;" >Registro guardado con exito...</span>';
		...
		$funcionextrag="actualiza_despuesg()";
  		$template_reemplazo='templateformsweb/maestro_standar_proveedor/';			  
...
{
        $("#lista_resultado").load("../proveedor_d/lista_proveedores.php",{
...
?></td>
<td valign="top"><table width="260" border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
