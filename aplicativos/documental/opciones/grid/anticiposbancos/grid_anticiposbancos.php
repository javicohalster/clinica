 ...
 $('#<?php echo $_POST["namemodulo"]; ?>').DataTable( {
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="borrar_registroanticipobanco(\'<?php echo $tabla;  ?>\',\'<?php echo $campo_id; ?>\','+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">scan_delete</span></td></tr></table>'; //<center><img src="images/delete.png"  /></center>
...
function borrar_registroanticipobanco(tabla,campo,valor)
{

	 if (confirm("Esta seguro que desea borrar este registro ?"))
	 { 

	 $("#grid_borrar_antb").load("aplicativos/documental/opciones/grid/grid_borrarmovanticipo.php",{
     ptabla:tabla,
	 pcampo:campo,
	 pvalor:valor
  },function(result){  

	 desplegar_grid_anticiposbancos()
	  $('#divBody_interno_anticiposbancos').html('');

  });  

  $("#grid_borrar_antb").html("Espere un momento");  
