...
$rs_datosmenu = $DB_gogess->executec($lista_datosmenu,array(145));
...
echo '<table id="datatable_extras" class="display responsive cell-border" cellspacing="0" width="100%">
<thead><tr>';
//echo '<th >Imprimir </th>';
echo '<th >Editar</th>';
if($boto_borrar)
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/opciones/grid/hextras/grid_hextras_nuevo.php\',\'Editar\',\'divBody_interno<?php echo $_POST["indice_grid"]; ?>\','+full["<?php echo $campo_id ?>"]+',\'<?php echo @$_POST["pVar2"]; ?>\',\'<?php echo '145'; ?>\',0,0,0,0)" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
				}
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="borrar_registrohextras(\'<?php echo $tabla;  ?>\',\'<?php echo $campo_id; ?>\','+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><center><img src="images/delete.png"  /></center></td></tr></table>';
...
function borrar_registrohextras(tabla,campo,valor)
{
...
$varable_enviafunc=base64_encode("desplegar_grid_hextras();");
