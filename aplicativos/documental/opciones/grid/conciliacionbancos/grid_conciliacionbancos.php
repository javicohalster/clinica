...
echo '<th class="text-uppercase text-secondary font-weight-bolder opacity-7 sorting">Estado</th>';
if($boto_borrar)
{
...
<!--
 ...
 $('#<?php echo $_POST["namemodulo"]; ?>').DataTable( {
		...
		"mRender": function (data,type,full)
				{
                 if(full["estcomp_id"]==1)
				 {
				   return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td class="align-middle text-center text-sm"><span class="badge fs-6 badge-sm bg-gradient-danger">PENDIENTE</span></td></tr></table>'; //style="color: rgb(255, 255, 255); background-color: rgb(153, 0, 0);" ><center>PENDIENTE</center>
				 }
				 else
				 {
				   return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td class="align-middle text-center text-sm"><span class="badge fs-6 badge-sm bg-gradient-success">CONCLUIDA</span></td></tr></table>'; //style="color: rgb(255, 255, 255); background-color: rgb(0, 153, 51);"><center>CONCLUIDA</center>
				 }
