		 ...
		 $sql_cp=" and dns_invegresosvarios.egrec_id in (".$busca_compras.") ";
				  ...
				  //echo $lista_campor;
                   ...
                   if($rs_listacmp)
				   {
						...
						$bdestino='';
						$bdestino=$objformulario->replace_cmb("dns_destinosvarios","destv_id,destv_nombre"," where destv_id=",$rs_listacmp->fields["destv_id"],$DB_gogess);
						...
						echo '<td onclick="'.$link_borrar.'" style="cursor:pointer" ></td>';
						}
