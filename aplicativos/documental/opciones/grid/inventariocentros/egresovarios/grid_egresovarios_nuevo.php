...
$lista_tabla="select * from gogess_sistable where tab_name='dns_invegresosvarios'";
$rs_tabla = $DB_gogess->executec($lista_tabla,array());
	...
	$variableb=0;
	 ...
	 if($csearch)
	 {
	   $busca_procesado="select * from dns_invegresosvarios where egrec_id='".$csearch."'";
   ...
   if($egrec_procesado==1)
	...
	else
	{
	   if($descargo_x==7)
	   {
	    ...
	    $campos_tipo=Array
		(	
			'tipomov_id'=> 'selectdescargo',
			'egrec_motivo'=> 'text',
			'egrec_otrosdestino'=>'hidden3',
			'tdes_id'=> 'hidden2',
			'centrod_id'=>'selectdestino1'
	   ...
	   $campos_tipo=Array
		(	
			'tipomov_id'=> 'selecteinvgre',
			'egrec_motivo'=> 'text',
			'egrec_otrosdestino'=>'hidden3',
			'tipomov_id'=> 'hidden2',
			'tdes_id'=> 'hidden2',
			'centrod_id'=>'selectdestino2'
...
$template_reemplazo='templateformsweb/maestro_standar_invegresovarios2/';			  
