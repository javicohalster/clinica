...
$leeplantilla=leer_contenido_completo("../../../../../../plantillas/invegresovarios_lista.php");	

$id_mob=base64_decode($_GET["aleat"]);
$lista_data="select * from  dns_invegresosvarios where egrec_id='".base64_decode($_GET["aleat"])."'";
...
$lista_mivdata="select categ_id from dns_invtemporaldespacho inner join dns_cuadrobasicomedicamentos on dns_invtemporaldespacho.cuadrobm_id=dns_cuadrobasicomedicamentos.cuadrobm_id inner join dns_movimientoinventario on dns_invtemporaldespacho.moviin_id=dns_movimientoinventario.moviin_id where dns_invtemporaldespacho.egrec_id='".$id_mob."'";
$rs_mivdata = $DB_gogess->executec($lista_mivdata,array());

$categ_id=0;
$categ_id=$rs_mivdata->fields["categ_id"];


$lista_pro='';
$lista_miv="select * from dns_invtemporaldespacho inner join dns_cuadrobasicomedicamentos on dns_invtemporaldespacho.cuadrobm_id=dns_cuadrobasicomedicamentos.cuadrobm_id inner join dns_movimientoinventario on dns_invtemporaldespacho.moviin_id=dns_movimientoinventario.moviin_id where dns_invtemporaldespacho.egrec_id='".$id_mob."'";
