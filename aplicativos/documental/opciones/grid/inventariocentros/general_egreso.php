...
?>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 panel-heading">
                            <h3 class="text-white text-capitalize ps-3 panel-title"><?php echo $ncentro; ?><br />
                                EGRESOS VARIOS</h3>
                        </div>
                    </div>
	  ...
	  if($centro_activoentrecentros==1)
	{
	  ?>
                                            <input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" type="button"
                                                name="Button" value="TRANSFERENCIAS ENTRE CENTROS"
                                                onclick="abrir_standar('egresovarios/grid_egresovarios_nuevo.php','Transferencias_Entre_Centros','divBody_producto','divDialog_producto',800,600,0,0,0,0,0,0,'<?php echo $_GET["insu"]; ?>')" />
                                            <?php
	  }
	  ?>
                                        </td>
	  ...
	  if($centro_activoentrecentros==1)
	{
	  ?>
                                            <input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" type="button"
                                                name="Button3" value="DESCARGOS VARIOS"
                                                onclick="abrir_standar('egresovarios/grid_egresovarios_nuevo.php','Descargos_Varios','divBody_producto','divDialog_producto',800,600,0,0,0,0,0,7,'<?php echo $_GET["insu"]; ?>')" />
                                            <?php
	  }
	  ?>
                                        </td>
        ...
        <div id="grid_borrarencentro"></div>
        <div id="listado_v"></div>
        <br />
        <?php
}
else
...
?>
        ...
        function compras_prkprod(egrec_id) {
            //alert(compra_id);
            abrir_standar('egresovarios/seleccionarp.php', 'DESPACHO', 'divBody<?php echo $subindice; ?>',
        ...
        function borrar_registro_bucentro(tabla, campo, valor) {

            if (confirm("Esta seguro que desea borrar este registro ?")) {

                $("#grid_borrarencentro").load(
                    "../../../../../aplicativos/documental/opciones/grid/grid_borrarencentro.php", {
                        ptabla: tabla,
                        pcampo: campo,
                        pvalor: valor
                    },
                ...
                $("#grid_borrarencentro").html("Espere un momento...");
        ...
        function borrar_registro_tempcent(tabla, campo, valor) {

            if (confirm("Esta seguro que desea borrar este registro ?")) {

                $("#grid_borrar").load("../../../../../aplicativos/documental/opciones/grid/grid_borrarcent.php", {
                    ptabla: tabla,
                    pcampo: campo,
                    pvalor: valor
                }, function(result) {
