...
$leeplantilla=leer_contenido_completo("../../../../../plantillas/egreso_cab.php");	

$id_mob=$_POST["pVar1"];
$lista_data="select * from  dns_egresocentros where egrec_id='".$id_mob."'";
...
{
  $("#proceso_ingval").load("aplicativos/documental/opciones/grid/inventariodns/procesar_recepcion.php",{
