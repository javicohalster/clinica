...
$tabla_vista="app_cliente";

$subindice="_cliente";

$campos_paragrid="'clie_id','emp_id','clie_nombre','clie_apellido','clie_registrado','clie_telefono','clie_email'";
     ...
     { 
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_cliente.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',0,0,0,0,0,0)" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
