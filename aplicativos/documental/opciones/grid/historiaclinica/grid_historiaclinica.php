...
$carpeta='historiaclinica';

$tabla="corpo_historiaclinica";

$tabla_vista="corpo_historiaclinica_vista";

$subindice="_historiaclinica";

$campos_paragrid="'hist_id','hist_motivoconsulta','hist_fecharegistro','nombres_medicos','nombres_clientes'";
 ...
 $('#datatable1').DataTable( {
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_historiaclinica.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',0,0,0,0,0,0)" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
