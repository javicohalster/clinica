...
$lista_cantidad="select count(*) as totalnum from ".$tabla_vista." where ".$sqltotal;
$rs_tablacantidad = $DB_gogess->executec($lista_cantidad,array());
//filtros
?>
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_substandarformpsicologia.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo @$_POST["pVar2"]; ?>\',\'<?php echo @$_POST["pVar3"]; ?>\',\'<?php echo @$_POST["pVar4"]; ?>\',0,0,0)" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
...
<?php
if($rs_tablacantidad->fields["totalnum"]>=1)
{
?>
function evitar_masprimera()
{
    $('#boton_msg').html("<b>Solo se permite un formulario de primera vez por patolog\u00eda....</b>");
