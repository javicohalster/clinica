...
<!--
 ...
 $('#<?php echo $_POST["namemodulo"]; ?>').DataTable( {
		...
		"mRender": function (data,type,full)
				{
                 if(full["estcompt_id"]==1)
				 {
				   return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td style="color: rgb(255, 255, 255); background-color: rgb(153, 0, 0);" ><center>PENDIENTE</center></td></tr></table>';
				 }
				 else
				 {
				   return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td style="color: rgb(255, 255, 255); background-color: rgb(0, 153, 51);" ><center>CONCLUIDA</center></td></tr></table>';
				 }
