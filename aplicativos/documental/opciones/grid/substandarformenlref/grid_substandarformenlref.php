...
//echo $_SESSION['datafrank1109_jobt_id'];
if($_SESSION['datafrank1109_jobt_id']==2)
{
$boto_borrar=1;
}
else
...
if(@$_SESSION['datafrank1109_sessid_emp_id'])
{

  $sql1=$rs_datosmenu->fields["mnupan_campoenlace"]." = ".@$_SESSION['datafrank1109_sessid_emp_id']." and ";
...
if($id_llega)
{
$sql4=" enlace_idexterno='".$id_llega."' and ";
}

if($tabla_llega)
{
$sql5=" enlace_tablaexterno='".$tabla_llega."' and ";
}
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantallapreconsulta(\'aplicativos/documental/datos_substandarformenlref.php\',\'Editar\',\'divBodyref_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo @$_POST["pVar2"]; ?>\',\'<?php echo @$_POST["pVar3"]; ?>\',\'<?php echo @$_POST["pVar4"]; ?>\',\'<?php echo @$id_llega; ?>\',\'<?php echo @$tabla_llega; ?>\',0,0,0,\'<?php echo @$proviene_de; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
