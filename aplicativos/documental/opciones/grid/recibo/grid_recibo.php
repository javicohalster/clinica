...
if($_SESSION['datadarwin2679_sessid_inicio'])
	{
       ...
       {
	    //  $sql4=" usua_id='".$_SESSION['datadarwin2679_sessid_inicio']."' and ";	
		}
	}
...
<!--
 ...
 $('#datatable1').DataTable( {
		...
		"mRender": function (data,type,full)
				{
                  if(full["doccab_anulado"]=='')
				 {
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_recibo.php\',\'Editar\',\'divBody_ext\',\''+full["<?php echo $campo_id ?>"]+'\',\'<?php echo $_POST["pVar2"]; ?>\',0,0,0,0,0)" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">edit_note</span></td></tr></table>'; //<center><img src="images/editar.png"  /></center>
				 }
				}
		 },
		 { 
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/datos_anularrecibo.php\',\'Anular\',\'divBody_anular\',\'divDialog_anular\',400,290,\''+full["<?php echo $campo_id ?>"]+'\',0,0,0,0,0,0)" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">block</span></td></tr></table>'; //<center><img src="images/anular.png"  /></center>
