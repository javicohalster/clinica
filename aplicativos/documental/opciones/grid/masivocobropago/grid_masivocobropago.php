...
<!--
 ...
 $('#datatable1').DataTable( {
		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_masivocobropago.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo $_POST["pVar2"]; ?>\',0,0,0,0,0)" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">edit_note</span></td></tr></table>'; //<center><img src="images/editar.png"  /></center>
		...
		"mRender": function (data,type,full)
				...
				if(full["crb_procesado"]==1)
				{
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td style=cursor:pointer ><center>PROCESADO</center></td></tr></table>';
				}
				else
				{
