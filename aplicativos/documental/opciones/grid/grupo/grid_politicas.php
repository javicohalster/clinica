...
echo '<th >Editar</th>';
echo '<th >Feriados y Vacaciones</th>';
echo '<th >Horas Entrada</th>';
if($boto_borrar)
 ...
 $('#datatable1').DataTable( {
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_politicas.php\',\'Editar\',\'divBody_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo $_POST["pVar2"]; ?>\',0,0,0,0,\'<?php echo $_POST["pVar7"]; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/opciones/panel/panel_standarvacaciones.php\',\'FyV\',\'divBody_ext\',\'divDialog_ext\',990,600,'+full["<?php echo $campo_id ?>"]+',56,0,0,0,0,\'<?php echo $_POST["pVar7"]; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="abrir_standar(\'aplicativos/documental/opciones/panel/panel_standarhorast.php\',\'Horas\',\'divBody_ext\',\'divDialog_ext\',990,600,'+full["<?php echo $campo_id ?>"]+',57,0,0,0,0,\'<?php echo $_POST["pVar7"]; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
