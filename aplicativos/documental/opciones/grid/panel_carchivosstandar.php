...
$comillasimple="'";
$subindice='_carchivosstandar';
$carpeta='carchivosstandar';
...

{
...

    {
        ...
        case 'jpg': case 'gif': case 'png': case 'jpeg': case 'pdf': case 'PDF': case 'XML': case 'xml': case 'docx': case 'xlsx':
...
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_carchivosstandar.php'.$comill_s.','.$comill_s.'TARIFARIO'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.',0,'.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	
...
echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-primary"  '.$link_asignar.'  style="background-color:#000066"  ><span class="glyphicon glyphicon-signal"></span>&nbsp;&nbsp;ASIGNAR RUBROS A TODOS</button>';
