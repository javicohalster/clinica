...
';	
		...
		@$funcionextrag=" desplegar_grid_informeevolucionparticular(); 
...

{
   ...
   ver_formularioenpantalla('aplicativos/documental/opciones/grid/atencion/grid_atencion_nuevo.php','ATENCION','divBody_interno_atencion',$('#atenc_id').val(),$('#clie_id').val(),'49',0,0,0,0);
