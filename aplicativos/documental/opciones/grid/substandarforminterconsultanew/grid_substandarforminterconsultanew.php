		...
		"mRender": function (data,type,full)
				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantallapreconsulta(\'aplicativos/documental/datos_substandarforminterconsultanew.php\',\'Editar\',\'divBodyref_ext\','+full["<?php echo $campo_id ?>"]+',\'<?php echo @$_POST["pVar2"]; ?>\',\'<?php echo @$_POST["pVar3"]; ?>\',\'<?php echo @$_POST["pVar4"]; ?>\',\'<?php echo @$id_llega; ?>\',\'<?php echo @$tabla_llega; ?>\',0,0,0,\'<?php echo @$proviene_de; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
