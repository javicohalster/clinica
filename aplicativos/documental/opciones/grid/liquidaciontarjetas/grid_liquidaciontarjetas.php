 ...
 $('#<?php echo $_POST["namemodulo"]; ?>').DataTable( {
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="borrar_registrotarjetas(\'<?php echo $tabla;  ?>\',\'<?php echo $campo_id; ?>\','+full["<?php echo $campo_id ?>"]+')" style=cursor:pointer ><span class="ms-2 fs-1 material-symbols-outlined">scan_delete</span></td></tr></table>'; //<center><img src="images/delete.png"  /></center>
...
function borrar_registrotarjetas(tabla,campo,valor)
{

	 if (confirm("Esta seguro que desea borrar este registro ?"))
	 { 

	 $("#grid_borrartarje").load("aplicativos/documental/opciones/grid/grid_borrartarjeta.php",{
     ptabla:tabla,
	 pcampo:campo,
	 pvalor:valor
  },function(result){  

     desplegar_grid_liquidaciontarjetas();
	 $('#divBody_interno_liquidaciontarjetas').html('');

  });  

  $("#grid_borrartarje").html("Espere un momento");  
