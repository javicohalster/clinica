...
$rs_datosmenu = $DB_gogess->executec($lista_datosmenu,array(56));
...
echo '<table id="datatable_ext" class="display responsive cell-border" cellspacing="0" width="100%">
...
if(@$_POST['pVar1'])
{
   ...
   $sql1=$rs_datosmenu->fields["mnupan_campoenlace"]." = ".@$_POST['pVar1']." and ";
 ...
 $('#datatable_ext').DataTable( {
		...
		"mRender": function (data,type,full)

				{
				 ...
				 return '<table border="0" cellspacing="0" cellpadding="0" ><tr><td onclick="ver_formularioenpantalla(\'aplicativos/documental/datos_vacaciones.php\',\'Editar\',\'divBody_extvaca\','+full["<?php echo $campo_id ?>"]+',56,0,0,0,0,\'<?php echo $_POST["pVar7"]; ?>\')" style=cursor:pointer ><center><img src="images/editar.png"  /></center></td></tr></table>';
