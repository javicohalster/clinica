...
function desplegar_grid() {
    $("#grid<?php echo $subindice; ?>").load(
        "aplicativos/documental/opciones/grid/<?php echo $carpeta; ?>/grid<?php echo $subindice; ?>.php", {
            ...
            rucci_valor: $('#rucci_valor').val(),
            ncomercial: $('#ncomercial').val(),
            nrepresentante: $('#nrepresentante').val(),
            tipoper_id: $('#tipoper_id').val()
...
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_persona.php'.$comill_s.','.$comill_s.'TARIFARIO'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.',0,'.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	
...
echo '&nbsp; &nbsp; &nbsp; &nbsp; <a href="aplicativos/reportes/personalizado/panel.php?ireport=57" target="_blank" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" style="background-color:#000066"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;REPORTE EN EXCEL PROVEEDORES</a> ';

echo '&nbsp; &nbsp; &nbsp; &nbsp; <a href="aplicativos/reportes/personalizado/panel.php?ireport=67" target="_blank" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" style="background-color:#000066"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;REPORTE EN EXCEL CLIENTES</a> ';

include("buscador_persona.php");
