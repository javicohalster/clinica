...
$comillasimple="'";
$subindice='_substandarginecologia';
$carpeta='substandarginecologia';
?>
...
$link_datos= 'ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_substandarformunico.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_unico'.$comill_s.','.$comill_s.$psic_id_valor.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.','.$comill_s.$eteneva_id.$comill_s.',0,'.$comill_s.$centro_id.$comill_s.')';	
