...
<?php
$nombre_medico="select * from app_usuario where usua_id=".$_GET["usua_idvaltx"];
...
//especialidad
$nombre_espscialidad="select * from dns_especialidad where especi_id=".$_GET["areag"];
...
<table width="520" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><B>SEMANA - <?php echo $_GET["semananumero"]; ?></B></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
...
<table width="990px" border="1" cellpadding="5" cellspacing="0" >
  <tr>
	...
	for($i=0;$i<count($lista_dias_valor);$i++)
	{
	    ...
	    echo   "<td nowrap='nowrap' style='padding-top:6px; padding-bottom:6px; padding-left:6px; padding-right:6px;font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px;font-weight:bold' ><b>".$dia_nombre."</b> (".$lista_dias_valor[$i].")</td>";
	}
  ...
  ?>
  <tr <?php echo $colorbg; ?>  >
     <td style='padding-top:5px; padding-bottom:5px; padding-left:5px; padding-right:5px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; font-weight:bold'   >
	       ...
	       <?php
			 ...
			 $lista_buscatc="select count(*) as total from  faesa_terapiasregistro inner join app_cliente on faesa_terapiasregistro.clie_id=app_cliente.clie_id where faesa_terapiasregistro.usua_id=".$_GET["usua_idvaltx"]." and terap_fecha='".$lista_dias_valor[$i]."' and terap_hora='".$rs_lhoras->fields["hora_tiempo"]."'";
			...
			if($rs_lbuscatc->fields["total"]>0)
			{
			 ...
			 echo "<td style='padding-top:5px; padding-bottom:5px; padding-left:5px; padding-right:5px;font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px;' ".$colorbgtd." >";
			 ...
			 else
			 {
				   ...
				   //TERAPIA
					 $lista_buscat="select * from  faesa_terapiasregistro inner join app_cliente on faesa_terapiasregistro.clie_id=app_cliente.clie_id where faesa_terapiasregistro.usua_id=".$_GET["usua_idvaltx"]." and terap_fecha='".$lista_dias_valor[$i]."' and terap_hora='".$rs_lhoras->fields["hora_tiempo"]."'";
				   ...
				   //eVALUACION INTEGRAL
				   $bandera=0;
				   $busca_citas="select tu.usua_id,integr_hora,faesa_asigahorario.clie_id,clie_nombre,clie_apellido,atenc_id from faesa_asigahorario inner join faesa_integragrupo tu on faesa_asigahorario.grup_id=tu.grup_id inner join app_cliente on faesa_asigahorario.clie_id=app_cliente.clie_id where tu.usua_id=".$_GET["usua_idvaltx"]." and asighor_fecha='".$lista_dias_valor[$i]."' and integr_hora='".$rs_lhoras->fields["hora_tiempo"]."'";	
