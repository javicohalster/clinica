...

                {
...

                    {
                        ...
                        $(".showImage" + ncampo).html("&nbsp;<a href='archivo/" + data +
                            "' target='_blank' class='thumbnail' ><img src='archivo/" + data +
                            "' alt='125x125' width='180px' ></a>");
                    ...
                    <div class="card-body px-0 pb-2">
                        <form id="form_<?php echo $rs_tabla->fields["tab_name"] ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="ms-3 pe-md-3 align-items-center col-xs-3">
                                    <?php

$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_recibo.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	
...
$comill_s="'";
$linkarchivo= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/genera_archivorecibos.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	

echo '<button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary"  '.$linkarchivo.'  style="background-color:#000066"  ><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;ARCHIVO Y REPORTES</button>';
...
?>
        ...
        function seguro_rp() {
            myWindow2 = window.open('https://coresalud.msp.gob.ec/coresalud/app.php/publico/rpis/afiliacion/consulta',
                'Red', 'width=750,height=500,scrollbars=YES');
