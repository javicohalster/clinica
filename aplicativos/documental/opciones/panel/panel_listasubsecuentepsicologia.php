...
$comillasimple="'";
$subindice='_subsecuentepsicologia';
$carpeta='subsecuentepsicologia';
...
$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_substandarformdoblesubpsicologia.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.',0,0,'.$comill_s.@$psicolo_id.$comill_s.')" style=cursor:pointer';	


//echo '<div align="center">';

$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/datos_substandarformpsicologia.php','Editar','divBody_ext','".@$psicolo_id."','".@$clie_id."',68,'".$atenc_id."',0,0,0);";
