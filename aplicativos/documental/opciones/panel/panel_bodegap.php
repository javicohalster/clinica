                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 panel-heading">
                                <h3 class="text-white text-capitalize ps-3 panel-title" style="color:#000033">BODEGA
                                    PRINCIPAL</h3>
                            </div>
                        </div>
...
?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="16%" style="cursor:pointer" onclick="tablas_celdas(1)">
                                            <div align="center"><span class="style1"><b>MEDICAMENTOS</b></span>
                                            </div>
                                        </td>
                                        <td width="27%">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td style="cursor:pointer" onclick="tablas_celdascompras(1)">
                                            <div align="center"><b>COMPRAS</b></div>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <div align="center"><b></b><b>EGRESO A SUB-BODEGAS</b></div>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td style="cursor:pointer" onclick="tablas_celdascompras(1)"><img
                                                src="images/compras.png" width="200" height="179" /></td>
                                        <td>&nbsp;</td>
                                        <td style="cursor:pointer" onclick="tablas_celdasdespacho(1)"><img
                                                src="images/despachomed.png" width="200" height="179" /></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                ...
                <div class="card mt-4">
                    <div class="card-header pb-0 p-3">
                        <div class="d-flex align-items-center">
                            <span class="fs-4">Secci&oacute;n se usa para movimientos varios
                                como paso a bodega cuarentena, donaciones a otras intituciones etc.
                            </span>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td width="19%">&nbsp;</td>
                                    <td width="16%" style="cursor:pointer">&nbsp;</td>
                                    <td width="27%">&nbsp;</td>
                                    <td width="19%" style="cursor:pointer"></td>
                                    <td width="19%">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td style="cursor:pointer">
                                        <div align="center"><b>INGRESOS VARIOS</b></div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td style="cursor:pointer">
                                        <div align="center"><b>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td style="cursor:pointer" onclick="tablas_celdasingresos(1)"><img
                                            src="images/compras.png" width="200" height="179" /></td>
                                    <td>&nbsp;</td>
                                    <!-- <td style="cursor:pointer" onclick="tablas_celdasegresos(1)"  >
                                        <img src="images/despachomed.png" width="200" height="179" /></td>
                                        <td>&nbsp;</td> -->
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>
                                        <div align="center"><b>RECEPCION DE SUB-BODEGAS A BODEGA PRINCIPAL</b></div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td style="cursor:pointer"></td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td style="cursor:pointer" onclick="listar_ingresos()"><img
                                            src="images/ingredecentros.png" width="200" height="179" /></td>
                                    <td>&nbsp;</td>
                                    <td style="cursor:pointer"></td>
                                    <td>&nbsp;</td>
                                </tr>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card my-4" id="lista_pendientes"></div>
            </div>
        </div>
...
function tablas_celdas(id) {
    ...
    myWindow4 = window.open('aplicativos/documental/opciones/grid/bodegadns/general_total.php?insu=' + id,
...
function tablas_celdasingresos(id) {
    myWindow4 = window.open('aplicativos/documental/opciones/grid/bodegadns/general_ingresos.php?insu=' + id,
        'ventana_ingresos', 'width=' + screen.width + ',height=' + screen.height +
        ',top=0, left=0,scrollbars=YES,fullscreen=yes');
    myWindow4.focus();
...
function listar_ingresos() {
    ...
    $("#lista_pendientes").load("aplicativos/documental/opciones/grid/bodegadns/listar_ingresosbp.php", {
