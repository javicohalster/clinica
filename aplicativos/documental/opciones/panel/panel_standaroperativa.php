...
<div class="alert alert-success" role="alert">
  <b>Aviso Importante!!! En la lista solo se desplegar&aacute; sus datos registrados</b>.
</div>
...
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_operativa.php'.$comill_s.','.$comill_s.'TARIFARIO'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.',0,'.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	
