...
<table width="550" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="8" bgcolor="#A0CBD8"><div align="left"><strong>MEDICAMENTO PRIMERA VEZ</strong></div></td>
  </tr>
  <tr>
    <td width="94" bgcolor="#E2EFF3"><span class="style1">Permitir Descarga</span></td>
  ...
  if($rs_medi1)
 {
  ...
  <tr>
	...
	<?php
	$listaid='';
	$listaid=$tablareceta.$rs_medi1->fields["plantra_id"];
	...
	{
	?>
	 <textarea name="<?php echo $listaid; ?>txt_motivo" cols="15" id="<?php echo $listaid; ?>txt_motivo"></textarea>
      <input name="Guardar" type="button" id="Guardar" value="Permitir Descarga" onclick="solicita_permisodespacho('<?php echo $rs_medi1->fields["plantra_id"]; ?>','<?php echo $tablareceta; ?>')" />
	<?php
	}
	else
	{
	   echo '<center><b>Permiso Vigente</b></center>';
	}
...
$rs_medi1 = $DB_gogess->executec($lista_medicametos,array());
  ...
  if($rs_medi1)
 {
  ...
  <tr>
	...
	<?php
	$listaid='';
	$listaid=$tablareceta.$rs_medi1->fields["plantrai_id"];
	...
	?>
	 <textarea name="<?php echo $listaid; ?>txt_motivo" cols="15" id="<?php echo $listaid; ?>txt_motivo"></textarea>
      <input name="Guardar" type="button" id="Guardar" value="Permitir Descarga" onclick="solicita_permisodespacho('<?php echo $rs_medi1->fields["plantrai_id"]; ?>','<?php echo $tablareceta; ?>')" />
	<?php
	}
	else
	{
...
<table width="550" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="8" bgcolor="#A0CBD8"><div align="left"><strong>MEDICAMENTO SUBSECUENTE</strong></div></td>
  </tr>
  <tr>
    <td width="94" bgcolor="#E2EFF3"><span class="style1">Permitir Descarga</span></td>
    <td width="94" bgcolor="#E2EFF3"><span class="style2"><strong>C&oacute;digo</strong></span></td>
...
$lista_medicametos="select * from dns_atencion inner join ".$tablaprincipa." on dns_atencion.atenc_id=".$tablaprincipa.".atenc_id inner join  ".$tablareceta." on  ".$tablaprincipa.".".$enlace."=".$tablareceta.".".$enlace." where dns_atencion.atenc_hc='".$_POST["nhc"]."' and plantrai_despachado=''";
...
<table width="550" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="8" bgcolor="#A0CBD8"><div align="left"><strong>MEDICAMENTO ODONTOLOGIA</strong></div></td>
  </tr>
  <tr>
    <td width="94" bgcolor="#E2EFF3"><span class="style1">Permitir Descarga</span></td>
    <td width="94" bgcolor="#E2EFF3"><span class="style2"><strong>C&oacute;digo</strong></span></td>
...
<table width="550" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="8" bgcolor="#A0CBD8"><div align="left"><strong>MEDICAMENTO SUBSECUENTE ODONTOLOGIA</strong></div></td>
  </tr>
  <tr>
    <td width="94" bgcolor="#E2EFF3"><span class="style1">Permitir Descarga</span></td>
    <td width="94" bgcolor="#E2EFF3"><span class="style2"><strong>C&oacute;digo</strong></span></td>
...
$lista_medicametos="select * from dns_atencion inner join ".$tablaprincipa." on dns_atencion.atenc_id=".$tablaprincipa.".atenc_id inner join  ".$tablareceta." on  ".$tablaprincipa.".".$enlace."=".$tablareceta.".".$enlace." where dns_atencion.atenc_hc='".$_POST["nhc"]."' and plantra_despachado='' ";
...
<table width="550" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="8" bgcolor="#A0CBD8"><div align="left"><strong>MEDICAMENTO PRE HOSPITALARIO</strong></div></td>
  </tr>
  <tr>
    <td width="94" bgcolor="#E2EFF3"><span class="style1">Permitir Descarga</span></td>
    <td width="94" bgcolor="#E2EFF3"><span class="style2"><strong>C&oacute;digo</strong></span></td>
...
//solicita permiso
function solicita_permisodespacho(id,tabla)
{
  if($('#'+tabla+id+'txt_motivo').val()=='')
  {
    alert("Por favor llene el motivo");
    return false;
  }
  
  
  $("#grid_ejecuta_despachar").load("aplicativos/documental/opciones/panel/farmacia/permiso.php",{

  plantra_id:id,
  tabla:tabla,
  centro_id:'<?php echo $_SESSION['datadarwin2679_centro_id'];  ?>',
  usua_id:'<?php echo $_SESSION['datadarwin2679_sessid_inicio']; ?>',
  txt_motivo:$('#'+tabla+id+'txt_motivo').val()
