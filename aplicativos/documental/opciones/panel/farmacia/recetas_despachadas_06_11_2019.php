...
$lista_medicametos="select * from dns_atencion inner join ".$tablaprincipa." on dns_atencion.atenc_id=".$tablaprincipa.".atenc_id inner join  ".$tablareceta." on  ".$tablaprincipa.".".$enlace."=".$tablareceta.".".$enlace." where dns_atencion.atenc_hc='".$_POST["nhc"]."' and plantra_despachado='SI' and DATE_ADD(plantra_fecharegistro,INTERVAL 5 DAY)>=NOW()";  
...
$lista_medicametos="select * from dns_atencion inner join ".$tablaprincipa." on dns_atencion.atenc_id=".$tablaprincipa.".atenc_id inner join  ".$tablareceta." on  ".$tablaprincipa.".".$enlace."=".$tablareceta.".".$enlace." where dns_atencion.atenc_hc='".$_POST["nhc"]."' and plantrai_despachado='SI' and DATE_ADD(plantrai_fecharegistro,INTERVAL 5 DAY)>=NOW()";  
