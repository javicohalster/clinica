...
$linkeditar= 'onClick="abrir_standar('.$comill_s.'aplicativos/documental/datos_standarmovimiento.php'.$comill_s.','.$comill_s.'Movimiento_Inventario'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.'divDialog_ext'.$comill_s.',990,600,0,'.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,'.$comill_s.$_POST["pVar7"].$comill_s.')" style=cursor:pointer';	
