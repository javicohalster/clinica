...
$lista_productosx="select * from dns_precuenta inner join dns_detalleprecuenta on dns_precuenta.precu_id=dns_detalleprecuenta.precu_id inner join dns_cuadrobasicomedicamentos on dns_detalleprecuenta.detapre_codigop=dns_cuadrobasicomedicamentos.cuadrobm_codigoatc where dns_precuenta.precu_id='".$valor_id."' and detapre_id='".$detapre_id."'  and dns_detalleprecuenta.centrob_id not in (9999,8888) ";
