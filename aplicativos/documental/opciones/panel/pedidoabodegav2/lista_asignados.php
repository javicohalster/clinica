...
?>
  <table width="100%" border="1" cellpadding="0" cellspacing="0">
	...
	<?php
	$valor_total=0;
 $lista_precuentas="select *,dns_preddetalleparteoperatorio.usua_id as usario_enf from dns_preddetalleparteoperatorio left join dns_centrosalud_ext on dns_preddetalleparteoperatorio.centrob_id=dns_centrosalud_ext.centro_id  where partop_id='".$partop_id."' and detapre_tipo in (1,2) order by detapre_id asc";
...
$("#campo_valorxx").load("aplicativos/documental/opciones/panel/pedidoabodegav2/guarda_campop.php",{
...
function ver_asientoc(partop_id,detapre_id)
{
   //if($('#doccab_ndocumento').val()!='-documento-')
	 //{
      myWindow3=window.open('pdfasientos/pdfasientoprecuenta_i.php?xml=' + partop_id+'&detapre_id='+detapre_id,'ventana_asientocontable','width=850,height=700,scrollbars=YES');
      myWindow3.focus();
    // }
  // else
   //{
