...
$busca_pedido="select * from ".$_POST["tabla"]." where partop_id='".$partop_id."'";
...
$inserta_datadis="INSERT INTO dns_preddetalleparteoperatorio (partop_id, clie_id, mnupan_id, detapre_tipo, detapre_codigop, detapre_detalle, detapre_cantidad, detapre_precio, detapre_fecharegistro, usua_id, centro_id, atenc_id, detapre_codigoform,detapre_idgrid,detapre_table,centrob_id,detapre_origen,moviin_id,cuadrobm_id,conve_id,detapre_precioventa,perioc_id,detapre_tipofarmacia) VALUES ('".$partop_id."','".$clie_id."','".$mnupan_id."','".$detapre_tipo."','".$detapre_codigop."','".$detapre_detalle."','".$detapre_cantidad."','".$detapre_precio."','".$detapre_fecharegistro."','".$usua_id."','".$centro_id."','".$atenc_id."','".$detapre_codigoform."','".$detapre_idgrid."','".$table."','".$centrob_id."','".$detapre_origen."','".$moviin_iddes."','".$cuadrobm_id."','".$conve_id."','".$detapre_precioventa."','".$perioc_id."','".$detapre_tipofarmacia."');";
