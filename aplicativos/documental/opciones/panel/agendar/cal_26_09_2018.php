				...
				if($rs_terapia)
                   {
	                  ...
	                  while (!$rs_terapia->EOF) {	
						     ...
						     <td style="color:#3169D2" '.$color.' ><b> T-'.$rs_area->fields["especi_iniciales"].' '.$rs_terapia->fields["terap_hora"].'<br>'.$rs_nmedico->fields["usua_codigoiniciales"].'</b></td>
							 <td '.$color.' >'.ucwords(strtolower(utf8_encode($rs_terapia->fields["clie_nombre"]))).'</td>
					        </tr>';
