...
<div class="panel panel-default">
 <div class="panel-heading">
    ...
    <h3 class="panel-title" style="color:#000033" >Inventario Inicial Sub-Bodegas</h3>
...
myWindow4=window.open('aplicativos/documental/opciones/grid/inventariodns/general_totalini.php?insu='+id,'ventana_celda','width='+screen.width+',height='+screen.height+',top=0, left=0,scrollbars=YES,fullscreen=yes');
myWindow4.focus();
