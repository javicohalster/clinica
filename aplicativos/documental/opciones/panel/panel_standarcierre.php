...
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_standarcierre.php'.$comill_s.','.$comill_s.'TARIFARIO'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.',0,'.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	
...
?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card my-4" id=grid<?php echo $subindice; ?>></div><br><br>
                </div>
            </div>
            <script type="text/javascript">
            <!--
