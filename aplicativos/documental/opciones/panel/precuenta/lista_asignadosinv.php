...
<?php
 $lista_precuentaslbdega="select distinct centrob_id from dns_detalleprecuenta left join dns_centrosalud_origen on dns_detalleprecuenta.centrob_id=dns_centrosalud_origen.centro_id  where precu_id='".$precu_id."' and detapre_tipo in (1,2) ";
...
?>
 ...
 $lista_precuentas="select * from dns_detalleprecuenta left join dns_centrosalud_origen on dns_detalleprecuenta.centrob_id=dns_centrosalud_origen.centro_id  where precu_id='".$precu_id."' and detapre_tipo in (1,2) and centrob_id='".$rs_lprecuentasbdega->fields["centrob_id"]."'";
...
function procesa_data_pboega(bodega,precu_id)
{

$("#area_data_"+bodega).load("procesa_dataenvio.php",{
   centrob_id:bodega,
   precu_id:precu_id
