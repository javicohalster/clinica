...
?>  
 <input type="button" name="Submit2" value="Imprimir N" onclick="imprimir_docn()" />
...
function imprimir_docn() {
window.open('aplicativos/documental/opciones/panel/precuenta/lista_asignadosimpn.php?precu_id=<?php echo $precu_id; ?>&centro_id='+$('#centro_id').val(),'ventana1','width=750,height=500,scrollbars=YES');
