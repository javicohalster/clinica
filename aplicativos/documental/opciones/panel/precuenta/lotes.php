...
?>
		...
		<table width="200" border="1" align="center" cellpadding="4" cellspacing="0">
			<tr>
				<td bgcolor="#DBEAEE">
					<div align="center"><strong>Seleccionar</strong></div>
				</td>
				<td bgcolor="#DBEAEE">
					<div align="center"><strong>Codigo</strong></div>
				</td>
				<td bgcolor="#DBEAEE">
					<div align="center"><strong>Cantidad Disponible</strong></div>
				</td>
				<td bgcolor="#DBEAEE">
					<div align="center"><strong>Lote</strong></div>
				</td>
				<td bgcolor="#DBEAEE">
					<div align="center"><strong>Caducidad</strong></div>
				</td>

				<td nowrap bgcolor="#DBEAEE">
					<div align="center"><strong>Cantidad a entregar </strong></div>
				</td>
			</tr>
			<?php
			...
			?>
						<tr>
							...
							<td nowrap bgcolor="#F0FBFF">
								<div align="center">&nbsp;<?php echo $rs_bupedido->fields["precu_id"]; ?>&nbsp;</div>
							</td>
							<td bgcolor="#F0FBFF">
								<div align="center">&nbsp;<?php echo $actual_porlote; ?>&nbsp;
							...
							<td nowrap bgcolor="#F0FBFF">
								<div align="center">&nbsp;<?php echo $rs_paraentrega->fields["moviin_nlote"]; ?>&nbsp;</div>
							</td>
							<!-- <td nowrap bgcolor="#F0FBFF"><div align="center">&nbsp;<?php echo $rs_paraentrega->fields["moviin_preciocompra"]; ?>&nbsp;</div></td> -->
							<td nowrap bgcolor="#F0FBFF">
								<div align="center">&nbsp;<?php echo $rs_paraentrega->fields["moviin_fechadecaducidad"]; ?>&nbsp;</div>
							</td>

							<td bgcolor="#F0FBFF">
								<div align="center"><input name="cantidad_valor_<?php echo $rs_paraentrega->fields["moviin_id"]; ?>" type="number" id="cantidad_valor_<?php echo $rs_paraentrega->fields["moviin_id"]; ?>" value="0" size="10" onChange="suma_valores()">
								</div>
							</td>
						</tr>
			<?php
		...
		<br>
		<center>
			<div id="id_inactivad"><input type="button" name="Submit" value="Entregar" onClick="seleccionado_valores()"></div>
		</center>
		...
		<script type="text/javascript">
			...
			function entregar_datos(datos_data) {
				...
				$("#div_procesaentrega").load("aplicativos/documental/opciones/panel/precuenta/entregando_medicamentos.php", {
