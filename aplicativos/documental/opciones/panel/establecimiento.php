...
function genera_establecimiento()
{
   $("#div_establ").load("aplicativos/documental/opciones/extras/genera_establecimiento.php",{
	...
	pemision_id:$('#pemision_id').val()
	  ...
	  ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_facturas.php','Perfil','divBody_ext','<?php echo $_POST["pVar1"] ?>','<?php echo $_POST["pVar2"] ?>',0,0,0,0,0);
