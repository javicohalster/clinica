...
$ci_paciente=$_POST["ci_pacientepr"];
$clie_id=0;
...
$usua_permitirreposicion=0;
$usua_permitirotrbredp=0;
$usua_permitirab=0;
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
   ...
   <tr>
    <td colspan="2">
      Area:
	   <select name="area_id " id="area_id"  class="form-control" onchange="desplegar_listainventario()">
        <?php
	         echo '<option value="">---Seleccionar--</option>';
			
			   $objformulario->fill_cmb("lpin_area","area_id,area_nombre",$area_id," order by area_nombre asc ",$DB_gogess);	
  ...
  <tr>
    ...
    <td valign="bottom"><input type="button" name="Submit" value="DESPLEGAR" onclick="desplegar_listainventario()" /></td>
  </tr>
  <tr>
...
window.open('aplicativos/documental/opciones/panel/pedidoabodegav3/lista_asignadosinv.php?precu_id=<?php echo $precu_id; ?>&centro_id='+$('#centro_id').val(),'ventana1','width=750,height=500,scrollbars=YES');

}

function imprimir_doc() {
window.open('aplicativos/documental/opciones/panel/pedidoabodegav3/lista_asignadosimp.php?precu_id=<?php echo $precu_id; ?>&centro_id='+$('#centro_id').val(),'ventana1','width=750,height=500,scrollbars=YES');

}

function imprimir_docexcel() {
window.open('aplicativos/documental/opciones/panel/pedidoabodegav3/lista_asignadosimp.php?excel=1&precu_id=<?php echo $precu_id; ?>&centro_id='+$('#centro_id').val(),'ventana1','width=750,height=500,scrollbars=YES');
...
function lista_cmb()
{
   ...
   $("#lista_mediext").load("aplicativos/documental/opciones/panel/pedidoabodegav3/cmb_listamed.php",{
...
function ejecuta_despachar(cuadrobm_id,centro_id,maximop,clie_id)
{
  ...
  abrir_standar("aplicativos/documental/opciones/panel/pedidoabodegav3/lotes.php","Despacho","divBody_pdespacho","divDialog_pdespacho",580,500,'<?php echo $precu_id; ?>','dns_precuenta',centro_id,'<?php echo $_SESSION['datadarwin2679_sessid_inicio']; ?>','<?php echo $clie_id; ?>',maximop,cuadrobm_id);
...
function desplegar_listainventario()
{
  ...
  if($('#centro_id').val()=='')
  {
   ...
   $("#lista_bodega").load("aplicativos/documental/opciones/panel/pedidoabodegav3/lista_medinsu.php",{
...
function desplegar_listatarifario()
{
   ...
   $("#lista_tarfario").load("aplicativos/documental/opciones/panel/pedidoabodegav3/lista_tarifario.php",{
...
function desplegar_asignados()
{
   ...
   $("#lista_asignado").load("aplicativos/documental/opciones/panel/pedidoabodegav3/lista_asignados.php",{
...
function desplegar_asignadostarifatio()
{
   ...
   $("#lista_tarasignado").load("aplicativos/documental/opciones/panel/pedidoabodegav3/lista_asignadostar.php",{
...
if($('#cantidp_'+prod_id).val()=='')
 ...
 $("#lista_tarasignado").load("aplicativos/documental/opciones/panel/pedidoabodegav3/asignar_gtar.php",{
...
function asgnar_detalle(cuadrobm_id,centro_id,maximop,clie_id)
{
 ...
 $("#lista_asignado").load("aplicativos/documental/opciones/panel/pedidoabodegav3/asignar_g.php",{
...
if (confirm("Esata seguro en borrar") == true) {
 ...
 $("#p_borrar").load("aplicativos/documental/opciones/panel/pedidoabodegav3/borrar_g.php",{
