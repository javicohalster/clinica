...
$busca_precuenta="select * from dns_preddetalleprecuentav where detapre_id='".$detapre_id."'";
...
$busca_medi="delete from dns_preddetalleprecuentav where detapre_id='".$detapre_id."'";
