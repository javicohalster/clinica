...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#E9F1F5"><div align="center">CODIGO</div></td>
...
{
?>
<input type="button" name="Submit" value="PROCESAR DASCARGO" onclick="procesa_data_pboega('<?php echo $centro_id; ?>','<?php echo $precu_id; ?>','<?php echo $clie_id; ?>')" />
<?php
}
else
{
...
<input type="button" name="Submit" value="PROCESAR DASCARGO RED PUBLICA" onclick="procesa_data_redpu('<?php echo $centro_id; ?>','<?php echo $precu_id; ?>','<?php echo $clie_id; ?>')" />
