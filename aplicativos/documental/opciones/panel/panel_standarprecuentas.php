                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="ms-3 pe-md-3 align-items-center">
                            <a href="aplicativos/reportes/personalizado/panel.php?ireport=56" target="_blank"
                                ...
                                <span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;REPORTE PRECUENTAS</a>
                        </div>
...
function desplegar_precuenta() {
    ...
    $("#lsta_precuenta").load("aplicativos/documental/opciones/panel/precuentagenerada/precuenta.php", {
