...
<center>
<input name="busca_paciente" type="hidden" id="busca_paciente" value="" />
...
<table width="700" border="1" align="center">
  <tr>
    <td colspan="2" bgcolor="#D7E6F4" class="css_txt5"><div align="center">No. Uso </div></td>
  </tr>
  <tr>
    <td colspan="2" class="css_txt5"><div align="center">
      ...
      <input name="n_terapiasval" type="text" id="n_terapiasval" size="5" value="1" />
    </div>
        <div id="lista_user"> </div></td>
  </tr>
  <tr>
    <td bgcolor="#D7E6F4" class="css_txt5"><div align="center">Responsable</div></td>
...
?>
  ...
  <tr>
    <td colspan="2">
	<div align="center"><br />
	  <select class="form-control" name="quiro_idval" id="quiro_idval" style="width:200px">
...
?>
	...
	<div align="center"><br />
      <b>Motivo:</b>
      <input name="terap_motivoval" type="text" id="terap_motivoval" size="50" value="USO QUIROFANO" /><br><br>
    </div>
...
function generar_registros()
{
  ...
  {
    alert("Ingrese la la cantidad de reuniones...");
    return false;
  }
  
  if($('#terap_motivoval').val()=='')
  {
  ...
  $("#genera_registros").load("genera_registroquirofano.php",{
