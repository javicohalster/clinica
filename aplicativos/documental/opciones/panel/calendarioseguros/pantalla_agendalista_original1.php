...
<table width="700" border="1" align="center">
  ...
  <tr>
	...
	<td bgcolor="#D7E6F4" class="css_txt5"><div align="center">OBS</div></td>
    <td bgcolor="#D7E6F4" class="css_txt5">&nbsp;</td>
  </tr>

  <tr>
     <td><div align="center">
      <select class="form-control" name="prof_idvalx1" id="prof_idvalx1" style="width:110px" onchange="">
        <option value="">--Especialidad--</option>
        <?php
         $objformulario->fill_cmb('pichinchahumana_extension.dns_profesion','prof_id,prof_nombre','',' where prof_id=35 order by prof_nombre asc',$DB_gogess);
        ?>
      </select>
    </div></td>

    <td><div align="center">
      <select class="form-control" name="usua_idvalx1" id="usua_idvalx1" style="width:100px" onchange="valida_dataagenda('1')">
...
?>
  ...
  <tr>
    <td><div align="center">
      <select class="form-control" name="prof_idvalx2" id="prof_idvalx2" style="width:110px" onchange="">
        <option value="">--Especialidad--</option>
        <?php
         $objformulario->fill_cmb('pichinchahumana_extension.dns_profesion','prof_id,prof_nombre','',' where prof_id=35  order by prof_nombre asc',$DB_gogess);
        ?>
    ...
    <td><div align="center">
      <select class="form-control" name="usua_idvalx2" id="usua_idvalx2" style="width:100px" onchange="valida_dataagenda('2')" >
        <option value="">--Profesional--</option>
        <?php
$objformulario->fill_cmb('app_usuario','usua_id,usua_nombre,usua_apellido','',' where usua_agenda=1  order by usua_nombre asc',$DB_gogess);
?>
...
?>
  ...
  <tr>
    <td><div align="center">
      <select class="form-control" name="prof_idvalx3" id="prof_idvalx3" style="width:110px" onchange="">
        <option value="">--Especialidad--</option>
        <?php
         $objformulario->fill_cmb('pichinchahumana_extension.dns_profesion','prof_id,prof_nombre','',' where prof_id=35  order by prof_nombre asc',$DB_gogess);
        ?>
    ...
    <td><div align="center">
      <select class="form-control" name="usua_idvalx3" id="usua_idvalx3" style="width:100px" onchange="valida_dataagenda('3')" >
        <option value="">--Profesional--</option>
        <?php
...
?>
  ...
  <tr>
    <td><div align="center">
      <select class="form-control" name="prof_idvalx4" id="prof_idvalx4" style="width:110px" onchange="">
        <option value="">--Especialidad--</option>
        <?php
         $objformulario->fill_cmb('pichinchahumana_extension.dns_profesion','prof_id,prof_nombre','',' where prof_id=35  order by prof_nombre asc',$DB_gogess);
        ?>
    ...
    <td><div align="center">
      <select class="form-control" name="usua_idvalx4" id="usua_idvalx4" style="width:100px" onchange="valida_dataagenda('4')" >
        <option value="">--Profesional--</option>
        <?php
...
?>
  ...
  <tr>
    <td><div align="center">
      <select class="form-control" name="prof_idvalx5" id="prof_idvalx5" style="width:110px" onchange="">
        <option value="">--Especialidad--</option>
        <?php
         $objformulario->fill_cmb('pichinchahumana_extension.dns_profesion','prof_id,prof_nombre','',' where prof_id=35  order by prof_nombre asc',$DB_gogess);
        ?>
    ...
    <td><div align="center">
      <select class="form-control" name="usua_idvalx5" id="usua_idvalx5" style="width:100px" onchange="valida_dataagenda('5')" >
        <option value="">--Profesional--</option>
        <?php
...
?>
  ...
  <tr>
    <td><div align="center">
      <select class="form-control" name="prof_idvalx6" id="prof_idvalx6" style="width:110px" onchange="">
        <option value="">--Especialidad--</option>
        <?php
         $objformulario->fill_cmb('pichinchahumana_extension.dns_profesion','prof_id,prof_nombre','',' where prof_id=35  order by prof_nombre asc',$DB_gogess);
        ?>
    ...
    <td><div align="center">
      <select class="form-control" name="usua_idvalx6" id="usua_idvalx6" style="width:100px" onchange="valida_dataagenda('6')" >
        <option value="">--Profesional--</option>
        <?php
...
?>
  ...
  <tr>
    <td><div align="center">
      <select class="form-control" name="prof_idvalx7" id="prof_idvalx7" style="width:110px" onchange="">
        <option value="">--Especialidad--</option>
        <?php
         $objformulario->fill_cmb('pichinchahumana_extension.dns_profesion','prof_id,prof_nombre','',' where prof_id=35  order by prof_nombre asc',$DB_gogess);
        ?>
    ...
    <td><div align="center">
      <select class="form-control" name="usua_idvalx7" id="usua_idvalx7" style="width:100px" onchange="valida_dataagenda('7')" >
        <option value="">--Profesional--</option>
        <?php
