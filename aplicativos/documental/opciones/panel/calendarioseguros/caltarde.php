	...
	if($rs_personal)
    {
	   ...
	   $rs_lbuscat = $DB_gogess->executec($lista_buscat,array());
					 if($rs_lbuscat)
					 {
						...
						$link_alerta='onclick=abrir_standar(\'aplicativos/documental/opciones/panel/calendarioseguros/obs.php\',\'OBSERVACION\',\'divBody_obs\',\'divDialog_obs\',400,250,\''.$rs_lbuscat->fields["terap_id"].'\',0,0,0,0,0,0);';						 
