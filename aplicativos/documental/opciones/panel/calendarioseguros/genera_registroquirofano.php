...
if(@$_POST["quiro_idval"])
{
$quiro_id=$_POST["quiro_idval"];
}
else
{
$quiro_id=0;
...
for($z=0;$z<count($array_diasfecha);$z++)
{
 ...
 $inserta_datos="insert into faesa_terapiasregistro (atenc_hc,clie_id,terap_fecha,terap_hora,terap_autorizacion,especi_id,usua_id,centro_id,usuar_id,terap_fecharegistro,terap_motivo,quiro_id) values ('','0','".$array_diasfecha[$z]."','".$array_horasfecha[$z]."','".$_POST["n_autorizacionval"]."','".$especi_id."','".$_POST["usua_idvalx"]."','".$_POST["centro_id"]."','".$_POST["usuar_id"]."','".date("Y-m-d")."','".$terap_motivoval."','".$quiro_id."')";
