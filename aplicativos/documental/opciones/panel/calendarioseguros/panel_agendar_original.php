...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <!-- <td>&nbsp;</td>	
    ...
    {
	?>
	<td><input type="button" name="Submit" value="Imprimir Horario Tarde" onClick="ver_calendario_generalimptarde()" class="form-control"  ></td>
	<?php
	}
	else
	{
...
{
abrir_standar('pantalla_agendalista.php','AGENDAMIENTO','divBody_agenda','divDialog_agenda',900,600,0,0,0,0,0,0,0);
}
