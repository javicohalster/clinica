...
<div class="panel panel-default">
 <div class="panel-heading">
    ...
    <h3 class="panel-title" style="color:#000033" >LISTA MEDICAMENTOS/DISPOSITIVOS NO PLANILLABLES</h3>
...
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_controlconsumo.php'.$comill_s.','.$comill_s.'TARIFARIO'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.',0,'.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	
