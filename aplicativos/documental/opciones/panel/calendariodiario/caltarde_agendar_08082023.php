					 ...
					 if($rs_lbuscat)
					 {
						  while (!$rs_lbuscat->EOF) {
							...
							$apellido_dato=explode(" ",$rs_lbuscat->fields["clie_apellido"]);
							 ...
							 /////////////// dr
							 $n_seguro='';
							 if($rs_lbuscat->fields["conve_id"])
							 {
							 $busca_seguro="select * from pichinchahumana_extension.dns_convenios where conve_id='".$rs_lbuscat->fields["conve_id"]."'";
							 ...
							 ////////////////// dr
							  ...
							  echo '<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
									  <tr>
										...
										<td ><center><span style="color:#000000" ><b>'.$name_seg."<BR>".$paciente_data.$terap_motivo.$n_quirofano.$terap_medicompanies.$terap_copago.'/</b></span></center></td>
										<td ></td>
									  </tr>
								 </table>';
