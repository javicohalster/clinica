...
<table border="1" cellpadding="5" cellspacing="0" >
  <tr>
	...
	if($rs_personal)
    {
	  ...
	  // {
	 echo '<td style="padding-top:6px; padding-bottom:6px; padding-left:6px; padding-right:6px;font-size:9px" >'.utf8_encode($rs_personal->fields["usua_nombre"]).'<br>'.utf8_encode($nombre_dos[0]).'</td>';
	  // }
  ...
  ?>		   
	...
	if($rs_personal)
    {
	  ...
	  // {
	   ...
	   $lista_buscat="select terap_id,atenc_hc,especi_id,faesa_terapiasregistro.usua_id,faesa_terapiasregistro.clie_id,terap_fecha,terap_hora,terap_autorizacion,terap_estado,terap_fechapago,terap_nfactura,faesa_terapiasregistro.centro_id,faesa_terapiasregistro.usuar_id,terap_fecharegistro,terap_recuperacion,terap_observacion,terap_tipoevatera,tipopac_id,clie_nombre,clie_apellido,terap_motivo,terap_asiste,quiro_id from  faesa_terapiasregistro left join app_cliente on faesa_terapiasregistro.clie_id=app_cliente.clie_id where faesa_terapiasregistro.usua_id=".$rs_personal->fields["usua_id"]." and terap_fecha='".$fecha_valor."' and terap_hora='".$arreglo_horas[$hi]."' and terap_cancelado=0";
							 ...
							 $n_quirofano="<br>".$rs_bquirofano->fields["quiro_nombre"];
							  ...
							  echo '<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
									  <tr>
										...
										<td ><center><span style="color:#000000" ><b>'.$paciente_data.$terap_motivo.$n_quirofano.'/</b></span></center></td>
										<td ></td>
									  </tr>
								 </table>';
