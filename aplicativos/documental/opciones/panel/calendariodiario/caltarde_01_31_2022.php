	   ...
	   $rs_lbuscat = $DB_gogess->executec($lista_buscat,array());
					 if($rs_lbuscat)
					 {
						  while (!$rs_lbuscat->EOF) {
							...
							if($_SESSION['datadarwin2679_sessid_inicio']==$rs_lbuscat->fields["usua_id"])
							 ...
							 $busca_atencioid="select * from dns_atencion where clie_id='".$rs_lbuscat->fields["clie_id"]."'";
							 $rs_atncionid = $DB_gogess->executec($busca_atencioid,array());	
							 $atenc_id=0;
							 $atenc_id=$rs_atncionid->fields["atenc_id"];
							 
						$link_evolucion='onclick=ver_formularioenpantalla(\'aplicativos/documental/datos_standarterapia.php\',\'Editar\',\'divBody_ext\',\''.$atenc_id.'\',\'42\',0,0,0,0,1)';
					 ...
					 echo '<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
							  <tr>
								...
								<td '.$link_evolucion.'  style="cursor:pointer" ><img src="images/evolucion.png" width="30" height="30" /></td>
