...
include_once("../../../../../cfg/conexion.php");

global $objportal;

if (!isset($objportal)) {
    $objportal = new portal();
    $objportal->datos_portal(1, $DB_gogess);
}
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><span class="Estilo3"><div class="input-group input-group-outline my-3">      
      <input name="fecha_valor" type="text" id="fecha_valor" value="<?php echo $fecha_hoy; ?>" class="form-control"  />
    </div></span></td>

    <td>&nbsp;</td>
    <td><input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" type="button" name="Button" value="Ver" onclick="ver_diario()" /></td>
   ...
   <!-- <td>&nbsp;</td>	
	...
	<td>&nbsp;</td>-->
	<td>&nbsp;</td>
	<td onclick="btn_listaag()" ><span class="material-symbols-outlined" style="cursor:pointer">menu</span></td> <!--<img src="horaroslista.png" width="50" height="50">-->
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<?php
	if($horario=='t')
    {
	?>
	<td><input type="button" name="Submit" value="Imprimir Agenda" onClick="ver_calendario_generalimptarde()" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary form-control"  ></td>
	<?php
	}
	else
	{
	?>
	<td><input type="button" name="Submit" value="Imprimir Horario Ma&ntilde;ana" onClick="ver_calendario_generalimpmanana()" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary form-control"  ></td>
	<?php
	}
	?>
    <td>&nbsp;</td>
...
{
abrir_standar('pantalla_agendalista.php','AGENDAMIENTO','divBody_agenda','divDialog_agenda',950,600,0,0,0,0,0,0,0);
}
...
<script src="DataTables/dataTables.fixedHeader.min.js" type="text/javascript"></script>
