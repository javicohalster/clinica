...
$actualiza_valor="update cereni_asistenciagrupo set asig_asiste='".$asig_asiste."' where asig_id='".$rs_bcasietg->fields["asig_id"]."'";
...
$inserta_data="insert into cereni_asistenciagrupo (asigm_id,clie_id,centro_id,asig_fecha,asig_asiste,asig_fecharegisto,usua_id) values ('".$asigm_id."','".$clie_id."','".$centro_id."','".$asig_fecha."','".$asig_asiste."','".$asig_fecharegisto."','".$usua_id."')";
