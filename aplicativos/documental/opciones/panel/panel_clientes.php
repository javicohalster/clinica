    ...
    <div id="lista_manos">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h3 class="panel-title" style="color:#000033">PERSONAS</h3>
            ...
            <div class="panel-body">
                ...
                <form id="form_app_cliente" name="form_app_cliente" method="post" action="" class="form-horizontal"
...
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_cliente.php'.$comill_s.','.$comill_s.'CLIENTE'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.',0,0,0,0,0,0,0)" style=cursor:pointer';	
...
echo '<button type="button" class="mb-sm btn btn-primary"  '.$linkeditar.'  style="background-color:#000066"  ><span class="glyphicon glyphicon-plus"></span>Primera vez </button>';
