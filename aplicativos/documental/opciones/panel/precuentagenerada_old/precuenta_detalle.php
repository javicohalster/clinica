...
function procesar_factura()
{
   ...
   $("#procesando_detalle").load("aplicativos/documental/opciones/panel/precuenta/facturar.php",{
...
$("#campo_valor").load("aplicativos/documental/opciones/panel/precuentagenerada/guarda_campo.php",{
