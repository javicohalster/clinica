...
$busca_precuenta="select * from dns_preddetalleprecuenta where detapre_id='".$detapre_id."'";
...
$busca_medi="delete from dns_preddetalleprecuenta where detapre_id='".$detapre_id."'";
