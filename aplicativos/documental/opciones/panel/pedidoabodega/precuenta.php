...
window.open('aplicativos/documental/opciones/panel/pedidoabodega/lista_asignadosinv.php?precu_id=<?php echo $precu_id; ?>&centro_id='+$('#centro_id').val(),'ventana1','width=750,height=500,scrollbars=YES');

}

function imprimir_doc() {
window.open('aplicativos/documental/opciones/panel/pedidoabodega/lista_asignadosimp.php?precu_id=<?php echo $precu_id; ?>&centro_id='+$('#centro_id').val(),'ventana1','width=750,height=500,scrollbars=YES');

}

function imprimir_docexcel() {
window.open('aplicativos/documental/opciones/panel/pedidoabodega/lista_asignadosimp.php?excel=1&precu_id=<?php echo $precu_id; ?>&centro_id='+$('#centro_id').val(),'ventana1','width=750,height=500,scrollbars=YES');
...
function lista_cmb()
{
   ...
   $("#lista_mediext").load("aplicativos/documental/opciones/panel/pedidoabodega/cmb_listamed.php",{
...
function ejecuta_despachar(cuadrobm_id,centro_id,maximop,clie_id)
{
  ...
  abrir_standar("aplicativos/documental/opciones/panel/pedidoabodega/lotes.php","Despacho","divBody_pdespacho","divDialog_pdespacho",580,500,<?php echo $precu_id; ?>,'dns_precuenta',centro_id,'<?php echo $_SESSION['datadarwin2679_sessid_inicio']; ?>','<?php echo $clie_id; ?>',maximop,cuadrobm_id);
...
function desplegar_listainventario()
{
  if($('#centro_id').val()=='')
  {
   ...
   $("#lista_bodega").load("aplicativos/documental/opciones/panel/pedidoabodega/lista_medinsu.php",{
...
function desplegar_listatarifario()
{
   ...
   $("#lista_tarfario").load("aplicativos/documental/opciones/panel/pedidoabodega/lista_tarifario.php",{
...
function desplegar_asignados()
{
   ...
   $("#lista_asignado").load("aplicativos/documental/opciones/panel/pedidoabodega/lista_asignados.php",{
...
function desplegar_asignadostarifatio()
{
   ...
   $("#lista_tarasignado").load("aplicativos/documental/opciones/panel/pedidoabodega/lista_asignadostar.php",{
...
if($('#cantidp_'+prod_id).val()=='')
 ...
 $("#lista_tarasignado").load("aplicativos/documental/opciones/panel/pedidoabodega/asignar_gtar.php",{
...
function asgnar_detalle(cuadrobm_id,centro_id,maximop,clie_id)
{
 ...
 $("#lista_asignado").load("aplicativos/documental/opciones/panel/pedidoabodega/asignar_g.php",{
...
if (confirm("Esata seguro en borrar") == true) {
 ...
 $("#p_borrar").load("aplicativos/documental/opciones/panel/pedidoabodega/borrar_g.php",{
