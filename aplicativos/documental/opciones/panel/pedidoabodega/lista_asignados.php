...
?>
  <table width="100%" border="1" cellpadding="0" cellspacing="0">
	...
	<?php
	$valor_total=0;
	$lista_precuentas="select * from dns_preddetalleprecuenta left join dns_centrosalud_ext on dns_preddetalleprecuenta.centrob_id=dns_centrosalud_ext.centro_id  where precu_id='".$precu_id."' and detapre_tipo in (1,2) order by detapre_id asc";
