...
-->
 ...
 $lista_precuentas="select * from dns_preddetalleprecuenta left join dns_centrosalud_origen on dns_preddetalleprecuenta.centrob_id=dns_centrosalud_origen.centro_id  where precu_id='".$precu_id."' and detapre_tipo in (1,2)";
