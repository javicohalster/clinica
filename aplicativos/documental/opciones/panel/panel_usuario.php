...
<div class="container" style="padding-top: 1em; padding-right:1em; padding-left:1em; max-width:90%;">
...
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_standarusuario.php'.$comill_s.','.$comill_s.'TARIFARIO'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.',0,'.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	

echo '<button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary"  '.$linkeditar.'><span class="glyphicon glyphicon-plus"></span>NUEVO REGISTRO</button>'; //style="background-color:#000066"  
                                ...
                                <div class="ms-md-auto pe-md-3 align-items-center">
                                    <div align="center">
                                        <button type="button" class="btn btn-outline-primary btn-sm mb-0"
                                            onclick=" ver_informedns(11,'')">LISTA
                                            USUARIOS</button>
                                    </div>
                                </div>
                                <!--
                                                ...
                                                <td>
                                                    ...
                                                    <div align="center">
                                                        <button type="button" class="mb-sm btn btn-primary"
                                                            onclick="ver_informedns(11,'')"
                                                            style="background-color:#000066">LISTA USUARIOS</button>
                                                    </div>
...
function ver_informedns(seccion, id) {
    ...
    myWindow2 = window.open('reportes/certificado_standarusuario.php?seccion=' + seccion + '&idsec=' + id + '&dhoja=' +
        reponsables, 'ventana_consentimiento', 'width=950,height=600,scrollbars=YES');
    myWindow2.focus();
