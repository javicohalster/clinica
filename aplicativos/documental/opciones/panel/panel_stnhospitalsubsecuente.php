...
$comillasimple="'";
$subindice='_stnhospitalsubsecuente';
$carpeta='stnhospitalsubsecuente';
...
$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_stnhospitalsubsecuente.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.','.$comill_s.$tipofor_id.$comill_s.','.$comill_s.$anam_id.$comill_s.','.$comill_s.$centro_id.$comill_s.')" style=cursor:pointer';	


$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/datos_stnhospitalanamnesis.php','Editar','divBody_ext','".$anam_id."','".@$clie_id."',122,'".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linkimprimirc='onClick=genera_cartillaevolucion();';

echo '<button type="button" class="mb-sm btn btn-info" '.$linkimprimirc.'  style="cursor:pointer"><span class="glyphicon glyphicon-print"></span>CARTILLA</button>&nbsp;&nbsp;';
...
function genera_pdfevolucion()
{
	...
	window.open("pdfformularios2/pdfformevolucionhospital.php?ssr=<?php echo $campos_data64."|" ?>"+"<?php echo $anam_id; ?>", "_blank");

}

function genera_cartillaevolucion()
{
	 
	window.open("cartillaformularios/pdfformevolucionhospital.php?ssr=<?php echo $campos_data64."|" ?>"+"<?php echo $anam_id; ?>", "_blank");
