...
$comillasimple="'";
$subindice='_substandarformimagennew';
$carpeta='substandarformimagennew';
...
$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_substandarformimagennew.php'.$comill_s.','.$comill_s.'IMAGENOLOGIA'.$comill_s.','.$comill_s.'divBodylab_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.','.$comill_s.$id_llega.$comill_s.','.$comill_s.$tabla_llega.$comill_s.','.$comill_s.$centro_id.$comill_s.')" style=cursor:pointer';	
