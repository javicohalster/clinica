...
$comillasimple="'";
$subindice='_subsecuenteodontologa';
$carpeta='subsecuenteodontologa';
...
$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_substandarformdoblesubodontologia.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.',0,0,'.$comill_s.@$odonto_id.$comill_s.')" style=cursor:pointer';	


//echo '<div align="center">';

$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/datos_substandarformodontologia.php','Editar','divBody_ext','".@$odonto_id."','".@$clie_id."',62,'".$atenc_id."',0,0,0);";
...
{	 
	location.href = "pdfformularios/pdfformulario_odontevolucion.php?ssr=<?php echo $campos_data64."|" ?>"+"<?php echo $odonto_id; ?>";
}
