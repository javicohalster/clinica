...
<div align="center">
  <table width="800" border="0" cellpadding="4" cellspacing="4">
    <tr>
      ...
      <td><span class="css_uno">CI MEDICO: </span></td>
    ...
    <tr>
      <td class="css_uno">AREA DIAGNOSTICO:</td>
    ...
    <tr>
      <td class="css_uno"><select name="tab_name" id="tab_name" style="width:220px" class="form-control" >
        <?php
			 ...
			 $lista_tablas_diag="select distinct gogess_sistable.tab_name,tab_title from gogess_sisfield inner join gogess_sistable on gogess_sisfield.tab_name=gogess_sistable.tab_name where ttbl_id=1";
