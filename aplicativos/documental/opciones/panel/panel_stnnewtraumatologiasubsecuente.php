...
$comillasimple="'";
$subindice='_stnnewtraumatologiasubsecuente';
$carpeta='stnnewtraumatologiasubsecuente';
...
$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_stnnewtraumatologiasubsecuente.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.','.$comill_s.$tipofor_id.$comill_s.','.$comill_s.$anam_id.$comill_s.','.$comill_s.$centro_id.$comill_s.')" style=cursor:pointer';	


$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/datos_stnnewtraumatologiaanamnesis.php','Editar','divBody_ext','".$anam_id."','".@$clie_id."',201,'".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
function genera_pdfevolucion()
{
	    ...
	    location.href = "pdfformularios/pdfformevolucionnewtraumatologia.php?ssr=<?php echo $campos_data64."|" ?>"+"<?php echo $anam_id; ?>";
