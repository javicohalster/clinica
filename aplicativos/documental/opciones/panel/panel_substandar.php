...
<div class="panel panel-default">
 <div class="panel-heading">
    ...
    <h3 class="panel-title" style="color:#000033" ><?php echo utf8_encode(strtoupper($rs_tabla->fields["tab_title"])); ?></h3>
...
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_substandar.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$_POST["pVar2"].$comill_s.','.$comill_s.$_POST["pVar3"].$comill_s.',0,0,0,0)" style=cursor:pointer';	
...
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/datos_pacientes.php','Editar','divBody_ext','".@$_POST["pVar2"]."','25',0,0,0,0,0);";
