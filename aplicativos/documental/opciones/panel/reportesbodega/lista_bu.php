...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
    <?php
 $lista_campor="select * from dns_cuadrobasicomedicamentos where categ_id='".$categ_id."' and cuadrobm_historial=0 and (cuadrobm_codigoatc like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_principioactivo like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_nombrecomercial like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_nombredispositivo like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_primerniveldesagregcion like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_presentacion like '%".$_POST["bu_txtproducto"]."%' or cuadrobm_concentracion like '%".$_POST["bu_txtproducto"]."%')  order by  cuadrobm_principioactivo asc";
...
?>
    <tr>
        <td width="82"><input class="fs-5 btn bg-gradient-dark mb-0 my-2 btn btn-primary" type="button" name="Button"
                value="Seleccionar" onClick="selecciona_p('<?php echo $rs_tabla->fields["cuadrobm_codigoatc"]; ?>')">
        </td>
        <td width="218">
            <?php echo $rs_tabla->fields["cuadrobm_codigoatc"]." ".utf8_encode($rs_tabla->fields[$ncampo_val]).' '.utf8_encode($concatena_nom); ?>
        </td>
    </tr>
    <?php	  
	  $rs_tabla->MoveNext();
