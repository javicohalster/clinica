...
<center><B><?php echo $ncentro; ?><br /> INGRESOS VARIOS </B></center><br />  
...
if($('#categ_id').val()==1)
{
	urlpath='r_fechacortepartidaCT.php';
}
else
{
	urlpath='r_fechacortepartidadCT.php';	
}
...
if($('#fechai').val()=='')
{
  alert("FECHA INICIO OBLIGATORIO");
  return false;
}
