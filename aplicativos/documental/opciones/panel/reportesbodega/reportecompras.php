  ...
  <table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
	  ...
	  <td>
	   ...
	   <select name="categ_id" id="categ_id" style="font-size:11px; width:120px" class="form-control" >
	        <?php
      ...
      <td></td>
      <td><div id="sub_c" >
	    <input name="subcateg_idx" type="hidden" id="subcateg_idx" value="" />
	 </div></td>
      <td>&nbsp;</td>
      <td>Fecha Inicio: </td>
      ...
      <td>&nbsp;</td>
	   <td>Fecha Fin: </td>
      <td><input name="fechaf" type="text" id="fechaf" autocomplete="off" class="form-control" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
...
$("#listado_v").load("r_reportecompras.php",{
  fechai:$('#fechai').val(),
  fechaf:$('#fechaf').val(),
