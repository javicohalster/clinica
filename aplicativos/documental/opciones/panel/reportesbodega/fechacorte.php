        ...
        <div class="row">
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h3 class="text-white text-capitalize ps-3 panel-title"><?php echo $ncentro; ?>CONSUMO
                                MEDICAMENTOS/DISPOSITIVOS POR RANGO DE FECHA</h3>
                        </div>
                    </div>
           ...
           ?>
                                        ...
                                        <td><input class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" type="button"
                                                name="Button" value="Ver Corte" onclick="ver_reporte()" /></td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </tbody>
                            ...
                            <form action="ficheroExcel.php" method="post" target="_blank" id="FormularioExportacion">
                                <div class="text-center">
                                    <div>
                                        <span class="fs-5">Exportar a Excel</span>
                                    </div>
                                    <div>
                                        <span class="material-symbols-outlined fs-1 my-3 botonExcel"
                                            style="cursor: pointer">table</span>
                                    </div>
                                    <!-- 
                                    <p>Exportar a Excel <img src="imagenes/export_to_excel.gif" class="botonExcel" />
                                    </p>
                                    -->
