...
<center><B><?php echo $ncentro; ?><br /> KARDEX POR BODEGAS </B></center><br />  
...
<div align="center">
  <table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td>
	  <table cellspacing="2" border="0"><tbody><tr><td onclick="buscar_producto_select()" style="cursor:pointer"><img src="../../../../../images/searchbu.png" width="20" height="18"></td></tr> </tbody></table>	  </td>
      <td>No. Lote </td>
      <td>
	  <div id="listado_lote">
      ...
      <td>&nbsp;</td>
      <td><input type="button" name="Button" value="Ver Kardex" onclick=" elige_reporte()" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
  </table>
...
function elige_reporte()
{

if($('#centro_idval').val()=='')
{
  alert("SELECCIONE CENTRO");
  return false;
}


if($('#centro_idval').val()==1)
{
ver_reporteprincipal();
}
else
{
ver_reporte();
...
$("#listado_v").load("r_kardexcentro.php",{
...
function ver_lista()
{
  ...
  $("#listado_p").load("listapcentro.php",{
...
function ver_listalotes()
{
  ...
  $("#listado_lote").load("listalotecentro.php",{
  categ_id:$('#categ_id').val(),
  codigo_pr:$('#codigo_pr').val(),
  centro_id:$('#centro_idval').val()
