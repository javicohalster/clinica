...
<div class="input-group input-group-static my-3">
    <select class="form-control" name="lote_pr" id="lote_pr" style="font-size:11px; width:120px">
        <?php
	          printf("<option value=''>---Categorias--</option>");  
			  $busca_lotes="select distinct moviin_nlote from dns_principalmovimientoinventario where cuadrobm_id='".$rs_nmedic->fields["cuadrobm_id"]."' and perioac_id='".$per_activo."'";
