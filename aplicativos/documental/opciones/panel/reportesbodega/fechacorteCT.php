    ...
    <div class="container-fluid py-2">
        <div class="row">
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h3 class="text-white text-capitalize ps-3 panel-title"><?php echo $ncentro; ?>FECHA DE
                                CORTE MEDICAMENTOS/DISPOSITIVOS A LA FECHA</h3>
                        </div>
                    </div>
                    <div id="campo_valor" style="height:20px"></div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0 w-50 mx-auto">
           ...
           ?>
                                        ...
                                        <td>
                                            <div class="input-group input-group-static my-3">
                                                <input name="fechaf" type="date" id="fechaf" autocomplete="off" />
                                            </div>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
...
?>
    ...
    function ver_reporte() {
        ...
        $("#listado_v").load("r_fechacorteCT.php", {
            fechaf: $('#fechaf').val(),
