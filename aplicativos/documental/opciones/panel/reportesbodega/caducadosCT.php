...
<center><B><?php echo $ncentro; ?><br /> CADUCADOS Y POR CADUCAR EN BODEGA PRINCIPAL </B></center><br />  
...
<div align="center">
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
	  <td><input name="fechaf" type="hidden" id="fechaf" autocomplete="off" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><input type="button" name="Button" value="Ver Lista" onclick="ver_reporte()" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
  </table>
...
$("#listado_v").load("r_caducadosCT.php",{
  fechaf:$('#fechaf').val(),
