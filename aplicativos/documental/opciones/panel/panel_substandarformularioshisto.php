...
$comillasimple="'";
$subindice='_substandarformhisto';
$carpeta='substandarformhisto';
...
$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantallaextendida('.$comill_s.'aplicativos/documental/datos_substandarformhisto.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.',0,0,0,0,0,0,'.$comill_s.@$protoop_idenlace.$comill_s.','.$comill_s.@$protoop_tblprincipal.$comill_s.')" style=cursor:pointer';	
