...
<div>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <div id="g_semanal" style="width:150px"></div>
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3 panel-title">AGENDAR</h6>
                    </div>
                </div>
                <div class="card-body px-0 pb-2" align="center">
                    <span onclick="ver_diacal('t')" class="material-symbols-outlined"
                        style="font-size: 100px; cursor:pointer">calendar_clock</span>
                </div>
            </div>
        </div>
    </div>
...
function btn_agendar() {
    abrir_standar('aplicativos/documental/opciones/panel/agendart/pantalla_agenda.php', 'AGENDAMIENTO',
        'divBody_agenda', 'divDialog_agenda', 900, 600, 0, 0, 0, 0, 0, 0, 0);
}

function ver_diacal(horario) {


    window.open('aplicativos/documental/opciones/panel/calendariodiario/panel_agendar.php?horario=' + horario +
        '&fecha_valor=' + $('#anio_idg').val() + '-' + $('#mes_idg').val() + '-' + $('#dia_idgval').val(), '_blank');
