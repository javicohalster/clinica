...
$comillasimple="'";
$subindice='_substandarform_sub';
$carpeta='substandarform_sub';
...
$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_substandarform_sub.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.',0,0,'.$comill_s.$centro_id.$comill_s.')" style=cursor:pointer';	
