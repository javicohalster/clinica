...
if(@$_SESSION['datadarwin2679_sessid_inicio'])
{
	...
	{
	  include("establecimientorecibos.php");
	}	
	//----------------------------------------
...
else
{
	...
	$varable_enviafunc=base64_encode("ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_recibos.php','Perfil','divBody_ext','','34',0,0,0,0,0)");
