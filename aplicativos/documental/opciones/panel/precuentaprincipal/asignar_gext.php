...
$busca_clientex="select * from app_cliente where clie_id='".$clie_id."'";
...
$precios_valores=$objBodega->busca_precioproducto($cuadrobmext_id,$DB_gogess);

$detapre_precio=0;
$detapre_precioventa=0;
...
$detapre_tipox=$_POST["detapre_tipox"];
$detapre_tipo=$detapre_tipox;
$mnupan_id=0;
...
$detapre_precioventa=$objFormulascontable->formulas_pvp($convenio,$detapre_precio,$DB_gogess);
...
$inserta_datadis="INSERT INTO dns_detalleprecuentaprincipal (precu_id, clie_id, mnupan_id, detapre_tipo, detapre_codigop, detapre_detalle, detapre_cantidad, detapre_precio, detapre_fecharegistro, usua_id, centro_id, atenc_id, detapre_codigoform,detapre_idgrid,detapre_table,centrob_id,detapre_origen,moviin_id,cuadrobm_id,detapre_observacion,detapre_precioventa) VALUES ('".$precu_id."','".$clie_id."','".$mnupan_id."','".$detapre_tipo."','".$detapre_codigop."','".$detapre_detalle."','".$detapre_cantidad."','".$detapre_precio."','".$detapre_fecharegistro."','".$usua_id."','".$centro_id."','".$atenc_id."','".$detapre_codigoform."','".$detapre_idgrid."','".$table."','".$centrob_id."','".$detapre_origen."','0','".$cuadrobmext_id."','".$detapre_observacion."','".$detapre_precioventa."');";
