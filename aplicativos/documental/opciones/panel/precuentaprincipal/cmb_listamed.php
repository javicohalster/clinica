...
else
{
   ...
   Tipo:<select name="detapre_tipox" id="detapre_tipox"  class="form-control" >
      <?php
	  echo '<option value="">---Seleccionar--</option>';
	  $objformulario->fill_cmb("dns_categoriadns","categ_id,categ_nombre",$detapre_tipox," where categ_id in (1,2) order by categ_nombre asc ",$DB_gogess);			
	  ?>	  
    </select>   
...
function asgnar_detalleexternonobodega()
{
 ...
 $("#lista_asignadoext").load("aplicativos/documental/opciones/panel/precuentaprincipal/asignar_gext.php",{
