...
function buscar_proforma()
{
   ...
   $("#buscar_proforma").load("aplicativos/documental/opciones/panel/precuentaprincipal/asignar_proforma.php",{
...
function procesar_factura()
{
   ...
   $("#procesando_detalle").load("aplicativos/documental/opciones/panel/precuentaprincipal/facturar.php",{
