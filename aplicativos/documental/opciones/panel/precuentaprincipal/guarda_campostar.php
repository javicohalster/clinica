...
$actualiza_data="update ".$_POST["tabla"]." set ".$_POST["campo"]."='".$_POST["valor"]."',detapre_precioventa='".$_POST["valor"]."' where ".$_POST["campoidtabla"]."='".$_POST["id"]."'";
$okvalor=$DB_gogess->executec($actualiza_data); 

$lista_totales="select sum(ROUND(detapre_precio, 2)*detapre_cantidad) as total_g from dns_detalleprecuentaprincipal where precu_id='".$precu_id."' and detapre_tipo='".$tipo."'"; 
...
$('#cmb_total<?php echo $_POST["id"]; ?>').html('<?php echo $_POST["valor"]*$cantidad; ?>');
