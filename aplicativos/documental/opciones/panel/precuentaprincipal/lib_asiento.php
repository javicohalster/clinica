...
$lista_productosx="select * from dns_precuenta inner join dns_detalleprecuentaprincipal on dns_precuenta.precu_id=dns_detalleprecuentaprincipal.precu_id inner join dns_cuadrobasicomedicamentos on dns_detalleprecuentaprincipal.detapre_codigop=dns_cuadrobasicomedicamentos.cuadrobm_codigoatc where dns_precuenta.precu_id='".$valor_id."' and detapre_id='".$detapre_id."'  and dns_detalleprecuentaprincipal.centrob_id not in (9999,8888) ";
...
$lista_cuentas='';
$lista_productos="select * from dns_precuenta inner join dns_detalleprecuentaprincipal on dns_precuenta.precu_id=dns_detalleprecuentaprincipal.precu_id inner join dns_cuadrobasicomedicamentos on dns_detalleprecuentaprincipal.detapre_codigop=dns_cuadrobasicomedicamentos.cuadrobm_codigoatc where dns_precuenta.precu_id='".$valor_id."' and detapre_id='".$rs_prdx->fields["detapre_id"]."'";
...
$busca_cabeceraasiento="delete from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='4' and comcont_tablas='dns_detalleprecuentaprincipal' and comcont_idtablas='".$detapre_id."'";
...
//fecha
$busca_fecha="select * from dns_detalleprecuentaprincipal where 	detapre_id='".$detapre_id."'";
...
$concepto='';
$concepto='INVENTARIO . PRECUENTA CNS:'.$doccab_ndocumento.' CI: '.$clie_rucci.' - '.$doccab_nombrerazon_cliente.' '.$doccab_apellidorazon_cliente.' '.$detapre_codigop.' '.$detapre_detalle;
...
//========================datos para comporbante===================================
$busca_cabeceraasiento="select * from lpin_comprobantecontable where comcont_tabla='".$tabla_asiento."' and comcont_idtabla='".$valor_id."' and tipoa_id='4' and comcont_tablas='dns_detalleprecuentaprincipal' and comcont_idtablas='".$detapre_id."'";
$rs_bcabecera = $DB_gogess->executec($busca_cabeceraasiento);
...
( '4', '".$doccab_fechaemision_cliente."', '".$concepto."', '".$doccab_ndocumento."', 'APROBADO', 0, '".$comcont_enlace."', '".$_SESSION['datadarwin2679_sessid_inicio']."', '".$fecha_hoy."','".$_SESSION['datadarwin2679_centro_id']."', '".$tabla_asiento."', '".$valor_id."','AUTOMATICO','".$doccab_anulado."','".$detapre_id."','dns_detalleprecuentaprincipal','".$detapre_id."');";
