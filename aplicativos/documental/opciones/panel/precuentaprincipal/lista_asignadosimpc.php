...
<?php
$lista_precuentasx="select round((sum(detapre_precioventa*detapre_cantidad)),2) as totalmed from dns_detalleprecuentaprincipal left join dns_centrosalud on dns_detalleprecuentaprincipal.centrob_id=dns_centrosalud.centro_id  where precu_id='".$precu_id."' and detapre_tipo in (1)  order by detapre_tipo asc";
...
$lista_precuentasx1="select round((sum(detapre_precioventa*detapre_cantidad)),2) as totalmed from dns_detalleprecuentaprincipal left join dns_centrosalud on dns_detalleprecuentaprincipal.centrob_id=dns_centrosalud.centro_id  where precu_id='".$precu_id."' and detapre_tipo in (2)  order by detapre_tipo asc";
...
//IVA
$total_ivavalor=0;
$lista_precuentasiva="select * from dns_detalleprecuentaprincipal left join dns_centrosalud on dns_detalleprecuentaprincipal.centrob_id=dns_centrosalud.centro_id  where precu_id='".$precu_id."' and detapre_tipo in (2)  order by detapre_tipo asc";
...
?>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0">
    <tr>
	  ...
	  <td bgcolor="#A6CED7" class="css_titulo"><div align="center">12% IVA </div></td>
	...
	$lista_precuentas="select * from dns_detalleprecuentaprincipal left join dns_centrosalud on dns_detalleprecuentaprincipal.centrob_id=dns_centrosalud.centro_id  where precu_id='".$precu_id."' and detapre_tipo in (3,4) order by detapre_tipo asc";
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
	...
	$lista_precuentas="select * from dns_detalleprecuentaprincipal left join dns_centrosalud on dns_detalleprecuentaprincipal.centrob_id=dns_centrosalud.centro_id  where precu_id='".$precu_id."' and detapre_tipo in (1)  order by detapre_tipo asc";
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
	...
	$lista_precuentas="select * from dns_detalleprecuentaprincipal left join dns_centrosalud on dns_detalleprecuentaprincipal.centrob_id=dns_centrosalud.centro_id  where precu_id='".$precu_id."' and detapre_tipo in (2)  order by detapre_tipo asc";
