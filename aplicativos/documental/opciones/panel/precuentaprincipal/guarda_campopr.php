...
$lista_totales="select sum(detapre_precioventa*detapre_cantidad) as total_g from dns_detalleprecuentaprincipal where precu_id='".$precu_id."' and detapre_tipo='".$tipo."'"; 
...
$('#totales_gen<?php echo $tipo; ?>').html('<?php echo round($okv_totales->fields["total_g"],2); ?>')
