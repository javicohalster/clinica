...
<div class="panel panel-default">
  ...
  <div class="panel-heading">
    ...
    <h3 class="panel-title" style="color:#000033" >M&Eacute;DICOS</h3>
...
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_medico.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.',0,0,0,0,0,0,0)" style=cursor:pointer';	
