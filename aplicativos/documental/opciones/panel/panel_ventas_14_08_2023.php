...
$contenido_btn.='<button type="button" class="mb-sm btn btn-primary"  '.$linkeditarbtn.'  style="background-color:#000066"  ><span class="glyphicon glyphicon-plus"></span>'.$rs_gogessform->fields["vardev_nombre"].'</button>';
...
{
echo $contenido_btn.'&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-primary"  '.$linkeditar.'  style="background-color:#000066"  ><span class="glyphicon glyphicon-plus"></span>NUEVO REGISTRO</button>';
}
else
{
...
echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-success"  '.$link_b.'  style="background-color:#000066"  >LISTADO</button>';
}
?>
</div>
</div>
