                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 panel-heading">
                            <h3 class="text-white text-capitalize ps-3 panel-title" style="color:#000033">DESCARGO DE
                                    ...
                                    <tr>
                                        <th>
                                            <div class="d-flex justify-content-center align-items-center gap-2">
                                                ...
                                                <input class="fs-6 btn bg-gradient-dark mb-0 btn btn-primary"
...
function desplegar_precuenta() {
    ...
    $("#lsta_precuenta").load("aplicativos/documental/opciones/panel/precuenta/precuenta.php", {
