...
<div class="panel panel-default">
  ...
  <div class="panel-heading">
    ...
    <h3 class="panel-title" style="color:#000033" >HISTORIAS CLINICAS(M&Eacute;DICOS)</h3>
...
<form id="form_app_cliente" name="form_app_cliente" method="post" action="" class="form-horizontal" enctype="multipart/form-data" > 
...
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_historiaclinica.php'.$comill_s.','.$comill_s.'HISTORIA_CLINICA'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.',0,0,0,0,0,0,0)" style=cursor:pointer';	
