...
$comillasimple="'";
$subindice='_substandarnewprotocolooperatorio';
$carpeta='substandarnewprotocolooperatorio';
?>
...
function desplegar_grid()
{
  ...
  pVar11:'<?php echo $protoop_idenlace; ?>',
  pVar12:'<?php echo $protoop_tblprincipal; ?>'
...
$linkeditar= 'onClick=ver_formularioenpantallaextendida('.$comill_s.'aplicativos/documental/datos_substandarnewprotocolooperatorio.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.@$clie_id.$comill_s.','.$comill_s.$mnupan_id.$comill_s.','.$comill_s.$atenc_id.$comill_s.','.$comill_s.$eteneva_id.$comill_s.','.$comill_s.$tipofor_id.$comill_s.','.$comill_s.$centro_id.$comill_s.',0,0,0,'.$comill_s.$protoop_idenlace.$comill_s.','.$comill_s.$protoop_tblprincipal.$comill_s.')';	
...
//$linkapaciente="onClick=ver_formularioenpantallaregresar('aplicativos/documental/datos_stnhospitalanamnesis.php','Editar','divBody_ext','".$protoop_idenlace."','".@$clie_id."','122','".$atenc_id."',0,'0','".$centro_id."')";
//$linkapaciente="onClick=ver_formularioenpantallaregresar('aplicativos/documental/datos_stnnewhospitalizacionanamnesis.php','Editar','divBody_ext','".$protoop_idenlace."','".@$clie_id."','210','".$atenc_id."',0,'0','".$centro_id."')";
$linkapaciente="onClick=ver_formularioenpantallaregresar('aplicativos/documental/datos_stnnewhospitalizacionanamnesis.php','Editar','divBody_ext','".$protoop_idenlace."','".@$clie_id."','210','".$atenc_id."',0,'0','".$centro_id."')";
//echo $linkapaciente;
