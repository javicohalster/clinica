...
$comillasimple="'";
$subindice='_multiplecabecera';
$carpeta='multiplecabecera';
?>
...
$comill_s="'";
$linkarchivo= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/genera_multiplearchivo.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	
