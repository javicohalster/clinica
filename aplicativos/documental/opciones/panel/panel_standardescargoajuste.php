...
{
   abrir_standar('aplicativos/documental/opciones/panel/precuenta_detalleajuste.php','DETALLES _PRECUENTA','divBody_precuenta','divDialog_precuenta',800,500,precu_id,0,0,0,0,0,0);
}
//-->
</SCRIPT>
...
function desplegar_precuenta()
{
  if($('#ci_paciente').val()=='')
  {
   ...
   $("#lsta_precuenta").load("aplicativos/documental/opciones/panel/precuentaajuste/precuenta.php",{
