...
function ver_reporteinventario() {
 myWindow2=window.open('reportes/reporte_inventario.php','Inventario','width=750,height=500,scrollbars=YES');
 myWindow2.focus();

}

function ver_reporteinventarioindividual() {
 myWindow2=window.open('reportes/reporte_inventarioindividual.php?ivalor='+$('#usua_id').val(),'Inventario','width=750,height=500,scrollbars=YES');
 myWindow2.focus();

}

function ver_reportemantenimiento() {
 myWindow2=window.open('reportes/reporte_mantenimiento.php?ivalor='+$('#usua_id').val(),'Inventario','width=750,height=500,scrollbars=YES');
 myWindow2.focus();
...
<?php
$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_inventario.php'.$comill_s.','.$comill_s.'TARIFARIO'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.',0,'.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	
...
$link_reporte='onClick="ver_reporteinventario()" style=cursor:pointer';

echo '<button type="button" class="mb-sm btn btn-primary"  '.$link_reporte.'  style="background-color:#000066"  >LISTA GENERAL</button>';
?>
</div>
...
$link_reporte='onClick="ver_reporteinventarioindividual()" style=cursor:pointer';

echo '<button type="button" class="mb-sm btn btn-primary"  '.$link_reporte.'  style="background-color:#000066"  >LISTA INDIVIDUAL</button>';
?>
</div>
...
<div class="form-group">
	...
	$link_reporte='onClick="ver_reportemantenimiento()" style=cursor:pointer';
	
	echo '<button type="button" class="mb-sm btn btn-primary"  '.$link_reporte.'  style="background-color:#000066"  >LISTA MANTENIMIENTO</button>';
	?>
	</div>
