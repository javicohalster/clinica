...
<table class="table table-bordered"  style="width:100%" >
 ...
 if($rs_data)
 {
	  ...
	  while (!$rs_data->EOF) {	
		...
		if($rs_data->fields["hill_codigo"]=='AYUDANTE' or $rs_data->fields["hill_codigo"]=='ANESTESIOLOGO' or $rs_data->fields["hill_codigo"]=='COCIRUJANO')
		{
		  $precio_valor=0;	
		  $busca_detalles="select sum(detapre_precioventa*detapre_cantidad) as total from dns_detalleprecuenta where precu_id='".$precu_id."'  and detapre_tipohg='MAC'";
...
$("#agregar_serviciohill").load("aplicativos/documental/opciones/panel/precuentagenerada/agregar_serviciohill.php",{
hill_id:hill_id,
