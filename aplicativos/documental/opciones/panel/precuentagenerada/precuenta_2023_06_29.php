...
window.open('aplicativos/documental/opciones/panel/precuentagenerada/lista_asignadosimp.php?precu_id=<?php echo $precu_id; ?>&centro_id='+$('#centro_id').val(),'ventana1','width=750,height=500,scrollbars=YES');
