...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
	<tr>
		<td bgcolor="#CCCCCC" class="css_titulo">
			<div align="center"> </div>
		</td>
		<td bgcolor="#CCCCCC" class="css_titulo">
			<div align="center">Bodega </div>
		</td>
		<td bgcolor="#CCCCCC" class="css_titulo">
		...
		<td bgcolor="#A6CED7" class="css_titulo">
			<div align="center">P.Compra</div>
		</td>
		<td bgcolor="#A6CED7" class="css_titulo">
		...
		?>
		<td bgcolor="#CCCCCC" class="css_titulo">
			<div align="center">CORRECION</div>
		</td>
		<?php
		//}
		?>
	...
	<?php
	$valor_total = 0;
	$lista_precuentas = "select * from dns_detalleprecuenta left join dns_centrosalud_ext on dns_detalleprecuenta.centrob_id=dns_centrosalud_ext.centro_id  where precu_id='" . $precu_id . "' and detapre_tipo in (1) order by detapre_id asc";
	...
	if ($rs_lprecuentas) {
		while (!$rs_lprecuentas->EOF) {
			...
			$centrob_idvalida = 0;
			$centrob_idvalida = $rs_lprecuentas->fields["centrob_id"];
			...
			if ($rs_lprecuentas->fields["centrob_id"] == 55 || $rs_lprecuentas->fields["centrob_id"] == 8888 || $rs_lprecuentas->fields["centrob_id"] == 9999) {
				$comulla_simple = "'";
				$tabla_valordata = "";
				$campo_valor = "";
	...
	?>
				<tr>
					<td height="21" class="css_texto">
						<div align="center">
							<?php
							if ($centrob_idvalida == 55) {
								if ($_SESSION['datadarwin2679_sessid_inicio'] == 2) {
							?>
									<input type="button" name="Submit" value="&lt;&lt;--" onClick="borrar_asigxprincipal('<?php echo $rs_lprecuentas->fields["detapre_id"]; ?>')">
								<?php
								}
							} else {
								?>
					...
					<td class="css_texto" style="font-size:10px">
						<div align="center"><?php echo $rs_lprecuentas->fields["centro_nombre"] . ' ' . $rs_lprecuentas->fields["detapre_observacion"]; ?></div>
					</td>
					<td class="css_texto" style="font-size:10px">
						<div align="center"><?php echo $usuariod; ?></div>
					</td>
					<td class="css_texto" style="font-size:10px">
						<div align="center"><?php echo $rs_lprecuentas->fields["detapre_detalle"] . "<hr>" . $rs_lprecuentas->fields["detapre_codigop"]; ?></div>
					</td>
					<td class="css_texto" style="font-size:10px">
						<div align="center"><?php echo $rs_lprecuentas->fields["detapre_cantidad"]; ?></div>
					</td>
					<?php
					...
					<td class="css_texto">
						<div align="center">
							<div id="cmb_detapre_precioventa<?php echo $rs_lprecuentas->fields[$ide_producto]; ?>"><?php echo round($rs_lprecuentas->fields["detapre_precioventa"], 2); ?></div>
						</div>
					</td>
					<td class="css_texto">
						<div align="center">
							<div id="cmb_total<?php echo $rs_lprecuentas->fields[$ide_producto]; ?>"><?php echo round(($rs_lprecuentas->fields["detapre_precioventa"] * $rs_lprecuentas->fields["detapre_cantidad"]), 2); ?></div>
						</div>
					</td>
					<td class="css_texto" style="font-size:10px" onclick="ver_asientoc('<?php echo $precu_id; ?>','<?php echo $rs_lprecuentas->fields["detapre_id"]; ?>')">
						<div align="center"><?php echo $rs_lprecuentas->fields["detapre_fecharegistro"]; ?></div>
					</td>
			...
			?>
				<tr>
					...
					<td class="css_texto">
						<div align="center"><?php echo round($rs_lprecuentas->fields["detapre_precio"], 2); ?></div>
					</td>
					<td class="css_texto">
						<div align="center"><?php echo round($rs_lprecuentas->fields["detapre_precioventa"], 2); ?></div>
					</td>
					<td class="css_texto">
						<div align="center"><?php echo round(($rs_lprecuentas->fields["detapre_precioventa"] * $rs_lprecuentas->fields["detapre_cantidad"]), 2); ?></div>
					</td>
					<td class="css_texto" style="font-size:10px" onclick="ver_asientoc('<?php echo $precu_id; ?>','<?php echo $rs_lprecuentas->fields["detapre_id"]; ?>')">
						<div align="center"><?php echo $rs_lprecuentas->fields["detapre_fecharegistro"]; ?></div>
					</td>
					...
					<?php
					if ($_SESSION['datadarwin2679_sessid_inicio'] == '2' || $_SESSION['datadarwin2679_sessid_inicio'] == '427' || $_SESSION['datadarwin2679_sessid_inicio'] == '510'  || $_SESSION['datadarwin2679_sessid_inicio'] == '501') {
					?><td>
							<input type="submit" name="Submit2" value="Corregir Precio" onclick="corregir_preciox('<?php echo $precu_id; ?>','<?php echo $rs_lprecuentas->fields["detapre_id"]; ?>')" />
						</td>
					<?php
	...
	?>
	<tr>
		<td height="21" bgcolor="#CCCCCC" class="css_texto">
			<div align="center">&nbsp;</div>
		</td>
		<td height="21" bgcolor="#CCCCCC" class="css_texto">
			<div align="center">&nbsp;</div>
		</td>
		<td bgcolor="#CCCCCC" class="css_texto">
			<div align="center">&nbsp;</div>
		</td>
		<td bgcolor="#CCCCCC" class="css_texto">
			<div align="center">&nbsp;</div>
		...
		<td bgcolor="#CCCCCC" class="css_texto">
			<div align="center"><b>
					<div id="totales_gen1"><?php echo round($valor_total, 2); ?></div>
				</b></div>
		</td>
		<td bgcolor="#CCCCCC" class="css_texto">
			<div align="center">&nbsp;</div>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
	...
	<?php
	$valor_total = 0;
	$lista_precuentas = "select * from dns_detalleprecuenta left join dns_centrosalud_ext on dns_detalleprecuenta.centrob_id=dns_centrosalud_ext.centro_id  where precu_id='" . $precu_id . "' and detapre_tipo in (2) order by detapre_id asc";
	...
	?>
			...
			?>
				<tr>
					...
					<td class="css_texto" style="font-size:10px">
						<div align="center"><?php echo $rs_lprecuentas->fields["detapre_detalle"]; ?></div>
					</td>
					<td class="css_texto" style="font-size:10px">
						<div align="center"><?php echo $rs_lprecuentas->fields["detapre_cantidad"]; ?></div>
					</td>
	...
	<tr>
		...
		<td bgcolor="#CCCCCC" class="css_texto">
			<div align="center"><b>
					<div id="totales_gen2"><?php echo round($valor_total, 2); ?></div>
				</b></div>
		</td>
		<td bgcolor="#CCCCCC" class="css_texto">
			<div align="center">&nbsp;</div>
...
<script type="text/javascript">
	...
	function corregir_preciox(precu_id, detapre_id) {
		...
		if (confirm("Esata seguro en realizar el proceso") == true) {
			...
			$("#corrige_precio").load("aplicativos/documental/opciones/panel/precuentagenerada/corrige_precio.php", {
	...
	function guardar_campospr(tabla, campo, id, valor, campoidtabla, cantidad, clie_id, precu_id, tipo) {
		...
		$("#campo_valor").load("aplicativos/documental/opciones/panel/precuentagenerada/guarda_campopr.php", {
