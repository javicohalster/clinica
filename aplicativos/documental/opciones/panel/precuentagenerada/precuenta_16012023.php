...
function hill_ver()
{
abrir_standar("aplicativos/documental/opciones/panel/precuentagenerada/mghill.php","TARIFARIO","divBody_insumo","divDialog_insumo",900,600,'<?php echo $precu_id; ?>',0,0,0,0,0,0);
}
...
function ejecuta_despachar(cuadrobm_id,centro_id,maximop,clie_id)
{
  ...
  abrir_standar("aplicativos/documental/opciones/panel/precuentagenerada/lotes.php","Despacho","divBody_pdespacho","divDialog_pdespacho",580,500,<?php echo $precu_id; ?>,'dns_precuenta',centro_id,'<?php echo $_SESSION['datafrank1109_sessid_inicio']; ?>','<?php echo $clie_id; ?>',maximop,cuadrobm_id);
