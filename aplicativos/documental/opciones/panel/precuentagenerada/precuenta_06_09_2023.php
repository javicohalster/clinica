...
window.open('aplicativos/documental/opciones/panel/precuentagenerada/lista_asignadosimp.php?precu_id='+$('#pr_seleccionado').val()+'&centro_id='+$('#centro_id').val(),'ventana1','width=750,height=500,scrollbars=YES');

}

function imprimir_docexcel() {
window.open('aplicativos/documental/opciones/panel/precuentagenerada/lista_asignadosimp.php?excel=1&precu_id='+$('#pr_seleccionado').val()+'&centro_id='+$('#centro_id').val(),'ventana1','width=750,height=500,scrollbars=YES');
