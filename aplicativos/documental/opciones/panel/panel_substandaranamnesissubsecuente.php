...
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/datos_substandarformunicoanamnesis.php','Editar','divBody_ext','".$anam_id."','".@$clie_id."',44,'".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
