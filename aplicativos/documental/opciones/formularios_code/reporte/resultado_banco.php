...
<table width="800" border="0" align="center" cellpadding="2" cellspacing="2">
 ...
 $variable_imp.='<tr bgcolor="#4270BB">
  ...
  $valor_rowspan='';
    ...
    $variable_imp.='<td class=borde_tabla >'.$rs_listapreg->fields["regl_nombre"].'</td>';
     
	  
	  $variable_imp.='<td class=borde_tabla >';
	  
	  $variable_imp.='<table  border="0" align="center" cellpadding="2" cellspacing="2" >';
	  ...
	  $rs_lista_preg= $DB_gogess->executec($lista_preguntasd,array($rs_listaform->fields["form_id"],$rs_listapreg->fields["regl_id"]));
	   ...
	   while (!$rs_lista_preg->EOF) {
	       ...
	       $variable_imp.='<tr><td class=borde_tabla >'.$rs_lista_preg->fields["pregf_nombre"].'</td></tr>';
