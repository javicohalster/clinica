...
<?php
$linkapaciente="onClick=ver_formularioenpantallaextendida('aplicativos/documental/opciones/panel/panel_substandarformunicoprotocolooperatorio.php','Editar','divBody_ext','','".@$clie_id."','127','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."',0,0,0,'".$protoop_idenlace."','".$protoop_tblprincipal."');";
  ...
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {
	    ...
	    location.href = "pdfformularios/pdformularioprotocolo.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val();
	 }
	 else
	 {
       alert("Por favor guarde el resgistro para imprimir"); 	 
