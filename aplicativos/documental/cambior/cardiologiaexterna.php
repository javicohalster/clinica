...
$busca_cliente="select * from dns_cardiologiaconsultaexterna where conext_id='".$id_valor."'";
...
$actualiza_paciente="update dns_cardiologiaconsultaexterna set conext_fecharegistro='".$nueva_fecha."' where conext_id='".$id_valor."'";
...
if(@$rs_acpaciente)
{
   ...
   //pichinchahumana_extension.dns_cardiodiagnosticoexterna
   $busca_organos="update pichinchahumana_extension.dns_cardiodiagnosticoexterna set diagn_fecharegistro='".$nueva_fecha."' where conext_enlace='".$conext_enlace."' and diagn_fecharegistro like '".$busca_fechareg[0]."%'";
   $rs_organos = $DB_gogess->executec($busca_organos,array());    
   //pichinchahumana_extension.dns_cardiodiagnosticoexterna
   
   //pichinchahumana_extension.dns_cardiocuadrobasicocexterno   
   $busca_organos="update pichinchahumana_extension.dns_cardiocuadrobasicocexterno set cuabas_fecharegistro='".$nueva_fecha."' where conext_enlace='".$conext_enlace."' and cuabas_fecharegistro like '".$busca_fechareg[0]."%'";
   $rs_organos = $DB_gogess->executec($busca_organos,array());   
   //pichinchahumana_extension.dns_cardiocuadrobasicocexterno
   ...
   //pichinchahumana_extension.dns_cardiorecetaconsultaexterna 
    
   $lista_rescetdia="select * from pichinchahumana_extension.dns_cardiorecetaconsultaexterna where plantra_despachado='' and conext_enlace='".$conext_enlace."' and plantra_fecharegistro like '".$busca_fechareg[0]."%'";
   $rs_listarecetas = $DB_gogess->executec($lista_rescetdia,array());
   if($rs_listarecetas)
		{
			while (!$rs_listarecetas->EOF) {
    
   $busca_organos1="update pichinchahumana_extension.dns_cardiorecetaconsultaexterna set plantra_fecharegistro='".$nueva_fecha."' where plantra_id='".$rs_listarecetas->fields["plantra_id"]."'";
   $rs_organos1 = $DB_gogess->executec($busca_organos1,array()); 
   
    $permid_idtabla=$rs_listarecetas->fields["plantra_id"];
	$permid_tabla="pichinchahumana_extension.dns_cardiorecetaconsultaexterna";
	$permid_acepta=1;
  ...
  //borra permisos anteriores
   ...
   //pichinchahumana_extension.dns_cardiodisposiexterno
   
   $lista_rescetdia="select * from pichinchahumana_extension.dns_cardiodisposiexterno where plantrai_despachado='' and conext_enlace='".$conext_enlace."' and plantrai_fecharegistro like '".$busca_fechareg[0]."%'";
   $rs_listarecetas = $DB_gogess->executec($lista_rescetdia,array());
   if($rs_listarecetas)
		{
			while (!$rs_listarecetas->EOF) {
    
   $busca_organos1="update pichinchahumana_extension.dns_cardiodisposiexterno set plantrai_fecharegistro='".$nueva_fecha."' where plantrai_id='".$rs_listarecetas->fields["plantrai_id"]."'";
   $rs_organos1 = $DB_gogess->executec($busca_organos1,array()); 
   
    $permid_idtabla=$rs_listarecetas->fields["plantrai_id"];
	$permid_tabla="pichinchahumana_extension.dns_cardiodisposiexterno";
	$permid_acepta=1;
	$permid_motivo="INGRESO_ANTERIOR_SOPORTE_SISTEMA";
	$permid_fecharegistro=date("Y-m-d H:i:s");
	$usua_id=$usua_id_vl;
  ...
  //borra permisos anteriores
   ...
   $inserta_rastro="insert into pichinchahumana_extension.dns_cambiofecharegistro (cbfech_tabla,cbfech_idvalor,cbfech_fecharegistroanterior,cbfech_fecharegistronueva,cbfech_motivo,cbfech_fechacambio,usua_id) values ('dns_cardiologiaconsultaexterna','".$id_valor."','".$fecha_anterior."','".$nueva_fecha."','".$ttext_motivo."','".date("Y-m-d H:i:s")."','".$_SESSION['datadarwin2679_sessid_inicio']."')";
