...
<div align="center">
         ...
         <div class="col-xs-12">
          ...
          <div id="guardab_btn" >
			<!-- <button type="submit" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" >GUARDAR '.strtoupper($rs_tabla->fields["tab_title"]).'</button> -->
			<button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" onclick="busca_pregistradoguarda()" >GUARDAR '.strtoupper($rs_tabla->fields["tab_title"]).'</button>
          </div>
...
<button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_facturas.php','Perfil','divBody_ext',0,'<?php echo $_POST["pVar2"]; ?>',0,0,0,0,0)" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span> Regresar </button>

<?php

$comill_s="'";
$linkeditar= 'onClick="ver_formularioenpantalla('.$comill_s.'aplicativos/documental/datos_cabecera.php'.$comill_s.','.$comill_s.'MEDICOS'.$comill_s.','.$comill_s.'divBody_ext'.$comill_s.','.$comill_s.$comill_s.','.$comill_s.$_POST["pVar2"].$comill_s.',0,0,0,0,0)" style=cursor:pointer';	

echo '&nbsp;&nbsp;&nbsp;<button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary"  '.$linkeditar.'  style="background-color:#000066"  ><span class="glyphicon glyphicon-plus"></span>NUEVA FACTURA</button>';
...
else
{
	...
	echo $_POST["pVar2"];
   $varable_enviafunc='';
   $varable_enviafunc=base64_encode("ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_facturas.php','Perfil','divBody_ext','','".$_POST["pVar2"]."',0,0,0,0,0)");
