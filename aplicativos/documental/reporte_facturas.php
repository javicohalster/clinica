...
if($su_quito==2)
{
 ...
 $lista_servicios="select * from beko_documentocabecera  cab inner join beko_documentodetalle detall on cab.doccab_id=detall.doccab_id where doccab_fechaemision_cliente>='".$desde_val."' and doccab_fechaemision_cliente<='".$hasta_val."' and doccab_ndocumento like '".$fact_val."%' order by doccab_ndocumento asc";
