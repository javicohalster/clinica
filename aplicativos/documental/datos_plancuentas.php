...
<div align="center">
		 <div class="form-group">
         <div class="col-xs-12"><div id="boton_guardarformdatapc">
...
<div align="center">
		 <div class="form-group">
         <div class="col-xs-12"><div id="boton_guardarformdata2pc">
			<button type="button" class="mb-sm btn btn-primary" onclick="enviar_formulariodata('.$comillasimple.'form_'.$table.$comillasimple.')"  > GRABAR  </button>
		</div></div>
		</div>
...
function genera_ordenamiento()
{
   $("#divBody_ordenamiento").load("aplicativos/documental/plandecuentas/ordenarcuenta.php",{
 
  },function(result){  

      desplegar_grid_plancuentas();
	   
  });  
  $("#divBody_ordenamiento").html("Espere un momento");  
...
<div id="divBody_ordenamiento"></div>