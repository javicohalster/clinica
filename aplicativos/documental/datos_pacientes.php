...
$busca_dataus="select * from app_usuario where usua_id='".$_SESSION['datadarwin2679_sessid_inicio']."'";
$rs_dataus = $DB_gogess->executec($busca_dataus,array());
$conve_id_us=$rs_dataus->fields["conve_id"];
$envia_ac='';
if($conve_id_us==2)
{
  $envia_ac=" ver_formularioenpantalla('aplicativos/documental/datos_pacientes.php','PACIENTES','divBody_ext','','25',0,0,0,0,0);
   alert('Registro guardado el formulario se limpiara para un nuevo registro...');";
}	  
...
<button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" onclick="ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_pacientes.php','Perfil','divBody_ext',0,'<?php echo $_POST["pVar2"]; ?>',0,0,0,0,0)" style="cursor:pointer"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;&nbsp;&nbsp;Regresar a Lista Pacientes</button>

<?php
if($conve_id_us==2)
{
echo "<div style='color:#FF0000' ><b>ALERT!!!: SI USTED ES USUARIO MEDICOMPANIES AL COLOCAR GUARDAR SE LE ACTUALIZAR LA PAGINA PARA EVITAR REGISTROS DUPLICADOS</b></div>";
}
?>
<p></p>
