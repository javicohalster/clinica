...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnemergenciaanamnesis.php','Editar','divBody_ext','','".@$clie_id."','140','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnemergenciasubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'141',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";

$linksubsecuente="onClick=abre_formulariosecundario()";

echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button style="width:210px" type="button" class="mb-sm btn btn-primary" '.$linksubsecuente.'  style="cursor:pointer">  <span class="glyphicon glyphicon-list"></span> EVOLUCI&Oacute;N Y PRESCRIPCIONES </button>';
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnemergenciasubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','141','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
...
function genera_pdf()
{
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {	 
	    window.open("pdfformularios/pdformularioemergencia.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val(), '_blank')
		//location.href = "pdfformularios/pdformularioemergencia.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val();
	 }
	 else
	 {
       alert("Por favor guarde el resgistro para imprimir");	 
