...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewgastroenterologiaanamnesis.php','Editar','divBody_ext','','".@$clie_id."','208','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewgastroenterologiasubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'209',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";
...
$linkeditar= 'onClick=abrir_laboratorionewk();';
echo '&nbsp;&nbsp;<a href="javascript:abrir_laboratorionewk();"><img src="images/labiconnew.png?dtt='.date("his").'">.<span class="selected"></span></a>';
...
function abrir_laboratorionewk()
{
   if($('#<?php echo $campo_primario; ?>').val()=='')
   {
     alert("Guarde el registro para hacer el pedido de laboratorio");
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewgastroenterologiasubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','209','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
