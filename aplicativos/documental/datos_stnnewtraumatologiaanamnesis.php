...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewtraumatologiaanamnesis.php','Editar','divBody_ext','','".@$clie_id."','201','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewtraumatologiasubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'202',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";
...
$linkeditar= 'onClick=abrir_laboratorionewt();';
echo '&nbsp;&nbsp;<a href="javascript:abrir_laboratorionewt();"><img src="images/labiconnew.png?dtt='.date("his").'">.<span class="selected"></span></a>';
...
function abrir_laboratorionewt()
{
   if($('#<?php echo $campo_primario; ?>').val()=='')
   {
     alert("Guarde el registro para hacer el pedido de laboratorio");
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewtraumatologiasubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','202','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
