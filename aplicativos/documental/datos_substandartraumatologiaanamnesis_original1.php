...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_substandartraumatologiaanamnesis.php','Editar','divBody_ext','','".@$clie_id."','107','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_substandartraumatologiasubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'108',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";
...
$linkcambior="onclick=abrir_standar('aplicativos/documental/cambio_fecha.php','CAMBIO','divBody_foto','divDialog_foto',500,300,'traumatologia',$('#anam_id').val(),0,0,0,0,0) style='cursor:pointer'";
//echo '&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-warning" '.$linkcambior.'  style="cursor:pointer"> CAMBIAR FECHA REGISTRO </button>';

$linkhistorialr="onclick=abrir_standar('aplicativos/documental/historial_fecha.php','CAMBIO','divBody_foto','divDialog_foto',790,300,'traumatologia',$('#anam_id').val(),0,0,0,0,0) style='cursor:pointer'";
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_substandartraumatologiasubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','108','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
  ...
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {
	    ...
	    location.href = "pdfformularios/pdformulariotraumatologia.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val();
	 }
	 else
	 {
       alert("Por favor guarde el resgistro para imprimir"); 	 
