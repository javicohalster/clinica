...
{
$busca_sihaydata="select * from ".$table." where labinfor_cuenta=".$cuenta_info." and ".$rs_tablaprimaria->fields["tab_campoprimario"]."=?";
...
if($table=='dns_newlaboratorioinforme')
{
$busca_sihaydata="select * from ".$table." where labinfor_cuenta=".$cuenta_info." and ".$rs_tablaprimaria->fields["tab_campoprimario"]."=?";
$rs_sihaydata = $DB_gogess->executec($busca_sihaydata,array(@$_POST["pVar7"]));
}
...
<div class="form-group">
    ...
    <div class="col-md-6">
	      ...
	      <button type="button" class="mb-sm btn btn-primary" onclick="ver_formularioenpantalla('aplicativos/documental/datos_substandarformdoble.php','DOBLE','divBody_ext','<?php echo $_POST["pVar7"]; ?>','<?php echo @$clie_id; ?>','<?php echo $mnupan_id; ?>','<?php echo $atenc_id; ?>',0,0,0)" style="cursor:pointer"><span class="glyphicon glyphicon-plus"></span><?php echo utf8_encode($rs_tablaprimaria->fields["tab_title"]); ?></button>
...
if($table=='dns_newlaboratorioinforme')
{
  $linkpdf="pdfnewlaboratorioinforme";
