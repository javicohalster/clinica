...
<table width="100" border="1" cellpadding="2" cellspacing="0">
  <tr>
    ...
    <td><span class="arplano">nombre_cliente</span></td>
	 <td><span class="arplano">apellido_cliente</span></td>
...
$solo_fecha=explode(" ",$rs_data->fields["doccab_fechaemision_cliente"]);
 ...
 $rs_medico = $DB_gogess->executec($busca_medico,array());
  ...
  <tr>
    ...
    <td nowrap="nowrap"><span class="arplano"><?php echo utf8_encode($rs_data->fields["doccab_nombrerazon_cliente"]);  ?></span></td>
	<td nowrap="nowrap"><span class="arplano"><?php echo utf8_encode($rs_data->fields["doccab_apellidorazon_cliente"]);  ?></span></td>
	<td nowrap="nowrap"><span class="arplano"><?php echo utf8_encode($rs_data->fields["doccab_direccion_cliente"]);  ?></span></td>
    <td nowrap="nowrap"><span class="arplano"><?php echo $rs_data->fields["docdet_codprincipal"];  ?></span></td>
    <td nowrap="nowrap"><span class="arplano"><?php echo utf8_encode($rs_data->fields["docdet_descripcion"]);  ?></span></td>
    ...
    <td nowrap="nowrap"><span class="arplano"><?php echo $rs_data->fields["doccab_clavedeaccesos"];  ?></span></td>
