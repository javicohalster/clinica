...
$solo_fecha=explode(" ",$rs_data->fields["doccab_fechaemision_cliente"]);
 ...
 $rs_medico = $DB_gogess->executec($busca_medico,array());
  ...
  $documento.='<tr>
	...
	<td nowrap="nowrap"><span class="arplano">'.utf8_encode($rs_data->fields["doccab_apellidorazon_cliente"]).'</span></td>
    ...
    <td nowrap="nowrap" style=mso-number-format:"@" ><span class="arplano">'.$rs_data->fields["doccab_clavedeaccesos"].'</span></td>
