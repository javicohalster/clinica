...
<?php
$linkapaciente="onClick=ver_formularioenpantallaextendida('aplicativos/documental/opciones/panel/panel_stnepicrisisanamnesis.php','Editar','divBody_ext','','".@$clie_id."','125','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."',0,0,0,'".$protoop_idenlace."','".$protoop_tblprincipal."');";
