...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewhospitalizacionanamnesis.php','Editar','divBody_ext','','".@$clie_id."','210','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewhospitalizacionsubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'211',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";

$linksubsecuente="onClick=abre_formulariosecundario()";

echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button style="width:380px" type="button" class="mb-sm btn btn-primary" '.$linksubsecuente.'  style="cursor:pointer">  <span class="glyphicon glyphicon-list"></span> SUBSECUENTES EVOLUCI&Oacute;N Y PRESCRIPCIONES </button>';
...
$linkeditar= 'onClick=abrir_laboratorionew();';
//echo '&nbsp;&nbsp;&nbsp;<button type="button" class="mb-sm btn btn-primary"  '.$linkeditar.'  style="background-color:#000066"  ><span class="glyphicon glyphicon-plus"></span>PEDIDOS DE LABORATORIO</button>';
echo '&nbsp;&nbsp;<a href="javascript:abrir_laboratorionew();"><img src="images/labiconnew.png?dtt='.date("his").'">.<span class="selected"></span></a>';
...
//$link_protocolo='ver_formularioenpantallaextendida(\'aplicativos/documental/opciones/panel/panel_substandarnewprotocolooperatorio.php\',\'Perfil\',\'divBody_ext\',\'\',\''.$clie_id.'\',\'127\',\''.$atenc_id.'\',0,\'0\',\''.$centro_id.'\',0,0,0,$(\'#'.$campo_primario.'\').val(),\''.$table.'\')';
$link_protocolo='ver_formularioenpantallaextendida(\'aplicativos/documental/opciones/panel/panel_substandarnewprotocolooperatorio.php\',\'Perfil\',\'divBody_ext\',\'\',\''.$clie_id.'\',\'213\',\''.$atenc_id.'\',0,\'0\',\''.$centro_id.'\',0,0,0,$(\'#'.$campo_primario.'\').val(),\''.$table.'\')';
...
//$link_protocolo='ver_formularioenpantallaextendida(\'aplicativos/documental/opciones/panel/panel_stnnewepicrisisanamnesis.php\',\'Perfil\',\'divBody_ext\',\'\',\''.$clie_id.'\',\'125\',\''.$atenc_id.'\',0,\'0\',\''.$centro_id.'\',0,0,0,$(\'#'.$campo_primario.'\').val(),\''.$table.'\')';
   $link_protocolo='ver_formularioenpantallaextendida(\'aplicativos/documental/opciones/panel/panel_stnnewepicrisisanamnesis.php\',\'Perfil\',\'divBody_ext\',\'\',\''.$clie_id.'\',\'214\',\''.$atenc_id.'\',0,\'0\',\''.$centro_id.'\',0,0,0,$(\'#'.$campo_primario.'\').val(),\''.$table.'\')';
...
function abrir_enfermeria()
{
  ...
  $link_protocolo='ver_formularioenpantallaextendida(\'aplicativos/documental/opciones/panel/panel_substandarformularios.php\',\'Perfil\',\'divBody_ext\',\'\',\''.$clie_id.'\',\'66\',\''.$atenc_id.'\',0,\'0\',\''.$centro_id.'\',0,0,0,$(\'#'.$campo_primario.'\').val(),\''.$table.'\')';
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_stnnewhospitalizacionsubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','211','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
...
function genera_pdf()
{
  if($('#<?php echo $campo_primariodata; ?>').val()>0)
	 {	 
	    location.href = "pdfformularios/pdformularionewhospitalizacion.php?ssr=<?php echo $campos_data64."|" ?>"+$('#<?php echo $campo_primariodata; ?>').val();
	 }
	 else
	 {
       alert("Por favor guarde el resgistro para imprimir");	 
