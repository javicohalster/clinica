...
<div class="col-xs-2">
Desde:<input name="desde_val" type="text" id="desde_val">
</div>

<div class="col-xs-2">

Desde:<input name="hasta_val" type="text" id="hasta_val">
</div>
...
<div class="col-xs-2">&nbsp;<br />
<input type="button" name="Submit2" value="Reporte por Area" onClick="ver_reportexarea()" style="width:150px" >
</div>
