...
function genera_asientoanticipobanco()
{
 
   var urlasiento;
   urlasiento='';
   
	urlasiento='aplicativos/documental/asientos/bancos/ejecuta_anticipobanco.php';	
	

   $("#asiento_cm2").load(urlasiento,{
  ...
  $("#asiento_cm2").html("Espere un momento");  
