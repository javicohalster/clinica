...
<div align="center">
         ...
         <div class="col-xs-12"><div id="boton_guardarformdata">
			<button type="button" class="fs-5 btn bg-gradient-dark mb-0 btn btn-primary" onclick="enviar_formulariodata('.$comillasimple.'form_'.$table.$comillasimple.')"  > GRABAR  </button>
		</div></div>
		</div>
                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 panel-heading">
                            <h3 class="text-white text-capitalize ps-3 panel-title" style="color:#000033">
                                <?php echo $titulo_formualario; ?></h3>
                        </div>
                    </div>
...
echo '<div class="ms-3 pe-md-3 align-items-center">';
...
$("#lab_fechasolicitud").datepicker({
    dateFormat: 'yy-mm-dd'
});
$("#lab_fechatoma").datepicker({
    dateFormat: 'yy-mm-dd'
});
...
function imprimir_datos() {
    if ($('#<?php echo $campo_primariodata; ?>').val() > 0) {
        myWindow3 = window.open(
            'aplicativos/documental/datos_substandarformunico_print.php?iddata=<?php echo $tab_id ?>&pVar2=<?php echo @$clie_id; ?>&pVar4=<?php echo $atenc_id; ?>&pVar5=<?php echo $eteneva_id; ?>&pVar3=<?php echo $mnupan_id; ?>&pVar9=' +
            $('#<?php echo $campo_primariodata; ?>').val(), 'ventana_reporteunico',
...
function genera_pdf() {
    if ($('#<?php echo $campo_primariodata; ?>').val() > 0) {
        location.href = "pdfformularios/pdformulariohospital.php?ssr=<?php echo $campos_data64."|" ?>" + $(
            '#<?php echo $campo_primariodata; ?>').val();
    } else {
        alert("Por favor guarde el resgistro para imprimir");
    }
...
function genera_asientomb() {

    var urlasiento;
    urlasiento = '';

    urlasiento = 'aplicativos/documental/asientos/bancos/ejecuta_movimientobanco.php';


    $("#asiento_cm").load(urlasiento, {
    ...
    $("#asiento_cm").html("Espere un momento");
