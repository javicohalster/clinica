<table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><input type="button" name="Button2" value="Quitar Anulado" onClick="qanular_registro()"></td>
  </tr>
</table>
...
if (confirm("Esta seguro que desea anular este recibo?"))
{ 


   $("#grid_anu").load("aplicativos/documental/anularrecibo.php",{

    doccab_id:'<?php echo $_POST["pVar1"]; ?>',
...
{ 
   ...
   $("#grid_anu").load("aplicativos/documental/qanularrecibo.php",{
