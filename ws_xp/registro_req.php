...
if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS') {
	...
	foreach ($req_data as $row) {
	   ...
	   if(in_array(utf8_encode($row["catag_nombre"]), $categorias))
	   {
...
$query = $db->prepare("INSERT INTO app_requerimiento (usua_id, requ_observacion, requ_categoria, tiempres_id, pais_id, cant_id, requ_sector, requ_barrio, requ_paracuando, fpagcl_id, provee_id, requ_grafico, requ_estado, requ_fecharegistro) VALUES (:usua_id,:requ_observacion,:requ_categoria,:tiempres_id,:pais_id,:cant_id,:requ_sector,:requ_barrio,:requ_paracuando,:fpagcl_id,:provee_id,:requ_grafico,:requ_estado,:requ_fecharegistro)");
