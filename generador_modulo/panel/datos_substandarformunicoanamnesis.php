...
<?php
$linkapaciente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_substandarformunicoanamnesis.php','Editar','divBody_ext','','".@$clie_id."','-principal-','".$atenc_id."',0,'".$tipofor_id."','".$centro_id."');";
...
$linksubsecuente="onClick=ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_substandaranamnesissubsecuente.php','Perfil','divBody_ext','',".$clie_id.",'-subsecuente-',".$atenc_id.",0,'".$tipofor_id."',".$centro_id.");";
...
function  abre_formulariosecundario()
{
  if($('#<?php echo $campo_primario; ?>').val()>0)
   {
     ver_formularioenpantalla('aplicativos/documental/opciones/panel/panel_substandaranamnesissubsecuente.php','SECUNDARIO','divBody_ext',0,'<?php echo @$clie_id; ?>','-subsecuente-','<?php echo $atenc_id; ?>','<?php echo $tipofor_id; ?>',$('#<?php echo $campo_primario; ?>').val(),'<?php echo $centro_id; ?>');
