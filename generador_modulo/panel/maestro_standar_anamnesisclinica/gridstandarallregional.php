...
<b>R</b>= REGIONAL <b>S</b>= SISTEMICO,  <b>CP</b> = CON EVIDENCIA DE PATOLOGIA, <b>SP</b> = SIN EVIDENCIA DE PATOLOGIA 
...
if($rs_lvalcombo)
{
	  ...
	  $camidcl='';
	  if($fie_tablasubgrid=='pichinchahumana_extension.dns_gridorgano')
      {
	    $camidcl='opcorg_id';
	  }
	  else
