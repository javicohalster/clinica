...
myWindow4=window.open('<?php echo @$pathc.$objtableform->path_templateform ?>dibujo.php?iddibujo='+iddibujo,'ventana_dibujo','width=750,height=500,scrollbars=YES');
	...
	?>
	  ...
	  <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td onclick="dibujar('<?php echo $csearch ?>')" style="cursor:pointer"><img src="<?php echo @$pathc.$objtableform->path_templateform ?>dibujo.png" width="128" height="128" border="0" /></td>
