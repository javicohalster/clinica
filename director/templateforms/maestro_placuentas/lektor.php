...
while (!feof($fp)){
       ...
       print_r($array_fila);
		...
		if(count($code_plam)==1)
		{
		  ...
		  $planc_codigoc='';
		  $insert_data="insert into lpin_plancuentas(planc_codigo,planc_codigoc,planc_nombre) values ('".$planc_codigo."','".$planc_codigoc."','".$planc_nombre."');";
		  echo $insert_data."<br>";
		...
		else
		{
		   ...
		   $planc_nombre=trim($nombre);
		   $planc_codigoc='';
		   $insert_data="insert into lpin_plancuentas(planc_codigo,planc_codigoc,planc_nombre,plancs_id) values ('".$planc_codigo."','".$planc_codigoc."','".$planc_nombre."','".$id_reg."');";
