...
<div align="center"><br />
    <br />
    <input type="button" name="Submit" value="Ver plan de cuentas" onclick="ver_plancuentas()" />	
    <br />
  <br />
    <?php        
if(@$csearch)
...
function ver_plancuentas() {
window.open('templateforms/maestro_placuentas/plan_cuentas.php','ventana1','width=750,height=500,scrollbars=YES');
