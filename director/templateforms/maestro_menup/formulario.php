...
?>
                <br /><br /> <table width="400" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td bgcolor="#C6D2E1"><div align="center"><b>GENERAR CABECERA</b> </div></td>
    </tr>
    <tr>
      <td><div align="center">
        <p>Nombre Tabla:
          <input name="n_tabla_valor" type="text" id="n_tabla_valor" />
            <input type="button" name="Button" value="Generar" onclick="genera_code();" />
        </p>
        <p><div id="id_genera"></div></p>
        <p>&nbsp; </p>
      </div></td>
    </tr>
  </table>			  </td>
...
function genera_code()
{
   ...
   window.open('templateforms/maestro_menup/generacode.php?id_inicio='+$('#n_tabla_valor').val(),'genera','width=750,height=500,scrollbars=YES');
