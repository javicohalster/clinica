...
?>  
  <tr>
	...
	<textarea name="graph_operationy<?php echo $id_val; ?>" cols="50" rows="4" id="graph_operationy<?php echo $id_val; ?>" onblur="guarda_operation('<?php echo $id_val; ?>','graph_id')" ><?php echo $operationy; ?></textarea>
...
function guarda_operation(id_val,graph_id)
{

	 $("#div_gdatosgrid").load("templateforms/maestro_standar_illustrator/goperation_val.php",{		 
	 
	  valor:$('#graph_operationy'+id_val).val(),
	  graph_id:id_val
