...
<script type="text/javascript" src="mapplic/js/hammer.min.js"></script>
...
<!--
function lista_tablas_filter()
{
  $("#div_listat_filter").load("templateforms/maestro_standar_illustrator/listat_filter.php",{},function(result){  
    
  });  
  $("#div_listat_filter").html("Wait a moment...");
...
function lista_campos_filter()
{

  $("#div_listac_filter").load("templateforms/maestro_standar_illustrator/listac_filter.php",{ltablas:$('#ltablas_filter').val()},function(result){  
    
	
  });  
  $("#div_listac_filter").html("Wait a moment...");
...
function agrega_groupX()
{
   if($('#lcampos').val()==null)
	...
	dato_val=$('#lcampos option:selected').html()+",";
	id_val=$('#lcampos option:selected').val()+",";
	
	$('#x_group').html(dato_val);
	$('#x_group_id').val(dato_val);
...
function quitar_camposY()
{
	...
	$('#graph_labelformula_label').html('');
	$('#graph_labelformula').html('');
	$('#graph_formula').html('');
...
function ver_grafico()
{
	...
	//alert($('#graph_formula').val());
	var fechas_bus;
	
	fechas_bus=$('#date_start').val()+"|"+$('#date_end').val()+"|"+$('#graph_decimals').val()+"|"+$('#scale_min').val()+"|"+$('#scale_max').val();
	
	
	abrir_pantalla("templateforms/maestro_standar_illustrator/panel_grafico.php","GRAPH","divBody_grafico","divDialog_grafico",800,500,$('#x_campo_id').val(),$('#y_campo_id').val(),$('#typeg_name').val(),$('#script_data').val(),$('#x_group_id').val(),$('#graph_formula').val(),fechas_bus);
	
}


function ver_grafico_eject(x_campo_id,y_campo_id,typeg_name,x_group_id,graph_formula,graph_decimals,scale_min,scale_max)
{
	var fechas_bus;
	
	fechas_bus=$('#date_start').val()+"|"+$('#date_end').val()+"|"+graph_decimals+"|"+scale_min+"|"+scale_max;
	abrir_pantalla("templateforms/maestro_standar_illustrator/panel_grafico.php","GRAPH","divBody_grafico","divDialog_grafico",800,500,x_campo_id,y_campo_id,typeg_name,'',x_group_id,graph_formula,fechas_bus);
...
function grid_graph(opcion,graph_id)
{
	...
	//alert($('#x_group_id').val());
	 ...
	 graph_formula:$('#graph_formula').val(),
	 graph_decimals:$('#graph_decimals').val()
...
abrir_pantalla("templateforms/maestro_standar_illustrator/opy.php","Y_OP","divBody_grafico","divDialog_grafico",700,400,$('#graph_labelformula').val(),0,0,0,0,0,0);
...
function add_filter()
{
	...
	var dato_val=$('#varillu_fieldfilter').val();
	
	dato_val=dato_val+$('#lcampos_filter option:selected').html()+",";
	
	$('#varillu_fieldfilter').val(dato_val);
...
function add_grupo()
{
	...
	var dato_val=$('#varillu_fieldgroup').val();
	
	dato_val=$('#lcampos_filter option:selected').html()+","+dato_val;
	
	$('#varillu_fieldgroup').val(dato_val);
	
}

function quitar_grupo()
{
	$('#varillu_fieldgroup').val('');
...
<label for="textfield">Scale min:</label>
<input type="text" name="scale_min" id="scale_min" value="0">

<label for="textfield">Scale max:</label>
<input type="text" name="scale_max" id="scale_max" value="0" > 
              ...
              <table width="700px" border="0" cellpadding="0" cellspacing="2">    
                  ...
                  <td width="292" rowspan="2" valign="top">
                    ...
                    <div id=div_listaag >
                      <table width="350" height="226" border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                          <td height="146" bgcolor="#FFFFFF" class="borde_tabla" ><input name="y_campo" type="hidden" id="y_campo_id" value="" /><div id="y_campo" class="texto-vertical-2" ></div>
                          
                          <input name="graph_formula" type="hidden" id="graph_formula" value="" />
                          <input name="graph_labelformula" type="hidden" id="graph_labelformula" value="" />
                          <div id="graph_labelformula_label" class="texto-vertical-2" ></div>
						  
						  <input name="graph_decimals" type="hidden" id="graph_decimals" value="" />
                ...
                <tr>
                  ...
                  <td width="39" valign="top">
                    ...
                    <br />
                    <input type="button" name="Submit2" value="Add [Y] Ope" onclick="add_yop()" style="width:100px" />
                    <br />
    ...
    <table width="700px" border="0" cellpadding="2" cellspacing="1">
          ...
          <tr>
            <td>
              ...
              <table width="700px" border="0" cellpadding="0" cellspacing="2">    
                <tr>
                  <td valign="top"><input type="button" name="Submit" value="See tables" onclick="lista_tablas_filter()" /></td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top">&nbsp;</td>
                  <td width="292" rowspan="2" valign="top">
...
?>
                ...
                <tr>
                  <td width="227" valign="top">
                    <div id="div_listat_filter" >
                      <select name="ltablas_filter" size="10" id="ltablas_filter">
                        </select>
                    </div>                </td>
                  <td width="185" valign="top">
                    <div id="div_listac_filter" >
                      <select name="lcampos_filter" size="10" id="lcampos_filter">
                        </select>
                      </div>
                    </td>
                  <td width="39" valign="top">
                      ...
                      <input id="typeg_name"  name="typeg_name" type="hidden" value="0" />
                    <br />
                    <input type="button" name="Submit2" value="Add [Filter]" onclick="add_filter()" style="width:150px" />
                    
                    <br />
                    <input type="button" name="Submit2" value="Add [Group]" onclick="add_grupo()" style="width:150px" />
                    <br />
                    <input type="button" name="Submit2" value="Remove [Filter]" onclick="quitar_filtro()" style="width:150px" />
                    <br />
                    <input type="button" name="Submit2" value="Remove [Group]" onclick="quitar_grupo()" style="width:150px"/>
                    <br />
                    <br />
                    <br />
