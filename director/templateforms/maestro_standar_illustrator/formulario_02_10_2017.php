              ...
              <table width="700px" border="0" cellpadding="0" cellspacing="2">    
                <tr>
                  ...
                  <td width="292" rowspan="2" valign="top">
                    ...
                    <div id=div_listaag >
                      <table width="200" height="200" border="0" cellpadding="2" cellspacing="2">
                        <tr>
                ...
                <tr>
                  ...
                  <td width="39" valign="top">
                    <select name="typeg_name" size="1" id="typeg_name" style="width:100px" >
                      <option value="0">-type graph-</option>
                      <?php
					  $objformulario->fill_cmb("rose_typegraph","typeg_name,typeg_name",@$vbus,@$orden,$DB_gogess);		  
					  ?>
                      </select>
                    <br />
