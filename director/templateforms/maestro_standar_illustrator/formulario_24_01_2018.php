...
function ver_grafico()
{
	...
	fechas_bus=$('#date_start').val()+"|"+$('#date_end').val()+"|"+$('#graph_decimals').val();
...
function ver_grafico_eject(x_campo_id,y_campo_id,typeg_name,x_group_id,graph_formula,graph_decimals)
{
	var fechas_bus;
	
	fechas_bus=$('#date_start').val()+"|"+$('#date_end').val()+"|"+graph_decimals;
