...
$listatablas="select * from gogess_sistable where instan_id=2";
              ...
              <select name="ltablas" size="10" id="ltablas" onclick="lista_campos()" >
				...
				<?php
					...
					{  
					  ...
					  echo '<option value="'.$resultlistat->fields["tab_name"].'">'.utf8_encode($resultlistat->fields["tab_title"]).'</option>';
