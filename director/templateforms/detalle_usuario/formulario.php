...
?></td>
			   ...
			   ?>
			     <label>
			     <input type="button" name="Submit" value="RESET CLAVE" onclick="resetclv('<?php echo $csearch; ?>')" />
			     </label>	
...
function resetclv(idv)
{

   $("#clv_panel").load("templateforms/detalle_usuario/clvreset.php",{
    idv:idv
