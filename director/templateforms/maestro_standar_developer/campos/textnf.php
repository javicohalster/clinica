		  ...
		  else
           {
			 ...
			 echo $this->fie_title." ".$this->fie_txtizq."<input name='".$nombre_campo."' type='text' class='".$this->fie_styleobj."'  value='".$this->sendvar[$this->fie_sendvar]."' maxlength='".$len."' ".$this->fie_attrib." size='".$this->fie_lencampo."'  >".$this->fie_txtextra;
             ...
             else
              {
				...
				{
                   echo $this->fie_title." Desde:".$this->fie_txtizq."<input name='".$nombre_campo."' type='text' class='".$this->fie_styleobj."'  value='".$this->fie_value."' maxlength='".$len."' ".$this->fie_attrib." size='7' >".$this->fie_txtextra;
				   
				   echo "Hasta: <input name='".$nombre_campo."2' type='text' class='".$this->fie_styleobj."'  value='".$this->fie_value."' maxlength='".$len."' ".$this->fie_attrib." size='7' >".$this->fie_txtextra;
