...
{
   myWindow3=window.open('templateforms/detalle_grupos/verreporte.php?ireport='+irep,'ventana_reporte','width=850,height=700,scrollbars=YES');
   myWindow3.focus();
...
?></td>
   ...
   if(@$csearch)
	...
	?>
	  <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td onclick="ver_reporte('<?php echo @$csearch; ?>')" style="cursor:pointer"><img src="images/reportg.png" width="100" height="100" /></td>
        </tr>
      </table>	
	 <?php
	 }
