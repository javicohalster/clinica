...
$busca_empresa=$objformulario->replace_cmb("app_usuario","usua_id,emp_id","where usua_id=",@$listab,$DB_gogess);
...
$objformulario->sendvar["horax"]=date("h:i:s");
			 ...
			 $objformulario->sendvar["emp_idx"]=$busca_empresa;
...
showUser_combog('estbl_id',$('#emp_id').val(),'divestbl_id','emp_id','app_usuario_caja','',0,0,0,0,0);
