...
function lista_articulos()
{
	...
	$("#lista_art").load("templateforms/detalle_capitulos/lista_articulos.php",{
	tmojcapitulos_codigo:'<?php echo $objformulario->contenid["tmojcapitulos_codigo"] ?>'
  },function(result){  

  });  
    $("#lista_art").html("Espere un momento...");  
...
{
	$("#procesar_art").load("templateforms/detalle_capitulos/procesar_articulos.php",{
	tmojcapitulos_codigo:'<?php echo $objformulario->contenid["tmojcapitulos_codigo"] ?>'
  },function(result){  
    lista_articulos();
  });  
    $("#procesar_art").html("Espere un momento..."); 
...
?></td>
	...
	?>
    <div id="procesar_art" ></div>
      <table width="300" border="0" cellpadding="2" cellspacing="2">
        <tr>
          <td bgcolor="#CAD2D9">LISTA ARTICULOS</td>
          <td bgcolor="#CAD2D9"><input type="button" name="button" id="button" value="Procesar" onclick="procesar_articulos()" /></td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#DEE2E7">
