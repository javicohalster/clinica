			  ...
			  $rs_grid = $DB_gogess->Execute($selecTabla); 
				 ...
				 if($rs_grid)
				 {
						...
						{										
							...
							$this->fie_name=$rs_grid->fields[maymin("fie_name")];
			...
			function form_format_field($table,$field,$DB_gogess)
{
  ...
  $rs_gogessform = $DB_gogess->Execute($selecTabla);
     	while (!$rs_gogessform->EOF) {				
				...
				if(trim($rs_gogessform->fields[$this->maymin("tab_campoprimario")]))
				{
				$this->tab_campoprimario=trim($rs_gogessform->fields[$this->maymin("tab_campoprimario")]);
			 ...
			 if ($rs_grt)
			   {
				   ...
				   while ($i < $ncampos) 
						...
						if($this->tab_campoprimario)
						{
						 $campo_primario=$this->tab_campoprimario;
           ...
           if(!($this->listab))
		   {
					 ////////////////////////////////
					  ...
					  else
					  {
					   ...
					   $datos="select * from ".$this->tabla." order by ".$this->tab_campoprimario." desc";		
					   $datoscompleto="select * from ".$this->tabla." order by ".$this->tab_campoprimario." desc";	
					  }
					 ///////////////////////////////////// 
			  }
			  else
