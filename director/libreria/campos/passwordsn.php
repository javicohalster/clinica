		  ...
		  if (!($this->contenid[$nombre_campo]==""))
           {
			...
			if($this->fie_inactivoftabla)
			{
			 ...
			 <input name="'.$nombre_campo.'"  id="'.$nombre_campo.'"  type="password" class="'.$this->fie_styleobj.'"  value="'.$this->contenid[$nombre_campo].'" maxlength="'.$len.'" '.$this->fie_attrib.' size="'.$this->fie_lencampo.'" >
			 '.$this->txtobligatorio.'</td>			 
			 ...
			 <td valign="top" class="'.$this->fie_style.'" >'.$this->fie_txtizq.'</td>
			 <td valign="top" class="'.$this->fie_style.'" nowrap="nowrap" >
			 <input name="'.$nombre_campo.'1"  id="'.$nombre_campo.'1"  type="password" class="'.$this->fie_styleobj.'"  value="'.$this->contenid[$nombre_campo].'" maxlength="'.$len.'" '.$this->fie_attrib.' size="'.$this->fie_lencampo.'" >
			 '.$this->txtobligatorio.'</td>			 
			 <td><div  id="'.$nombre_campo."_despliegue".'1" ></div></td>
			 <td class="'.$this->fie_style.'" >'.$this->fie_txtextra.'</td>			
			 </tr>';		 
          ...
          else
           {
			 ...
			 if($this->fie_inactivoftabla)
			{
			 ...
			 <td valign="top" class="'.$this->fie_style.'" >'.$this->fie_txtizq.'</td>
			 <td valign="top" class="'.$this->fie_style.'" nowrap="nowrap" >
			 <input name="'.$nombre_campo.'"  id="'.$nombre_campo.'"  type="password" class="'.$this->fie_styleobj.'"  maxlength="'.$len.'" '.$this->fie_attrib.' size="'.$this->fie_lencampo.'" >
			 '.$this->txtobligatorio.'</td>			 
			 <td><div  id="'.$nombre_campo."_despliegue".'" ></div></td>
			 <td class="'.$this->fie_style.'" >'.$this->fie_txtextra.'</td>		
			 </tr>';
			 ...
			 <td valign="top" class="'.$this->fie_style.'" >'.$this->fie_txtizq.'</td>
			 <td valign="top" class="'.$this->fie_style.'" nowrap="nowrap" >
			 <input name="'.$nombre_campo.'1"  id="'.$nombre_campo.'1"  type="password" class="'.$this->fie_styleobj.'"  maxlength="'.$len.'" '.$this->fie_attrib.' size="'.$this->fie_lencampo.'" >
			 '.$this->txtobligatorio.'</td>			 
			 <td><div  id="'.$nombre_campo."_despliegue".'1" ></div></td>
			 <td class="'.$this->fie_style.'" >'.$this->fie_txtextra.'</td>		
			 </tr>';
