 ...
 if (!($this->imprpt))
	   ...
	   //No impresión
			...
			echo '<div id="txtHint'.$nombre_campo.'" style="float:left">			 
			 ...
			 <div id=bt style=float:left><input name="oc'.$nombre_campo.'"  type="Button" value="Subir..." onClick=subirarchiv("'.$nombre_campo.'") class='.$this->fie_styleobj.'> </div><a href="'.$this->em_patharchivo.$this->contenid[$nombre_campo].'" target="_blank" rel="lytebox"  ><img src="libreria/campos/imgtxtarchivo/descarga.jpg" width="20" height="21" border="0"></a>			 
			 '.$this->fie_txtextra.'';
			}
			else
			{
