...
$ingresadom='';
$porcentaje='';
	  $listac_idm="select count(*) as total,tipoing_id,mate_id from media_causasdet inner join media_causascab on media_causasdet.caucab_id=media_causascab.caucab_id where 	year(caudet_fechaingreso)='".trim($datos_val[0])."' group by tipoing_id,mate_id";
...
$p->SetTitle("Resultados por materia");
