...
$objformulario->sistable_arr=$gogess_sistable;
 ...
 $data_xmlfirmado=trim($resultlistat->fields["compra_xmlfirmado"]);
 $doccab_estadosri=trim($resultlistat->fields["compra_estadosri"]);
 
 $doccab_nautorizacion=trim($resultlistat->fields["compra_autorizacion"]);
 $doccab_fechaaut=trim($resultlistat->fields["compra_fechaaut"]);
 ...
 header("Content-Disposition: attachment; filename="."LQ".$compra_nfactura.".xml");
 echo $xml_rest;
}
