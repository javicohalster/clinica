		  ...
		  if (!(@$this->contenid[$nombre_campo]==""))
		  ...
		  else
           {
			...
			{			 
			 ...
			 echo'<div class="col-xs-5" align="right" ><b>'.$this->fie_title.' '.$this->fie_txtizq.$this->txtobligatorio.'</b></div>';
			 echo '<div class="col-xs-5">';
			 echo '<input  name="'.$nombre_campo.'" id="'.$nombre_campo.'" type="hidden" class="'.$this->fie_styleobj.'"  value="'.$this->sendvar[$this->fie_sendvar].'" >';
			...
			else
			{
			 ...
			 echo'<div class="col-xs-5" align="right" ><b>'.$this->fie_title.' '.$this->fie_txtizq.$this->txtobligatorio.'</b></div>';
			 echo '<div class="col-xs-5">';
			 echo '<input  name="'.$nombre_campo.'" id="'.$nombre_campo.'" type="hidden" class="'.$this->fie_styleobj.'"  value="'.$this->fie_value.'" >';
			 echo $this->fie_value;
             echo '</div>';
			 echo '<div class="col-xs-1">';
			 echo '<div  id="'.$nombre_campo."_despliegue".'" ></div>';
