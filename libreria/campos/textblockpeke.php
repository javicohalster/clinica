		  ...
		  if (!(@$this->contenid[$nombre_campo]==""))
           {						
			...
			else
			{
			 ...
			 echo '<input placeholder="'.utf8_encode($placeholder).'" name="'.$nombre_campo.'" id="'.$nombre_campo.'" type="text" class="'.$this->fie_styleobj.'"  value="'.$this->contenid[$nombre_campo].'" maxlength="'.$len.'" '.str_replace("chr39","'",$this->fie_attrib).'  readonly >';
             echo '</div>';
		  ...
		  else
           {
			...
			{			 
			 ...
			 echo'<div class="col-xs-5" align="right" ><b>'.utf8_encode($this->fie_title.' '.$this->fie_txtizq.$this->txtobligatorio).'</b></div>';
			 echo '<div class="col-xs-5">';
			 echo '<input placeholder="'.utf8_encode($placeholder).'" name="'.$nombre_campo.'" id="'.$nombre_campo.'" type="text" class="'.$this->fie_styleobj.'"  value="'.$this->sendvar[$this->fie_sendvar].'" maxlength="'.$len.'" '.str_replace("chr39","'",$this->fie_attrib).' readonly >';
             echo '</div>';
			 echo '<div class="col-xs-1">';
			 echo '<div  id="'.$nombre_campo."_despliegue".'" ></div>';
			 echo '</div>'; 
			...
			else
			{
			 ...
			 echo'<div class="col-xs-5" align="right" ><b>'.utf8_encode($this->fie_title.' '.$this->fie_txtizq.$this->txtobligatorio).'</b></div>';
			 echo '<div class="col-xs-5">';
			 echo '<input placeholder="'.utf8_encode($placeholder).'" name="'.$nombre_campo.'" id="'.$nombre_campo.'" type="text" class="'.$this->fie_styleobj.'"  value="'.$this->fie_value.'" maxlength="'.$len.'" '.str_replace("chr39","'",$this->fie_attrib).'  readonly >';
             echo '</div>';
			 echo '<div class="col-xs-1">';
			 echo '<div  id="'.$nombre_campo."_despliegue".'" ></div>';
			 echo '</div>'; 
