...
if (!($this->imprpt))
				...
				if (@$this->contenid[$nombre_campo]<>"")	
      {
			...
			$comilla_s="'";
             ...
             echo '<div class="showImage'.$nombre_campo.'"><a href="'.@$this->pathext.'archivo/'.$this->contenid[$nombre_campo].'" target="_blank"><img src="'.@$this->pathext.'archivo/file.png" alt="125x125" width="70px" ></a></div>';
