       ...
       if (!(@$this->contenid[$nombre_campo]==""))
           ...
           {						
			...
			{  
			 ...
			 echo'<div class="col-xs-3" align="right" ><b>'.$this->fie_title.' '.$this->fie_txtizq.$this->txtobligatorio.'</b></div>';
...

			{
			 ...
			 echo '<div class="form-group">';
			 echo'<div class="col-xs-3" align="right"><b>'.$this->fie_title.' '.$this->fie_txtizq.'</b></div>';
			 echo '<div class="col-xs-7">';
