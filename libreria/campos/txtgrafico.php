...
if (!($this->imprpt))
				...
				if (@$this->contenid[$nombre_campo]<>"")	
      {
			...
			echo '<div id="txtHint'.$nombre_campo.'" style="float:left">			 
			 ...
			 <div id=bt style=float:left><input name="oc'.$nombre_campo.'"  type="Button" value="Subir" onClick=subirarchiv("'.$nombre_campo.'") class='.$this->fie_styleobj.'> </div><a href="'.@$this->pathext.'archivo/'.$this->contenid[$nombre_campo].'" target="_blank" ><img src="archivo/23227ZMYBY20190423.png" border="0"></a>			 
			...
			$comilla_s="'";
             ...
             echo '<div class="showImage'.$nombre_campo.'"><a href="'.@$this->pathext.'archivo/'.$this->contenid[$nombre_campo].'" target="_blank"><img src="archivo/23227ZMYBY20190423.png" alt="125x125"  ></a></div>';
		...
		{	                
		    ...
		    $rmp= '<a href="'.@$this->pathext.'archivo/'.$this->contenid[$nombre_campo].'" target="_blank"><img src="archivo/23227ZMYBY20190423.png" alt="125x125"  ></a>';	
