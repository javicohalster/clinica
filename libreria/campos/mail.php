		  ...
		  if (!($this->contenid[$nombre_campo]==""))
           {						
			...
			{			 
			 ...
			 echo '<tr bgcolor="#E0E8EB" >
			 <td valign="top" class="'.$this->fie_style.'">'.$this->fie_title.'</td>
			 <td valign="top"  >'.$this->fie_txtizq.'</td>
			 <td valign="top"  ><input name="'.$nombre_campo.'"  id="'.$nombre_campo.'" type="text" class="'.$this->fie_styleobj.'"  value="'.$this->contenid[$nombre_campo].'" maxlength="'.$len.'" '.$this->fie_attrib.' size="'.$this->fie_lencampo.'" >'.$this->txtobligatorio.'</td>			 
			 <td><div  id="'.$nombre_campo."_despliegue".'" ></div></td>			 
			 <td  >'.$this->fie_txtextra;			 
			 //campos concatenados
		  ...
		  else
           {
					   ...
					   if($this->fie_inactivoftabla)
			{
			 ...
			 <td valign="top" class="'.$this->fie_style.'">'.$this->fie_title.'</td>
			 <td valign="top"  >'.$this->fie_txtizq.'</td>
			 <td valign="top"  ><input name="'.$nombre_campo.'" id="'.$nombre_campo.'" type="text" class="'.$this->fie_styleobj.'"  value="'.$this->sendvar[$this->fie_sendvar].'" maxlength="'.$len.'" '.$this->fie_attrib.' size="'.$this->fie_lencampo.'" >'.$this->txtobligatorio.'</td>			 
			 <td><div  id="'.$nombre_campo."_despliegue".'" ></div></td>			 
			 <td  >'.$this->fie_txtextra;			 
			 //campos concatenados
			 $buscaconcatenacion="select * from  kyradm_sisfieldconcatena where fie_id=".$this->fie_id;
			  			   ...
			  			   if($this->fie_inactivoftabla)
			{
			 ...
			 <td valign="top" class="'.$this->fie_style.'">'.$this->fie_title.'</td>
			 <td valign="top"  >'.$this->fie_txtizq.'</td>
			 <td valign="top"  ><input name="'.$nombre_campo.'" id="'.$nombre_campo.'" type="text" class="'.$this->fie_styleobj.'"  value="'.$this->fie_value.'" maxlength="'.$len.'" '.$this->fie_attrib.' size="'.$this->fie_lencampo.'" >'.$this->txtobligatorio.'</td>			 
			 <td><div  id="'.$nombre_campo."_despliegue".'" ></div></td>			 
			 <td  >'.$this->fie_txtextra;			 
			 //campos concatenados
			 $buscaconcatenacion="select * from  kyradm_sisfieldconcatena where fie_id=".$this->fie_id;
