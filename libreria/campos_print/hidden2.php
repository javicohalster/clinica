       ...
       if (!(@$this->contenid[$nombre_campo]==""))
           ...
           {						
...

			{
			 ...
			 echo '<div class="form-group">';
			 echo'<label class="control-label col-xs-3">'.utf8_encode($this->fie_title).'</label>';
			 echo '<div class="col-xs-7">';
...

          {
...

			{
			 ...
			 echo'<label class="control-label col-xs-3">'.utf8_encode($this->fie_title).'</label>';
			 echo '<div class="col-xs-7">';
			 echo '<input name="'.$nombre_campo.'"  id="'.$nombre_campo.'"  type="hidden" value="'.@$this->sendvar[$this->fie_sendvar].'"><div id="despliegue_'.$nombre_campo.'">'.utf8_decode($rmp).'</div>';
             echo '</div>';
			 echo '<div class="col-xs-1">';
			 echo '</div>'; 
			 echo '<div class="col-xs-1">';
