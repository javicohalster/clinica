  ...
  switch (@$_REQUEST["opcion_".$table]) 
	{
     case "guardar":
      {
            ...
            $objformulario->formulario_guardar(@$table,@$_POST,@$typesql,@$listab,@$campo,@$obp,$DB_gogess);
     ...
     case "actualizar":
      {            
			...
			$objformulario->campoant=$campoant;			
			$objformulario->opcp=@$opcp;  
             $objformulario->formulario_update($table,$_POST,$typesql,$idab,$listab,$campo,$obp,$DB_gogess);
       }
     case "buscar":
      {
     ...
     case "borrar":
      {
			...
			$objformulario->campoant=$campoant;		
			$objformulario->opcp=$opcp;
            $objformulario->formulario_delete($table,$idab,$listab,$campo,$obp,$DB_gogess);
