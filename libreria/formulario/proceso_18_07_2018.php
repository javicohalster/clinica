...

{
   ...
   $select["d"]='<select class="form-control" name="dia_'.$ncampo.'" id="dia_'.$ncampo.'" onClick="fecha_bloqueasignaedad(\'dia_'.$ncampo.'\',\'mes_'.$ncampo.'\',\'anio_'.$ncampo.'\',\''.$ncampo.'\')" ><option value="00">-dia-</option>';
   ...
   $select["m"]='<select class="form-control" name="mes_'.$ncampo.'" id="mes_'.$ncampo.'" onClick="fecha_bloqueasignaedad(\'dia_'.$ncampo.'\',\'mes_'.$ncampo.'\',\'anio_'.$ncampo.'\',\''.$ncampo.'\')"   ><option value="00">-mes-</option>';
   ...
   $select["Y"]='<select class="form-control" name="anio_'.$ncampo.'" id="anio_'.$ncampo.'" onClick="fecha_bloqueasignaedad(\'dia_'.$ncampo.'\',\'mes_'.$ncampo.'\',\'anio_'.$ncampo.'\',\''.$ncampo.'\')"   ><option value="00000">-a&ntilde;o-</option>';
