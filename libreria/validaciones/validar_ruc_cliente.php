...
$comparativa2=1;
$buscaruc="select client_ciruc from factur_cliente where dat_ruc='".$_REQUEST[$_POST['campo_validar']]."'";
$estado="true";
...
//$insertv="insert into rastreo (valor) value ('".$_POST["tidcomp_codigocl"]."')";
//$DB_gogess->Execute($insertv);

if(trim($_POST["tidcomp_codigocl"])=='06' OR trim($_POST["tidcomp_codigocl"])=='08' OR trim($_POST["tidcomp_codigocl"])=='09')
{
