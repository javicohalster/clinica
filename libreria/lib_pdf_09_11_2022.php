...
if($id==0)
           ...
           <thead>
             <tr>
			   ...
			   <th class="css_bordesbarra">Cod</th>			   
               <th class="css_bordesbarra">Cant</th>
               <th class="css_bordesbarra">Descripci&oacute;n</th>
			   <th class="css_bordesbarra">Cod. Almacen</th>
			   <th class="css_bordesbarra">Precio Unitario </th>
			   <th class="css_bordesbarra">Dscto 1 %</th>
			   <th class="css_bordesbarra">Dscto 2 %</th>
			   <th class="css_bordesbarra">Dscto $</th>
			   <th class="css_bordesbarra">IVA</th>
               <th class="css_bordesbarra">Precio Total </th>
             </tr>
  </thead>	
			';
			}
...
function lee_retencion($estructura,$plantilla,$numeroAutorizacion,$fechaAutorizacion,$logotipo_imd,$code_barra)
{
		 ...
		 if( $descripcioncodret==InformacionAdicional1.$ix)
	  {
		 ...
		 // $baseimpd=$estructura->impuestos->impuesto[$id]->baseImponible;
...
$fechaemidos=$estructura->impuestos->impuesto[$id]->fechaEmisionDocSustento->__toString();			
			 $griddata.='<tr>  
               ...
               $griddata.='<td bgcolor="#FFFFFF" class="css_bordes_d">'.$codigoRetencion.' : '.$descodigorett.'</td>';
							...
							$griddata.='<td bgcolor="#FFFFFF" class="css_bordes">'.number_format($estructura->impuestos->impuesto[$id]->baseImponible->__toString(), 2, ".", ",").'</td> 
