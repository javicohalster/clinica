...
if($documento=='07')
{
 ...
 $client = new nusoap_client("https://celcer.sri.gob.ec/comprobantes-electronicos-ws/RecepcionComprobantesOffline?wsdl", true);
...
if($documento=='07')
{
 ...
 $cliente = new nusoap_client("https://celcer.sri.gob.ec/comprobantes-electronicos-ws/AutorizacionComprobantesOffline?wsdl", true);
