...
$intercon_emergencia=$rs_sihaydata->fields["intercon_emergencia"]; 
$intercon_hospital=$rs_sihaydata->fields["intercon_hospital"]; 
$intercon_urgente=$rs_sihaydata->fields["intercon_urgente"];
$intercon_fecharegistro=$rs_sihaydata->fields["intercon_fecharegistro"];
$intercon_especialidad=$rs_sihaydata->fields["intercon_especialidad"]; 
$intercon_cama=$rs_sihaydata->fields["intercon_cama"];
$intercon_sala=$rs_sihaydata->fields["intercon_sala"];
$intercon_servconsultado=$rs_sihaydata->fields["intercon_servconsultado"];
$intercon_servsolicita=$rs_sihaydata->fields["intercon_servsolicita"];
$intercon_fecharegistro=$rs_sihaydata->fields["intercon_fecharegistro"];
...
$intercon_enlace =$rs_sihaydata->fields["intercon_enlace"];
  ...
  $url="plantillas/form007anversonewinterconsultasolicitud.php";
  ...
  //
   $lee_plantilla=str_replace("-intercon_especialidad-",$intercon_especialidad,$lee_plantilla);
   $lee_plantilla=str_replace("-intercon_cama-",$intercon_cama,$lee_plantilla);
   $lee_plantilla=str_replace("-intercon_sala-",$intercon_sala,$lee_plantilla);
   
   
   
   
$intercon_urgente=$rs_sihaydata->fields["intercon_urgente"];
if($intercon_urgente==1)
{
  $intercon_urgente='X';
  $lee_plantilla=str_replace("-intercon_urgentesi-",$intercon_urgente,$lee_plantilla);
  $lee_plantilla=str_replace("-intercon_urgenteno-","",$lee_plantilla);
}
else 
{
  $intercon_urgente='X';
  $lee_plantilla=str_replace("-intercon_urgenteno-",$intercon_urgente,$lee_plantilla);
  $lee_plantilla=str_replace("-intercon_urgentesi-","",$lee_plantilla);
}
   ...
   $lee_plantilla=str_replace("-intercon_servconsultado-",$intercon_servconsultado,$lee_plantilla);
   $lee_plantilla=str_replace("-intercon_servsolicita-",$intercon_servsolicita,$lee_plantilla);
	  ...
	  case 5:
		...
		/*  if($intercon_urgente)
		  ...
		  */
		  ...
		  if($intercon_emergencia)
		  {
		  $lee_plantilla=str_replace("-m1-","",$lee_plantilla);
		  $lee_plantilla=str_replace("-m2-","X",$lee_plantilla);
		  }
		
		  if($intercon_hospital)
		  {
		  $lee_plantilla=str_replace("-m1-","",$lee_plantilla);
		  $lee_plantilla=str_replace("-m2-","",$lee_plantilla);
		  $lee_plantilla=str_replace("-m3-","X",$lee_plantilla);
		  }
		
		  $lee_plantilla=str_replace("-m1-","",$lee_plantilla);
		  $lee_plantilla=str_replace("-m2-","",$lee_plantilla);
		  $lee_plantilla=str_replace("-m3-","",$lee_plantilla);
...
//==================================================
 ...
 //diagnosticos
   ...
   $diagosticos_rv="select * from dns_diagnosticonewinterconsulta where intercon_enlace ='".$intercon_enlace."' limit 6";
...
$separa_fecha_hora=explode(" ",$intercon_fecharegistro);
 
 $lee_plantilla=str_replace("-intercon_fecharegistro-",$separa_fecha_hora[0],$lee_plantilla);
 $lee_plantilla=str_replace("-fechhora-",$separa_fecha_hora[1],$lee_plantilla);
