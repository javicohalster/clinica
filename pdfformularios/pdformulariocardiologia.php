...
$anam_fecharegistro=$rs_sihaydata->fields["anam_fecharegistro"];
  ...
  $url="plantillas/form003anversocardio.php";
  ...
  $datos_ro='';
  $rebicion_organos="select * from pichinchahumana_extension.dns_cardiologiagridorgano a inner join pichinchahumana_combos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
...
//==================================================
 ...
 $datos_freg='';
 $fisco_regional="select * from pichinchahumana_extension.dns_cardiologiagridexamenfisico a inner join pichinchahumana_combos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from pichinchahumana_extension.dns_cardiologiadiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
