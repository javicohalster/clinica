...
$anam_fecharegistro=$rs_sihaydata->fields["anam_fecharegistro"];
  ...
  $url="plantillas/form003anversoemergencia.php";
  ...
  $lee_plantilla=str_replace("-motivoconsulta-",$anam_motivoconsulta,$lee_plantilla);
   ///campos varios///========== 
 $lista_standar='anam_fechaatencion,anam_otroseguro,anam_personanotificacion,anam_parentesco,anam_direccionnotificacion,anam_telefononotificacion,anam_acompanante,anam_ciacompanante,anam_direccionacompanante,anam_telefonoacompanante,anam_fuenteinfo,anam_entregapaciente,anam_telefonoentrega,anam_hora,anam_rh,anam_otracondicion,anam_motivollegada,anam_lugarevento,anam_direccionevento,anam_fechaevento,anam_horaevento,anam_vehiculo,anam_otroevento,anam_horadenuncia,anam_obsevento,anam_valor,anam_horaexamen,anam_obsabuso,anam_porcentaje,anam_picadura,anam_mordedura,anam_emferpactual,anam_otrosdt,anam_otrosdtuno,anam_gesta,anam_partos,anam_abortos,anam_cesareas,anam_menstruacion,anam_gestacion,anam_frecuenciafetal,anam_tiempo,anam_uterna,anam_presentacion,anam_dilatacion,anam_borramiento,anam_plano,anam_contracciones,anam_observaciones,anam_problemas,anam_obsplandiagnostico,anam_diasincapacidad,anam_causa';
 ...
 $lee_plantilla=str_replace("-".$lista_standararray[$i]."-",$lab_marca,$lee_plantilla); 
  ...
  ///campos varios///==========
   ...
   ///campos CHECKS varios///========== XXXXXXXXXXXXXXX
 $lista_standar='anam_iess,anam_formallegada,anam_vialibre,anam_viaobstruida,anam_estable,anam_inestable,anam_accidente,anam_envenenamiento,anam_violencia,anam_custodia,anam_etilico,anam_alcoholemia,anam_otassustancias,anam_sospecha,anam_abusofisico,anam_abusopsico,anam_abusosexual,anam_gradouno,anam_gradodos,anam_gradotres,anam_alergicos,anam_clinicos,anam_ginecologicos,anam_traumatologicos,anam_pediatricos,anam_quirurgicos,anam_farmacologicos,anam_otrosapfr,anam_penetrante,anam_nopenetrante,anam_expuesta,anam_cerrada,anam_amputacion,anam_hemorragia,anam_diagmordedura,anam_diagpicadura,anam_excoriacion,anam_masa,anam_hematoma,anam_gi,anam_gii,anam_giii,anam_fetal,anam_rotas,anam_pelvis,anam_sangrado,anam_biometria,anam_quimicasanguinea,anam_gasometria,anam_endoscopia,anam_rxabdomen,anam_tomografia,anam_ecografiapelvica,anam_interconsulta,anam_uroanalisis,anam_electrolitos,anam_electrocardiograma,anam_rxtorax,anam_rxosea,anam_resonancia,anam_ecoabdomen,anam_ecoabdomen,anam_domiciliosal,anam_conexterna,anam_obssalida,anam_internacion,anam_vivo,anam_establesal,anam_inestablesal,anam_muertoemergencia';
 $lista_standararray=array();
 $lista_standararray=explode(",",$lista_standar);
 ...
 $lee_plantilla=str_replace("-".$lista_standararray[$i]."-",$lab_marca,$lee_plantilla); 
  ...
  ///campos CHEKS varios///==========   XXXXXXXXXXXXXXXXX
  ...
  $datos_ro='';
  $rebicion_organos="select * from pichinchahumana_extension.dns_emergenciagridorgano a inner join pichinchahumana_combos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
...
//==================================================
 ...
 $datos_freg='';
 $fisco_regional="select * from pichinchahumana_extension.dns_emergenciagridexamenfisico a inner join pichinchahumana_combos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from pichinchahumana_extension.dns_emergenciadiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
