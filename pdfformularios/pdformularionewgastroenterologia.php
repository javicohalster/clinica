  ...
  if($rs_ro)
	{
		while (!$rs_ro->EOF) {
		  ...
		  $rebicion_buorganos="select * from pichinchahumana_extension.dns_newgastroenterologiagridorgano a  where opcorg_id='".$rs_ro->fields["opcorg_id"]."' and anam_enlace='".$anam_enlace."'";
  ...
  if($rs_freg)
	{
		while (!$rs_freg->EOF) {
		   ...
		   $fisco_regionalbusca="select * from pichinchahumana_extension.dns_newgastroenterologiagridexamenfisico a inner join pichinchahumana_combos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where  a.opcexa_id='".$rs_freg->fields["opcexa_id"]."' and anam_enlace='".$anam_enlace."'";
