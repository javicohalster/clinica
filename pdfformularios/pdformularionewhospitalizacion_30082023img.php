...
$listacamposcss="select * from dns_registrolesiones inner join pichinchahumana_extension.dns_lesioneshospi on dns_registrolesiones.les_id=pichinchahumana_extension.dns_lesioneshospi.les_id where anam_enlace='".$anam_enlace."'"; 
...
$cuentase=0;	
$listacamposcss="select * from pichinchahumana_extension.dns_lesioneshospi"; 
   $rs_lessines = $DB_gogess->executec($listacamposcss,array());
   if($rs_lessines)
	{
			while (!$rs_lessines->EOF) {	
