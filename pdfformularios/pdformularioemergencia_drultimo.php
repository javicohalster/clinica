...
$anam_fecharegistro=$rs_sihaydata->fields["anam_fecharegistro"];
  ...
  $lee_plantilla=str_replace("-motivoconsulta-",$anam_motivoconsulta,$lee_plantilla);
   ///campos varios///========== 
 $lista_standar='anam_fechaatencion,anam_personanotificacion,anam_parentesco,anam_direccionnotificacion,anam_telefononotificacion,anam_acompanante,anam_ciacompanante,'
         . 'anam_direccionacompanante,anam_telefonoacompanante,anam_formallegada';
