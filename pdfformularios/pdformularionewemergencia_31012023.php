...
from app_cliente c INNER JOIN pichinchahumana_combos.dns_nacionalidad n on c.nac_id=n.nac_id
INNER JOIN pichinchahumana_combos.app_genero g on c.clie_genero=g.gen_gen
INNER JOIN pichinchahumana_combos.app_estadocivil e on c.civil_id=e.civil_id
INNER JOIN pichinchahumana_combos.dns_instruccion i on c.clie_instruccion=i.instruccion_id 
INNER JOIN pichinchahumana_extension.dns_convenios co on c.conve_id=co.conve_id
...
$datos_anamnesis="SELECT et.tipoetnia_id, et.tipoetnia_nombre,newem.anam_ahogamiento, newem.anam_accidentetransito FROM dns_newemergenciaanamesis newem
inner join cmb_etnia et on et.tipoetnia_id=newem.tipoetnia_id
where newem.clie_id='".$clie_id."'";
...
$anam_ahogamiento=$rs_dcdatos_anamnesis->fields["anam_ahogamiento"];
$anam_accidentetransito=$rs_dcdatos_anamnesis->fields["anam_accidentetransito"];
...
$anam_exobservacion=$rs_sihaydata->fields["anam_exobservacion"];
  ...
  $url="plantillas/form008anversoemergencia.php";
