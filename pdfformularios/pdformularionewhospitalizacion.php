...
$anam_fuaprostatico=$rs_sihaydata->fields["anam_fuaprostatico"];
$anam_fuecoprostatico=$rs_sihaydata->fields["anam_fuecoprostatico"]; 
...
$anam_analisis=$rs_sihaydata->fields["anam_analisis"]; 
$anam_descripcionexafis=$rs_sihaydata->fields["anam_descripcionexafis"];
//////DR
$anam_metodopfamiliartex=$rs_sihaydata->fields["anam_metodopfamiliartex"]; 
$anam_edadsex=$rs_sihaydata->fields["anam_edadsex"];
////DR

  //=========================================================================
  
  
  $url="plantillas/form003anversonewhospitalizacion.php";
...
$lee_plantilla=str_replace("-ucodigo-",$uni_codiog,$lee_plantilla);
  ...
  $datos_ap='';
  $antecedentes_personales="select * from pichinchahumana_extension.dns_antecedentespersonaleshospi a inner join pichinchahumana_combos.dns_opcionantecedenteshospi b on a.opcioante_id=b.opcioante_id where clie_id='".$clie_id."'";
...
if($rs_ap)
  ...
  $lee_plantilla=str_replace("-ap11-",'',$lee_plantilla); 
 /*
  if($anam_biopsia==1)
  {     
  ...
  */
 ////DR
  $lee_plantilla=str_replace("-anam_metodopfamiliartex-",$anam_metodopfamiliartex,$lee_plantilla);
  $lee_plantilla=str_replace("-anam_edadsex-",$anam_edadsex,$lee_plantilla);
  $lee_plantilla=str_replace("-anam_terapiahormonaltext-",$anam_terapiahormonaltext,$lee_plantilla); 
 ////DR
  ...
  $datos_af='';
  $antecedentes_familiares="select * from pichinchahumana_extension.dns_antecedentesfamiliareshospi a inner join pichinchahumana_combos.dns_tipofamiliarhospi b on a.tipfam_id=b.tipfam_id where clie_id='".$clie_id."'";
...
/*  $datos_ro='';
  $rebicion_organos="select * from pichinchahumana_extension.dns_newhospitalizaciongridorgano a inner join pichinchahumana_combos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
  ...
  $datos_ro='';
  $rebicion_organos="select * from pichinchahumana_combos.dns_opcionorgano where opcorg_id!=99";
  $rs_ro = $DB_gogess->executec($rebicion_organos,array());
  if($rs_ro)
	{
		while (!$rs_ro->EOF) {
		
		  $rebicion_buorganos="select * from pichinchahumana_extension.dns_newhospitalizaciongridorgano a  where a.opcorg_id='".$rs_ro->fields["opcorg_id"]."' and anam_enlace='".$anam_enlace."'";
		  $rs_buorg = $DB_gogess->executec($rebicion_buorganos,array());
		
		  if($rs_buorg->fields["tiporg_nombre"]=='CP')
		  {
		  $datos_ro.=$rs_ro->fields["opcorg_id"].".- ".$rs_buorg->fields["gorgano_observacion"].", ";		  
		  $lee_plantilla=str_replace("-rocp".$rs_ro->fields["opcorg_id"]."-",'X',$lee_plantilla); 
		  $lee_plantilla=str_replace("-rosp".$rs_ro->fields["opcorg_id"]."-",'',$lee_plantilla);
		  }
		  else
		  {
		  $datos_ro.=$rs_ro->fields["opcorg_id"].".- SIN EVIDENCIA DE PATOLOGIA, ";		  
		  //$lee_plantilla=str_replace("-rocp".$rs_ro->fields["opcorg_id"]."-",'X',$lee_plantilla); 
		  //$lee_plantilla=str_replace("-rosp".$rs_ro->fields["opcorg_id"]."-",'',$lee_plantilla);
  ...
  if($anam_fuaprostatico=='0000-00-00')
  {
      $anam_fuaprostatico='';
  }
  if($anam_fuecoprostatico=='0000-00-00')
  {
      $anam_fuecoprostatico='';
  }
...
//================================================== 
  ...
  $lee_plantilla=str_replace("-anam_fuaprostatico-","NO APLICA",$lee_plantilla); 
  $lee_plantilla=str_replace("-anam_fuecoprostatico-","NO APLICA",$lee_plantilla);
...
{
//================================================== 
  $lee_plantilla=str_replace("-anam_gesta-","NO APLICA",$lee_plantilla);
  $lee_plantilla=str_replace("-anam_partos-","NO APLICA",$lee_plantilla);
  $lee_plantilla=str_replace("-anam_abortos-","NO APLICA",$lee_plantilla);
  $lee_plantilla=str_replace("-anam_cesareas-","NO APLICA",$lee_plantilla);
  $lee_plantilla=str_replace("-anam_fum-","NO APLICA",$lee_plantilla);
  $lee_plantilla=str_replace("-anam_fup-","NO APLICA",$lee_plantilla);
  $lee_plantilla=str_replace("-anam_fuc-","NO APLICA",$lee_plantilla);
  $lee_plantilla=str_replace("-anam_colposcopia-","NO APLICA",$lee_plantilla);
  $lee_plantilla=str_replace("-anam_mamografia-","NO APLICA",$lee_plantilla);
  $lee_plantilla=str_replace("-anam_menarquiaedad-","NO APLICA",$lee_plantilla); 
  $lee_plantilla=str_replace("-anam_menopausiaedad-","NO APLICA",$lee_plantilla); 
  $lee_plantilla=str_replace("-anam_ciclos-","NO APLICA",$lee_plantilla); 
  $lee_plantilla=str_replace("-anam_hijosvivos-","NO APLICA",$lee_plantilla);
  $lee_plantilla=str_replace("-anam_fuaprostatico-",$anam_fuaprostatico,$lee_plantilla);  
  $lee_plantilla=str_replace("-anam_fuecoprostatico-",$anam_fuecoprostatico,$lee_plantilla);
//==================================================
}
...
//  $lee_plantilla=str_replace("-anam_mamografia-",$anam_mamografia,$lee_plantilla);
  ...
  $lee_plantilla=str_replace("-anam_analisis-",$anam_analisis,$lee_plantilla);
  $lee_plantilla=str_replace("-anam_descripcionexafis-",$anam_descripcionexafis,$lee_plantilla);
  ...
  $sig_vitales="select * from dns_signosvitales where (anam_enlace='".$anam_enlace."' or atenc_enlace in (select atenc_enlace  from dns_atencion where atenc_id='".$atenc_id."') or anam_enlace in (select atenc_enlace  from dns_atencion where atenc_id='".$atenc_id."'))  order by signovita_fecharegistro desc limit 1";
  
  // $sig_vitales="select * from dns_signosvitales where (anam_enlace in (select atenc_enlace  from dns_atencion where atenc_id='".$atenc_id."') or )  order by signovita_fecharegistro desc limit 1";
 ...
 $datos_freg='';
 $fisco_regional="select * from pichinchahumana_extension.dns_newhospitalizaciongridexamenfisico a inner join pichinchahumana_combos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from pichinchahumana_extension.dns_newhospitalizaciondiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
...
<!--
 ...
 #contenedor_imp {
	...
	left:0px;
	position: relative;
	background-image:url(images/diagramatopograficohospi.png);
}
';


$listacamposcss="select * from dns_registrolesioneshospi where anam_enlace='".$anam_enlace."'"; 
...
$lista_detallesless='';
$listacamposcss="select * from dns_registrolesioneshospi inner join pichinchahumana_extension.dns_lesioneshospi on dns_registrolesioneshospi.les_id=pichinchahumana_extension.dns_lesioneshospi.les_id where anam_enlace='".$anam_enlace."'"; 
 $rs_camposcss = $DB_gogess->executec($listacamposcss,array()); 
   if($rs_camposcss)
   {
			 while (!$rs_camposcss->EOF) {
			...
			$lesionesx.='<div id=L'.strtolower($rs_camposcss->fields["less_id"]).'_div ><img src="images/'.$rs_camposcss->fields["les_id"].'.png" width="13" height="13"  /></div>';
			 ...
			 $lee_plantilla=str_replace("-".$rs_camposcss->fields["les_code"]."-",'X',$lee_plantilla); 
			 
			 $lista_detallesless.=$rs_camposcss->fields["les_code"]." ".$rs_camposcss->fields["les_nombre"]."<br>";
 ...
 $listacamposcssx="select * from  pichinchahumana_extension.dns_lesioneshospi"; 
 $rs_camposcssx = $DB_gogess->executec($listacamposcssx,array()); 
   if($rs_camposcssx)
   {
			 while (!$rs_camposcssx->EOF) {
             
			 $lee_plantilla=str_replace("-".$rs_camposcssx->fields["les_code"]."-",'',$lee_plantilla); 
		    

			 $rs_camposcssx->MoveNext();
			 }
   }   
...
$lee_plantilla=str_replace("-freglistado-",$lista_detallesless,$lee_plantilla);
