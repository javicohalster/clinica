...
$conteo_pg=0;
$busca_listapg="select * from ".$table." where anam_id='".$anam_idpg."' order by conext_id asc";
   ...
   if($rs_blistapg)
	{
		while (!$rs_blistapg->EOF) {
		  ...
		  $conteo_pg++;
		  $actualizpg="update ".$table." set conext_pagina='".$conteo_pg."-".$array_letrascon[$conteo_pg]."' where conext_id='".$rs_blistapg->fields["conext_id"]."'";
...
for($i=0;$i<$numero_entero;$i++)
{
   ...
   $url="plantillas/evoform002reversonewveolucionhospi.php";
