...
$n_subcate='';
$n_subcate=$objformulario->replace_cmb("dns_subarea","suba_id,suba_nombre","where suba_id=",$rs_sihaydata->fields["suba_id"],$DB_gogess);
  //=========================================================================
  
  
  $url="plantillas/form003anverso.php";
  ...
  $lee_plantilla=str_replace("-categor-",$n_subcate,$lee_plantilla);
...
$lista_standararray=explode(",",$lista_standar);
 ...
 $lee_plantilla=str_replace("-".$lista_standararray[$i]."-",$lab_marca,$lee_plantilla); 
  ...
  if($filtro==1)
  {
  $antecedentes_personales="select * from pichinchahumana_extension.dns_antecedentespersonales a inner join pichinchahumana_combos.dns_opcionantecedentes b on a.opcioante_id=b.opcioante_id where clie_id='".$clie_id."' and a.usua_id='".$_SESSION['datadarwin2679_sessid_inicio']."'";
  }
  else
  {
  ...
  $datos_af='';
   if($filtro==1)
  {
  $antecedentes_familiares="select * from pichinchahumana_extension.dns_antecedentesfamiliares a inner join pichinchahumana_combos.dns_tipofamiliar b on a.tipfam_id=b.tipfam_id where clie_id='".$clie_id."'   and a.usua_id='".$_SESSION['datadarwin2679_sessid_inicio']."'";
  }
  else
  {
  ...
  $datos_ro='';
  $rebicion_organos="select * from pichinchahumana_extension.dns_gridorgano a inner join pichinchahumana_combos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
...
//==================================================
 ...
 $datos_freg='';
 $fisco_regional="select * from pichinchahumana_extension.dns_gridexamenfisico a inner join pichinchahumana_combos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from dns_diagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
