...
//================================================== 
  ...
  $lee_plantilla=str_replace("-anam_colposcopia-",'',$lee_plantilla);
  $lee_plantilla=str_replace("-anam_mamografia-",'',$lee_plantilla); 
  $lee_plantilla=str_replace("-anam_fuaprostatico-",'',$lee_plantilla);
  $lee_plantilla=str_replace("-anam_fuecoprostatico-",'',$lee_plantilla);
//==================================================
}
...
//  $lee_plantilla=str_replace("-anam_mamografia-",$anam_mamografia,$lee_plantilla);
  ...
  $sig_vitales="select * from dns_signosvitales where (anam_enlace='".$anam_enlace."' or atenc_enlace in (select atenc_enlace  from dns_atencion where atenc_id='".$atenc_id."'))  order by signovita_fecharegistro desc limit 1";
