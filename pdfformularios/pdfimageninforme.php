...
$nomb_medico=$objformulario->replace_cmb("app_usuario","usua_id,usua_nombre,usua_apellido","where usua_id=",$rs_sihaydata->fields["usua_id"],$DB_gogess);
  ...
  $url="plantillas/imagen_informe.php";
  ...
  $datos_solicitud="select * from dns_imagenologia where imgag_id='".$rs_sihaydata ->fields["imgag_id"]."'";
...
//edad actual
 ...
 $lee_plantilla=str_replace("-imginfo_personarecibe-",$imginfo_parroquia,$lee_plantilla); 
 ...
 $imgag_servicio=$rs_solicitud->fields["imgag_servicio"];
 ...
 $lista_standar='imginfo_rxconvencional,imginfo_tomografia,imginfo_resonancia,imginfo_ecografia,imginfo_procedimientos,imginfo_otros,imginfo_unico,imginfo_multiple';
