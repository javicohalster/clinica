...
$comprobantepdf=<<<TEMPLATE
    ...
    <div style="font-size:11px;">
                    ...
                    <div style="width: 3.3cm; height:0.8cm; text-align:center; font-size:6px;">
                        <table border="0" style="border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td style="margin:0px; padding:0px;"><div style="width:1.1cm; height: 0.5cm; text-align:center; border-right:0.02cm solid #000; border-top:0.02cm solid #000; overflow:hidden; line-height:0.4cm;"><!-- ## -->&nbsp;</div></td>
                                <td style="margin:0px; padding:0px;"><div style="width:1.08cm; height: 0.5cm; text-align:center; border-top:0.02cm solid #000; overflow:hidden; line-height:0.4cm;"><!-- ## -->&nbsp;</div></td>
                            </tr>
                        </table>
                    </div>
                </td>
                ...
                <td style="margin:0px; padding:0px; border:0.02cm solid #000;">
                    <div style="width: 17.2cm;">
                        <table border="0" style="border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="margin:0px; padding:0px;"><div class="fs-8" style="border-top:0.02cm solid #000; border-right: 0.02cm solid #000; width: 10.6cm; text-align:center; overflow:hidden;"><!-- ## -->&nbsp;</div></td>
                                <td style="margin:0px; padding:0px; "><div class="fs-8" style="border-top:0.02cm solid #000; border-right: 0.02cm solid #000; width: 1.6cm; text-align:center; overflow:hidden;"><!-- ## -->&nbsp;</div></td>
                                <td style="margin:0px; padding:0px; "><div class="fs-8" style="border-top:0.02cm solid #000; border-right: 0.02cm solid #000; width: 1.82cm; text-align:center; overflow:hidden;"><!-- ## -->&nbsp;</div></td>
        ...
        <table border="0" style="border-collapse: collapse; margin-bottom:0.2cm;">
            ...
            <tr>
                <td style="margin:0px; padding:0px; border:0.02cm solid #000;">
                    <div class="fs-6 hidden-content" style="width: 17.2cm; height:1.9cm; text-align:left;">{$datos_af}</div>
                </td>
            </tr>
        </table>
