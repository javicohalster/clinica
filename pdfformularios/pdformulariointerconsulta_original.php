...
$usua_msp=$objformulario->replace_cmb("app_usuario","usua_id,usua_msp","where usua_id=",$rs_sihaydata->fields["usua_id"],$DB_gogess);
  ...
  $url="plantillas/form003anversointerconsultasolicitud.php";
...
$lista_standar='intercon_fecharegistro,intercon_planeducacional,intercon_planterapeutico,intercon_pruebasdiagnosticas,intercon_clinicoactual';
