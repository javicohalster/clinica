...
//=============================================================================
 $lista_standar='anam_resumenclinico,anam_resumenevolucion,anam_hallazgos,anam_resumentratamiento,anam_condicionegreso,anam_diasestadia,anam_diasincapacidad';
...
//=============================================================================
 ...
 //diagnosticos2
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from pichinchahumana_extension.dns_epicrisisdiagnosticoanamnesisegreso where anam_enlace='".$anam_enlace."' limit 6";
   $rs_dgnostico = $DB_gogess->executec($diagosticos_rv,array());
   if($rs_dgnostico)
	{
		while (!$rs_dgnostico->EOF) {
