...
//=============================================================================
 $lista_standar='protoop_proyectada,protoop_realizada,protoop_cirujanouno,protoop_cirujanodos,protoop_ayudanteuno,protoop_ayudantedos,protoop_instrumentista,protoop_circulante,protoop_anestesiologo,protoop_horainicio,protoop_horafin,protoop_dieresis,protoop_exposicion,protoop_exploracion,protoop_procedimiento,protoop_sintesis,protoop_complicaciones,protoop_examen,protoop_examendetalle,protoop_diagnostico,protoop_tecerayudante,protoop_ayudanteanestesia,protoop_tipoanestesia';
 $lista_standararray=array();
 $lista_standararray=explode(",",$lista_standar);
