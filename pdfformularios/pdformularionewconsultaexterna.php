...
$anam_nhoja=$rs_sihaydata->fields["anam_nhoja"];
  ...
  $url="plantillas/form003anversonewconsultaexterna.php";
...
/////////////////
  ...
  */
  ...
  /*$datos_ro='';
  $rebicion_organos="select * from pichinchahumana_extension.dns_newconsultaexternagridorgano a inner join pichinchahumana_combos.dns_opcionorganonewconext b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
  ...
  if($rs_ro)
	{
		while (!$rs_ro->EOF) {
		  ...
		  $rebicion_buorganos="select * from pichinchahumana_extension.dns_newconsultaexternagridorgano a  where opcorg_id='".$rs_ro->fields["opcorg_id"]."' and anam_enlace='".$anam_enlace."'";
...
/* $datos_freg='';
 $fisco_regional="select * from pichinchahumana_extension.dns_newconsultaexternagridexamenfisico a inner join pichinchahumana_combos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
  ...
  if($rs_freg)
	{
		while (!$rs_freg->EOF) {
		   ...
		   $fisco_regionalbusca="select * from pichinchahumana_extension.dns_newconsultaexternagridexamenfisico a inner join pichinchahumana_combos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where  a.opcexa_id='".$rs_freg->fields["opcexa_id"]."' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from pichinchahumana_extension.dns_newconsultaexternadiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
