...
$anam_fecharegistro=$rs_sihaydata->fields["anam_fecharegistro"];
 ...
 // $url="plantillas/form003anversoepicrisis.php";
  $url="plantillas/form06anversoepicrisis.php";
 ...
 $resumen_clinico="select * from  pichinchahumana_original.dns_epicrisisanamesis where anam_resumenclinico='".$anam_resumenclinico."'";
 $rs_ap = $DB_gogess->executec($resumen_clinico,array());
 ...
 /* $antecedentes_personales="select * from pichinchahumana_extension.dns_antecedentespersonales a inner join pichinchahumana_combos.dns_opcionantecedentes b on a.opcioante_id=b.opcioante_id where clie_id='".$clie_id."'";
  ...
  $datos_ro='';
  $rebicion_organos="select * from pichinchahumana_extension.dns_epicrisisgridorgano a inner join pichinchahumana_combos.dns_opcionorgano b on a.opcorg_id=b.opcorg_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
...
//==================================================
 ...
 $datos_freg='';
 $fisco_regional="select * from pichinchahumana_extension.dns_epicrisisgridexamenfisico a inner join pichinchahumana_combos.dns_opcionexamenfisico b on a.opcexa_id=b.opcexa_id where tiporg_nombre='CP' and anam_enlace='".$anam_enlace."'";
 ...
 //diagnosticos
   $datos_diagnostico='';
   $cuentase=0;
   $diagosticos_rv="select * from pichinchahumana_extension.dns_epicrisisdiagnosticoanamnesis where anam_enlace='".$anam_enlace."' limit 6";
