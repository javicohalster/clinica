...
$lista_detalle="select * from gogess_subgrid where subgri_id=1"; 
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" class="css_precio"  >Pagado:<?php echo $rscampos_valor->fields["doccab_pagacon"]; ?><br />
...
De acuerdo a la resoluci&oacute;n No NAC-DGERCGC14-00790 del <br />SRI, Pichincha pone a su disposici&oacute;n <br />en su portal web la opcion de consulta de documentos <br />tributarios.
www.pichinchahumana.gob.ec  <br />
Ingrese su identificaci&oacute;n que consta en este recibo, seleccione <br />el documento tributario que desea imrpimir y respladar.<br />
</div>
=================================================
