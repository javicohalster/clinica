...
-- Tiempo de generación: 27-09-2016 a las 09:02:44
...
CREATE TABLE IF NOT EXISTS `beko_ambiente` (
  `ambi_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `beko_bodega` (
  `bode_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `beko_canton` (
  `cant_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `beko_catgproducto` (
  `catpr_id` int(11) NOT NULL AUTO_INCREMENT,
  `catpr_nombre` varchar(250) NOT NULL,
  PRIMARY KEY (`catpr_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `beko_cliente` (
  ...
  PRIMARY KEY (`clie_id`),
  UNIQUE KEY `clie_rucci` (`clie_rucci`)
...
CREATE TABLE IF NOT EXISTS `beko_documentocabecera` (
  ...
  PRIMARY KEY (`doccab_id`),
  UNIQUE KEY `doccab_ndocumento` (`doccab_ndocumento`),
  UNIQUE KEY `doccab_clavedeaccesos` (`doccab_clavedeaccesos`)
...
('011711467884171146788400120160923112710439', 1, 1, 1, 1, '01', '001-001-000000020', '2309201601171146788400110010010000000201271043911', '1711467884001', '1711467884', 'FRANKLIN AGUAS', 'COTOCOLLAO', '2532445', 'falider@hotmail.com', '2016-09-23', 12, 0, 0, 0, 1.68, 0, 0, 0, 13.68, '', '', 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 1, 30);

--
-- Disparadores `beko_documentocabecera`
--
DROP TRIGGER IF EXISTS `registro_caja_TRIGGER`;
DELIMITER //
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `registro_cajaactualiza_TRIGGER`;
DELIMITER //
...
CREATE TABLE IF NOT EXISTS `beko_documentodetalle` (
  `docdet_id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, '011711467884171146788400120160923112710439', 'GHYNCMR14BP7EW20160313050633', '67', 1, 'Audifonos', '', '', '', 12, 2, 3, 14, 1.68, 0, 0, 12, 30);

--
-- Disparadores `beko_documentodetalle`
--
DROP TRIGGER IF EXISTS `registro_movimiento_antesde`;
DELIMITER //
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `registro_movimiento_reciboac`;
DELIMITER //
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `registro_movimiento_reciboborra`;
DELIMITER //
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `registro_movimiento_recibop`;
DELIMITER //
...
CREATE TABLE IF NOT EXISTS `beko_empdocumento` (
  `empdoc_id` int(11) NOT NULL AUTO_INCREMENT,
  `tipocmp_codigo` varchar(5) NOT NULL,
  `ambi_valor` int(11) NOT NULL,
  `tipoemi_codigo` int(11) NOT NULL,
  `emp_id` int(11) NOT NULL,
  PRIMARY KEY (`empdoc_id`)
...
CREATE TABLE IF NOT EXISTS `beko_establecimiento` (
  `estbl_id` int(11) NOT NULL AUTO_INCREMENT,
  `emp_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `beko_estado` (
  `estaf_id` int(11) NOT NULL AUTO_INCREMENT,
  `estaf_nombre` varchar(70) NOT NULL,
  PRIMARY KEY (`estaf_id`)
...
CREATE TABLE IF NOT EXISTS `beko_historicoing` (
  `hiing_id` int(11) NOT NULL AUTO_INCREMENT,
...
(72, '2016-09-21 22:14:40', '1711467884', '186.46.113.39', 0, 1),
(73, '2016-09-22 13:58:23', '1711467884', '186.46.113.39', 0, 1),
(74, '2016-09-22 14:34:16', '1711467884', '186.46.113.39', 0, 1),
(75, '2016-09-22 16:12:41', '1711467884', '186.46.113.39', 0, 1),
(76, '2016-09-22 23:45:02', '1711467884', '186.46.207.109', 0, 1),
(77, '2016-09-22 23:49:57', '1711467884', '186.46.207.109', 0, 1),
(78, '2016-09-23 23:25:56', '1711467884', '200.85.83.50', 0, 1),
(79, '2016-09-24 13:22:22', '1711467884', '201.217.82.215', 0, 1),
(80, '2016-09-24 13:25:53', '1711467884', '201.217.82.215', 0, 1),
(81, '2016-09-24 14:03:12', '18028591', '201.217.82.215', 0, 2),
(82, '2016-09-24 14:17:29', '1711467884', '201.217.82.215', 0, 1),
(83, '2016-09-25 03:18:18', '1711467884', '181.113.96.196', 0, 1);
...
CREATE TABLE IF NOT EXISTS `beko_impresioncampos` (
  `impcamp_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `beko_impuesto` (
  `impu_id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 1, 3, '', 1, 0, 12, '2016-09-23', '011711467884171146788400120160923112710439', 0, 0);

--
-- Disparadores `beko_movimiento`
--
DROP TRIGGER IF EXISTS `actualizar_beko_movimiento`;
DELIMITER //
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `borrar_beko_movimiento`;
DELIMITER //
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `inser_beko_movimiento`;
DELIMITER //
...
CREATE TABLE IF NOT EXISTS `beko_producto` (
  ...
  UNIQUE KEY `produ_codigoserial` (`produ_codigoserial`),
  KEY `emp_id` (`emp_id`)
...
(1, 1, 1, 2, 'GHYNCMR14BP7EW20160313050633', 'Audifonos', 'Samsung', '', 12, 1, '2016-03-13', 10, 17, 2, 3, 0);
...
CREATE TABLE IF NOT EXISTS `beko_registrocaja` (
  `regisc_id` int(11) NOT NULL AUTO_INCREMENT,
  `emp_id` int(11) NOT NULL,
...
(6, 1, 8, '2016-09-23 00:00:00', '', '011711467884171146788400120160923112710439', '001-001-000000020', 13.68, 1, 'DOLAR', 30, 0, '');
...
CREATE TABLE IF NOT EXISTS `beko_tarifa` (
  `tari_id` int(11) NOT NULL AUTO_INCREMENT,
  `impu_codigo` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `beko_tipocaja` (
  `tipca_id` int(11) NOT NULL AUTO_INCREMENT,
  `tipca_nombre` varchar(90) NOT NULL,
  PRIMARY KEY (`tipca_id`)
...
CREATE TABLE IF NOT EXISTS `beko_tipocampoimp` (
  `ticaimp_id` int(11) NOT NULL AUTO_INCREMENT,
  `ticaimp_nombre` varchar(250) NOT NULL,
  PRIMARY KEY (`ticaimp_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `beko_tipoemision` (
  `tipoemi_id` int(11) NOT NULL AUTO_INCREMENT,
  `emis_valor` int(11) NOT NULL,
  `tipoemi_nombre` varchar(250) NOT NULL,
  PRIMARY KEY (`tipoemi_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `beko_tipoimp` (
  `tipimp_id` int(11) NOT NULL AUTO_INCREMENT,
  `tipimp_nombre` varchar(90) NOT NULL,
  PRIMARY KEY (`tipimp_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `beko_tipomov` (
  `tipmv_id` int(11) NOT NULL AUTO_INCREMENT,
  `tipmv_nombre` varchar(90) NOT NULL,
  `tipmv_signo` int(11) NOT NULL,
  PRIMARY KEY (`tipmv_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;
...
(30, 1, 3, '1711467884', 'Franklin', 'Oswaldo', '094873893', 'Direccion  de prueba', '2322343', 2015, 'franklin.aguas', '25d55ad283aa400af464c76d713c07ad', 'franklin.aguas@funcionjudicial.gob.ec', '2016-09-25', '03:18:18', '0000-00-00', 1, '42020151022023554', 1, 1),
...
(37, 2, 1, '18028591', 'DIANA CAROLINA', 'BADILLO HERRERA', '0995709887', 'Vasco de Contreras', '', 0, 'diana.badillo', '2f38bf5ebb611e3f73878c1111e4da08', 'diana.badillo@gmail.com', '2016-09-24', '14:03:12', '0000-00-00', 1, '', 1, 0),
(38, 2, 2, '1802859163', 'Gerardo', 'Badillo', '0982025782', 'san carlos', '', 0, 'gerardo.badillo', 'ae02fec0a711ac1a5a0a727adfc58013', 'gerardo.badillo', '0000-00-00', '00:00:00', '0000-00-00', 0, '', 0, 1);
...
CREATE TABLE IF NOT EXISTS `beko_usuariosperfil` (
  ...
  PRIMARY KEY (`per_id`),
  KEY `FK_beko_usuariosperfil` (`usua_id`)
...
(50, 30, 51, '1', '0000-00-00 00:00:00'),
(51, 36, 51, '1', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `beko_usuario_caja` (
  `fuca_id` int(11) NOT NULL AUTO_INCREMENT,
  `usua_id` int(11) NOT NULL,
  `emp_id` int(11) NOT NULL,
  `estbl_id` int(11) NOT NULL,
  `punto_id` int(11) NOT NULL,
...
--
-- Estructura Stand-in para la vista `beko_usuario_vista`
--
CREATE TABLE IF NOT EXISTS `beko_usuario_vista` (
`usua_id` int(11)
,`emp_id` int(11)
,`emp_nombre` varchar(250)
,`tipo_id` int(11)
,`tipo_nombre` varchar(200)
,`usua_ciruc` varchar(90)
,`usua_nombre` varchar(250)
,`usua_apellido` varchar(250)
,`usua_usuario` varchar(90)
,`usua_email` varchar(250)
,`usua_estado` int(11)
,`etiqueta` char(100)
,`usua_adm` int(11)
);
...
CREATE TABLE IF NOT EXISTS `gogess_aplication` (
  `ap_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_areausuarios` (
  `accw_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_conocimiento` (
  `cono_id` int(32) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_datosg` (
  `em_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_detperfil` (
  `detp_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_iconomenuhome` (
  `iico_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_instancia` (
  `instan_id` int(32) NOT NULL AUTO_INCREMENT,
  `instan_nombre` char(200) NOT NULL,
  `instan_detalle` text NOT NULL,
  PRIMARY KEY (`instan_id`)
...
CREATE TABLE IF NOT EXISTS `gogess_itemmenu` (
  `ite_id` bigint(64) NOT NULL AUTO_INCREMENT,
  `men_id` int(32) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `gogess_itemmenuaplicativo` (
  `itmenap_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
(51, 2, 'Empresa', 3, 0, '', '1', 8, '', 1, '25123DE20160924.png', 1);
...
CREATE TABLE IF NOT EXISTS `gogess_menu` (
  `men_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_menuopcion` (
  `meopap_id` bigint(64) NOT NULL AUTO_INCREMENT,
  `menap_id` int(32) DEFAULT NULL,
  `opap_id` int(32) DEFAULT NULL,
  PRIMARY KEY (`meopap_id`)
...
CREATE TABLE IF NOT EXISTS `gogess_objtable` (
  `ot_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_obl` (
  `obl_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_opcionaplicativo` (
  `opap_id` bigint(64) NOT NULL AUTO_INCREMENT,
  `ap_id` int(32) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gogess_perfil` (
  `per_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_prgvalidar` (
  `prgv_id` int(32) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_ptemplate` (
  `temp_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_sess` (
  ...
  KEY `gogess_sess_gogess_sess_IX_gogess_sess` (`sess_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('aqualis1474588904', 'sadmin', 'c5edac1b8c1d58bad90a246d8f08f53b', 'Sistemas', 1, 0, 'NULL', 0, 'NULL'),
('aqualis1474723380', 'sadmin', 'c5edac1b8c1d58bad90a246d8f08f53b', 'Sistemas', 1, 0, 'NULL', 0, 'NULL'),
('aqualis1474724276', 'sadmin', 'c5edac1b8c1d58bad90a246d8f08f53b', 'Sistemas', 1, 0, 'NULL', 0, 'NULL');
...
CREATE TABLE IF NOT EXISTS `gogess_sino` (
  `si_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_sisfield` (
  `fie_id` bigint(64) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`fie_id`),
  UNIQUE KEY `gogess_sisfield_fie_name_tab_name_key` (`tab_name`,`fie_name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3198 ;
...
(2928, 'int', '', 'temp_id', 'beko_empresa', 'Tipo:', '', '', '', 'select', 'select', '', '', '', 0, 'cmbforms', 'OKcampo', '', '', 'replace', 'beko_tipoemp', 'temp_id,temp_nombre', '', '', 1, 1, 1, 1, 0, 'where temp_id=', '1', 'temp_idx', 1, 25, 0, 0, 0, '', 0, 'NULL', '0', '', 2, '', '', '', '', '', '', '', '', '', 0, '', 1, 0, 0),
...
(3191, 'int', '', 'movi_precio', 'beko_movimiento', 'Precio compra/venta:', '', '', '', 'text', 'text', '', '', '', 0, 'cmbforms', 'OKcampo', '', '', '', 'beko_movimiento', '', '', '', 1, 1, 1, 1, 0, '', '1', '', 1, 7, 0, 0, 0, '', 0, 'NULL', '0', '', 5, '', '', '', '', '', '', '', '', '', 0, '', 1, 0, 0),
...
CREATE TABLE IF NOT EXISTS `gogess_sisfieldconcatena` (
  `fiecon_id` bigint(64) NOT NULL AUTO_INCREMENT,
  `fie_id` int(32) NOT NULL,
  `tab_name` char(60) DEFAULT NULL,
  `fieenlace_id` int(32) NOT NULL,
  PRIMARY KEY (`fiecon_id`)
...
CREATE TABLE IF NOT EXISTS `gogess_sistable` (
  `tab_id` bigint(64) NOT NULL AUTO_INCREMENT,
  `tab_name` char(60) DEFAULT 'NULL',
  ...
  PRIMARY KEY (`tab_id`),
  UNIQUE KEY `gogess_sistable_tab_name_key` (`tab_name`)
...
CREATE TABLE IF NOT EXISTS `gogess_sisusers` (
  `sisu_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_styletable` (
  `st_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_subgrid` (
  `subgri_id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_subtabla` (
  `sub_id` bigint(64) NOT NULL AUTO_INCREMENT,
  `tab_id` int(32) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `gogess_subtablatr` (
  `subtr_id` bigint(64) NOT NULL AUTO_INCREMENT,
  `tab_id` int(32) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `gogess_sys` (
  `sys_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_template` (
  `tem_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_tl` (
  `tl_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_typecmp` (
  `tyc_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_uvic` (
  `uvic_id` bigint(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gogess_validaciones` (
  `valid_id` int(32) NOT NULL AUTO_INCREMENT,
...
(420, 3032, 12, 'true', 'El valor deve ser num&eacute;rico (punto para decimales)', ''),
(421, 3191, 1, 'true', 'Campo obligatorio', ''),
(422, 3191, 12, 'true', 'campo num&eacute;rico (Punto para decimales)', '');
...
CREATE TABLE IF NOT EXISTS `sth_report` (
  ...
  PRIMARY KEY (`rept_id`),
  UNIQUE KEY `sth_report_rept_aleatunico_key` (`rept_aleatunico`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `sth_reportdetalle` (
  `reptdet_id` int(11) NOT NULL AUTO_INCREMENT,
  `rept_id` int(11) NOT NULL,
  `reptdet_tabla` text,
  `reptdet_campo` text,
  PRIMARY KEY (`reptdet_id`)
...
--
-- Estructura para la vista `beko_usuario_vista`
--
DROP TABLE IF EXISTS `beko_usuario_vista`;

CREATE  VIEW `beko_usuario_vista` AS select `beko_usuario`.`usua_id` AS `usua_id`,`beko_usuario`.`emp_id` AS `emp_id`,`beko_empresa`.`emp_nombre` AS `emp_nombre`,`beko_tipopersonal`.`tipo_id` AS `tipo_id`,`beko_tipopersonal`.`tipo_nombre` AS `tipo_nombre`,`beko_usuario`.`usua_ciruc` AS `usua_ciruc`,`beko_usuario`.`usua_nombre` AS `usua_nombre`,`beko_usuario`.`usua_apellido` AS `usua_apellido`,`beko_usuario`.`usua_usuario` AS `usua_usuario`,`beko_usuario`.`usua_email` AS `usua_email`,`beko_usuario`.`usua_estado` AS `usua_estado`,`gogess_sino`.`etiqueta` AS `etiqueta`,`beko_usuario`.`usua_adm` AS `usua_adm` from (((`beko_usuario` join `gogess_sino` on((`beko_usuario`.`usua_estado` = `gogess_sino`.`value`))) join `beko_tipopersonal` on((`beko_usuario`.`tipo_id` = `beko_tipopersonal`.`tipo_id`))) join `beko_empresa` on((`beko_usuario`.`emp_id` = `beko_empresa`.`emp_id`)));
