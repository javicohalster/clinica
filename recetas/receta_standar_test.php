...
//echo $lista_servicios;
 ...
 if($rs_data)
 {
	  while (!$rs_data->EOF) {	
		...
		{
	    $plantra_indicaciones.=$rs_data->fields["plantra_indicaciones"]."<br>";
		}
	    $cuenta++;
        $tbl_listareceta.='<tr>';
...
$tbl_listareceta.='<tr><td bgcolor="#DFE9EE" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:7px" >INDICACIONES</td></tr>';
$tbl_listareceta.='<tr><td style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:8px" >'.$plantra_indicaciones.'</td></tr>';
$tbl_listareceta.='</table><br>';

//lee recetado

$lee_plantilla=str_replace("-receta-",utf8_decode($tbl_listareceta),$lee_plantilla);
