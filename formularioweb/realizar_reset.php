...
$autoriza_ingresox="select * from app_asisten where asite_email='".trim($email_recuperar)."'";
...
$valoralet=$asite_rucci.mt_rand(1,500);
...
echo "<center><br><br><br><b>Su clave temporal: </b>".$valoralet."</center>";
//actualiza
...
$formato_email="select email_titulo,email_texto from app_emailformato where email_id=2";
...
try {
$mail_asunto='RECUPERACION DE CLAVE - ALIANZA NORTE';
...
{
      echo "<center><br><br><br><b>Usuario no existe porfavor verifique el correo</center>";
