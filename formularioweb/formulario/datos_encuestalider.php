...
<div align="center">
         ...
         <div class="col-xs-12">
			...
			<button type="submit" class="mb-sm btn btn-primary" >ENVIAR INFORME</button>
...
';	
        ...
        @$funciones_cuandoguarda="$('#".@$divresultado."').html('".@$mensajege."')";
		 ...
		 $envia_data="";
		 $envia_data=" envio_email_form(result_insertado,'".$table."','Reporte enviado');
		    ";

$funcionextrag=$envia_data." "." abrir_standar('grid/grid_asistencia.php','divBody_lista',0,0,0,0,0,0,0); ";
//abrir_standar('grid/grid_asistencia.php','divBody_lista',0,0,0,0,0,0,0);
  		$template_reemplazo='templateformsweb/maestro_standar_encuesta/';
?>	
<style>
label.error{
color:red;
...
function envio_email_form(idinsertado,formu_id,mensaje)
{
	
	
	$("#divBody_envioemail").load("aplicativos/modulos_standar/standar_envio.php",{
...
<div class="alert alert-success"> <B>ENCUESTA E INFORME</B> </div>
