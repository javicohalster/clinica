...
<head>
	...
	<title>PICHINCHA HUMANA- FORMULARIO DE REGISTRO - AGENDAMIENTO VIA WEB</title>
...
<div data-role="page" id="home">
	...
	<div data-role="header" data-position="inline">
		...
		<h1>PICHINCHA HUMANA - AGENDAMIENTO DE CITAS M&Eacute;DICAS</h1>
...
$query = <<<QUERY
    ...
    WHERE prof_id in (select prof.prof_id from app_usuario us inner join dns_gridfuncionprofesional espe on us.usua_enlace=espe.usua_enlace inner join pichinchahumana_extension.dns_profesion prof on espe.prof_id=prof.prof_id where prof.prof_id not in (38,777,888,911116,77))  order by prof_nombre asc
QUERY;
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td><a href="https://api.whatsapp.com/send?phone=593992524221&text=Bienvenidos%20Pichincha%20Humana%20te%20saluda" target="_blank"><img src="images/whatsapp.png?sn=<?php echo date("YmnHis"); ?>" width="50" height="50" /></a></td>
