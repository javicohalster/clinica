...
mysql_connect($server, $db_user, $db_pass) or die ("iba_online Database CONNECT Error");                                                                   
mysql_db_query($database, "INSERT INTO iba_online VALUES ('$timestamp','$REMOTE_ADDR','$PHP_SELF')") or die("iba_online Database INSERT Error"); 
mysql_db_query($database, "DELETE FROM iba_online WHERE timestamp<$timeout") or die("iba_online Database DELETE Error");
$result=mysql_db_query($database, "SELECT DISTINCT ip FROM iba_online WHERE file='$PHP_SELF'") or die("iba_online Database SELECT Error");
