...
{
  $selecTabla="select * from iba_sistable where iba_sistable.tab_name like '".$table."' and fie_active=1";    
  $resultado = mysql_query($selecTabla);
  if ($resultado)
  {
  		while($row = mysql_fetch_array($resultado)) 
...
{
  $selecTabla="select * from iba_sistable where tab_name like '".$table."'";   
  $resultado = mysql_query($selecTabla);
  if ($resultado)
  {
