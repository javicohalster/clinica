		  ...
		  else
           {
             ...
             { 
             ...
             else
              {
				...
				{
				  printf("<tr><td valign='top'><div  class='%s'>%s</div></td><td></td><td><div  class='%s'> %s</div></td><td class='txtextra'><input name='%s' type='text' class='%s'  value='%s' maxlength='%s' %s size='%s' %s readonly=0> %s</td></tr>",$this->fie_style,$this->fie_title,$this->fie_style,$this->fie_txtizq,$nombre_campo,$this->fie_styleobj,$this->fie_value,$len,$this->fie_attrib,$this->fie_lencampo,$tabindx,$this->fie_txtextra);
