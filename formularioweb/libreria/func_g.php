  ...
  switch ($opcion) 
	{
     case "guardar":
      {
			...
			$objformulario->idingreso=$idingreso;
		
			
            $objformulario->formulario_guardar($table,$_POST,$typesql,$varsend,$listab,$campo,$obp);
     ...
     case "actualizar":
      {            
			...
			$objformulario->opcp=$opcp;  
			$objformulario->idingreso=$idingreso;
             $objformulario->formulario_update($table,$_POST,$typesql,$idab,$varsend,$listab,$campo,$obp);
       }
     case "buscar":
      {
