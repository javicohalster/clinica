...
<head>
	...
	<meta http-equiv="Refresh" content="1;URL=fichaingreso.php" />
...
<div data-role="page" id="home">
	...
	<div data-role="header" data-position="inline">
		...
		<h1>PICHINCHA HUMANA - FICHA DE INGRESO</h1>
...
<table>
    <tr>
        <td><img  id="u3700" src="images/logohome.png?crc=<?php echo date("YmdHis"); ?>" alt=""  ></td>
        <td><img src="images/prefectura_pichincha.png?crc=<?php echo date("YmdHis"); ?>" alt=""  ></td>
    </tr>
</table>
...
<center><b><div style="font-size:17px" >FICHA DE INGRESO</div></b></center>
...

{
   ...
   $("#formulario_id").load("formulario/datos_discipulado.php",{
