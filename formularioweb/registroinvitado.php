...
<?php
//busca banner
$lista_banner="select * from app_banner where bann_activo=1 and tipb_id=3 order by bann_id desc";
...
<center><b>BASE DE DATOS</b></center>
...
function ver_formulario()
{
   ...
   $("#formulario_id").load("formulario/datos_invitado.php",{
