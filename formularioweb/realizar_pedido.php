...
$email_encargado=$rs_empdata->fields["emp_emailoracion"];

$inserta_reserva="insert into app_oracion (emp_id,asite_id,orac_pedido,orac_fecha) values ('".$emp_id."','".$asite_id."','".utf8_decode($orac_pedido)."','".$fecha_rserva."')";  
...
$contenido_val='<table width="26%" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td height="70" bgcolor="#FFFFFF"><br><div align="center"><b>PEDIDO DE ORACION</b> <BR> 
      <b>NOMBRE:</b> '.$rs_gogessformx->fields["asite_nombre"]." ".$rs_gogessformx->fields["asite_apellido"].'<BR> 
      <b>FECHA:</b> '.$fecha_rserva.'<br>
      <b>PEDIDO:</b> '.$orac_pedido.'<br>
    </div></td>
  </tr>
</table>';

echo "<br><br><center><b>SU PEDIDO DE ORACION FUE ENVIADO...</b></center>";
...
$formato_email="select email_titulo,email_texto from app_emailformato where email_id=16";
