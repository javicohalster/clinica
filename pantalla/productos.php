...
function desplegarencuadros($arreglolista,$border,$cellpadding,$cellspacing,$columnas)
{
	...
	$ib=0;
	$lista_productos="select * from app_producto where produ_activo=1 and emp_id=".$empresa_id;
 ...
 $cuadro_valor[$ib]='<table border="0" cellpadding="0" cellspacing="0" bgcolor="#D7E9EA">
  <tr>
    <td  style="cursor:pointer" onClick="asignar_quitar('.$comilla.$_POST["clie_idp"].$comilla.','.$comilla.$_POST["facttmp_codetempp"].$comilla.','.$rs_producto->fields["produ_id"].',1)"  ><img src="archivo/'.$nfoto.'" width="100" height="100" ></td>
  </tr>
  <tr>
